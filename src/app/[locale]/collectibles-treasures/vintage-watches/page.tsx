...
const topChoices = [
  { id:'tc1', title:'Longines Conquest 1962', price:8000, location:'Rabat', rating:4.7, reviews:15, image:'https://images.pexels.com/photos/1413420/pexels-photo-1413420.jpeg?auto=compress&w=400', desc:'Fine vintage Swiss timepieces — Omega, Longines, Zenith and rare independents from Morocco\'s most discerning collectors.' },
  { id:'tc2', title:'Omega Seamaster Vintage', price:15500, location:'Casablanca', rating:4.8, reviews:23, image:'https://images.pexels.com/photos/277390/pexels-photo-277390.jpeg?auto=compress&w=400', desc:'Fine vintage Swiss timepieces — Omega, Longines, Zenith and rare independents from Morocco\'s most discerning collectors.' },
  { id:'tc3', title:'Zenith El Primero 1969', price:23000, location:'Marrakech', rating:4.9, reviews:31, image:'https://images.pexels.com/photos/265804/pexels-photo-265804.jpeg?auto=compress&w=400', desc:'Fine vintage Swiss timepieces — Omega, Longines, Zenith and rare independents from Morocco\'s most discerning collectors.' },
]
const bentoListings = [
  { id:'bc1', title:'Tissot Seastar 1960s', price:3000, location:'Marrakech', image:'https://images.pexels.com/photos/1413420/pexels-photo-1413420.jpeg?auto=compress&w=400' },
  { id:'bc2', title:'Rado Golden Horse', price:7200, location:'Fès', image:'https://images.pexels.com/photos/277390/pexels-photo-277390.jpeg?auto=compress&w=400' },
  { id:'bc3', title:'Breitling Premier 1945', price:11400, location:'Tangier', image:'https://images.pexels.com/photos/265804/pexels-photo-265804.jpeg?auto=compress&w=400' },
  { id:'bc4', title:'Movado Museum Dial', price:15600, location:'Agadir', image:'https://images.pexels.com/photos/690154/pexels-photo-690154.jpeg?auto=compress&w=400' },
  { id:'bc5', title:'Universal Geneve', price:19800, location:'Meknès', image:'https://images.pexels.com/photos/1413420/pexels-photo-1413420.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'dc1', title:'Longines Conquest 1962', price:1500, location:'Rabat', image:'https://images.pexels.com/photos/1413420/pexels-photo-1413420.jpeg?auto=compress&w=400' },
  { id:'dc2', title:'Omega Seamaster Vintage', price:4300, location:'Casablanca', image:'https://images.pexels.com/photos/277390/pexels-photo-277390.jpeg?auto=compress&w=400' },
  { id:'dc3', title:'Zenith El Primero 1969', price:7100, location:'Marrakech', image:'https://images.pexels.com/photos/265804/pexels-photo-265804.jpeg?auto=compress&w=400' },
  { id:'dc4', title:'Tissot Seastar 1960s', price:9900, location:'Fès', image:'https://images.pexels.com/photos/690154/pexels-photo-690154.jpeg?auto=compress&w=400' },
  { id:'dc5', title:'Rado Golden Horse', price:12700, location:'Tangier', image:'https://images.pexels.com/photos/1413420/pexels-photo-1413420.jpeg?auto=compress&w=400' },
  { id:'dc6', title:'Breitling Premier 1945', price:15500, location:'Agadir', image:'https://images.pexels.com/photos/277390/pexels-photo-277390.jpeg?auto=compress&w=400' },
  { id:'dc7', title:'Movado Museum Dial', price:18300, location:'Meknès', image:'https://images.pexels.com/photos/265804/pexels-photo-265804.jpeg?auto=compress&w=400' },
  { id:'dc8', title:'Universal Geneve', price:21100, location:'Chefchaouen', image:'https://images.pexels.com/photos/690154/pexels-photo-690154.jpeg?auto=compress&w=400' },
]
...
export default function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const [activePill, setActivePill] = useState('Vintage Watches')
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Vintage Watches' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>⌚ Vintage Watches</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Fine vintage Swiss timepieces — Omega, Longines, Zenith and rare independents fr...</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>⌚ Vintage Watches</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Fine vintage Swiss timepieces — Omega, Longines, Zenith and ...</p>
          ...
          {ALL_SUBCATS.map(cat=>(
            <Link key={cat.slug} href={`/${locale}/collectibles-treasures/${cat.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'8px 18px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: cat.slug==='vintage-watches' ? '#161d1b' : 'white',
                color: cat.slug==='vintage-watches' ? 'white' : '#6b7a76',
                borderColor: cat.slug==='vintage-watches' ? '#161d1b' : 'rgba(186,202,197,0.4)',
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Vintage Watches Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Vintage Watches</h2>
        ...
        <CategoryFooterNav
          ...
          related={ALL_SUBCATS.filter(c=>c.slug!=='vintage-watches').slice(0,8).map(c=>({ label:c.label, href:`/${locale}/collectibles-treasures/${c.slug}`, emoji:c.emoji }))}
