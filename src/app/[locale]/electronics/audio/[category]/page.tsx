...
const CATS: Record<string,{ label:string; hero:string; desc:string; count:string; models:string[]; priceRanges:string[] }> = {
  'all-audio': { label:'All Audio', hero:'https://images.pexels.com/photos/374720/pexels-photo-374720.jpeg?auto=compress&w=1600', desc:'Browse the complete SouKni audio equipment collection.', count:'3,840',
    models:['AirPods Pro 2','WH-1000XM5','HomePod','Marshall Acton III','Shure SM7B','Pioneer DDJ-1000'], priceRanges:['Any Price','0 – 500 MAD','500 – 1,500 MAD','1,500 – 4,000 MAD','4,000+ MAD'] },
  'headphones': { label:'Headphones', hero:'https://images.pexels.com/photos/374720/pexels-photo-374720.jpeg?auto=compress&w=1600', desc:'Over-ear and on-ear headphones for every listening style.', count:'980',
    models:['Sony WH-1000XM5','Bose QuietComfort Ultra','Sennheiser Momentum 4','AirPods Max','Beats Studio Pro'], priceRanges:['Any Price','0 – 800 MAD','800 – 2,000 MAD','2,000 – 4,500 MAD','4,500+ MAD'] },
  'earbuds': { label:'Earbuds', hero:'https://images.pexels.com/photos/3945667/pexels-photo-3945667.jpeg?auto=compress&w=1600', desc:'True wireless earbuds with premium sound and ANC.', count:'1,240',
    models:['AirPods Pro 2','Galaxy Buds 3 Pro','Sony WF-1000XM5','Bose QuietComfort Earbuds II','Pixel Buds Pro'], priceRanges:['Any Price','0 – 400 MAD','400 – 1,000 MAD','1,000 – 2,500 MAD','2,500+ MAD'] },
  'speakers': { label:'Speakers', hero:'https://images.pexels.com/photos/1279107/pexels-photo-1279107.jpeg?auto=compress&w=1600', desc:'Portable and home speakers from Bluetooth to smart audio.', count:'720',
    models:['HomePod 2nd Gen','Marshall Acton III','Sonos Era 300','JBL Charge 5','Bose SoundLink Max'], priceRanges:['Any Price','0 – 500 MAD','500 – 1,500 MAD','1,500 – 4,000 MAD','4,000+ MAD'] },
  'hifi-systems': { label:'HiFi Systems', hero:'https://images.pexels.com/photos/374720/pexels-photo-374720.jpeg?auto=compress&w=1600', desc:'High-fidelity audio systems for audiophiles.', count:'186',
    models:['Denon PMA-900HNE','Marantz Model 40n','Klipsch RP-8000F','Yamaha R-N800A'], priceRanges:['Any Price','0 – 4,000 MAD','4,000 – 10,000 MAD','10,000 – 20,000 MAD','20,000+ MAD'] },
  'microphones': { label:'Microphones', hero:'https://images.pexels.com/photos/3945667/pexels-photo-3945667.jpeg?auto=compress&w=1600', desc:'Studio and podcast microphones for creators.', count:'340',
    models:['Shure SM7B','Rode NT1','Neumann U87','Blue Yeti X','Audio-Technica AT2020'], priceRanges:['Any Price','0 – 800 MAD','800 – 2,500 MAD','2,500 – 6,000 MAD','6,000+ MAD'] },
  'dj-equipment': { label:'DJ Equipment', hero:'https://images.pexels.com/photos/1279107/pexels-photo-1279107.jpeg?auto=compress&w=1600', desc:'DJ controllers, mixers and turntables for every setup.', count:'240',
    models:['Pioneer DDJ-1000','Pioneer CDJ-3000','Denon Prime 4+','Numark Mixtrack Pro FX','Rane Twelve'], priceRanges:['Any Price','0 – 3,000 MAD','3,000 – 8,000 MAD','8,000 – 18,000 MAD','18,000+ MAD'] },
}

const ALL_CATS = [
  { label:'All Audio', slug:'all-audio' }, { label:'Headphones', slug:'headphones' }, { label:'Earbuds', slug:'earbuds' },
  { label:'Speakers', slug:'speakers' }, { label:'HiFi Systems', slug:'hifi-systems' }, { label:'Microphones', slug:'microphones' }, { label:'DJ Equipment', slug:'dj-equipment' },
]

const IMGS = [
  'https://images.pexels.com/photos/374720/pexels-photo-374720.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/3945667/pexels-photo-3945667.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/1279107/pexels-photo-1279107.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/374720/pexels-photo-374720.jpeg?auto=compress&w=400',
]
    ...
    <article onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)}
      ...
      <div style={{ padding:'16px 18px', flex:1, display:'flex', flexDirection:'column' as const }}>
        ...
        <div style={{ marginTop:'auto', display:'flex', gap:'8px' }}>
          ...
          <a href="https://wa.me/212600000000?text=Hi%2C%20I%20found%20your%20audio%20listing%20on%20SouKni!" target="_blank" rel="noopener noreferrer"
...
function makeListings(cat: string, count: number) {
  const cd = CATS[cat] || CATS['all-audio']
  const brands = ['Apple','Sony','Bose','Sennheiser','JBL','Marshall','Shure','Pioneer DJ','Samsung','Bang & Olufsen']
  ...
  return Array.from({length:count},(_,i)=>({
    brand: brands[i%brands.length], title: cd.models[i%cd.models.length], price: 280 + ((i*1973)%8000),
...
export default function AudioCategoryPage() {
  ...
  const catSlug = (params?.category as string) || 'all-audio'
  const catData = CATS[catSlug] || CATS['all-audio']
  ...
  const brandsList = ['Apple','Sony','Bose','Sennheiser','JBL','Marshall','Shure','Pioneer DJ']
  const brandTiles = [
    { name:'Apple', image:'https://images.pexels.com/photos/1714207/pexels-photo-1714207.jpeg?auto=compress&w=600', count:'620' },
    { name:'Sony', image:'https://images.pexels.com/photos/3394650/pexels-photo-3394650.jpeg?auto=compress&w=600', count:'540' },
    { name:'Bose', image:'https://images.pexels.com/photos/1649771/pexels-photo-1649771.jpeg?auto=compress&w=600', count:'480' },
    { name:'Sennheiser', image:'https://images.pexels.com/photos/1714208/pexels-photo-1714208.jpeg?auto=compress&w=600', count:'410' },
    { name:'JBL', image:'https://images.pexels.com/photos/1714209/pexels-photo-1714209.jpeg?auto=compress&w=600', count:'380' },
    { name:'Marshall', image:'https://images.pexels.com/photos/3394650/pexels-photo-3394650.jpeg?auto=compress&w=600', count:'290' },
    { name:'Shure', image:'https://images.pexels.com/photos/1714207/pexels-photo-1714207.jpeg?auto=compress&w=600', count:'260' },
    { name:'Pioneer DJ', image:'https://images.pexels.com/photos/1649771/pexels-photo-1649771.jpeg?auto=compress&w=600', count:'230' },
  ]
    ...
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'360px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center' as const, maxWidth:'860px', padding:'0 24px', width:'100%' }}>
          <p style={{ fontSize:'11px', ...UB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.2em', marginBottom:'12px' }}>ELECTRONICS › AUDIO</p>
      ...
      <main style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 24px 80px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'10px', ...UB, color:C.muted, textTransform:'uppercase' as const, letterSpacing:'0.12em', marginBottom:'12px' }}>
          {[{label:'Rabat',href:`/${locale}`},{label:'Electronics',href:`/${locale}/electronics`},{label:'Audio',href:`/${locale}/electronics/audio`},{label:catData.label,href:null}].map((c,i,arr)=>(
        ...
        <div style={{ display:'flex', gap:'10px', flexWrap:'wrap' as const, marginBottom:'20px' }}>
          {ALL_CATS.map(cat=>(
            <Link key={cat.slug} href={`/${locale}/electronics/audio/${cat.slug}`}
        ...
        <section style={{ marginBottom:32 }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:`repeat(${Math.min(brandTiles.length,7)},1fr)`, gap:12 }}>
            {brandTiles.map(brand=>(
              <Link key={brand.name} href={`/${locale}/electronics/audio/${catSlug}/${brand.name.toLowerCase().replace(/\s+/g,'-').replace(/[^a-z0-9-]/g,'')}`} style={{ textDecoration:'none' }}>
        ...
        <section style={{ marginBottom:'48px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'14px' }}>
            {ALL_CATS.filter(c=>c.slug!==catSlug).slice(0,8).map(c=>(
              <Link key={c.slug} href={`/${locale}/electronics/audio/${c.slug}`}
        ...
        <div style={{ textAlign:'center' as const }}>
          <Link href={`/${locale}/electronics/audio`} style={{ display:'inline-flex', alignItems:'center', gap:'8px', padding:'16px 40px', borderRadius:'100px', backgroundColor:C.ink, color:'white', textDecoration:'none', fontSize:'12px', ...UB, textTransform:'uppercase' as const, letterSpacing:'0.1em' }}>← Back to All Audio</Link>
        </div>
      </main>
    </div>
  )
