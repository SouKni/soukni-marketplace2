...
const CATS: Record<string,{ label:string; hero:string; desc:string; count:string; models:string[]; priceRanges:string[] }> = {
  'all-cameras': { label:'All Cameras', hero:'https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&w=1600', desc:'Browse the complete SouKni cameras and imaging collection.', count:'2,180',
    models:['Sony A7 IV','Canon EOS R5','Nikon Z8','RED Komodo 6K','DJI Mavic 3 Pro','GoPro Hero 12'], priceRanges:['Any Price','0 – 3,000 MAD','3,000 – 10,000 MAD','10,000 – 25,000 MAD','25,000+ MAD'] },
  'mirrorless': { label:'Mirrorless', hero:'https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&w=1600', desc:'Compact mirrorless cameras with pro-level image quality.', count:'640',
    models:['Sony A7 IV','Canon EOS R6 Mark II','Nikon Z8','Fujifilm X-T5','Panasonic Lumix S5 II'], priceRanges:['Any Price','0 – 8,000 MAD','8,000 – 18,000 MAD','18,000 – 32,000 MAD','32,000+ MAD'] },
  'dslrs': { label:'DSLRs', hero:'https://images.pexels.com/photos/51383/photo-camera-subject-photographer-51383.jpeg?auto=compress&w=1600', desc:'Classic DSLR cameras for reliable, budget-friendly photography.', count:'480',
    models:['Canon EOS 5D Mark IV','Nikon D850','Canon EOS 90D','Nikon D780'], priceRanges:['Any Price','0 – 5,000 MAD','5,000 – 12,000 MAD','12,000 – 22,000 MAD','22,000+ MAD'] },
  'cinema-cameras': { label:'Cinema Cameras', hero:'https://images.pexels.com/photos/2510428/pexels-photo-2510428.jpeg?auto=compress&w=1600', desc:'Professional cinema cameras for filmmaking.', count:'140',
    models:['RED Komodo 6K','Blackmagic URSA Mini Pro','Sony FX6','Canon C70'], priceRanges:['Any Price','0 – 20,000 MAD','20,000 – 45,000 MAD','45,000 – 90,000 MAD','90,000+ MAD'] },
  'lenses': { label:'Lenses', hero:'https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&w=1600', desc:'Prime and zoom lenses for every mount and focal length.', count:'520',
    models:['Sony 24-70mm f/2.8 GM','Canon RF 50mm f/1.2L','Sigma 85mm Art','Nikon Z 70-200mm f/2.8'], priceRanges:['Any Price','0 – 3,000 MAD','3,000 – 8,000 MAD','8,000 – 15,000 MAD','15,000+ MAD'] },
  'drones': { label:'Drones', hero:'https://images.pexels.com/photos/336232/pexels-photo-336232.jpeg?auto=compress&w=1600', desc:'Aerial drones for photography, video, and inspection.', count:'260',
    models:['DJI Mavic 3 Pro','DJI Air 3','DJI Mini 4 Pro','DJI Inspire 3'], priceRanges:['Any Price','0 – 4,000 MAD','4,000 – 10,000 MAD','10,000 – 20,000 MAD','20,000+ MAD'] },
  'action-cameras': { label:'Action Cameras', hero:'https://images.pexels.com/photos/2510428/pexels-photo-2510428.jpeg?auto=compress&w=1600', desc:'Rugged action cams for sports, travel, and adventure.', count:'340',
    models:['GoPro Hero 12','DJI Osmo Action 4','Insta360 X4','GoPro Hero 11 Mini'], priceRanges:['Any Price','0 – 1,500 MAD','1,500 – 3,500 MAD','3,500 – 6,000 MAD','6,000+ MAD'] },
}

const ALL_CATS = [
  { label:'All Cameras', slug:'all-cameras' }, { label:'Mirrorless', slug:'mirrorless' }, { label:'DSLRs', slug:'dslrs' },
  { label:'Cinema Cameras', slug:'cinema-cameras' }, { label:'Lenses', slug:'lenses' }, { label:'Drones', slug:'drones' }, { label:'Action Cameras', slug:'action-cameras' },
]

const IMGS = [
  'https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/51383/photo-camera-subject-photographer-51383.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/2510428/pexels-photo-2510428.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/336232/pexels-photo-336232.jpeg?auto=compress&w=400',
]
    ...
    <article onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)}
      ...
      <div style={{ padding:'16px 18px', flex:1, display:'flex', flexDirection:'column' as const }}>
        ...
        <div style={{ marginTop:'auto', display:'flex', gap:'8px' }}>
          ...
          <a href="https://wa.me/212600000000?text=Hi%2C%20I%20found%20your%20camera%20listing%20on%20SouKni!" target="_blank" rel="noopener noreferrer"
...
function makeListings(cat: string, count: number) {
  const cd = CATS[cat] || CATS['all-cameras']
  const brands = ['Sony','Canon','Nikon','Fujifilm','Panasonic','RED','DJI','GoPro','Blackmagic','Insta360']
  ...
  return Array.from({length:count},(_,i)=>({
    brand: brands[i%brands.length], title: cd.models[i%cd.models.length], price: 1200 + ((i*1973)%22000),
    location: locs[i%locs.length], condition: conds[i%conds.length], img: IMGS[i%IMGS.length], badge: badges[i%badges.length],
  }))
}

export default function CamerasCategoryPage() {
  const params = useParams()
  const locale = (params?.locale as string) || 'en'
  const catSlug = (params?.category as string) || 'all-cameras'
  const catData = CATS[catSlug] || CATS['all-cameras']
  ...
  const brandTiles = [
    { name:'Sony', image:'https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&w=600', count:'560' },
    { name:'Canon', image:'https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&w=600', count:'480' },
    { name:'Nikon', image:'https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&w=600', count:'420' },
    { name:'Fujifilm', image:'https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&w=600', count:'310' },
    { name:'Panasonic', image:'https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&w=600', count:'260' },
    { name:'RED', image:'https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&w=600', count:'150' },
    { name:'DJI', image:'https://images.pexels.com/photos/1697912/pexels-photo-1697912.jpeg?auto=compress&w=600', count:'390' },
    { name:'GoPro', image:'https://images.pexels.com/photos/1697912/pexels-photo-1697912.jpeg?auto=compress&w=600', count:'420' },
    { name:'Blackmagic', image:'https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&w=600', count:'120' },
    { name:'Insta360', image:'https://images.pexels.com/photos/1697912/pexels-photo-1697912.jpeg?auto=compress&w=600', count:'210' },
  ]
    ...
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'360px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center' as const, maxWidth:'860px', padding:'0 24px', width:'100%' }}>
          <p style={{ fontSize:'11px', ...UB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.2em', marginBottom:'12px' }}>ELECTRONICS › CAMERAS</p>
      ...
      <main style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 24px 80px' }}>
        ...
        <section style={{ marginBottom:32 }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:`repeat(${Math.min(brandTiles.length,7)},1fr)`, gap:12 }}>
            {brandTiles.map(brand=>(
              <Link key={brand.name} href={`/${locale}/electronics/cameras/${catSlug}/${brand.name.toLowerCase().replace(/\s+/g,'-').replace(/[^a-z0-9-]/g,'')}`} style={{ textDecoration:'none' }}>
        ...
        <section style={{ marginBottom:'48px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'14px' }}>
            {ALL_CATS.filter(c=>c.slug!==catSlug).slice(0,8).map(c=>(
              <Link key={c.slug} href={`/${locale}/electronics/cameras/${c.slug}`}
        ...
        <div style={{ textAlign:'center' as const }}>
          <Link href={`/${locale}/electronics/cameras`} style={{ display:'inline-flex', alignItems:'center', gap:'8px', padding:'16px 40px', borderRadius:'100px', backgroundColor:C.ink, color:'white', textDecoration:'none', fontSize:'12px', ...UB, textTransform:'uppercase' as const, letterSpacing:'0.1em' }}>← Back to All Cameras</Link>
        </div>
      </main>
    </div>
  )
