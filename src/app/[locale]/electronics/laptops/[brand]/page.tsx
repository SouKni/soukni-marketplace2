...
function ListingCard({ id, brand, title, price, location, condition, img, badge, specs, phone, sellerId }: any) {
  ...
  return (
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      ...
      <main style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 24px 80px' }}>
        <Breadcrumb
          items={[{label:'Rabat',href:`/${locale}`},{label:'Electronics',href:`/${locale}/electronics`},{label:'Laptops',href:`/${locale}/electronics/laptops`},{label:brandData.label,href:null}]}
          mutedColor={C.muted}
          inkColor={C.ink}
        />
