...
const BRANDS: Record<string,{ label:string; hero:string; desc:string; count:string; models:string[]; priceRanges:string[] }> = {
  'all-laptops': { label:'All Laptops', hero:'https://images.pexels.com/photos/18105/pexels-photo.jpg?auto=compress&w=1600', desc:'Browse the complete SouKni laptops collection.', count:'4,218',
    models:['MacBook Pro M4 Max','ThinkPad X1 Carbon','XPS 15','ROG Zephyrus G16','Blade 16','Surface Laptop 7'],
    priceRanges:['Any Price','0 – 5,000 MAD','5,000 – 15,000 MAD','15,000 – 30,000 MAD','30,000 – 50,000 MAD','50,000+ MAD'] },
  'apple': { label:'Apple', hero:'https://images.pexels.com/photos/18105/pexels-photo.jpg?auto=compress&w=1600', desc:'MacBook Pro and Air models with M-series chips.', count:'980',
    models:['MacBook Pro 16" M4 Max','MacBook Pro 14" M3 Pro','MacBook Air 15" M3','MacBook Air 13" M2','MacBook Pro 13"'],
    priceRanges:['Any Price','0 – 10,000 MAD','10,000 – 20,000 MAD','20,000 – 35,000 MAD','35,000+ MAD'] },
  'hp': { label:'HP', hero:'https://images.pexels.com/photos/205421/pexels-photo-205421.jpeg?auto=compress&w=1600', desc:'HP Spectre, Envy and Pavilion laptops for every need.', count:'620',
    models:['Spectre x360 14"','Envy 16" RTX 4060','Pavilion Plus 14"','Omen 16 Gaming','EliteBook 840'],
    priceRanges:['Any Price','0 – 5,000 MAD','5,000 – 12,000 MAD','12,000 – 22,000 MAD','22,000+ MAD'] },
  'lenovo': { label:'Lenovo', hero:'https://images.pexels.com/photos/1229861/pexels-photo-1229861.jpeg?auto=compress&w=1600', desc:'ThinkPad and Legion laptops for business and gaming.', count:'540',
    models:['ThinkPad X1 Carbon Gen 12','Legion Pro 5i','Yoga 9i 2-in-1','IdeaPad Slim 5','ThinkBook 14'],
    priceRanges:['Any Price','0 – 5,000 MAD','5,000 – 12,000 MAD','12,000 – 22,000 MAD','22,000+ MAD'] },
  'dell': { label:'Dell', hero:'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&w=1600', desc:'XPS and Latitude laptops built for performance.', count:'480',
    models:['XPS 15 (9530)','XPS 13 Plus','Latitude 9440','Inspiron 16 Plus','Alienware m16'],
    priceRanges:['Any Price','0 – 5,000 MAD','5,000 – 14,000 MAD','14,000 – 25,000 MAD','25,000+ MAD'] },
  'asus': { label:'ASUS', hero:'https://images.pexels.com/photos/1229861/pexels-photo-1229861.jpeg?auto=compress&w=1600', desc:'ROG gaming laptops and Zenbook ultrabooks.', count:'420',
    models:['ROG Zephyrus G16','ROG Strix Scar 18','Zenbook 14 OLED','TUF Gaming A15','Vivobook Pro 16'],
    priceRanges:['Any Price','0 – 5,000 MAD','5,000 – 12,000 MAD','12,000 – 22,000 MAD','22,000+ MAD'] },
  'msi': { label:'MSI', hero:'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&w=1600', desc:'MSI gaming and creator laptops with top-tier GPUs.', count:'260',
    models:['Titan 18 HX','Raider GE78','Stealth 16','Creator Z16','Katana 15'],
    priceRanges:['Any Price','0 – 10,000 MAD','10,000 – 20,000 MAD','20,000 – 40,000 MAD','40,000+ MAD'] },
  'razer': { label:'Razer', hero:'https://images.pexels.com/photos/205421/pexels-photo-205421.jpeg?auto=compress&w=1600', desc:'Blade laptops — premium build with flagship gaming power.', count:'220',
    models:['Blade 16 RTX 4090','Blade 14 RTX 4070','Blade 15 RTX 4060'],
    priceRanges:['Any Price','0 – 15,000 MAD','15,000 – 25,000 MAD','25,000 – 40,000 MAD','40,000+ MAD'] },
}

const ALL_BRANDS = [
  { label:'All Laptops', slug:'all-laptops' }, { label:'Apple', slug:'apple' }, { label:'HP', slug:'hp' },
  { label:'Lenovo', slug:'lenovo' }, { label:'Dell', slug:'dell' }, { label:'ASUS', slug:'asus' }, { label:'MSI', slug:'msi' }, { label:'Razer', slug:'razer' },
]

const IMGS = [
  'https://images.pexels.com/photos/18105/pexels-photo.jpg?auto=compress&w=400',
  'https://images.pexels.com/photos/205421/pexels-photo-205421.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/1229861/pexels-photo-1229861.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&w=400',
]
...
function ListingCard({ brand, title, price, location, condition, img, badge, specs }: any) {
    ...
    <article onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)}
      ...
      <div style={{ padding:'16px 18px', flex:1, display:'flex', flexDirection:'column' as const }}>
        ...
        <div style={{ marginTop:'auto', display:'flex', gap:'8px' }}>
          ...
          <a href="https://wa.me/212600000000?text=Hi%2C%20I%20found%20your%20laptop%20listing%20on%20SouKni!" target="_blank" rel="noopener noreferrer"
...
function makeListings(brand: string, count: number) {
  const bd = BRANDS[brand] || BRANDS['all-laptops']
  ...
  const specsList = ['16GB / 512GB SSD','32GB / 1TB SSD','8GB / 256GB SSD','64GB / 2TB SSD','16GB / 1TB SSD']
  return Array.from({length:count},(_,i)=>({
    brand: bd.label, title: bd.models[i%bd.models.length], price: 3500 + ((i*2731)%42000),
...
export default function LaptopBrandPage() {
  const params = useParams()
  const locale = (params?.locale as string) || 'en'
  const brandSlug = (params?.brand as string) || 'all-laptops'
  const brandData = BRANDS[brandSlug] || BRANDS['all-laptops']
    ...
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'360px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center' as const, maxWidth:'860px', padding:'0 24px', width:'100%' }}>
          <p style={{ fontSize:'11px', ...UB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.2em', marginBottom:'12px' }}>ELECTRONICS › LAPTOPS</p>
          <h1 style={{ fontSize:'clamp(32px,5vw,52px)', ...UB, color:'white', marginBottom:'16px', lineHeight:1.05, textShadow:'0 4px 20px rgba(0,0,0,0.4)' }}>{brandData.label} Laptops in Rabat</h1>
      ...
      <main style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 24px 80px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'10px', ...UB, color:C.muted, textTransform:'uppercase' as const, letterSpacing:'0.12em', marginBottom:'12px' }}>
          {[{label:'Rabat',href:`/${locale}`},{label:'Electronics',href:`/${locale}/electronics`},{label:'Laptops',href:`/${locale}/electronics/laptops`},{label:brandData.label,href:null}].map((c,i,arr)=>(
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:'16px', marginBottom:'24px', flexWrap:'wrap' as const }}>
          <div>
            <h2 style={{ fontSize:'clamp(20px,2.5vw,28px)', ...UB, color:C.ink, marginBottom:'4px' }}>{brandData.label} Laptops for Sale in Rabat</h2>
        ...
        <div style={{ display:'flex', gap:'10px', flexWrap:'wrap' as const, marginBottom:'20px' }}>
          {ALL_BRANDS.map(b=>(
            <Link key={b.slug} href={`/${locale}/electronics/laptops/${b.slug}`}
        ...
        <div style={{ textAlign:'center' as const }}>
          <Link href={`/${locale}/electronics/laptops`} style={{ display:'inline-flex', alignItems:'center', gap:'8px', padding:'16px 40px', borderRadius:'100px', backgroundColor:C.ink, color:'white', textDecoration:'none', fontSize:'12px', ...UB, textTransform:'uppercase' as const, letterSpacing:'0.1em' }}>← Back to All Laptops</Link>
        </div>
      </main>
    </div>
  )
