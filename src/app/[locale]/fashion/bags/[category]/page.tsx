...
function ListingCard({ id, brand, title, price, location, condition, img, badge, style, phone, sellerId }: any) {
                  ...
                  <div style={{ flex:1, padding:'16px 20px', display:'flex', flexDirection:'column' as const, justifyContent:'space-between' }}>
                    ...
                    <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center' }}>
                      ...
                      <div style={{ display:'flex', gap:'8px' }}>
                        <MessageSellerButton listingId={undefined} sellerId={undefined} style={{ padding:'8px 16px', borderRadius:'10px', border:`1px solid ${C.ink}`, backgroundColor:'transparent', color:C.ink, fontSize:'10px', ...CB, cursor:'pointer' }}>Message</MessageSellerButton>
