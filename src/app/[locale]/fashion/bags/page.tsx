...
function FeaturedCard({ id, brand, title, price, location, img, badges, style, phone, sellerId }: any) {
...
function GridCard({ id, brand, title, price, img, badge, style, phone, sellerId }: any) {
  const { isFavorited, toggleFavorite } = useFavorites()
  const saved = isFavorited(id)
  const [hov,   setHov  ] = useState(false)
  return (
  ...
  return (
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      ...
      <main style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 24px 80px' }}>
        ...
        <FashionBreadcrumb pageLabel="Bags & Handbags" />
        ...
        <FashionCrossNav currentSlug="bags" />
