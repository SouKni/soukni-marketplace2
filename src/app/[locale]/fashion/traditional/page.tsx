...
import { FashionBreadcrumb } from '@/components/ui/FashionPageWrapper'
...
const I = {
  ...
  t1:      'https://images.pexels.com/photos/2220316/pexels-photo-2220316.jpeg?auto=compress&w=600',
  t2:      'https://images.pexels.com/photos/1536619/pexels-photo-1536619.jpeg?auto=compress&w=600',
  t3:      'https://images.pexels.com/photos/5935748/pexels-photo-5935748.jpeg?auto=compress&w=600',
  t4:      'https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&w=600',
  bento1:  'https://images.pexels.com/photos/2220316/pexels-photo-2220316.jpeg?auto=compress&w=900',
  bento2:  'https://images.pexels.com/photos/1536619/pexels-photo-1536619.jpeg?auto=compress&w=600',
  bento3:  'https://images.pexels.com/photos/5935748/pexels-photo-5935748.jpeg?auto=compress&w=600',
  bento4:  'https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&w=600',
  ...
  g5:      'https://images.pexels.com/photos/2220316/pexels-photo-2220316.jpeg?auto=compress&w=400',
}
...
const featuredItems = [
  { brand:'Ziana Prestige',  title:'Takchita Royale — Broderie Main',  price:18500, location:'Rabat, Agdal',         img:I.t1, badges:['featured','diamond']   },
  { brand:'Maison Couture',  title:'Kaftan Soirée — Velours & Perles', price:12800, location:'Casablanca',           img:I.t2, badges:['featured','certified'] },
  { brand:"L'Artisan Rabat", title:'Djellaba Luxe — Laine Fine',       price:4200,  location:'Rabat, Souissi',       img:I.t3, badges:['featured','new']       },
  { brand:'Atelier Zineb',   title:'Gandoura Été — Soie Pure',         price:3600,  location:'Marrakech, Hivernage', img:I.t4, badges:['featured','certified'] },
]
      ...
      <section style={{ position:'relative', height:'520px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center' as const, maxWidth:'960px', padding:'0 24px', width:'100%' }}>
          <h1 style={{ fontSize:'clamp(36px,6vw,64px)', ...UB, color:'white', marginBottom:'36px', lineHeight:1, textShadow:'0 4px 20px rgba(0,0,0,0.4)' }}>
            TRADITIONAL MOROCCAN WEAR.<br/><span style={{ color:C.mint }}>HERITAGE IN RABAT.</span>
          </h1>
          <div style={{ maxWidth:'780px', margin:'0 auto', backgroundColor:'rgba(255,255,255,0.12)', backdropFilter:'blur(12px)', border:'1px solid rgba(255,255,255,0.22)', borderRadius:'100px', padding:'8px', display:'flex', alignItems:'center' }}>
            ...
            <button onClick={()=>router.push(`/${locale}/search?q=${encodeURIComponent(keyword)}`)}
              style={{ backgroundColor:C.mint, color:C.ink, border:'none', padding:'16px 44px', borderRadius:'100px', fontSize:'11px', ...UB, textTransform:'uppercase' as const, letterSpacing:'0.12em', cursor:'pointer' }}
            >SEARCH</button>
          </div>
        </div>
      </section>
      ...
      <main style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 24px 80px' }}>
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:'16px', marginBottom:'24px', flexWrap:'wrap' as const }}>
          <div>
            ...
            <p style={{ fontSize:'14px', color:C.mint, ...CB }}>1,680 Ads in Rabat District</p>
          </div>
        ...
        <section style={{ marginBottom:'48px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'24px' }}>
            <div>
              <h3 style={{ fontSize:'clamp(18px,2.5vw,24px)', ...UB, color:C.ink, textTransform:'uppercase' as const, marginBottom:'4px' }}>Featured Traditional Wear</h3>
              <p style={{ fontSize:'14px', color:C.muted }}>Handcrafted pieces from Morocco's finest ateliers</p>
            </div>
        ...
        {/* PRO TRADITIONAL GRID */}
        <section style={{ marginBottom:'48px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'28px' }}>
            <h3 style={{ fontSize:'clamp(18px,2.5vw,24px)', ...UB, color:C.ink, textTransform:'uppercase' as const }}>Pro Traditional Discoveries</h3>
