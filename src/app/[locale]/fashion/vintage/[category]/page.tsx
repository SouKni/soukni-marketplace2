...
function ListingCard({ id, brand, title, price, location, condition, img, badge, era, phone, sellerId }: any) {
...
export default function VintageCategoryPage() {
  ...
  function mapDbRowToCard(row: any) {
    return {
      ...
      era: row.subcategory || '',
      img: (row.images && row.images[0]) || VINTAGE_IMGS[0],
  ...
  const listings = React.useMemo(() => {
    ...
    return items
  }, [catSlug, keyword, activeEra, activeBrand, activeSeller, price, city, diamond, sortBy, hasRealData, dbListings])
  const PAGE_SIZE = 12
                  ...
                  <div style={{ flex:1, padding:'16px 20px', display:'flex', flexDirection:'column' as const, justifyContent:'space-between' }}>
                    ...
                    <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center' }}>
                      ...
                      <div style={{ display:'flex', gap:'8px' }}>
                        <MessageSellerButton listingId={undefined} sellerId={undefined} style={{ padding:'8px 16px', borderRadius:'10px', border:'1px solid #161d1b', backgroundColor:'transparent', color:'#161d1b', fontSize:'10px', cursor:'pointer' }}>Message</MessageSellerButton>
