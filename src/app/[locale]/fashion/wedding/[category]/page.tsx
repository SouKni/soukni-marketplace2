...
export default function WeddingCategoryPage() {
  ...
  function mapDbRowToCard(row: any) {
    return {
      ...
      img: (row.images && row.images[0]) || WEDDING_IMGS[0],
  ...
  const listings = React.useMemo(() => {
    ...
    return items
  }, [catSlug, keyword, activeBrand, activeSeller, price, city, diamond, sortBy, hasRealData, dbListings])
  const PAGE_SIZE = 12
