...
const I = {
  ...
  h1:      'https://images.pexels.com/photos/6865187/pexels-photo-6865187.jpeg?auto=compress&w=600',
  h2:      'https://images.pexels.com/photos/4700421/pexels-photo-4700421.jpeg?auto=compress&w=600',
  h3:      'https://images.pexels.com/photos/3321574/pexels-photo-3321574.jpeg?auto=compress&w=600',
  h4:      'https://images.pexels.com/photos/4700422/pexels-photo-4700422.jpeg?auto=compress&w=600',
  h5:      'https://images.pexels.com/photos/324028/pexels-photo-324028.jpeg?auto=compress&w=600',
  h6:      'https://images.pexels.com/photos/4518651/pexels-photo-4518651.jpeg?auto=compress&w=600',
  h7:      'https://images.pexels.com/photos/4397899/pexels-photo-4397899.jpeg?auto=compress&w=600',
  h8:      'https://images.pexels.com/photos/6316068/pexels-photo-6316068.jpeg?auto=compress&w=600',
  h9:      'https://images.pexels.com/photos/6782570/pexels-photo-6782570.jpeg?auto=compress&w=600',
  h10:     'https://images.pexels.com/photos/3689334/pexels-photo-3689334.jpeg?auto=compress&w=600',
  h11:     'https://images.pexels.com/photos/3935346/pexels-photo-3935346.jpeg?auto=compress&w=600',
  h12:     'https://images.pexels.com/photos/3407777/pexels-photo-3407777.jpeg?auto=compress&w=600',
  samsung: 'https://images.pexels.com/photos/6865187/pexels-photo-6865187.jpeg?auto=compress&w=600',
  lg:      'https://images.pexels.com/photos/4700421/pexels-photo-4700421.jpeg?auto=compress&w=600',
  bosch:   'https://images.pexels.com/photos/3321574/pexels-photo-3321574.jpeg?auto=compress&w=600',
  breville:'https://images.pexels.com/photos/324028/pexels-photo-324028.jpeg?auto=compress&w=600',
  kitchenaid:'https://images.pexels.com/photos/4518651/pexels-photo-4518651.jpeg?auto=compress&w=600',
  smeg:    'https://images.pexels.com/photos/6316068/pexels-photo-6316068.jpeg?auto=compress&w=600',
  dyson:   'https://images.pexels.com/photos/4397899/pexels-photo-4397899.jpeg?auto=compress&w=600',
...
const featuredListings: Listing[] = [
  ...
  { id:'w4', badge:'diamond',   title:'Samsung Bespoke AI Series Black Onyx',      price:9200,  location:'Rabat, Hassan',   time:'1h ago',   image:I.h4 },
  { id:'k1', badge:'certified', title:'Breville Barista Pro Espresso Machine',     price:7400,  location:'Casablanca',      time:'2h ago',   image:I.h5 },
  { id:'k2', badge:'pro',       title:'KitchenAid Artisan 4.8L Stand Mixer',      price:4900,  location:'Rabat, Agdal',    time:'3h ago',   image:I.h6 },
]

const exclusiveListings: Listing[] = [
  { id:'e1', badge:'diamond',   title:'Samsung Neo QLED 85" 8K Flagship TV',      price:45900, location:'Rabat, Hay Riad', time:'Just now', image:I.h9 },
  { id:'f1', badge:'diamond',   title:'Samsung Bespoke Family Hub Smart Fridge',   price:24500, location:'Rabat, Hay Riad', time:'1h ago',   image:I.h10 },
  { id:'e3', badge:'certified', title:'LG CineBeam 4K Laser Projector',            price:24900, location:'Rabat, Agdal',   time:'2h ago',   image:I.h3 },
  { id:'f2', badge:'certified', title:'LG InstaView Door-in-Door Side-by-Side',    price:22900, location:'Rabat, Souissi', time:'3h ago',   image:I.h11 },
]

const discoveryListings: Listing[] = [
  { id:'d1',  badge:'diamond',   title:'LG AI DD 10kg Steam Refresh Washer',       price:5800,  location:'Rabat, Hay Riad', time:'Just now', image:I.h2 },
  { id:'d2',  badge:'certified', title:'Bosch Series 8 HomeConnect WiFi Washer',   price:8500,  location:'Rabat, Agdal',   time:'1h ago',   image:I.h3 },
  { id:'d3',  badge:'pro',       title:'Ninja Foodi Dual Zone Air Fryer Digital',  price:2200,  location:'Casablanca',     time:'2h ago',   image:I.h7 },
  { id:'d4',  badge:'diamond',   title:'Smeg Retro Series Breakfast Set Cream',    price:3100,  location:'Rabat, Hassan',  time:'3h ago',   image:I.h8 },
  { id:'d5',  badge:'certified', title:'B&O Beosound Theatre Soundbar Premium',    price:38500, location:'Rabat, Souissi', time:'4h ago',   image:I.h9 },
  { id:'d6',  badge:'diamond',   title:'Apple Studio Display 27-inch 5K Retina',  price:19500, location:'Rabat, Hassan',  time:'5h ago',   image:I.h9 },
  { id:'d7',  badge:'pro',       title:'Vinotemp 50-Bottle Dual-Zone Wine Fridge', price:12500, location:'Rabat, Agdal',   time:'6h ago',   image:I.h12 },
  { id:'d8',  badge:'certified', title:'Bosch Series 6 NoFrost Bottom Freezer',   price:9800,  location:'Rabat, Hassan',  time:'7h ago',   image:I.h10 },
  { id:'d9',  badge:'diamond',   title:'Dyson V15 Detect Absolute Vacuum',        price:5200,  location:'Casablanca',     time:'8h ago',   image:I.h7 },
  { id:'d10', badge:'certified', title:'Nespresso Vertuo Next Coffee Machine',     price:1800,  location:'Rabat',          time:'9h ago',   image:I.h5 },
  { id:'d11', badge:'pro',       title:'iRobot Roomba j9+ Self-Emptying Robot',   price:7500,  location:'Marrakech',      time:'10h ago',  image:I.h8 },
  { id:'d12', badge:'diamond',   title:'Miele Complete C3 PowerLine Vacuum',      price:4200,  location:'Casablanca',     time:'11h ago',  image:I.h3 },
]

const pills = ['All Appliances','Washing Machines','Refrigerators','Kitchen Appliances','Air Conditioners','Vacuum Cleaners','Coffee Machines','View More']
...
export default function HomeAppliancesPage({ params }: { params: Promise<{ locale:string }> }) {
  ...
  const [activePill, setActivePill] = useState('All Appliances')
  ...
  useEffect(() => {
    const t = setTimeout(() => {
      fetchListings({ category: 'home-appliances', sortBy: 'newest', limit: 20 }).then(rows => setDbListings(rows || []))
    }, 400)
  ...
  const realFeaturedListings  = dbListings.length >= 4  ? dbListings.slice(0, 4).map(r => mapDbRowToListing(r, I.h1))  : featuredListings
  const realExclusiveListings = dbListings.length >= 8  ? dbListings.slice(4, 8).map(r => mapDbRowToListing(r, I.h9))  : exclusiveListings
  const realDiscoveryListings = dbListings.length >= 12 ? dbListings.slice(8, 20).map(r => mapDbRowToListing(r, I.h5)) : discoveryListings
  ...
  return (
    <div style={{ fontFamily:"'Inter',sans-serif", backgroundColor:C.surface, minHeight:'100vh' }}>
      ...
      <section style={{ position:'relative', height:480, overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={I.hero} alt="Home Appliances" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 24px', maxWidth:760, width:'100%' }}>
          <h1 style={{ ...UB, fontSize:'clamp(36px,6vw,64px)', color:'white', lineHeight:1.0, marginBottom:20, textTransform:'uppercase' as const }}>
            HOME APPLIANCES.<br />EVERY ROOM IN RABAT.
          </h1>
          <div style={{ display:'flex', alignItems:'stretch', backgroundColor:'rgba(255,255,255,0.12)', backdropFilter:'blur(24px)', border:'1px solid rgba(255,255,255,0.25)', borderRadius:100, overflow:'hidden', maxWidth:680, margin:'0 auto', boxShadow:'0 8px 32px rgba(0,0,0,0.2)' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column' as const, padding:'14px 22px', flex:1, borderRight:'1px solid rgba(255,255,255,0.2)', gap:2 }}>
              ...
              <input value={heroKeyword} onChange={e=>setHeroKeyword(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} placeholder="Samsung, LG, Bosch, Dyson..." autoComplete="off" style={{ backgroundColor:'transparent', border:'none', outline:'none', fontSize:14, fontWeight:600, color:'white', fontFamily:"'Inter',sans-serif", padding:0, width:'100%' }} />
            </div>
...
<DDrop label="CITY" value={heroCity||'All Cities'} options={['All Cities',...CITIES]} open={cityOpen} setOpen={setCityOpen}
          ...
          <div style={{ flex:2, padding:'8px 20px', borderRight:'1px solid rgba(186,202,197,0.25)', display:'flex', flexDirection:'column' as const, gap:1 }}>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:6 }}>
              ...
              <input value={heroKeyword} onChange={e=>setHeroKeyword(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} placeholder="Samsung, LG, Bosch, KitchenAid..." autoComplete="off"
      ...
      <div style={{ maxWidth:1440, margin:'32px auto 0', padding:'0 40px 80px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:4 }}>
          <h2 style={{ ...UB, fontSize:22, color:C.ink }}>New and Pre-Owned Home Appliances in Rabat</h2>
        ...
        <p style={{ fontSize:14, color:C.muted, marginBottom:16 }}>4,910 Ads in Rabat District</p>

        {/* PILLS */}
        <div style={{ display:'flex', gap:8, marginBottom:16, overflowX:'auto', paddingBottom:4 }}>
          {pills.map(p=>(
            pillSlugs[p] ? (
              <Link key={p} href={`/${locale}/home-appliances/${pillSlugs[p]}`}
        ...
        <section style={{ marginBottom:48 }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:20 }}>
            <h2 style={{ ...UB, fontSize:13, color:C.ink, textTransform:'uppercase' as const, letterSpacing:'0.1em' }}>FEATURED PREMIUM APPLIANCES</h2>
        ...
        <section style={{ marginBottom:48 }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:20 }}>
            <h2 style={{ ...UB, fontSize:22, color:C.mint }}>Exclusive Appliances Collection</h2>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16 }}>
            ...
            <div style={{ borderRadius:24, overflow:'hidden', position:'relative', cursor:'pointer', minHeight:200 }}>
              <img src={I.h6} alt="Appliances Pro" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
              ...
              <div style={{ position:'absolute', inset:0, display:'flex', flexDirection:'column' as const, justifyContent:'center', padding:'0 28px' }}>
                <span style={{ background:'linear-gradient(135deg,#22d4a8,#0f9b8e)', color:'white', fontSize:9, fontWeight:900, padding:'4px 12px', borderRadius:100, textTransform:'uppercase' as const, letterSpacing:'0.1em', display:'inline-block', marginBottom:10, width:'fit-content' }}>SouKni Home Pro</span>
                <h3 style={{ ...UB, fontSize:18, color:'white', marginBottom:12, lineHeight:1.2 }}>Find certified appliances<br/>for every room.</h3>
        ...
        <section style={{ marginBottom:48 }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:20 }}>
            <h2 style={{ ...UB, fontSize:20, color:C.ink }}>Pro Appliance Discoveries</h2>
            <Link href="#" style={{ color:C.mint, fontWeight:700, fontSize:13, textDecoration:'none', display:'flex', alignItems:'center', gap:4 }}>View all <ChevronRight size={14} /></Link>
          </div>
        ...
        <section style={{ borderRadius:40, background:'linear-gradient(135deg,#22d4a8,#0f9b8e)', padding:'56px 64px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:40, flexWrap:'wrap' as const }}>
          <div>
            ...
            <p style={{ fontSize:15, color:'rgba(255,255,255,0.85)', maxWidth:480, lineHeight:1.7 }}>Get early access to new drops, exclusive member deals, and Morocco's finest home appliance listings.</p>
