...
const topChoices = [
  { id:'am1', title:'Senior Account Manager — Key Clients', desc:'Advertising agency seeking a Senior Account Manager to lead relationships with 8-10 key clients, manage campaign delivery, and drive account growth.', price:21000, location:'Casablanca, Finance City', rating:4.9, reviews:26, image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'am2', title:'Account Manager — B2B Distribution', desc:'FMCG distributor hiring an Account Manager to manage retail partner relationships, negotiate terms, and oversee order fulfillment across the Casablanca-Rabat corridor.', price:15000, location:'Rabat, Agdal', rating:4.7, reviews:19, image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'am3', title:'Strategic Account Executive — SaaS', desc:'Growing SaaS company hiring a Strategic Account Executive to manage upsell and expansion revenue across a portfolio of 40+ mid-market clients.', price:18000, location:'Casablanca, Maarif', rating:4.8, reviews:22, image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'amb1', title:'Junior Account Manager', price:9000, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'amb2', title:'Key Account Coordinator', price:11000, location:'Rabat', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'amb3', title:'Regional Account Manager', price:17000, location:'Marrakech', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'amb4', title:'Account Manager — Retail Partners', price:13000, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'amb5', title:'Account Growth Specialist', price:14500, location:'Rabat', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'amd1', title:'Account Manager — Media Agency', price:16000, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'amd2', title:'Wholesale Account Manager', price:12000, location:'Rabat', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'amd3', title:'Account Manager — Logistics Client', price:14000, location:'Tangier', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'amd4', title:'National Accounts Manager', price:22000, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'amd5', title:'Account Manager — Beauty Brands', price:13500, location:'Marrakech', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'amd6', title:'Account Management Analyst', price:10500, location:'Rabat', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'amd7', title:'Account Manager — Hospitality Sector', price:13000, location:'Agadir', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'amd8', title:'Account Relationship Manager', price:15500, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Account Management' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Account Management Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>112 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Account Management Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>112 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Account Management Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Account Management Positions</h2>
        ...
        <CategoryFooterNav
          ...
          related={ALL_CS_CATS.filter(c=>c.slug!=='account-management').map(c=>({ label:c.label, href:`/${locale}/jobs/customer-service/${c.slug}` }))}
