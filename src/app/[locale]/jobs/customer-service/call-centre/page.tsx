    ...
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <Link href={`/${locale}/jobs/customer-service`} style={{ color:'#6b7a76', textDecoration:'none' }}>Customer Service</Link><span>›</span>
          <span style={{ color:'#161d1b' }}>Call Centre</span>
        </nav>
        ...
        <section style={{ marginBottom:'40px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {ALL_CS_CATS.filter(c=>c.slug!=='call-centre').map(c=>(
              ...
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src={c.image} alt={c.label} style={{ width:'100%', height:'100%', objectFit:'cover', transition:'transform 0.4s' }} />
        ...
        <div style={{ textAlign:'center' as const, marginBottom:'40px' }}>
          <Link href={`/${locale}/jobs/customer-service`}
            style={{ display:'inline-flex', alignItems:'center', gap:'8px', padding:'14px 36px', borderRadius:'100px', backgroundColor:'#161d1b', color:'white', textDecoration:'none', fontSize:'12px', fontWeight:900, textTransform:'uppercase' as const, letterSpacing:'0.1em', transition:'background 0.2s' }}
