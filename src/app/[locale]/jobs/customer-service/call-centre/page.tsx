...
const topChoices = [
  { id:'cc1', title:'Call Centre Operations Manager', desc:'Major telecoms operator seeking a Call Centre Manager to oversee 120+ agents across two sites in Casablanca. KPI management, quality assurance, and workforce scheduling.', price:18000, location:'Casablanca, Maarif', rating:4.8, reviews:31, image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'cc2', title:'Bilingual Call Centre Agent FR/EN', desc:'Inbound call centre hiring bilingual agents for a European telecoms client. Full training provided, rotating shifts, performance bonuses.', price:6500, location:'Rabat, Agdal', rating:4.7, reviews:64, image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'cc3', title:'Call Centre Team Leader', desc:'Fast-growing BPO seeking a Team Leader to manage a pod of 15 agents, drive KPIs, and coach performance across quality and productivity metrics.', price:11000, location:'Casablanca, Sidi Maarouf', rating:4.9, reviews:27, image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'ccb1', title:'Outbound Sales Call Agent', price:5500, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'ccb2', title:'Call Centre Quality Analyst', price:9500, location:'Rabat', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'ccb3', title:'Trilingual Call Centre Agent', price:7500, location:'Tangier', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'ccb4', title:'Call Centre Workforce Planner', price:12000, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'ccb5', title:'Night Shift Call Centre Agent', price:6000, location:'Marrakech', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'ccd1', title:'Insurance Call Centre Advisor', price:7000, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'ccd2', title:'Call Centre Trainer', price:10000, location:'Rabat', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'ccd3', title:'Debt Collection Call Agent', price:6500, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'ccd4', title:'Call Centre Shift Supervisor', price:10500, location:'Fès', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'ccd5', title:'German-Speaking Call Agent', price:8500, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'ccd6', title:'Call Centre HR Coordinator', price:9000, location:'Rabat', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'ccd7', title:'Inbound Support Call Agent', price:6000, location:'Marrakech', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'ccd8', title:'Call Centre IT Support Liaison', price:11500, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Call Centre' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Call Centre Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>210 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Call Centre Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>210 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Call Centre Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Call Centre Positions</h2>
        ...
        <CategoryFooterNav
          ...
          related={ALL_CS_CATS.filter(c=>c.slug!=='call-centre').map(c=>({ label:c.label, href:`/${locale}/jobs/customer-service/${c.slug}` }))}
