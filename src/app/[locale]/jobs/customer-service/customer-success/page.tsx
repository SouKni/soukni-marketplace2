...
const ALL_CS_CATS = [
  { slug:'call-centre', label:'Call Centre', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=400' },
  { slug:'live-chat-support', label:'Live Chat Support', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { slug:'technical-support', label:'Technical Support', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { slug:'customer-success', label:'Customer Success', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { slug:'account-management', label:'Account Management', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
]

const HERO = 'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800'
const topChoices = [
  { id:'cus1', title:'Head of Customer Success — SaaS Scale-Up', desc:'Fast-growing B2B SaaS company hiring a Head of CS to build and lead a 12-person team, own retention strategy, and drive net revenue retention above 110%.', price:26000, location:'Casablanca, Finance City', rating:4.9, reviews:24, image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
  { id:'cus2', title:'Customer Success Manager — Enterprise Accounts', desc:'Fintech company seeking a Customer Success Manager to own onboarding and quarterly business reviews for 30+ enterprise clients across MENA.', price:19000, location:'Rabat, Agdal', rating:4.8, reviews:33, image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'cus3', title:'Onboarding & Success Specialist', desc:'HR tech platform hiring a Success Specialist focused on new client onboarding, training sessions, and adoption tracking during the first 90 days.', price:13000, location:'Casablanca, Maarif', rating:4.7, reviews:21, image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'cusb1', title:'Customer Success Associate', price:9000, location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
  { id:'cusb2', title:'Renewals & Retention Specialist', price:14000, location:'Rabat', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'cusb3', title:'Customer Health Score Analyst', price:11000, location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
  { id:'cusb4', title:'Customer Success Ops Manager', price:16000, location:'Rabat', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'cusb5', title:'Junior Customer Success Rep', price:7500, location:'Marrakech', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'cusd1', title:'Customer Success Manager — Fintech', price:15000, location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
  { id:'cusd2', title:'Client Onboarding Specialist', price:10000, location:'Rabat', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'cusd3', title:'Customer Success Team Coordinator', price:9500, location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
  { id:'cusd4', title:'Enterprise Customer Success Lead', price:20000, location:'Rabat', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'cusd5', title:'Customer Success Manager — E-commerce', price:12500, location:'Marrakech', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
  { id:'cusd6', title:'Customer Success Data Analyst', price:13500, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'cusd7', title:'Remote Customer Success Rep', price:9000, location:'Remote, Morocco', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
  { id:'cusd8', title:'Customer Success Playbook Manager', price:14500, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Customer Success' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Customer Success Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>128 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <Breadcrumb
          items={[
            ...
            { label:'Customer Service', href:`/${locale}/jobs/customer-service` },
            { label:'Customer Success' },
          ]}
        />

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Customer Success Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>128 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Customer Success Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Customer Success Positions</h2>
        ...
        <CategoryFooterNav
          relatedTitle="Explore Other Customer Service Categories"
          related={ALL_CS_CATS.filter(c=>c.slug!=='customer-success').map(c=>({ label:c.label, href:`/${locale}/jobs/customer-service/${c.slug}` }))}
          backHref={`/${locale}/jobs/customer-service`}
