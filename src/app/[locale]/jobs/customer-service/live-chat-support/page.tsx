...
const topChoices = [
  { id:'lc1', title:'Live Chat Support Team Lead', desc:'E-commerce platform seeking a Team Lead to manage 20 live chat agents across day and evening shifts. Response time SLAs, quality scoring, and escalation handling.', price:14000, location:'Casablanca, Maarif', rating:4.8, reviews:29, image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'lc2', title:'Live Chat & Social Media Agent', desc:'Retail brand hiring agents to manage live chat and social DMs across Instagram, Facebook, and WhatsApp Business. Fast typing and friendly tone required.', price:6500, location:'Rabat, Agdal', rating:4.7, reviews:41, image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'lc3', title:'Multilingual Live Chat Agent', desc:'SaaS company hiring FR/EN/AR live chat agents for pre-sales and support chat across three time zones. Fully remote with flexible scheduling.', price:8500, location:'Remote, Morocco', rating:4.9, reviews:22, image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'lcb1', title:'Live Chat Agent — E-commerce', price:6000, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'lcb2', title:'Chat Support QA Specialist', price:9000, location:'Rabat', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'lcb3', title:'Weekend Live Chat Agent', price:5000, location:'Tangier', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'lcb4', title:'Live Chat Operations Analyst', price:10000, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'lcb5', title:'Chatbot Escalation Specialist', price:8000, location:'Marrakech', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'lcd1', title:'Live Chat Agent — SaaS Platform', price:7000, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'lcd2', title:'Bilingual Live Chat Agent', price:6500, location:'Rabat', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'lcd3', title:'Live Chat Support Coordinator', price:8500, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'lcd4', title:'Social Media Chat Agent', price:6000, location:'Fès', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'lcd5', title:'Live Chat Agent — Fintech', price:9500, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'lcd6', title:'Remote Live Chat Agent', price:7500, location:'Remote, Morocco', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'lcd7', title:'Live Chat Agent — Travel Platform', price:7000, location:'Marrakech', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'lcd8', title:'Chat Support Trainer', price:11000, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Live Chat Support' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Live Chat Support Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>140 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Live Chat Support Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>140 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Live Chat Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Live Chat Support Positions</h2>
        ...
        <CategoryFooterNav
          ...
          related={ALL_CS_CATS.filter(c=>c.slug!=='live-chat-support').map(c=>({ label:c.label, href:`/${locale}/jobs/customer-service/${c.slug}` }))}
