...
const topChoices = [
  { id:'ts1', title:'Technical Support Team Lead — SaaS', desc:'B2B SaaS platform seeking a Technical Support Lead to manage 15 Tier 1/2 engineers, own escalation processes, and drive resolution time improvements.', price:16000, location:'Casablanca, Sidi Maarouf', rating:4.8, reviews:34, image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'ts2', title:'Technical Support Engineer — Tier 2', desc:'Telecoms provider hiring a Tier 2 Support Engineer for network and hardware troubleshooting, ticket escalation, and client-facing technical calls.', price:12000, location:'Rabat, Agdal', rating:4.7, reviews:27, image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'ts3', title:'Bilingual Technical Support Specialist', desc:'International software company hiring FR/EN technical support specialists for a growing EMEA support desk. Remote-friendly with flexible hours.', price:10000, location:'Remote, Morocco', rating:4.9, reviews:19, image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'tsb1', title:'Help Desk Technical Support Agent', price:7000, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'tsb2', title:'Technical Support Escalation Specialist', price:11000, location:'Rabat', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'tsb3', title:'Network Support Technician', price:9500, location:'Tangier', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'tsb4', title:'Technical Support QA Lead', price:13000, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'tsb5', title:'Remote Technical Support Agent', price:8500, location:'Remote, Morocco', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'tsd1', title:'Software Technical Support Agent', price:8000, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'tsd2', title:'Hardware Support Technician', price:7500, location:'Rabat', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'tsd3', title:'Technical Support Trainer', price:12000, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'tsd4', title:'Cloud Platform Support Engineer', price:14000, location:'Rabat', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'tsd5', title:'Mobile App Technical Support', price:8500, location:'Marrakech', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'tsd6', title:'Technical Support Shift Supervisor', price:11500, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'tsd7', title:'IT Helpdesk Support Agent', price:7000, location:'Fès', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'tsd8', title:'Technical Support Knowledge Base Writer', price:9000, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Technical Support' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Technical Support Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>165 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Technical Support Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>165 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Technical Support Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Technical Support Positions</h2>
        ...
        <CategoryFooterNav
          ...
          related={ALL_CS_CATS.filter(c=>c.slug!=='technical-support').map(c=>({ label:c.label, href:`/${locale}/jobs/customer-service/${c.slug}` }))}
