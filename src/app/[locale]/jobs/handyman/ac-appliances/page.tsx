...
const topChoices = [
  { id:'ac1', title:'AC Installation & Maintenance Technician', desc:'HVAC company hiring a Technician for split unit, cassette, and ducted AC installation and seasonal maintenance contracts. F-Gas certification preferred.', price:13000, location:'Casablanca, Sidi Maarouf', rating:4.8, reviews:26, image:HERO },
  { id:'ac2', title:'Home Appliance Repair Technician', desc:'Home services platform hiring an Appliance Repair Technician for washing machines, dishwashers, ovens, and refrigerators. On-demand call-outs.', price:10000, location:'Rabat & Casablanca', rating:4.7, reviews:34, image:HERO },
  { id:'ac3', title:'HVAC Engineer — Commercial Buildings', desc:'Facilities management company hiring an HVAC Engineer for centralised air conditioning systems in commercial towers and hospitals.', price:16000, location:'Casablanca, Finance City', rating:4.9, reviews:18, image:HERO },
]
const bentoListings = [
  { id:'acb1', title:'Split AC Installer', price:10000, location:'Casablanca', image:HERO },
  { id:'acb2', title:'Refrigerator Repair Technician', price:9000, location:'Rabat', image:HERO },
  { id:'acb3', title:'Washing Machine Repair Specialist', price:9000, location:'Marrakech', image:HERO },
  { id:'acb4', title:'AC Maintenance Operative', price:9500, location:'Tangier', image:HERO },
  { id:'acb5', title:'Smart AC & IoT Installer', price:12000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'acd1', title:'Oven & Microwave Repair Tech', price:8500, location:'Casablanca', image:HERO },
  { id:'acd2', title:'Water Heater Installation Tech', price:9000, location:'Rabat', image:HERO },
  { id:'acd3', title:'Cold Room & Freezer Engineer', price:13000, location:'Casablanca', image:HERO },
  { id:'acd4', title:'AC Gas Refill Technician', price:9000, location:'Marrakech', image:HERO },
  { id:'acd5', title:'Commercial Fridge Repair Tech', price:11000, location:'Casablanca', image:HERO },
  { id:'acd6', title:'Heat Pump Installer', price:13000, location:'Rabat', image:HERO },
  { id:'acd7', title:'Ventilation System Technician', price:11000, location:'Casablanca', image:HERO },
  { id:'acd8', title:'AC Cleaning & Filter Specialist', price:8000, location:'Agadir', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='AC & Appliances' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>AC & Appliance Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>AC & Appliances</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>AC & Appliance Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni AC & Appliances Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More AC & Appliance Positions</h2>
