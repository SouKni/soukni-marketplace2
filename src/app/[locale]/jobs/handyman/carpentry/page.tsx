...
const topChoices = [
  { id:'ca1', title:'Master Carpenter — Custom Furniture', desc:'Luxury furniture atelier seeking a Master Carpenter for bespoke kitchen, wardrobe, and living room commissions. CNC experience a strong plus.', price:15000, location:'Casablanca, Ain Diab', rating:4.9, reviews:13, image:HERO },
  { id:'ca2', title:'Site Carpenter — Residential Builds', desc:'Construction company hiring Site Carpenters for formwork, door and window fitting, and general finish carpentry on new builds.', price:10000, location:'Rabat, Temara', rating:4.7, reviews:24, image:HERO },
  { id:'ca3', title:'Furniture Restoration Specialist', desc:'Antique and interior studio hiring a Furniture Restoration Specialist for repair, refinishing, and upholstery of period and contemporary pieces.', price:11000, location:'Marrakech, Medina', rating:4.8, reviews:11, image:HERO },
]
const bentoListings = [
  { id:'cab1', title:'Kitchen Cabinet Maker', price:11000, location:'Casablanca', image:HERO },
  { id:'cab2', title:'Carpentry Apprentice', price:5000, location:'Fès', image:HERO },
  { id:'cab3', title:'Wooden Floor Installer', price:10000, location:'Rabat', image:HERO },
  { id:'cab4', title:'Door & Window Frame Fitter', price:9000, location:'Casablanca', image:HERO },
  { id:'cab5', title:'Outdoor Decking Carpenter', price:10000, location:'Agadir', image:HERO },
]
const discoveryGrid = [
  { id:'cad1', title:'Wardobe & Fitted Furniture Carpenter', price:10000, location:'Casablanca', image:HERO },
  { id:'cad2', title:'Roof Structure Carpenter', price:11000, location:'Rabat', image:HERO },
  { id:'cad3', title:'Joinery Specialist', price:10000, location:'Marrakech', image:HERO },
  { id:'cad4', title:'Shopfitting Carpenter', price:9500, location:'Casablanca', image:HERO },
  { id:'cad5', title:'Staircase Carpenter', price:12000, location:'Rabat', image:HERO },
  { id:'cad6', title:'CNC Machine Operator', price:11000, location:'Casablanca', image:HERO },
  { id:'cad7', title:'Bamboo & Rattan Craftsman', price:9000, location:'Marrakech', image:HERO },
  { id:'cad8', title:'Wooden Ceiling Installer', price:10000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Carpentry' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Carpentry Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <Link href={`/${locale}/jobs/handyman`} style={{ color:'#6b7a76', textDecoration:'none' }}>Handyman</Link><span>›</span>
          <span style={{ color:'#161d1b' }}>Carpentry</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Carpentry Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <div style={{ display:'flex', gap:'8px', marginBottom:'32px', flexWrap:'wrap' as const }}>
          {['All','Full-Time','Part-Time','Freelance'].map(t=>(
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Carpentry Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Carpentry Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h3 style={{ fontWeight:900, fontSize:'16px', color:'#161d1b', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'16px' }}>Explore Other Handyman Categories</h3>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
              <Link key="plumbing-repairs" href={`/${locale}/jobs/handyman/plumbing-repairs`}
              ...
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=400" alt="Plumbing Repairs" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  ...
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Plumbing Repairs</p>
                  </div>
                </div>
              </Link>
              <Link key="electrical-fixes" href={`/${locale}/jobs/handyman/electrical-fixes`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400" alt="Electrical Fixes" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Electrical Fixes</p>
                  </div>
                </div>
              </Link>
              <Link key="painting" href={`/${locale}/jobs/handyman/painting`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400" alt="Painting" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Painting</p>
                  </div>
                </div>
              </Link>
              <Link key="ac-appliances" href={`/${locale}/jobs/handyman/ac-appliances`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=400" alt="AC & Appliances" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>AC & Appliances</p>
                  </div>
                </div>
              </Link>
              <Link key="view-more" href={`/${locale}/jobs/handyman`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
        ...
        <div style={{ textAlign:'center' as const, marginBottom:'40px' }}>
          <Link href={`/${locale}/jobs/handyman`}
