...
const topChoices = [
  { id:'ef1', title:'Certified Electrician — Commercial Projects', desc:'Construction company hiring a Certified Electrician for fit-out of office towers and retail spaces. Experience with 3-phase wiring required.', price:13000, location:'Casablanca, Finance City', rating:4.9, reviews:22, image:HERO },
  { id:'ef2', title:'Residential Electrician — Renovation Specialist', desc:'Home renovation company hiring a Residential Electrician for rewiring, panel upgrades, and smart home installations across Casablanca villas.', price:11000, location:'Casablanca, Anfa', rating:4.8, reviews:19, image:HERO },
  { id:'ef3', title:'Electrical Maintenance Technician — Hotel', desc:'Hotel group seeking an Electrical Maintenance Technician for preventive and corrective maintenance across a 300-room property.', price:10000, location:'Marrakech, Hivernage', rating:4.7, reviews:31, image:HERO },
]
const bentoListings = [
  { id:'efb1', title:'Electrical Apprentice', price:5000, location:'Casablanca', image:HERO },
  { id:'efb2', title:'Solar Panel Installer', price:12000, location:'Agadir', image:HERO },
  { id:'efb3', title:'Smart Home Electrician', price:13000, location:'Rabat', image:HERO },
  { id:'efb4', title:'Industrial Electrician', price:14000, location:'Tangier', image:HERO },
  { id:'efb5', title:'On-Call Emergency Electrician', price:10000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'efd1', title:'Electrical Panel Specialist', price:12000, location:'Casablanca', image:HERO },
  { id:'efd2', title:'Lighting Installation Technician', price:9000, location:'Rabat', image:HERO },
  { id:'efd3', title:'CCTV & Alarm Installer', price:10000, location:'Casablanca', image:HERO },
  { id:'efd4', title:'EV Charging Point Installer', price:13000, location:'Casablanca', image:HERO },
  { id:'efd5', title:'Generator Maintenance Technician', price:12000, location:'Marrakech', image:HERO },
  { id:'efd6', title:'Electrical Safety Inspector', price:11000, location:'Rabat', image:HERO },
  { id:'efd7', title:'Data Cabling Electrician', price:10000, location:'Casablanca', image:HERO },
  { id:'efd8', title:'Outdoor Lighting Electrician', price:9500, location:'Agadir', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Electrical Fixes' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Electrical Fix Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>280 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Electrical Fixes</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Electrical Fix Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>280 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Electrical Positions</h2>
