...
const topChoices = [
  { id:'pa1', title:'Lead Painter — Luxury Villa Projects', desc:'High-end interior design firm seeking a Lead Painter for luxury villa renovations. Experience with decorative finishes, Tadelakt, and Venice plaster required.', price:12000, location:'Marrakech, Palmeraie', rating:4.9, reviews:17, image:HERO },
  { id:'pa2', title:'Commercial Painter — Office Fit-Out', desc:'Construction company hiring Commercial Painters for large-scale office and retail fit-outs. Speed and quality finishing essential.', price:9000, location:'Casablanca, Finance City', rating:4.7, reviews:29, image:HERO },
  { id:'pa3', title:'Decorative Painting Specialist', desc:'Interior studio hiring a Decorative Painting Specialist for bespoke wall murals, stencilling, and faux finishes across residential projects.', price:11000, location:'Rabat, Souissi', rating:4.8, reviews:14, image:HERO },
]
const bentoListings = [
  { id:'pab1', title:'Residential Interior Painter', price:8000, location:'Casablanca', image:HERO },
  { id:'pab2', title:'Exterior Facade Painter', price:9000, location:'Rabat', image:HERO },
  { id:'pab3', title:'Painting Apprentice', price:4500, location:'Tangier', image:HERO },
  { id:'pab4', title:'Spray Paint Technician', price:10000, location:'Casablanca', image:HERO },
  { id:'pab5', title:'Wallpaper & Feature Wall Specialist', price:9500, location:'Marrakech', image:HERO },
]
const discoveryGrid = [
  { id:'pad1', title:'Anti-Rust & Metal Painter', price:9000, location:'Casablanca', image:HERO },
  { id:'pad2', title:'Epoxy Floor Painter', price:10000, location:'Rabat', image:HERO },
  { id:'pad3', title:'Tadelakt Artisan', price:12000, location:'Marrakech', image:HERO },
  { id:'pad4', title:'Ceiling & Coving Painter', price:8500, location:'Casablanca', image:HERO },
  { id:'pad5', title:'Wood Staining Specialist', price:9000, location:'Fès', image:HERO },
  { id:'pad6', title:'Road Marking Painter', price:8000, location:'Casablanca', image:HERO },
  { id:'pad7', title:'Paint Quality Inspector', price:10000, location:'Rabat', image:HERO },
  { id:'pad8', title:'Hotel Room Repainting Operative', price:8000, location:'Agadir', image:HERO },
]
    ...
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Painting Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Painting Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Painting Positions</h2>
