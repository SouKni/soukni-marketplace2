...
const topChoices = [
  { id:'pr1', title:'Senior Plumber — Property Developer', desc:'Major property developer hiring a Senior Plumber for new residential builds across Casablanca. Experience with copper, PVC, and PPR pipe systems required.', price:12000, location:'Casablanca, Ain Sebaa', rating:4.8, reviews:28, image:HERO },
  { id:'pr2', title:'Plumbing Foreman — Hotel Group', desc:'Five-star hotel group seeking a Plumbing Foreman to manage maintenance for 3 Marrakech properties. On-call availability required.', price:14000, location:'Marrakech, Hivernage', rating:4.9, reviews:16, image:HERO },
  { id:'pr3', title:'Freelance Emergency Plumber', desc:'Home services platform hiring freelance plumbers for on-demand emergency call-outs across Rabat and Casablanca. Own tools required.', price:9000, location:'Rabat & Casablanca', rating:4.7, reviews:42, image:HERO },
]
const bentoListings = [
  { id:'prb1', title:'Residential Plumber', price:9000, location:'Casablanca', image:HERO },
  { id:'prb2', title:'Commercial Plumber', price:11000, location:'Rabat', image:HERO },
  { id:'prb3', title:'Plumbing Apprentice', price:5000, location:'Tangier', image:HERO },
  { id:'prb4', title:'Sanitation Engineer', price:12000, location:'Casablanca', image:HERO },
  { id:'prb5', title:'Bathroom Renovation Plumber', price:10000, location:'Marrakech', image:HERO },
]
const discoveryGrid = [
  { id:'prd1', title:'Pipe Fitting Specialist', price:10000, location:'Casablanca', image:HERO },
  { id:'prd2', title:'Water Heater Technician', price:9000, location:'Rabat', image:HERO },
  { id:'prd3', title:'Drainage & Sewage Specialist', price:11000, location:'Casablanca', image:HERO },
  { id:'prd4', title:'Irrigation System Plumber', price:9500, location:'Marrakech', image:HERO },
  { id:'prd5', title:'Gas Pipe Fitter', price:12000, location:'Casablanca', image:HERO },
  { id:'prd6', title:'Pool Plumbing Technician', price:10000, location:'Agadir', image:HERO },
  { id:'prd7', title:'Leak Detection Specialist', price:10000, location:'Rabat', image:HERO },
  { id:'prd8', title:'Plumbing Maintenance Operative', price:8500, location:'Fès', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Plumbing Repairs' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Plumbing Repair Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>310 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Plumbing Repairs</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Plumbing Repair Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>310 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Plumbing Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Plumbing Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
              ...
              <Link key="carpentry" href={`/${locale}/jobs/handyman/carpentry`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400" alt="Carpentry" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Carpentry</p>
                  </div>
                </div>
              </Link>
