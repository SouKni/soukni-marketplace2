...
const topChoices = [
  { id:'dc1', title:'Deep Cleaning Specialist — Post-Construction', desc:'Property developer hiring a Deep Cleaning Specialist for post-construction cleans of new apartments before handover. Own transport preferred.', price:8000, location:'Casablanca, Ain Sebaa', rating:4.8, reviews:19, image:HERO },
  { id:'dc2', title:'Deep Clean Team Lead — Hospitality', desc:'Hotel group seeking a Deep Clean Team Lead for seasonal deep-cleaning projects across 3 Marrakech properties. Project-based contract.', price:10000, location:'Marrakech, Hivernage', rating:4.9, reviews:14, image:HERO },
  { id:'dc3', title:'Carpet & Upholstery Deep Cleaner', desc:'Specialist cleaning company hiring a Carpet and Upholstery Deep Cleaner. Machine operation training provided. Commission on upsells.', price:7000, location:'Rabat', rating:4.7, reviews:22, image:HERO },
]
const bentoListings = [
  { id:'dcb1', title:'Kitchen Deep Cleaner', price:6500, location:'Casablanca', image:HERO },
  { id:'dcb2', title:'Bathroom Restoration Cleaner', price:6000, location:'Rabat', image:HERO },
  { id:'dcb3', title:'Tile & Grout Specialist', price:7000, location:'Marrakech', image:HERO },
  { id:'dcb4', title:'Deep Clean Operative', price:6000, location:'Casablanca', image:HERO },
  { id:'dcb5', title:'Steam Cleaning Technician', price:7500, location:'Tangier', image:HERO },
]
const discoveryGrid = [
  { id:'dcd1', title:'Post-Renovation Deep Cleaner', price:7000, location:'Casablanca', image:HERO },
  { id:'dcd2', title:'End-of-Tenancy Deep Cleaner', price:6500, location:'Rabat', image:HERO },
  { id:'dcd3', title:'Commercial Kitchen Deep Cleaner', price:7000, location:'Casablanca', image:HERO },
  { id:'dcd4', title:'Mould Remediation Cleaner', price:8000, location:'Marrakech', image:HERO },
  { id:'dcd5', title:'Deep Cleaning Quality Inspector', price:8500, location:'Casablanca', image:HERO },
  { id:'dcd6', title:'Window & Facade Deep Cleaner', price:7500, location:'Rabat', image:HERO },
  { id:'dcd7', title:'Furniture & Mattress Deep Cleaner', price:6500, location:'Casablanca', image:HERO },
  { id:'dcd8', title:'Oven & Appliance Deep Cleaner', price:6000, location:'Fès', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Deep Cleaning' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Deep Cleaning Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Deep Cleaning</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Deep Cleaning Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Deep Cleaning Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Deep Cleaning Positions</h2>
