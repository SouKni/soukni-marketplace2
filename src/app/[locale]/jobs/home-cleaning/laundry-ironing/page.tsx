...
const topChoices = [
  { id:'li1', title:'Laundry Supervisor — Luxury Hotel', desc:'Five-star hotel hiring a Laundry Supervisor to manage a 10-person team, oversee linen processing, and ensure quality standards for 200+ rooms.', price:10000, location:'Marrakech, Hivernage', rating:4.9, reviews:16, image:HERO },
  { id:'li2', title:'In-Home Laundry & Ironing Specialist', desc:'Premium home service company hiring an In-Home Specialist for weekly laundry, ironing, and wardrobe organisation visits across Casablanca villas.', price:7000, location:'Casablanca, Anfa', rating:4.8, reviews:24, image:HERO },
  { id:'li3', title:'Dry Cleaning Technician', desc:'Commercial dry cleaner hiring a Technician for garment inspection, stain treatment, and dry cleaning machine operation.', price:8000, location:'Rabat, Agdal', rating:4.7, reviews:18, image:HERO },
]
const bentoListings = [
  { id:'lib1', title:'Ironing Specialist', price:5500, location:'Casablanca', image:HERO },
  { id:'lib2', title:'Laundry Operative', price:5000, location:'Rabat', image:HERO },
  { id:'lib3', title:'Hotel Linen Room Attendant', price:5500, location:'Marrakech', image:HERO },
  { id:'lib4', title:'Wash & Fold Operative', price:5000, location:'Casablanca', image:HERO },
  { id:'lib5', title:'Wardrobe Organisation Specialist', price:7000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'lid1', title:'Laundry & Folding Operative', price:5000, location:'Casablanca', image:HERO },
  { id:'lid2', title:'Garment Care Specialist', price:6500, location:'Rabat', image:HERO },
  { id:'lid3', title:'Hospital Linen Laundry Worker', price:5500, location:'Casablanca', image:HERO },
  { id:'lid4', title:'Uniform Laundry Operative', price:5000, location:'Tangier', image:HERO },
  { id:'lid5', title:'Textile Restoration Specialist', price:7500, location:'Casablanca', image:HERO },
  { id:'lid6', title:'Collection & Delivery Laundry Driver', price:6000, location:'Rabat', image:HERO },
  { id:'lid7', title:'Laundromat Attendant', price:4500, location:'Fès', image:HERO },
  { id:'lid8', title:'Luxury Garment Care Specialist', price:8000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Laundry & Ironing' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Laundry & Ironing Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>120 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Laundry & Ironing</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Laundry & Ironing Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>120 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Laundry & Ironing Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Laundry & Ironing Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
              <Link key="residential-cleaning" href={`/${locale}/jobs/home-cleaning/residential-cleaning`}
              ...
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=400" alt="Residential Cleaning" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  ...
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Residential Cleaning</p>
                  </div>
                </div>
              </Link>
