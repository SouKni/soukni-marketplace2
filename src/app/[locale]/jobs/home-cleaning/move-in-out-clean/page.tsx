...
const topChoices = [
  { id:'mo1', title:'Move-Out Cleaning Team Lead', desc:'Property management company seeking a Move-Out Cleaning Team Lead to coordinate same-day turnaround cleans for vacated apartments. Fast-paced, car required.', price:9500, location:'Casablanca, Maarif', rating:4.8, reviews:22, image:HERO },
  { id:'mo2', title:'Move-In Cleaning Specialist', desc:'Real estate agency hiring a Move-In Specialist to prepare vacant properties for new tenants. Checklist-based, detail-oriented, and punctual.', price:7000, location:'Rabat, Agdal', rating:4.7, reviews:18, image:HERO },
  { id:'mo3', title:'End-of-Tenancy Cleaning Operative', desc:'Lettings agency contracting experienced end-of-tenancy cleaners for apartments and villas. Inventory check knowledge a plus.', price:6500, location:'Marrakech', rating:4.7, reviews:31, image:HERO },
]
const bentoListings = [
  { id:'mob1', title:'Move-Out Deep Clean Operative', price:6500, location:'Casablanca', image:HERO },
  { id:'mob2', title:'Rental Property Cleaner', price:6000, location:'Rabat', image:HERO },
  { id:'mob3', title:'Airbnb Turnover Cleaner', price:6000, location:'Marrakech', image:HERO },
  { id:'mob4', title:'New Build Pre-Delivery Cleaner', price:7000, location:'Casablanca', image:HERO },
  { id:'mob5', title:'Property Handover Specialist', price:8000, location:'Tangier', image:HERO },
]
const discoveryGrid = [
  { id:'mod1', title:'Move-In Cleaning Operative', price:6000, location:'Casablanca', image:HERO },
  { id:'mod2', title:'End-of-Lease Cleaner', price:6000, location:'Rabat', image:HERO },
  { id:'mod3', title:'Villa Handover Cleaner', price:7000, location:'Marrakech', image:HERO },
  { id:'mod4', title:'Rental Turnaround Cleaner', price:5500, location:'Agadir', image:HERO },
  { id:'mod5', title:'Move-Out Inspection Cleaner', price:7000, location:'Casablanca', image:HERO },
  { id:'mod6', title:'Student Accommodation Cleaner', price:5000, location:'Fès', image:HERO },
  { id:'mod7', title:'Move-In Sanitisation Specialist', price:7500, location:'Casablanca', image:HERO },
  { id:'mod8', title:'Property Management Cleaner', price:6500, location:'Rabat', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Move-In/Out Clean' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Move-In/Out Cleaning Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Move-In/Out Clean</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Move-In/Out Cleaning Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Move-In/Out Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Move-In/Out Positions</h2>
