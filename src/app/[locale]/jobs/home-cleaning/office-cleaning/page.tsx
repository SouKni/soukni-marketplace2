...
const topChoices = [
  { id:'oc1', title:'Office Cleaning Supervisor — Corporate Tower', desc:'Commercial cleaning company seeking a Supervisor for a 20-floor office tower in Casablanca Finance City. Team of 12, night shift operation.', price:10000, location:'Casablanca, Finance City', rating:4.8, reviews:28, image:HERO },
  { id:'oc2', title:'Daily Office Cleaner — Open Plan Office', desc:'Co-working space seeking a reliable daily cleaner for desks, common areas, kitchens, and toilets. Morning shift before 9am.', price:5500, location:'Rabat, Agdal', rating:4.7, reviews:42, image:HERO },
  { id:'oc3', title:'Industrial Cleaning Operative', desc:'Manufacturing facility hiring industrial cleaners for production floor, machinery surroundings, and locker rooms. Safety training provided.', price:7000, location:'Tangier Free Zone', rating:4.6, reviews:31, image:HERO },
]
const bentoListings = [
  { id:'ocb1', title:'Night Shift Office Cleaner', price:6000, location:'Casablanca', image:HERO },
  { id:'ocb2', title:'Medical Office Cleaner', price:6500, location:'Rabat', image:HERO },
  { id:'ocb3', title:'Bank Branch Cleaner', price:6000, location:'Casablanca', image:HERO },
  { id:'ocb4', title:'Hotel Public Area Cleaner', price:5500, location:'Marrakech', image:HERO },
  { id:'ocb5', title:'School Janitorial Cleaner', price:5000, location:'Fès', image:HERO },
]
const discoveryGrid = [
  { id:'ocd1', title:'Office Cleaning Operative', price:5500, location:'Casablanca', image:HERO },
  { id:'ocd2', title:'Retail Store Cleaner', price:5000, location:'Rabat', image:HERO },
  { id:'ocd3', title:'Gym & Fitness Centre Cleaner', price:5500, location:'Casablanca', image:HERO },
  { id:'ocd4', title:'Airport Terminal Cleaner', price:6500, location:'Casablanca', image:HERO },
  { id:'ocd5', title:'Hospital Ward Cleaner', price:6000, location:'Rabat', image:HERO },
  { id:'ocd6', title:'Restaurant & Cafe Cleaner', price:5000, location:'Marrakech', image:HERO },
  { id:'ocd7', title:'Government Building Cleaner', price:5500, location:'Rabat', image:HERO },
  { id:'ocd8', title:'Office Cleaning Team Leader', price:9000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Office Cleaning' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Office Cleaning Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>240 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Office Cleaning</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Office Cleaning Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>240 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Office Cleaning Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Office Cleaning Positions</h2>
