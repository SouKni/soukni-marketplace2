...
const topChoices = [
  { id:'rc1', title:'Residential Cleaning Team Leader', desc:'Growing home cleaning company seeking a Team Leader to manage 15 cleaners across Casablanca. Route planning, quality checks, and client satisfaction ownership.', price:9500, location:'Casablanca, Maarif', rating:4.8, reviews:34, image:HERO },
  { id:'rc2', title:'Live-In Housekeeper — Villa Residence', desc:'Private family in Rabat seeking a live-in housekeeper for daily cleaning, laundry, and light cooking. Accommodation and meals provided.', price:8000, location:'Rabat, Souissi', rating:4.9, reviews:21, image:HERO },
  { id:'rc3', title:'Weekly Residential Cleaner', desc:'Domestic cleaning agency hiring weekly residential cleaners for scheduled visits across Casablanca apartments and villas.', price:6000, location:'Casablanca, Anfa', rating:4.7, reviews:48, image:HERO },
]
const bentoListings = [
  { id:'rcb1', title:'Daily Housekeeper', price:6500, location:'Casablanca', image:HERO },
  { id:'rcb2', title:'Part-Time Home Cleaner', price:4500, location:'Rabat', image:HERO },
  { id:'rcb3', title:'Villa Cleaning Specialist', price:7500, location:'Marrakech', image:HERO },
  { id:'rcb4', title:'Residential Cleaning Supervisor', price:9000, location:'Casablanca', image:HERO },
  { id:'rcb5', title:'Weekend Home Cleaner', price:4000, location:'Tangier', image:HERO },
]
const discoveryGrid = [
  { id:'rcd1', title:'Apartment Cleaner', price:5500, location:'Casablanca', image:HERO },
  { id:'rcd2', title:'Home Cleaning Coordinator', price:8000, location:'Rabat', image:HERO },
  { id:'rcd3', title:'Expat Household Cleaner', price:7000, location:'Casablanca', image:HERO },
  { id:'rcd4', title:'Bi-Weekly Home Cleaner', price:5000, location:'Marrakech', image:HERO },
  { id:'rcd5', title:'Eco-Friendly Home Cleaner', price:6000, location:'Casablanca', image:HERO },
  { id:'rcd6', title:'Post-Party Residential Cleaner', price:6500, location:'Rabat', image:HERO },
  { id:'rcd7', title:'Furnished Apartment Cleaner', price:5500, location:'Tangier', image:HERO },
  { id:'rcd8', title:'Home Cleaning Quality Inspector', price:8500, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Residential Cleaning' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Residential Cleaning Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>380 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <Link href={`/${locale}/jobs/home-cleaning`} style={{ color:'#6b7a76', textDecoration:'none' }}>Home Cleaning</Link><span>›</span>
          <span style={{ color:'#161d1b' }}>Residential Cleaning</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Residential Cleaning Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>380 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Residential Cleaning Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Residential Cleaning Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h3 style={{ fontWeight:900, fontSize:'16px', color:'#161d1b', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'16px' }}>Explore Other Cleaning Categories</h3>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
              <Link key="office-cleaning" href={`/${locale}/jobs/home-cleaning/office-cleaning`}
              ...
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400" alt="Office Cleaning" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  ...
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Office Cleaning</p>
                  </div>
                </div>
              </Link>
              <Link key="deep-cleaning" href={`/${locale}/jobs/home-cleaning/deep-cleaning`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400" alt="Deep Cleaning" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Deep Cleaning</p>
                  </div>
                </div>
              </Link>
              <Link key="laundry-ironing" href={`/${locale}/jobs/home-cleaning/laundry-ironing`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400" alt="Laundry & Ironing" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Laundry & Ironing</p>
                  </div>
                </div>
              </Link>
              <Link key="move-in-out-clean" href={`/${locale}/jobs/home-cleaning/move-in-out-clean`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=400" alt="Move-In/Out Clean" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Move-In/Out Clean</p>
                  </div>
                </div>
              </Link>
              <Link key="view-more" href={`/${locale}/jobs/home-cleaning`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
        ...
        <div style={{ textAlign:'center' as const, marginBottom:'40px' }}>
          <Link href={`/${locale}/jobs/home-cleaning`}
