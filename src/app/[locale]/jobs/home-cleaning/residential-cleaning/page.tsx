      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <Breadcrumb
          items={[
            ...
            { label:'Home Cleaning', href:`/${locale}/jobs/home-cleaning` },
        ...
        <CategoryFooterNav
          relatedTitle="Explore Other Cleaning Categories"
          related={[
          ...
          backHref={`/${locale}/jobs/home-cleaning`}
          backLabel="Back to Home Cleaning"
        />
