...
const topChoices = [
  { id:'ao1', title:'Office Manager — Corporate HQ', desc:'Multinational seeking an Office Manager for its Casablanca HQ. Facilities, vendor management, travel booking, and PA support for 3 directors.', price:16000, location:'Casablanca, Finance City', rating:4.8, reviews:28, image:HERO },
  { id:'ao2', title:'Administrative Manager — Law Firm', desc:'Leading law firm hiring an Administrative Manager to oversee office operations, document management, and client reception for 40-lawyer team.', price:18000, location:'Casablanca, Anfa', rating:4.9, reviews:19, image:HERO },
  { id:'ao3', title:'Office Coordinator — Tech Startup', desc:'Fast-growing startup seeking an Office Coordinator for daily admin, supplier liaison, expense tracking, and team event organisation.', price:10000, location:'Rabat, Agdal', rating:4.7, reviews:34, image:HERO },
]
const bentoListings = [
  { id:'aob1', title:'Administrative Assistant', price:8000, location:'Casablanca', image:HERO },
  { id:'aob2', title:'Receptionist', price:7000, location:'Rabat', image:HERO },
  { id:'aob3', title:'Document Controller', price:10000, location:'Casablanca', image:HERO },
  { id:'aob4', title:'Office Administrator', price:9000, location:'Marrakech', image:HERO },
  { id:'aob5', title:'Facilities Coordinator', price:11000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'aod1', title:'Data Entry Clerk', price:7000, location:'Casablanca', image:HERO },
  { id:'aod2', title:'Mailroom Administrator', price:6500, location:'Rabat', image:HERO },
  { id:'aod3', title:'Filing & Records Clerk', price:7000, location:'Casablanca', image:HERO },
  { id:'aod4', title:'Procurement Administrator', price:10000, location:'Casablanca', image:HERO },
  { id:'aod5', title:'Travel & Logistics Coordinator', price:11000, location:'Rabat', image:HERO },
  { id:'aod6', title:'Office Support Generalist', price:8000, location:'Marrakech', image:HERO },
  { id:'aod7', title:'Virtual Assistant', price:8000, location:'Remote, Morocco', image:HERO },
  { id:'aod8', title:'Administrative Supervisor', price:13000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Admin & Office' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Admin & Office Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Admin & Office</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Admin & Office Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Admin & Office Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Admin & Office Positions</h2>
