...
const topChoices = [
  { id:'es1', title:'Executive Assistant to CEO', desc:'FTSE-listed company Morocco office seeking a bilingual EA for its CEO. Complex diary, international travel, board meeting prep, and stakeholder liaison.', price:22000, location:'Casablanca, Finance City', rating:4.9, reviews:14, image:HERO },
  { id:'es2', title:'Chief of Staff — Startup', desc:'High-growth startup hiring a Chief of Staff to support the founder on strategy, operations, and cross-functional project delivery.', price:28000, location:'Casablanca, Anfa', rating:4.8, reviews:11, image:HERO },
  { id:'es3', title:'PA to Managing Director', desc:'Professional services firm hiring a PA for MD diary management, client entertainment, expense management, and confidential correspondence.', price:16000, location:'Rabat, Agdal', rating:4.7, reviews:18, image:HERO },
]
const bentoListings = [
  { id:'esb1', title:'Executive PA', price:14000, location:'Casablanca', image:HERO },
  { id:'esb2', title:'Board Secretary', price:18000, location:'Rabat', image:HERO },
  { id:'esb3', title:'Personal Assistant', price:12000, location:'Casablanca', image:HERO },
  { id:'esb4', title:'C-Suite Administrator', price:15000, location:'Casablanca', image:HERO },
  { id:'esb5', title:'VIP Concierge Manager', price:16000, location:'Marrakech', image:HERO },
]
const discoveryGrid = [
  { id:'esd1', title:'Executive Coordinator', price:13000, location:'Casablanca', image:HERO },
  { id:'esd2', title:'Director-Level PA', price:14000, location:'Rabat', image:HERO },
  { id:'esd3', title:'Bilingual Executive Assistant', price:16000, location:'Casablanca', image:HERO },
  { id:'esd4', title:'Operations Chief of Staff', price:22000, location:'Casablanca', image:HERO },
  { id:'esd5', title:'Executive Communications Manager', price:18000, location:'Rabat', image:HERO },
  { id:'esd6', title:'Travel & Events PA', price:12000, location:'Casablanca', image:HERO },
  { id:'esd7', title:'Remote Executive Assistant', price:12000, location:'Remote, Morocco', image:HERO },
  { id:'esd8', title:'Executive Support Team Lead', price:20000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Executive Support' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Executive Support Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Executive Support</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Executive Support Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Executive Support Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Executive Support Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
              ...
              <Link key="recruitment" href={`/${locale}/jobs/hr-admin/recruitment`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400" alt="Recruitment" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Recruitment</p>
                  </div>
                </div>
              </Link>
