...
const topChoices = [
  { id:'hm1', title:'HR Director — Multinational', desc:'Leading multinational hiring an HR Director to oversee 800+ employees across Morocco operations. HRIS, ER, and talent strategy ownership.', price:45000, location:'Casablanca, Finance City', rating:4.9, reviews:18, image:HERO },
  { id:'hm2', title:'HR Business Partner — FMCG', desc:'Fast-growing consumer goods company seeking an HRBP to partner with 4 business units on performance, engagement, and organisational design.', price:28000, location:'Casablanca, Maarif', rating:4.8, reviews:24, image:HERO },
  { id:'hm3', title:'HR Manager — Mid-Size Tech Firm', desc:'Tech company hiring an HR Manager to own full HR function for 200 employees. Generalist profile with strong ER and compliance knowledge.', price:22000, location:'Rabat, Agdal', rating:4.7, reviews:31, image:HERO },
]
const bentoListings = [
  { id:'hmb1', title:'HR Generalist', price:14000, location:'Casablanca', image:HERO },
  { id:'hmb2', title:'People Operations Manager', price:20000, location:'Rabat', image:HERO },
  { id:'hmb3', title:'HR Coordinator', price:10000, location:'Marrakech', image:HERO },
  { id:'hmb4', title:'Compensation & Benefits Manager', price:24000, location:'Casablanca', image:HERO },
  { id:'hmb5', title:'Employee Relations Specialist', price:16000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'hmd1', title:'HR Analyst', price:13000, location:'Casablanca', image:HERO },
  { id:'hmd2', title:'HR Project Manager', price:18000, location:'Rabat', image:HERO },
  { id:'hmd3', title:'Workforce Planning Specialist', price:16000, location:'Casablanca', image:HERO },
  { id:'hmd4', title:'HR Compliance Officer', price:15000, location:'Rabat', image:HERO },
  { id:'hmd5', title:'HRIS Administrator', price:14000, location:'Casablanca', image:HERO },
  { id:'hmd6', title:'HR Operations Lead', price:17000, location:'Casablanca', image:HERO },
  { id:'hmd7', title:'Culture & Engagement Manager', price:16000, location:'Rabat', image:HERO },
  { id:'hmd8', title:'HR Shared Services Lead', price:18000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='HR Management' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>HR Management Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>HR Management</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>HR Management Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni HR Management Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More HR Management Positions</h2>
