...
const topChoices = [
  {
    id: 'hr1',
    title: 'Head of Human Resources — Multinational FMCG',
    desc: 'Leading FMCG company in Casablanca seeks an experienced HR Director to oversee 500+ employees. Full talent lifecycle management, compensation strategy, and organizational development.',
    price: 35000,
    location: 'Casablanca, Finance City',
    rating: 4.9,
    reviews: 48,
    image: 'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800',
  },
  {
    id: 'hr2',
    title: 'Senior Recruitment Manager — Tech & Digital',
    desc: 'Fast-growing Moroccan tech company hiring a Senior Talent Acquisition Manager. Own the full recruitment cycle for engineering, product, and data science roles across Morocco and MENA.',
    price: 22000,
  ...
  },
  {
    ...
    desc: 'Prestigious holding group seeking an Administrative Director to manage corporate operations, vendor relationships, facilities, and executive support functions across 3 offices in Morocco.',
    price: 28000,
...
const bentoListings = [
  { id:'bh1', title:'HR Business Partner — Banking Sector',    price:18000, location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=600' },
  { id:'bh2', title:'Payroll & Compensation Specialist',       price:12000, location:'Rabat',      image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'bh3', title:'Training & Development Manager',          price:15000, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'bh4', title:'Executive Assistant to CEO',              price:10000, location:'Marrakech',  image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=600' },
  { id:'bh5', title:'Office Manager — Law Firm',               price:9000,  location:'Rabat',      image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
]

const discoveryGrid = [
  { id:'dh1',  title:'HR Generalist — Startup',               price:8000,  location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=600' },
  { id:'dh2',  title:'Talent Acquisition Specialist',         price:9500,  location:'Rabat',      image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'dh3',  title:'HRIS & Systems Administrator',          price:11000, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'dh4',  title:'Labour Relations & Compliance Officer',  price:13000, location:'Tangier',    image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=600' },
  { id:'dh5',  title:'Administrative Coordinator',            price:7000,  location:'Rabat',      image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'dh6',  title:'Facilities & Office Services Manager',  price:10000, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'dh7',  title:'Diversity & Inclusion Manager',         price:16000, location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=600' },
  { id:'dh8',  title:'Personal Assistant — C-Suite',          price:9000,  location:'Marrakech',  image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
]

const pills = ['All HR & Admin','HR Management','Recruitment','Payroll','Training & Dev','Admin & Office','Executive Support','View More']
...
export default function HRAdminPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      ...
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt="HR & Admin" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>
            Find Top HR &amp; Admin Talent Near You!
          </h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>420 verified HR &amp; Admin positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'-28px auto 0', padding:'0 40px', position:'relative', zIndex:30 }}>
        <div style={{ backgroundColor:'rgba(255,255,255,0.9)', backdropFilter:'blur(20px)', borderRadius:'100px', padding:'10px 10px 10px 24px', boxShadow:'0 8px 40px rgba(0,0,0,0.12)', border:'1px solid rgba(255,255,255,0.6)', display:'flex', alignItems:'center' }}>
          {[
            ...
            { label:'Job Title', val:'HR Manager, Recruiter...' },
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'16px' }}>420 HR &amp; Admin positions across Morocco</p>

        {/* PILLS */}
        <div style={{ display:'flex', gap:'8px', marginBottom:'16px', overflowX:'auto', paddingBottom:'4px' }}>
          {pills.map(pill=>(
            pillSlugs[pill] ? (
              <Link key={pill} href={`/${locale}/jobs/hr-admin/${pillSlugs[pill]}`}
        ...
        {/* BENTO COLLECTION */}
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni HR &amp; Admin Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More HR &amp; Admin Positions</h2>
        ...
        <section style={{ borderRadius:'40px', background:'linear-gradient(135deg,#22d4a8,#0f9b8e)', padding:'56px 48px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'40px', flexWrap:'wrap' as const, marginBottom:'64px' }}>
          <div>
            ...
            <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.85)', maxWidth:'480px', lineHeight:1.7 }}>Post your HR &amp; Admin job today for free and reach thousands of qualified candidates across Morocco.</p>
