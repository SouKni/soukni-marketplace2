...
const topChoices = [
  { id:'r1', title:'Head of Talent Acquisition', desc:'High-growth tech company seeking a Head of TA to build the recruiting function from scratch. Own the full-cycle hiring for 150+ roles per year.', price:32000, location:'Casablanca, Finance City', rating:4.9, reviews:21, image:HERO },
  { id:'r2', title:'Senior Recruiter — Banking Sector', desc:'Major Moroccan bank hiring a Senior Recruiter for specialist and leadership roles. Executive search experience preferred.', price:22000, location:'Casablanca, Anfa', rating:4.8, reviews:17, image:HERO },
  { id:'r3', title:'Technical Recruiter — IT & Engineering', desc:'Software company hiring a Technical Recruiter for dev, data, and infrastructure roles. Boolean search and LinkedIn Recruiter expertise required.', price:18000, location:'Rabat, Agdal', rating:4.7, reviews:29, image:HERO },
]
const bentoListings = [
  { id:'rb1', title:'In-House Recruiter', price:14000, location:'Casablanca', image:HERO },
  { id:'rb2', title:'Campus Recruitment Officer', price:12000, location:'Rabat', image:HERO },
  { id:'rb3', title:'Recruitment Coordinator', price:10000, location:'Casablanca', image:HERO },
  { id:'rb4', title:'Executive Search Consultant', price:20000, location:'Casablanca', image:HERO },
  { id:'rb5', title:'Sourcing Specialist', price:13000, location:'Rabat', image:HERO },
]
const discoveryGrid = [
  { id:'rd1', title:'Volume Recruiter', price:11000, location:'Casablanca', image:HERO },
  { id:'rd2', title:'Employer Brand Specialist', price:14000, location:'Rabat', image:HERO },
  { id:'rd3', title:'Recruitment Marketing Manager', price:16000, location:'Casablanca', image:HERO },
  { id:'rd4', title:'Graduate Recruiter', price:11000, location:'Rabat', image:HERO },
  { id:'rd5', title:'Recruitment Data Analyst', price:13000, location:'Casablanca', image:HERO },
  { id:'rd6', title:'International Recruiter', price:16000, location:'Casablanca', image:HERO },
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Recruitment' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Recruitment Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Recruitment Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Recruitment Positions</h2>
