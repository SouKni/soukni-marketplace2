...
const topChoices = [
  { id:'td1', title:'Learning & Development Manager', desc:'Major telecoms company hiring an L&D Manager to own the annual training plan for 2,000 employees. LMS administration and facilitation skills required.', price:24000, location:'Casablanca, Finance City', rating:4.9, reviews:19, image:HERO },
  { id:'td2', title:'Corporate Trainer — Sales & Leadership', desc:'Consulting firm hiring a Corporate Trainer to deliver sales, communication, and leadership programmes across Morocco and MENA.', price:20000, location:'Casablanca, Maarif', rating:4.8, reviews:15, image:HERO },
  { id:'td3', title:'E-Learning Content Developer', desc:'EdTech company seeking an Instructional Designer to build interactive e-learning modules in Articulate Storyline and Rise.', price:16000, location:'Rabat, Agdal', rating:4.7, reviews:23, image:HERO },
]
const bentoListings = [
  { id:'tdb1', title:'Training Coordinator', price:11000, location:'Casablanca', image:HERO },
  { id:'tdb2', title:'Soft Skills Trainer', price:14000, location:'Rabat', image:HERO },
  { id:'tdb3', title:'LMS Administrator', price:13000, location:'Casablanca', image:HERO },
  { id:'tdb4', title:'Technical Skills Trainer', price:16000, location:'Casablanca', image:HERO },
  { id:'tdb5', title:'Onboarding Specialist', price:12000, location:'Marrakech', image:HERO },
]
const discoveryGrid = [
  { id:'tdd1', title:'Leadership Development Coach', price:18000, location:'Casablanca', image:HERO },
  { id:'tdd2', title:'Training Needs Analyst', price:13000, location:'Rabat', image:HERO },
  { id:'tdd3', title:'Compliance Training Specialist', price:14000, location:'Casablanca', image:HERO },
  { id:'tdd4', title:'Diversity & Inclusion Trainer', price:15000, location:'Casablanca', image:HERO },
  { id:'tdd5', title:'Sales Training Manager', price:18000, location:'Rabat', image:HERO },
  { id:'tdd6', title:'Customer Service Trainer', price:12000, location:'Casablanca', image:HERO },
  { id:'tdd7', title:'Digital Skills Trainer', price:14000, location:'Rabat', image:HERO },
  { id:'tdd8', title:'Training ROI Analyst', price:15000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Training & Dev' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Training & Dev Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Training & Dev</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Training & Dev Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Training & Dev Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Training & Dev Positions</h2>
