...
const topChoices = [
  { id:'cc1', title:'Cold Chain Manager — Food Export', desc:'Major agri-food exporter seeking a Cold Chain Manager to oversee temperature-controlled logistics for fresh produce exports to Europe. ATP certification preferred.', price:28000, location:'Agadir', rating:4.9, reviews:12, image:HERO },
  { id:'cc2', title:'Refrigerated Warehouse Supervisor', desc:'Food distribution company hiring a Refrigerated Warehouse Supervisor for a -25°C to +4°C multi-zone facility. HACCP and food safety knowledge required.', price:16000, location:'Casablanca, Marché de Gros', rating:4.8, reviews:18, image:HERO },
  { id:'cc3', title:'Cold Chain Compliance Officer', desc:'Pharmaceutical importer hiring a Cold Chain Compliance Officer for GDP-compliant storage, temperature logging, and deviation management.', price:18000, location:'Casablanca, Finance City', rating:4.7, reviews:14, image:HERO },
]
const bentoListings = [
  { id:'ccb1', title:'Reefer Truck Driver', price:10000, location:'Casablanca', image:HERO },
  { id:'ccb2', title:'Cold Store Operative', price:7500, location:'Agadir', image:HERO },
  { id:'ccb3', title:'Temperature Monitoring Technician', price:12000, location:'Casablanca', image:HERO },
  { id:'ccb4', title:'Cold Chain Coordinator', price:13000, location:'Rabat', image:HERO },
  { id:'ccb5', title:'Frozen Food Distribution Manager', price:18000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'ccd1', title:'Cold Room Maintenance Technician', price:13000, location:'Casablanca', image:HERO },
  { id:'ccd2', title:'Pharmaceutical Cold Chain Specialist', price:16000, location:'Casablanca', image:HERO },
  { id:'ccd3', title:'Fresh Produce Logistics Coordinator', price:14000, location:'Agadir', image:HERO },
  { id:'ccd4', title:'Cold Chain Data Analyst', price:13000, location:'Rabat', image:HERO },
  { id:'ccd5', title:'HACCP Quality Controller', price:12000, location:'Casablanca', image:HERO },
  { id:'ccd6', title:'Cold Chain Training Officer', price:14000, location:'Casablanca', image:HERO },
  { id:'ccd7', title:'Frozen Goods Import Agent', price:13000, location:'Tangier', image:HERO },
  { id:'ccd8', title:'Cold Chain Risk Manager', price:18000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Cold Chain' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Cold Chain Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Cold Chain</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Cold Chain Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Cold Chain Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Cold Chain Positions</h2>
