...
const topChoices = [
  { id:'ie1', title:'Import/Export Manager', desc:'International trading company seeking an Import/Export Manager to oversee customs clearance, freight forwarding, and supplier/buyer documentation across 12 markets.', price:28000, location:'Casablanca, Port', rating:4.9, reviews:15, image:HERO },
  { id:'ie2', title:'Customs Clearance Specialist', desc:'Licensed customs broker hiring a Clearance Specialist for maritime and air freight declarations, TIR carnets, and Ministry of Commerce liaison.', price:18000, location:'Casablanca, Derb Omar', rating:4.8, reviews:23, image:HERO },
  { id:'ie3', title:'International Trade Coordinator', desc:'FMCG exporter hiring a Trade Coordinator for export documentation, L/C management, phytosanitary certificates, and freight booking.', price:14000, location:'Agadir', rating:4.7, reviews:19, image:HERO },
]
const bentoListings = [
  { id:'ieb1', title:'Customs Declaration Agent', price:12000, location:'Casablanca', image:HERO },
  { id:'ieb2', title:'Freight Forwarding Coordinator', price:13000, location:'Tangier', image:HERO },
  { id:'ieb3', title:'Trade Finance Specialist', price:16000, location:'Casablanca', image:HERO },
  { id:'ieb4', title:'Export Documentation Clerk', price:10000, location:'Agadir', image:HERO },
  { id:'ieb5', title:'Port Logistics Agent', price:11000, location:'Tangier Med', image:HERO },
]
const discoveryGrid = [
  { id:'ied1', title:'Incoterms Compliance Officer', price:14000, location:'Casablanca', image:HERO },
  { id:'ied2', title:'Bonded Warehouse Administrator', price:11000, location:'Tangier', image:HERO },
  { id:'ied3', title:'Air Freight Agent', price:12000, location:'Casablanca', image:HERO },
  { id:'ied4', title:'Sea Freight Coordinator', price:13000, location:'Casablanca', image:HERO },
  { id:'ied5', title:'Tariff Classification Specialist', price:15000, location:'Rabat', image:HERO },
  { id:'ied6', title:'Export Sales Coordinator', price:14000, location:'Casablanca', image:HERO },
  { id:'ied7', title:'Import Procurement Agent', price:13000, location:'Casablanca', image:HERO },
  { id:'ied8', title:'Global Logistics Analyst', price:16000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Import/Export' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Import/Export Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>175 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Import/Export</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Import/Export Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>175 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Import/Export Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Import/Export Positions</h2>
