...
const topChoices = [
  { id:'sc1', title:'Supply Chain Director', desc:'Major FMCG group seeking a Supply Chain Director to oversee end-to-end operations for Morocco and West Africa. S&OP, procurement, and distribution ownership.', price:48000, location:'Casablanca, Finance City', rating:4.9, reviews:16, image:HERO },
  { id:'sc2', title:'Supply Chain Manager — Manufacturing', desc:'Industrial manufacturer hiring an SCM to manage sourcing, production planning, and finished goods distribution across 3 Moroccan sites.', price:30000, location:'Tangier Free Zone', rating:4.8, reviews:21, image:HERO },
  { id:'sc3', title:'Supply Chain Analyst', desc:'E-commerce company seeking an SC Analyst for demand forecasting, inventory optimisation, and supplier performance tracking.', price:16000, location:'Casablanca, Sidi Maarouf', rating:4.7, reviews:28, image:HERO },
]
const bentoListings = [
  { id:'scb1', title:'Procurement Manager', price:24000, location:'Casablanca', image:HERO },
  { id:'scb2', title:'Inventory Control Specialist', price:14000, location:'Rabat', image:HERO },
  { id:'scb3', title:'Demand Planner', price:16000, location:'Casablanca', image:HERO },
  { id:'scb4', title:'Supplier Relationship Manager', price:20000, location:'Casablanca', image:HERO },
  { id:'scb5', title:'Supply Chain Coordinator', price:12000, location:'Tangier', image:HERO },
]
const discoveryGrid = [
  { id:'scd1', title:'Logistics Planner', price:13000, location:'Casablanca', image:HERO },
  { id:'scd2', title:'Category Manager', price:18000, location:'Rabat', image:HERO },
  { id:'scd3', title:'S&OP Manager', price:22000, location:'Casablanca', image:HERO },
  { id:'scd4', title:'Supply Chain Systems Analyst', price:15000, location:'Casablanca', image:HERO },
  { id:'scd5', title:'Sourcing Specialist', price:14000, location:'Rabat', image:HERO },
  { id:'scd6', title:'Global Trade Compliance Officer', price:18000, location:'Casablanca', image:HERO },
  { id:'scd7', title:'Supply Chain Risk Manager', price:20000, location:'Casablanca', image:HERO },
  { id:'scd8', title:'3PL Relationship Manager', price:16000, location:'Tangier', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Supply Chain' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Supply Chain Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Supply Chain</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Supply Chain Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Supply Chain Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Supply Chain Positions</h2>
