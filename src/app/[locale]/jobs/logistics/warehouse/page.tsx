...
const topChoices = [
  { id:'w1', title:'Warehouse Manager — 3PL', desc:'Major 3PL operator seeking a Warehouse Manager for a 25,000m² fulfilment centre near Casablanca. Team of 80, WMS ownership, KPI management.', price:22000, location:'Casablanca, Nouaceur', rating:4.9, reviews:19, image:HERO },
  { id:'w2', title:'Warehouse Operations Supervisor', desc:'Retail distribution company hiring a Warehouse Supervisor for inbound, picking, packing, and outbound operations. Night shift leadership experience preferred.', price:14000, location:'Rabat, Salé', rating:4.8, reviews:31, image:HERO },
  { id:'w3', title:'Forklift Operator — Bonded Warehouse', desc:'Customs bonded warehouse seeking certified Forklift Operators for palletised goods handling. CACES or equivalent certification required.', price:8000, location:'Tangier Med Port', rating:4.7, reviews:44, image:HERO },
]
const bentoListings = [
  { id:'wb1', title:'Warehouse Operative', price:7000, location:'Casablanca', image:HERO },
  { id:'wb2', title:'Stock Controller', price:10000, location:'Rabat', image:HERO },
  { id:'wb3', title:'Picker & Packer', price:6500, location:'Casablanca', image:HERO },
  { id:'wb4', title:'Goods-In Clerk', price:8000, location:'Tangier', image:HERO },
  { id:'wb5', title:'Warehouse Shift Leader', price:12000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'wd1', title:'Receiving & Inspection Clerk', price:8000, location:'Casablanca', image:HERO },
  { id:'wd2', title:'Returns Processing Operative', price:7000, location:'Rabat', image:HERO },
  { id:'wd3', title:'WMS Administrator', price:12000, location:'Casablanca', image:HERO },
  { id:'wd4', title:'Kitting & Assembly Operative', price:7500, location:'Tangier', image:HERO },
  { id:'wd5', title:'Hazmat Warehouse Operative', price:9000, location:'Casablanca', image:HERO },
  { id:'wd6', title:'Automated Warehouse Technician', price:13000, location:'Casablanca', image:HERO },
  { id:'wd7', title:'Inventory Auditor', price:11000, location:'Rabat', image:HERO },
  { id:'wd8', title:'Warehouse Health & Safety Officer', price:14000, location:'Casablanca', image:HERO },
]
...
export default function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const PAGE_SIZE = Math.max(4, Math.ceil(discoveryGrid.length / 4))
  ...
  const paginatedDiscoveryGrid = filteredDiscoveryGrid.slice((clampedPage-1)*PAGE_SIZE, clampedPage*PAGE_SIZE)
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Warehouse' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Warehouse Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Warehouse Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Warehouse Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Warehouse Positions</h2>
        ...
        <div style={{ display:'flex', justifyContent:'center', alignItems:'center', gap:'8px', marginBottom:'48px' }}>
          ...
          <button onClick={()=>setPage(p=>Math.min(totalPages,p+1))} disabled={clampedPage>=totalPages}
            style={{ padding:'0 16px', height:'36px', borderRadius:'10px', border:'1px solid #e2e8f0', backgroundColor:'white', color:'#161d1b', fontWeight:700, fontSize:'13px', cursor:clampedPage>=totalPages?'not-allowed':'pointer', opacity:clampedPage>=totalPages?0.4:1, display:'flex', alignItems:'center', gap:'4px' }}>Next <ChevronRight size={14} /></button>
        </div>
        <section style={{ marginBottom:'40px' }}>
        ...
        <CategoryFooterNav
          ...
          related={[
            { label:'Supply Chain', href:`/${locale}/jobs/logistics/supply-chain` },
            { label:'Fleet Management', href:`/${locale}/jobs/logistics/fleet-management` },
            { label:'Import/Export', href:`/${locale}/jobs/logistics/import-export` },
            { label:'Last-Mile Delivery', href:`/${locale}/jobs/logistics/last-mile-delivery` },
            { label:'Cold Chain', href:`/${locale}/jobs/logistics/cold-chain` },
          ]}
