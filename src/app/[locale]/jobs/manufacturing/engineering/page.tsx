...
const topChoices = [
  { id:'e1', title:'Process Engineer — Automotive', desc:'Major OEM supplier seeking a Process Engineer for process improvement, cycle time reduction, and new model launch support on assembly lines.', price:24000, location:'Tangier Free Zone', rating:4.9, reviews:19, image:HERO },
  { id:'e2', title:'Industrial Engineer — Lean Manufacturing', desc:'Aeronautics manufacturer hiring an Industrial Engineer for VSM, kaizen facilitation, and ergonomics improvement across 4 production zones.', price:22000, location:'Casablanca, MIDPARC', rating:4.8, reviews:16, image:HERO },
  { id:'e3', title:'Mechanical Design Engineer', desc:'Precision components manufacturer seeking a Mechanical Design Engineer for CAD design, DFMEA, and prototype validation.', price:20000, location:'Casablanca, Ain Sebaa', rating:4.7, reviews:14, image:HERO },
]
const bentoListings = [
  { id:'eb1', title:'Automation Engineer', price:22000, location:'Tangier Free Zone', image:HERO },
  { id:'eb2', title:'Methods & Tooling Engineer', price:18000, location:'Casablanca', image:HERO },
  { id:'eb3', title:'Project Engineer', price:20000, location:'Kenitra', image:HERO },
  { id:'eb4', title:'R&D Engineer', price:22000, location:'Rabat', image:HERO },
  { id:'eb5', title:'Manufacturing Engineer', price:19000, location:'Tangier', image:HERO },
]
const discoveryGrid = [
  { id:'ed1', title:'Welding Engineer', price:18000, location:'Casablanca', image:HERO },
  { id:'ed2', title:'Plastics Process Engineer', price:17000, location:'Tangier', image:HERO },
  { id:'ed3', title:'Robotics Programmer', price:22000, location:'Tangier Free Zone', image:HERO },
  { id:'ed4', title:'CAD Designer', price:14000, location:'Casablanca', image:HERO },
  { id:'ed5', title:'Tooling Designer', price:16000, location:'Kenitra', image:HERO },
  { id:'ed6', title:'Energy Engineer', price:18000, location:'Casablanca', image:HERO },
  { id:'ed7', title:'Cost Estimating Engineer', price:17000, location:'Tangier', image:HERO },
  { id:'ed8', title:'NPI Engineer', price:20000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Engineering' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Engineering Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>195 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Engineering Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>195 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Engineering Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Engineering Positions</h2>
