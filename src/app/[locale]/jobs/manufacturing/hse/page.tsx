...
const HERO = 'https://images.pexels.com/photos/1546168/pexels-photo-1546168.jpeg?auto=compress&w=800'
const topChoices = [
  { id:'h1', title:'HSE Manager — Industrial Site', desc:'Major chemical plant seeking an HSE Manager to lead safety culture, regulatory compliance, and incident investigation across a 400-person site. NEBOSH preferred.', price:28000, location:'Casablanca, Mohammedia', rating:4.9, reviews:13, image:HERO },
  { id:'h2', title:'HSE Engineer — Automotive', desc:'Automotive OEM supplier hiring an HSE Engineer for risk assessment, safety audits, and ergonomics programmes across 3 production shifts.', price:20000, location:'Tangier Free Zone', rating:4.8, reviews:19, image:HERO },
  { id:'h3', title:'HSE Officer — Construction', desc:'Major infrastructure contractor seeking HSE Officers for site induction, permit-to-work management, and daily safety walks.', price:14000, location:'Casablanca & Rabat', rating:4.7, reviews:26, image:HERO },
]
const bentoListings = [
  { id:'hb1', title:'Environmental Compliance Officer', price:16000, location:'Casablanca', image:HERO },
  { id:'hb2', title:'Fire Safety Engineer', price:18000, location:'Tangier', image:HERO },
  { id:'hb3', title:'HSE Trainer', price:14000, location:'Casablanca', image:HERO },
  { id:'hb4', title:'Occupational Health Nurse', price:12000, location:'Kenitra', image:HERO },
  { id:'hb5', title:'HSE Coordinator', price:12000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'hd1', title:'Process Safety Engineer', price:20000, location:'Casablanca', image:HERO },
  { id:'hd2', title:'Waste Management Officer', price:13000, location:'Rabat', image:HERO },
  { id:'hd3', title:'HSE Auditor', price:16000, location:'Casablanca', image:HERO },
  { id:'hd4', title:'Emergency Response Coordinator', price:15000, location:'Tangier', image:HERO },
  { id:'hd5', title:'Ergonomics Specialist', price:14000, location:'Casablanca', image:HERO },
  { id:'hd6', title:'Chemical Safety Officer', price:15000, location:'Mohammedia', image:HERO },
  { id:'hd7', title:'HSE Data Analyst', price:13000, location:'Casablanca', image:HERO },
  { id:'hd8', title:'ISO 45001 Implementation Lead', price:18000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='HSE' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>HSE Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>HSE Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni HSE Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More HSE Positions</h2>
