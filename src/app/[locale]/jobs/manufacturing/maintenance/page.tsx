...
const topChoices = [
  { id:'m1', title:'Maintenance Manager — Automotive Plant', desc:'Tier 1 automotive supplier seeking a Maintenance Manager for a 600-person plant. TPM deployment, CMMS ownership, and 40-technician team management.', price:30000, location:'Kenitra, AIVP', rating:4.9, reviews:14, image:HERO },
  { id:'m2', title:'Electromechanical Maintenance Technician', desc:'Food manufacturer hiring Electromechanical Technicians for preventive and corrective maintenance on filling, sealing, and packaging lines.', price:13000, location:'Casablanca, Oukacha', rating:4.8, reviews:28, image:HERO },
  { id:'m3', title:'CNC Maintenance Specialist', desc:'Precision machining company seeking a CNC Maintenance Specialist for Fanuc and Siemens control systems. PLC programming a strong plus.', price:18000, location:'Casablanca, Ain Sebaa', rating:4.7, reviews:19, image:HERO },
]
const bentoListings = [
  { id:'mb1', title:'Mechanical Maintenance Tech', price:11000, location:'Tangier', image:HERO },
  { id:'mb2', title:'Electrical Maintenance Tech', price:12000, location:'Casablanca', image:HERO },
  { id:'mb3', title:'CMMS Administrator', price:13000, location:'Kenitra', image:HERO },
  { id:'mb4', title:'Pneumatics & Hydraulics Tech', price:13000, location:'Tangier Free Zone', image:HERO },
  { id:'mb5', title:'Maintenance Planner', price:14000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'md1', title:'Predictive Maintenance Analyst', price:15000, location:'Casablanca', image:HERO },
  { id:'md2', title:'Boiler & Steam Engineer', price:14000, location:'Casablanca', image:HERO },
  { id:'md3', title:'Instrumentation Technician', price:14000, location:'Tangier', image:HERO },
  { id:'md4', title:'Conveyor Systems Technician', price:12000, location:'Kenitra', image:HERO },
  { id:'md5', title:'Compressed Air Systems Tech', price:12000, location:'Casablanca', image:HERO },
  { id:'md6', title:'Maintenance Scheduler', price:11000, location:'Tangier Free Zone', image:HERO },
  { id:'md7', title:'Building Maintenance Supervisor', price:13000, location:'Casablanca', image:HERO },
  { id:'md8', title:'Spare Parts Manager', price:14000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Maintenance' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Maintenance Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>250 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Maintenance Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>250 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Maintenance Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Maintenance Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
              <Link key="production" href={`/${locale}/jobs/manufacturing/production`}
              ...
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=400" alt="Production" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  ...
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Production</p>
                  </div>
                </div>
              </Link>
