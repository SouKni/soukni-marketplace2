...
const HERO = 'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=1600'

const topChoices = [
  {
    id: 'mw1',
    title: 'Plant Manager — Automotive Manufacturing',
    desc: 'Major Tier-1 automotive supplier in Tangier seeks an experienced Plant Manager to oversee production of 2,000+ units/day. P&L responsibility, lean manufacturing, and team leadership of 400+ operators.',
    price: 45000,
  ...
  {
    id: 'mw2',
    title: 'Production Director — Food & Beverage',
    desc: 'Leading F&B manufacturer in Casablanca hiring a Production Director to manage 3 production lines, 200+ staff, and full compliance with ISO 22000 and HACCP standards across all shifts.',
    price: 38000,
  ...
  {
    id: 'mw3',
    title: 'Quality Control Manager — Aerospace',
    desc: 'Prestigious aerospace manufacturer in Nouaceur seeks a QC Manager with experience in AS9100 and Nadcap certifications. Responsible for incoming inspection, in-process control, and final acceptance testing.',
    price: 32000,
...
const bentoListings = [
  { id:'bm1', title:'Lean Manufacturing Engineer',          price:18000, location:'Tangier',    image:'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=600' },
  { id:'bm2', title:'Warehouse Supervisor — Night Shift',  price:10000, location:'Casablanca', image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600' },
  { id:'bm3', title:'Industrial Maintenance Technician',   price:12000, location:'Kenitra',    image:'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=600' },
  { id:'bm4', title:'Production Line Supervisor',          price:9500,  location:'Tangier',    image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600' },
  { id:'bm5', title:'HSE Manager — Chemical Plant',        price:22000, location:'Jorf Lasfar', image:'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=600' },
]

const discoveryGrid = [
  { id:'dm1',  title:'CNC Machinist — Precision Parts',     price:8000,  location:'Casablanca', image:'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=600' },
  { id:'dm2',  title:'Process Engineer — Textiles',         price:11000, location:'Fès',        image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600' },
  { id:'dm3',  title:'Inventory & Stock Controller',        price:8500,  location:'Tangier',    image:'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=600' },
  { id:'dm4',  title:'Packaging Line Operator — Senior',    price:7000,  location:'Casablanca', image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600' },
  { id:'dm5',  title:'EHS Coordinator — Manufacturing',     price:13000, location:'Kenitra',    image:'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=600' },
  { id:'dm6',  title:'Welding & Fabrication Specialist',    price:9000,  location:'Tangier',    image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600' },
  { id:'dm7',  title:'Automation & Robotics Engineer',      price:20000, location:'Casablanca', image:'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=600' },
  { id:'dm8',  title:'Forklift Operator & Material Handler', price:6500, location:'Casablanca', image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600' },
]

const pills = ['All Manufacturing','Production','Quality Control','Warehouse Ops','Engineering','Maintenance','HSE','View More']
...
export default function ManufacturingPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = React.use(params)
  const [city, setCity] = useState('')
  const [keyword, setKeyword] = useState('')
  const [applied, setApplied] = useState({ keyword: '', city: '', price: 'Any Range' })
  const [salary, setSalary] = useState('Any Range')
  const [activePill, setActivePill] = useState('All Manufacturing')
  ...
  const filteredDiscoveryGrid = filteredDiscoveryGridAll.slice((activePage-1)*DISCOVERY_PAGE_SIZE, activePage*DISCOVERY_PAGE_SIZE)
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      ...
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt="Manufacturing & Warehouse" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>
            Find Top Manufacturing &amp; Warehouse Jobs!
          </h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>720 verified manufacturing &amp; warehouse positions across Morocco</p>
          <div style={{ display:'flex', alignItems:'stretch', backgroundColor:'rgba(255,255,255,0.12)', backdropFilter:'blur(24px)', border:'1px solid rgba(255,255,255,0.25)', borderRadius:'100px', overflow:'hidden', maxWidth:'680px', margin:'0 auto', boxShadow:'0 8px 32px rgba(0,0,0,0.2)' }}>
            <div style={{ display:'flex', flexDirection:'column' as const, padding:'14px 20px', flex:'0 0 180px', borderRight:'1px solid rgba(255,255,255,0.2)', gap:'2px' }}>
              ...
              <input value={city} onChange={e=>setCity(e.target.value)} placeholder="Tangier"
            ...
            <div style={{ display:'flex', flexDirection:'column' as const, padding:'14px 20px', flex:1, borderRight:'1px solid rgba(255,255,255,0.2)', gap:'2px' }}>
              ...
              <input value={keyword} onChange={e=>setKeyword(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} placeholder="Plant manager, production, quality..."
                style={{ backgroundColor:'transparent', border:'none', outline:'none', fontSize:'14px', fontWeight:600, color:'white', fontFamily:'Inter, sans-serif', padding:0, width:'100%' }} />
            </div>
      ...
      <div style={{ maxWidth:'1440px', margin:'-28px auto 0', padding:'0 40px', position:'relative', zIndex:30 }}>
        <div style={{ backgroundColor:'rgba(255,255,255,0.9)', backdropFilter:'blur(20px)', borderRadius:'100px', padding:'10px 10px 10px 24px', boxShadow:'0 8px 40px rgba(0,0,0,0.12)', border:'1px solid rgba(255,255,255,0.6)', display:'flex', alignItems:'center' }}>
          <div style={{ flex:1, padding:'6px 20px', borderRight:'1px solid rgba(186,202,197,0.3)', display:'flex', flexDirection:'column' as const, gap:'1px' }}>
            ...
            <input value={city} onChange={e=>setCity(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} placeholder="Tangier" style={{ fontSize:'13px', fontWeight:500, color:'#161d1b', border:'none', outline:'none', background:'none', padding:0, width:'100%', fontFamily:'inherit' }} />
          </div>
          <div style={{ flex:2, padding:'6px 20px', borderRight:'1px solid rgba(186,202,197,0.3)', display:'flex', flexDirection:'column' as const, gap:'1px' }}>
            ...
            <input value={keyword} onChange={e=>setKeyword(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} placeholder="Plant manager, production, quality..." style={{ fontSize:'13px', fontWeight:500, color:'#161d1b', border:'none', outline:'none', background:'none', padding:0, width:'100%', fontFamily:'inherit' }} />
          </div>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Manufacturing &amp; Warehouse Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'16px' }}>720 Manufacturing &amp; Warehouse positions across Morocco</p>

        <div style={{ display:'flex', gap:'8px', marginBottom:'16px', overflowX:'auto', paddingBottom:'4px' }}>
          {pills.map(pill=>(
            pillSlugs[pill] ? (
              <Link key={pill} href={`/${locale}/jobs/manufacturing/${pillSlugs[pill]}`}
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', padding:'12px 0', borderTop:'1px solid rgba(186,202,197,0.25)', borderBottom:'1px solid rgba(186,202,197,0.25)', marginBottom:'16px', flexWrap:'wrap' as const, gap:'10px' }}>
          <div style={{ display:'flex', gap:'6px' }}>
            {['All','Full-Time','Part-Time','Shift Work'].map(tab=>(
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Manufacturing Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Manufacturing &amp; Warehouse Positions</h2>
        ...
        <div style={{ display:'flex', justifyContent:'center', alignItems:'center', gap:'8px', marginBottom:'48px' }}>
          ...
          <button onClick={()=>setActivePage(p=>Math.min(discoveryTotalPages,p+1))} disabled={activePage>=discoveryTotalPages}
            style={{ padding:'0 16px', height:'36px', borderRadius:'10px', border:'1px solid #e2e8f0', backgroundColor:'white', color:'#161d1b', fontWeight:700, fontSize:'13px', cursor:activePage>=discoveryTotalPages?'not-allowed':'pointer', opacity:activePage>=discoveryTotalPages?0.4:1, display:'flex', alignItems:'center', gap:'4px' }}>
        ...
        <section style={{ borderRadius:'40px', background:'linear-gradient(135deg,#22d4a8,#0f9b8e)', padding:'56px 48px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'40px', flexWrap:'wrap' as const, marginBottom:'64px' }}>
          <div>
            ...
            <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.85)', maxWidth:'480px', lineHeight:1.7 }}>Post your manufacturing or warehouse job today for free and reach thousands of qualified candidates across Morocco.</p>
        ...
        <CategoryFooterNav
          relatedTitle="Explore Other Manufacturing Jobs"
          related={[
            { label:'Production', href:`/${locale}/jobs/manufacturing/production` },
            { label:'Quality Control', href:`/${locale}/jobs/manufacturing/quality-control` },
            { label:'Warehouse Ops', href:`/${locale}/jobs/manufacturing/warehouse-ops` },
            { label:'Engineering', href:`/${locale}/jobs/manufacturing/engineering` },
            { label:'Maintenance', href:`/${locale}/jobs/manufacturing/maintenance` },
            { label:'HSE', href:`/${locale}/jobs/manufacturing/hse` },
          ]}
