...
const topChoices = [
  { id:'p1', title:'Production Manager — Automotive Parts', desc:'Tier 1 automotive supplier in Tangier seeking a Production Manager for a high-volume stamping and assembly line. Lean/TPM expertise required.', price:32000, location:'Tangier Free Zone', rating:4.9, reviews:18, image:HERO },
  { id:'p2', title:'Production Supervisor — Food & Beverage', desc:'Major F&B manufacturer hiring a Production Supervisor for a 3-shift operation. HACCP knowledge and team leadership experience required.', price:18000, location:'Casablanca, Ain Sebaa', rating:4.8, reviews:26, image:HERO },
  { id:'p3', title:'Production Planner — Textile', desc:'Textile exporter seeking a Production Planner for order scheduling, capacity planning, and liaison with procurement and logistics teams.', price:16000, location:'Fès, Zone Industrielle', rating:4.7, reviews:21, image:HERO },
]
const bentoListings = [
  { id:'pb1', title:'Line Leader', price:9000, location:'Tangier', image:HERO },
  { id:'pb2', title:'Production Coordinator', price:13000, location:'Casablanca', image:HERO },
  { id:'pb3', title:'Production Operator', price:7000, location:'Kenitra', image:HERO },
  { id:'pb4', title:'Shift Production Manager', price:20000, location:'Tangier Free Zone', image:HERO },
  { id:'pb5', title:'Production Scheduler', price:14000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'pd1', title:'Assembly Line Operator', price:7500, location:'Tangier', image:HERO },
  { id:'pd2', title:'Production Data Analyst', price:13000, location:'Casablanca', image:HERO },
  { id:'pd3', title:'Continuous Improvement Lead', price:18000, location:'Tangier Free Zone', image:HERO },
  { id:'pd4', title:'Production Clerk', price:8000, location:'Fès', image:HERO },
  { id:'pd5', title:'Packaging Line Operator', price:7000, location:'Casablanca', image:HERO },
  { id:'pd6', title:'Production Team Leader', price:11000, location:'Kenitra', image:HERO },
  { id:'pd7', title:'Injection Moulding Operator', price:8500, location:'Tangier', image:HERO },
  { id:'pd8', title:'Batch Production Chemist', price:15000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Production' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Production Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <Breadcrumb
          items={[
            ...
            { label:'Manufacturing', href:`/${locale}/jobs/manufacturing` },
            { label:'Production' },
          ]}
          mutedColor="#6b7a76"
          inkColor="#161d1b"
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Production Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Production Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Production Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h3 style={{ fontWeight:900, fontSize:'16px', color:'#161d1b', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'16px' }}>Explore Other Manufacturing Categories</h3>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
              <Link key="quality-control" href={`/${locale}/jobs/manufacturing/quality-control`}
              ...
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400" alt="Quality Control" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  ...
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Quality Control</p>
                  </div>
                </div>
              </Link>
              <Link key="warehouse-ops" href={`/${locale}/jobs/manufacturing/warehouse-ops`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400" alt="Warehouse Ops" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Warehouse Ops</p>
                  </div>
                </div>
              </Link>
              <Link key="engineering" href={`/${locale}/jobs/manufacturing/engineering`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400" alt="Engineering" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Engineering</p>
                  </div>
                </div>
              </Link>
              <Link key="maintenance" href={`/${locale}/jobs/manufacturing/maintenance`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=400" alt="Maintenance" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Maintenance</p>
                  </div>
                </div>
              </Link>
              <Link key="hse" href={`/${locale}/jobs/manufacturing/hse`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/1546168/pexels-photo-1546168.jpeg?auto=compress&w=400" alt="HSE" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>HSE</p>
                  </div>
                </div>
              </Link>
        ...
        <CategoryFooterNav
          backHref={`/${locale}/jobs/manufacturing`}
