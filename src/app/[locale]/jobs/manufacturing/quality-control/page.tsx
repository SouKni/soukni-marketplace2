...
const topChoices = [
  { id:'qc1', title:'Quality Manager — ISO 9001', desc:'Precision engineering company seeking a Quality Manager to lead ISO 9001 certification, internal audits, and customer quality liaison.', price:28000, location:'Casablanca, Ain Sebaa', rating:4.9, reviews:15, image:HERO },
  { id:'qc2', title:'Quality Engineer — Automotive', desc:'Tier 1 automotive supplier hiring a Quality Engineer for APQP, PPAP, and 8D problem-solving across stamping and injection lines.', price:20000, location:'Tangier Free Zone', rating:4.8, reviews:22, image:HERO },
  { id:'qc3', title:'Quality Inspector — Food Manufacturing', desc:'Food manufacturer seeking QC Inspectors for in-process and finished goods inspection. BRC/IFS audit experience preferred.', price:11000, location:'Casablanca, Marché de Gros', rating:4.7, reviews:31, image:HERO },
]
const bentoListings = [
  { id:'qb1', title:'Quality Technician', price:10000, location:'Tangier', image:HERO },
  { id:'qb2', title:'Metrology & Calibration Engineer', price:16000, location:'Casablanca', image:HERO },
  { id:'qb3', title:'Supplier Quality Engineer', price:18000, location:'Tangier Free Zone', image:HERO },
  { id:'qb4', title:'Quality Systems Coordinator', price:13000, location:'Rabat', image:HERO },
  { id:'qb5', title:'Laboratory Quality Analyst', price:12000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'qd1', title:'NDT Inspector', price:14000, location:'Casablanca', image:HERO },
  { id:'qd2', title:'Quality Auditor', price:15000, location:'Tangier', image:HERO },
  { id:'qd3', title:'Document Control Specialist', price:11000, location:'Casablanca', image:HERO },
  { id:'qd4', title:'Customer Quality Liaison', price:16000, location:'Tangier Free Zone', image:HERO },
  { id:'qd5', title:'Statistical Process Control Analyst', price:14000, location:'Casablanca', image:HERO },
  { id:'qd6', title:'Product Compliance Engineer', price:18000, location:'Rabat', image:HERO },
  { id:'qd7', title:'Quality Training Officer', price:13000, location:'Casablanca', image:HERO },
  { id:'qd8', title:'Quality Data Analyst', price:14000, location:'Tangier', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Quality Control' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Quality Control Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>220 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Quality Control Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>220 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Quality Control Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Quality Control Positions</h2>
