...
const topChoices = [
  { id:'wo1', title:'Warehouse Operations Manager — Manufacturing', desc:'Automotive plant seeking a Warehouse Ops Manager for WIP, raw materials, and finished goods management across a 15,000m² internal warehouse.', price:22000, location:'Kenitra, AIVP', rating:4.9, reviews:17, image:HERO },
  { id:'wo2', title:'Raw Materials Stores Supervisor', desc:'Chemical manufacturer hiring a Stores Supervisor for hazmat raw material receipt, storage, and issuance to production lines. COSHH awareness required.', price:14000, location:'Casablanca, Ain Sebaa', rating:4.7, reviews:24, image:HERO },
  { id:'wo3', title:'Finished Goods Warehouse Operative', desc:'FMCG manufacturer seeking Warehouse Operatives for palletising, wrapping, and loading finished goods for outbound distribution.', price:7500, location:'Casablanca, Oukacha', rating:4.6, reviews:48, image:HERO },
]
const bentoListings = [
  { id:'wob1', title:'Stores Controller', price:11000, location:'Tangier', image:HERO },
  { id:'wob2', title:'WMS Operator', price:12000, location:'Casablanca', image:HERO },
  { id:'wob3', title:'Goods-In Inspector', price:9000, location:'Kenitra', image:HERO },
  { id:'wob4', title:'Warehouse Shift Supervisor', price:14000, location:'Casablanca', image:HERO },
  { id:'wob5', title:'Kitting & Sequencing Operative', price:8000, location:'Tangier Free Zone', image:HERO },
]
const discoveryGrid = [
  { id:'wod1', title:'Cycle Count Coordinator', price:10000, location:'Casablanca', image:HERO },
  { id:'wod2', title:'Spare Parts Stores Keeper', price:9500, location:'Tangier', image:HERO },
  { id:'wod3', title:'Forklift Operator', price:8500, location:'Kenitra', image:HERO },
  { id:'wod4', title:'Returns & Rework Handler', price:8000, location:'Casablanca', image:HERO },
  { id:'wod5', title:'Inventory Planner', price:13000, location:'Casablanca', image:HERO },
  { id:'wod6', title:'Cross-Dock Operative', price:8000, location:'Tangier Free Zone', image:HERO },
  { id:'wod7', title:'Warehouse Safety Marshal', price:10000, location:'Casablanca', image:HERO },
  { id:'wod8', title:'Automated Store Technician', price:13000, location:'Tangier', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Warehouse Ops' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Warehouse Ops Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>285 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Warehouse Ops Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>285 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Warehouse Ops Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Warehouse Ops Positions</h2>
