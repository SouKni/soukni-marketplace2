...
const topChoices = [
  { id:'bc1', title:'Creative Director — Advertising Agency', desc:'Top Casablanca agency seeking a Creative Director to lead a team of 12 across brand identity, campaigns, and digital content. Portfolio of regional work required.', price:32000, location:'Casablanca, Maarif', rating:4.9, reviews:22, image:HERO },
  { id:'bc2', title:'Brand Manager — FMCG', desc:'International consumer goods company hiring a Brand Manager to own positioning, ATL/BTL planning, and agency briefing for a key Moroccan brand.', price:20000, location:'Casablanca, Anfa', rating:4.8, reviews:18, image:HERO },
  { id:'bc3', title:'Senior Art Director', desc:'Digital agency seeking a Senior Art Director with strong conceptual skills across print, digital, and social. Motion graphics experience is a plus.', price:17000, location:'Rabat, Agdal', rating:4.7, reviews:15, image:HERO },
]
const bentoListings = [
  { id:'bcb1', title:'Junior Graphic Designer', price:7000, location:'Casablanca', image:HERO },
  { id:'bcb2', title:'Brand Strategist', price:16000, location:'Rabat', image:HERO },
  { id:'bcb3', title:'Motion Graphics Designer', price:12000, location:'Casablanca', image:HERO },
  { id:'bcb4', title:'UX/UI Designer', price:14000, location:'Casablanca', image:HERO },
  { id:'bcb5', title:'Creative Copywriter', price:10000, location:'Marrakech', image:HERO },
]
const discoveryGrid = [
  { id:'bcd1', title:'Visual Identity Designer', price:11000, location:'Casablanca', image:HERO },
  { id:'bcd2', title:'Packaging Designer', price:10000, location:'Rabat', image:HERO },
  { id:'bcd3', title:'Brand Activation Manager', price:15000, location:'Casablanca', image:HERO },
  { id:'bcd4', title:'Illustrator & Visual Artist', price:9000, location:'Marrakech', image:HERO },
  { id:'bcd5', title:'Creative Project Manager', price:14000, location:'Casablanca', image:HERO },
  { id:'bcd6', title:'3D Product Visualizer', price:12000, location:'Rabat', image:HERO },
  { id:'bcd7', title:'Brand Content Creator', price:10000, location:'Casablanca', image:HERO },
  { id:'bcd8', title:'Creative Studio Manager', price:18000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Brand & Creative' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Brand & Creative Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Brand & Creative</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Brand & Creative Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Brand & Creative Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Brand & Creative Positions</h2>
