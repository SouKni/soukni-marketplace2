...
const ALL_MKT_CATS = [
  { slug:'digital-marketing', label:'Digital Marketing', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=400' },
  { slug:'brand-creative',    label:'Brand & Creative',  image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { slug:'social-media',      label:'Social Media',      image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { slug:'seo-content',       label:'SEO & Content',     image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { slug:'media-buying',      label:'Media Buying',      image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=400' },
]
const VIEW_MORE = { slug:'', label:'View More', image:'https://images.pexels.com/photos/1546168/pexels-photo-1546168.jpeg?auto=compress&w=400' }

const HERO = 'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800'
const topChoices = [
  { id:'dm1', title:'Head of Digital Marketing — E-commerce', desc:'Fast-growing Moroccan e-commerce platform seeks a Head of Digital to own performance marketing, CRM, and digital brand strategy. Google and Meta certifications required.', price:28000, location:'Casablanca, Finance City', rating:4.9, reviews:31, image:HERO },
  { id:'dm2', title:'Digital Marketing Manager — FMCG', desc:'Major consumer goods brand hiring a Digital Marketing Manager to lead paid media, SEO, and influencer strategy across Morocco and MENA.', price:22000, location:'Casablanca, Maarif', rating:4.8, reviews:24, image:HERO },
  { id:'dm3', title:'Performance Marketing Specialist', desc:'SaaS company seeking a Performance Marketing Specialist for Google Ads, Meta Ads, and LinkedIn campaigns. Strong ROAS and CAC optimization track record required.', price:16000, location:'Rabat, Agdal', rating:4.7, reviews:19, image:HERO },
]
const bentoListings = [
  { id:'dmb1', title:'Digital Marketing Executive', price:9000, location:'Casablanca', image:HERO },
  { id:'dmb2', title:'Paid Media Analyst', price:11000, location:'Rabat', image:HERO },
  { id:'dmb3', title:'Email Marketing Specialist', price:10000, location:'Casablanca', image:HERO },
  { id:'dmb4', title:'Digital Marketing Coordinator', price:8000, location:'Marrakech', image:HERO },
  { id:'dmb5', title:'Growth Marketing Manager', price:18000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'dmd1', title:'Digital Campaign Manager', price:14000, location:'Casablanca', image:HERO },
  { id:'dmd2', title:'Web Analytics Specialist', price:12000, location:'Rabat', image:HERO },
  { id:'dmd3', title:'Digital Marketing Trainer', price:13000, location:'Casablanca', image:HERO },
  { id:'dmd4', title:'CRM & Marketing Automation Lead', price:16000, location:'Rabat', image:HERO },
  { id:'dmd5', title:'Digital Marketing Freelancer', price:8000, location:'Remote, Morocco', image:HERO },
  { id:'dmd6', title:'E-commerce Marketing Manager', price:18000, location:'Casablanca', image:HERO },
  { id:'dmd7', title:'Digital Brand Strategist', price:17000, location:'Marrakech', image:HERO },
  { id:'dmd8', title:'App Marketing Specialist', price:14000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Digital Marketing' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Digital Marketing Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Digital Marketing</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Digital Marketing Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Digital Marketing Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Digital Marketing Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {[...ALL_MKT_CATS.filter(c=>c.slug!=='digital-marketing'), VIEW_MORE].map(c=>(
              <Link key={c.slug||'vm'} href={c.slug ? `/${locale}/jobs/marketing/${c.slug}` : `/${locale}/jobs/marketing`}
