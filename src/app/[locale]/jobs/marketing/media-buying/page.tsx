...
const topChoices = [
  { id:'mb1', title:'Media Planning Director', desc:'Top-tier media agency in Casablanca seeking a Media Planning Director to lead cross-channel planning for 8 major brand clients. TV, OOH, digital, and radio expertise required.', price:28000, location:'Casablanca, Maarif', rating:4.9, reviews:14, image:HERO },
  { id:'mb2', title:'Programmatic Media Buyer', desc:'Performance agency hiring a Programmatic Media Buyer to manage DV360 and The Trade Desk campaigns across Morocco and MENA. Strong CPM/CPA optimisation skills required.', price:16000, location:'Casablanca, Finance City', rating:4.8, reviews:11, image:HERO },
  { id:'mb3', title:'Meta & Google Ads Media Buyer', desc:'D2C brand in-house hiring a Meta & Google Ads specialist to manage 2M+ MAD/month in ad spend. ROAS-focused with strong creative testing experience.', price:14000, location:'Rabat, Agdal', rating:4.7, reviews:18, image:HERO },
]
const bentoListings = [
  { id:'mbb1', title:'Junior Media Buyer', price:8000, location:'Casablanca', image:HERO },
  { id:'mbb2', title:'OOH Media Planner', price:11000, location:'Rabat', image:HERO },
  { id:'mbb3', title:'TV & Radio Buying Executive', price:12000, location:'Casablanca', image:HERO },
  { id:'mbb4', title:'Paid Social Media Buyer', price:13000, location:'Casablanca', image:HERO },
  { id:'mbb5', title:'Affiliate Marketing Manager', price:14000, location:'Remote, Morocco', image:HERO },
]
const discoveryGrid = [
  { id:'mbd1', title:'Display Advertising Specialist', price:10000, location:'Casablanca', image:HERO },
  { id:'mbd2', title:'SEM Specialist — Google Search', price:11000, location:'Rabat', image:HERO },
  { id:'mbd3', title:'Media Buying Analyst', price:9500, location:'Casablanca', image:HERO },
  { id:'mbd4', title:'Amazon Ads Specialist', price:12000, location:'Casablanca', image:HERO },
  { id:'mbd5', title:'TikTok Ads Media Buyer', price:11000, location:'Marrakech', image:HERO },
  { id:'mbd6', title:'Media Buying Trainer', price:12000, location:'Casablanca', image:HERO },
  { id:'mbd7', title:'Influencer Paid Partnership Manager', price:13000, location:'Casablanca', image:HERO },
  { id:'mbd8', title:'Media Investment Manager', price:20000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Media Buying' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Media Buying Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Media Buying</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Media Buying Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Media Buying Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Media Buying Positions</h2>
