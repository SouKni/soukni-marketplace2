...
const topChoices = [
  { id:'sc1', title:'SEO Lead — E-commerce Platform', desc:'Fast-growing Moroccan e-commerce company seeking an SEO Lead to own technical SEO, content strategy, and link-building for a 50K+ product catalogue. Strong Python/GSC skills required.', price:18000, location:'Casablanca, Sidi Maarouf', rating:4.8, reviews:21, image:HERO },
  { id:'sc2', title:'Content Director — Digital Media', desc:'Online news and lifestyle platform hiring a Content Director to manage a 10-writer team, own editorial calendar, and drive 2M+ monthly sessions through organic search.', price:20000, location:'Rabat, Hassan', rating:4.9, reviews:16, image:HERO },
  { id:'sc3', title:'Multilingual Content Strategist', desc:'International brand hiring an FR/EN/AR Content Strategist to localise global content and build Morocco-specific SEO content pillars.', price:14000, location:'Remote, Morocco', rating:4.7, reviews:24, image:HERO },
]
const bentoListings = [
  { id:'scb1', title:'SEO Specialist', price:10000, location:'Casablanca', image:HERO },
  { id:'scb2', title:'Content Writer FR/EN', price:8000, location:'Rabat', image:HERO },
  { id:'scb3', title:'Technical SEO Analyst', price:12000, location:'Casablanca', image:HERO },
  { id:'scb4', title:'Blog & Editorial Manager', price:10000, location:'Casablanca', image:HERO },
  { id:'scb5', title:'Copywriter — Performance', price:9000, location:'Marrakech', image:HERO },
]
const discoveryGrid = [
  { id:'scd1', title:'Arabic Content Writer', price:7500, location:'Casablanca', image:HERO },
  { id:'scd2', title:'SEO Content Strategist', price:11000, location:'Rabat', image:HERO },
  { id:'scd3', title:'Link Building Specialist', price:9500, location:'Casablanca', image:HERO },
  { id:'scd4', title:'Video Script Writer', price:8500, location:'Marrakech', image:HERO },
  { id:'scd5', title:'Content Localization Manager', price:12000, location:'Casablanca', image:HERO },
  { id:'scd6', title:'E-commerce Product Copywriter', price:9000, location:'Casablanca', image:HERO },
  { id:'scd7', title:'SEO Reporting & Analytics Analyst', price:11000, location:'Rabat', image:HERO },
  { id:'scd8', title:'Newsletter & Email Copywriter', price:8000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='SEO & Content' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>SEO & Content Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <Link href={`/${locale}/jobs/marketing`} style={{ color:'#6b7a76', textDecoration:'none' }}>Marketing</Link><span>›</span>
          <span style={{ color:'#161d1b' }}>SEO & Content</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>SEO & Content Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni SEO & Content Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More SEO & Content Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h3 style={{ fontWeight:900, fontSize:'16px', color:'#161d1b', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'16px' }}>Explore Other Marketing Categories</h3>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
              <Link key="digital-marketing" href={`/${locale}/jobs/marketing/digital-marketing`}
              ...
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=400" alt="Digital Marketing" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  ...
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Digital Marketing</p>
                  </div>
                </div>
              </Link>
              <Link key="brand-creative" href={`/${locale}/jobs/marketing/brand-creative`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400" alt="Brand & Creative" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Brand & Creative</p>
                  </div>
                </div>
              </Link>
              <Link key="social-media" href={`/${locale}/jobs/marketing/social-media`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400" alt="Social Media" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Social Media</p>
                  </div>
                </div>
              </Link>
              <Link key="media-buying" href={`/${locale}/jobs/marketing/media-buying`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=400" alt="Media Buying" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Media Buying</p>
                  </div>
                </div>
              </Link>
              <Link key="view-more" href={`/${locale}/jobs/marketing`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
        ...
        <div style={{ textAlign:'center' as const, marginBottom:'40px' }}>
          <Link href={`/${locale}/jobs/marketing`}
