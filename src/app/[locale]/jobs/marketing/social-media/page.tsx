...
const topChoices = [
  { id:'sm1', title:'Social Media Manager — Luxury Brand', desc:'Premium Moroccan lifestyle brand hiring a Social Media Manager to own Instagram, TikTok, and Pinterest strategy. Strong visual storytelling and influencer network required.', price:16000, location:'Casablanca, Anfa', rating:4.8, reviews:28, image:HERO },
  { id:'sm2', title:'Head of Social Media — Media Group', desc:'Major Moroccan media group seeking a Head of Social to manage 8-account portfolio, oversee a 5-person team, and drive audience growth across platforms.', price:22000, location:'Casablanca, Finance City', rating:4.9, reviews:19, image:HERO },
  { id:'sm3', title:'TikTok & Reels Content Creator', desc:'Creator economy startup hiring a specialist to produce 20+ short-form videos per month, manage trends, and grow TikTok and Instagram Reels channels from 50K to 500K.', price:12000, location:'Remote, Morocco', rating:4.7, reviews:41, image:HERO },
]
const bentoListings = [
  { id:'smb1', title:'Community Manager', price:7500, location:'Casablanca', image:HERO },
  { id:'smb2', title:'Instagram Content Creator', price:9000, location:'Marrakech', image:HERO },
  { id:'smb3', title:'Social Media Analyst', price:10000, location:'Rabat', image:HERO },
  { id:'smb4', title:'Influencer Marketing Coordinator', price:11000, location:'Casablanca', image:HERO },
  { id:'smb5', title:'Social Ads Specialist', price:12000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'smd1', title:'LinkedIn Content Strategist', price:12000, location:'Rabat', image:HERO },
  { id:'smd2', title:'YouTube Channel Manager', price:10000, location:'Casablanca', image:HERO },
  { id:'smd3', title:'Social Media Trainer', price:11000, location:'Casablanca', image:HERO },
  { id:'smd4', title:'Pinterest Marketing Specialist', price:9000, location:'Marrakech', image:HERO },
  { id:'smd5', title:'Twitter/X Account Manager', price:8500, location:'Casablanca', image:HERO },
  { id:'smd6', title:'Social Media Customer Care Agent', price:7000, location:'Rabat', image:HERO },
  { id:'smd7', title:'Podcast & Audio Content Manager', price:10000, location:'Casablanca', image:HERO },
  { id:'smd8', title:'Social Media Reporting Analyst', price:11000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Social Media' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Social Media Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Social Media</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Social Media Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Social Media Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Social Media Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
              ...
              <Link key="seo-content" href={`/${locale}/jobs/marketing/seo-content`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400" alt="SEO & Content" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>SEO & Content</p>
                  </div>
                </div>
              </Link>
