...
const topChoices = [
  { id:'d1', title:'General Practitioner — Private Clinic', desc:'Expanding private clinic in Casablanca seeking a General Practitioner for outpatient consultations. Full caseload from day one. Attractive package with performance bonuses.', price:35000, location:'Casablanca, Maarif', rating:4.9, reviews:18, image:HERO },
  { id:'d2', title:'Specialist Cardiologist', desc:'Leading cardiology centre hiring a Consultant Cardiologist for inpatient and outpatient care. Cath lab access, echo suite, and MDT support provided.', price:55000, location:'Rabat, Agdal', rating:4.8, reviews:12, image:HERO },
  { id:'d3', title:'Emergency Medicine Physician', desc:'Major hospital group seeking an Emergency Medicine Physician for a high-volume A&E department. ATLS certification required.', price:40000, location:'Casablanca, Ain Sebaa', rating:4.8, reviews:9, image:HERO },
]
const bentoListings = [
  { id:'db1', title:'Paediatrician — Private Practice', price:38000, location:'Marrakech', image:HERO },
  { id:'db2', title:'Dermatologist — Aesthetic Clinic', price:45000, location:'Casablanca', image:HERO },
  { id:'db3', title:'Gynaecologist & Obstetrician', price:42000, location:'Rabat', image:HERO },
  { id:'db4', title:'Psychiatrist — Mental Health Centre', price:38000, location:'Casablanca', image:HERO },
  { id:'db5', title:'Radiologist — Imaging Centre', price:50000, location:'Casablanca', image:HERO },
]
const discoveryGrid = [
  { id:'dd1', title:'Ophthalmologist', price:40000, location:'Casablanca', image:HERO },
  { id:'dd2', title:'Orthopaedic Surgeon', price:55000, location:'Rabat', image:HERO },
  { id:'dd3', title:'ENT Specialist', price:38000, location:'Marrakech', image:HERO },
  { id:'dd4', title:'Anaesthesiologist', price:48000, location:'Casablanca', image:HERO },
  { id:'dd5', title:'Neurologist', price:45000, location:'Casablanca', image:HERO },
  { id:'dd6', title:'Oncologist', price:52000, location:'Rabat', image:HERO },
  { id:'dd7', title:'Urologist', price:42000, location:'Casablanca', image:HERO },
  { id:'dd8', title:'Endocrinologist', price:40000, location:'Fès', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Doctors' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Doctor Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Doctors</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Doctor Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Doctors Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Doctor Positions</h2>
