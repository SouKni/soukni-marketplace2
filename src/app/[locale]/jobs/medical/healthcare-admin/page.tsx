...
const topChoices = [
  { id:'ha1', title:'Hospital Operations Manager', desc:'Private hospital group seeking an Operations Manager to oversee daily hospital functions across 3 sites, manage non-clinical departments, and drive efficiency.', price:28000, location:'Casablanca, Finance City', rating:4.9, reviews:15, image:HERO },
  { id:'ha2', title:'Medical Secretary — Specialist Clinic', desc:'Multi-specialty clinic hiring a Medical Secretary for appointment scheduling, patient records management, and insurance pre-authorisation.', price:9000, location:'Rabat, Agdal', rating:4.7, reviews:28, image:HERO },
  { id:'ha3', title:'Healthcare Quality & Compliance Officer', desc:'Accreditation-seeking hospital hiring a Quality Officer to lead JCI/HAS compliance, incident reporting, and clinical audit programmes.', price:20000, location:'Casablanca, Ain Sebaa', rating:4.8, reviews:12, image:HERO },
]
const bentoListings = [
  { id:'hab1', title:'Patient Admissions Coordinator', price:8500, location:'Casablanca', image:HERO },
  { id:'hab2', title:'Medical Billing Specialist', price:10000, location:'Rabat', image:HERO },
  { id:'hab3', title:'Health Records Manager', price:11000, location:'Casablanca', image:HERO },
  { id:'hab4', title:'Hospital HR Manager', price:16000, location:'Casablanca', image:HERO },
  { id:'hab5', title:'Healthcare IT Coordinator', price:14000, location:'Rabat', image:HERO },
]
const discoveryGrid = [
  { id:'had1', title:'Medical Receptionist', price:7000, location:'Casablanca', image:HERO },
  { id:'had2', title:'Insurance Claims Handler', price:9000, location:'Rabat', image:HERO },
  { id:'had3', title:'Clinical Coder', price:10000, location:'Casablanca', image:HERO },
  { id:'had4', title:'Healthcare Project Manager', price:18000, location:'Casablanca', image:HERO },
  { id:'had5', title:'Sterilisation Technician', price:8000, location:'Marrakech', image:HERO },
  { id:'had6', title:'Biomedical Equipment Coordinator', price:12000, location:'Casablanca', image:HERO },
  { id:'had7', title:'Pharmacy Stock Controller', price:9000, location:'Rabat', image:HERO },
  { id:'had8', title:'Health & Safety Officer', price:13000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Healthcare Admin' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Healthcare Admin Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Healthcare Admin</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Healthcare Admin Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Healthcare Admin Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Healthcare Admin Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
              ...
              <Link key="physiotherapy" href={`/${locale}/jobs/medical/physiotherapy`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400" alt="Physiotherapy" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Physiotherapy</p>
                  </div>
                </div>
              </Link>
