...
const topChoices = [
  { id:'n1', title:'Head Nurse — ICU', desc:'Major teaching hospital seeking an experienced Head Nurse for the Intensive Care Unit. Team of 18, shift management, and quality assurance responsibilities.', price:18000, location:'Casablanca, CHU Ibn Rochd', rating:4.9, reviews:24, image:HERO },
  { id:'n2', title:'Theatre Scrub Nurse', desc:'Private surgical centre hiring an experienced Scrub Nurse for general and laparoscopic surgery lists. CNOR certification preferred.', price:14000, location:'Rabat, Clinique Agdal', rating:4.8, reviews:19, image:HERO },
  { id:'n3', title:'Community Outreach Nurse', desc:'NGO-backed health programme seeking a Community Nurse to deliver primary care, health education, and vaccination programmes in peri-urban areas.', price:10000, location:'Casablanca, Hay Mohammadi', rating:4.7, reviews:31, image:HERO },
]
const bentoListings = [
  { id:'nb1', title:'Paediatric Nurse', price:11000, location:'Casablanca', image:HERO },
  { id:'nb2', title:'Oncology Nurse', price:13000, location:'Rabat', image:HERO },
  { id:'nb3', title:'Emergency Nurse', price:12000, location:'Marrakech', image:HERO },
  { id:'nb4', title:'Mental Health Nurse', price:11000, location:'Casablanca', image:HERO },
  { id:'nb5', title:'School Health Nurse', price:9000, location:'Fès', image:HERO },
]
const discoveryGrid = [
  { id:'nd1', title:'Dialysis Nurse', price:12000, location:'Casablanca', image:HERO },
  { id:'nd2', title:'Midwife', price:11000, location:'Rabat', image:HERO },
  { id:'nd3', title:'Neonatal Nurse', price:12500, location:'Casablanca', image:HERO },
  { id:'nd4', title:'Home Care Nurse', price:9000, location:'Marrakech', image:HERO },
  { id:'nd5', title:'Orthopaedic Ward Nurse', price:11000, location:'Casablanca', image:HERO },
  { id:'nd6', title:'Cardiac Care Nurse', price:13000, location:'Rabat', image:HERO },
  { id:'nd7', title:'Infection Control Nurse', price:12000, location:'Casablanca', image:HERO },
  { id:'nd8', title:'Night Shift Staff Nurse', price:10000, location:'Tangier', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Nursing' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Nursing Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Nursing</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Nursing Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Nursing Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Nursing Positions</h2>
