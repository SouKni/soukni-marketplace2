...
const HERO = 'https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg?auto=compress&w=800'
const topChoices = [
  { id:'mc1', title:'Medical Director — Private Clinic', desc:'Expanding private clinic group in Casablanca seeking a Medical Director to oversee clinical operations across 4 sites. Specialisation in internal medicine or general surgery preferred.', price:55000, location:'Casablanca, Anfa', rating:4.9, reviews:41, image:'https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg?auto=compress&w=800' },
  { id:'mc2', title:'Senior Consultant Cardiologist', desc:'Leading cardiac centre in Rabat hiring a Senior Cardiologist for interventional procedures and outpatient consultations. Strong academic background and cath lab experience required.', price:80000, location:'Rabat, Hay Riad', rating:4.9, reviews:33, image:'https://images.pexels.com/photos/3985163/pexels-photo-3985163.jpeg?auto=compress&w=800' },
  { id:'mc3', title:'Head Nurse — Intensive Care Unit', desc:'University hospital seeking a Head Nurse to lead the ICU nursing team of 25 across day and night shifts. Advanced life support certification and 8+ years ICU experience required.', price:18000, location:'Casablanca, CHU', rating:4.8, reviews:27, image:'https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'mb1', title:'General Practitioner — Private Practice', price:35000, location:'Casablanca', image:'https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg?auto=compress&w=800' },
  { id:'mb2', title:'Registered Nurse — Oncology Ward', price:12000, location:'Rabat', image:'https://images.pexels.com/photos/3985163/pexels-photo-3985163.jpeg?auto=compress&w=800' },
  { id:'mb3', title:'Clinical Pharmacist', price:22000, location:'Casablanca', image:'https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg?auto=compress&w=800' },
  { id:'mb4', title:'Physiotherapist — Sports Clinic', price:16000, location:'Marrakech', image:'https://images.pexels.com/photos/3985163/pexels-photo-3985163.jpeg?auto=compress&w=800' },
  { id:'mb5', title:'Healthcare Operations Manager', price:28000, location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'md1', title:'Radiologist — Imaging Centre', price:45000, location:'Casablanca', image:'https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg?auto=compress&w=800' },
  { id:'md2', title:'Paediatric Nurse', price:11000, location:'Rabat', image:'https://images.pexels.com/photos/3985163/pexels-photo-3985163.jpeg?auto=compress&w=800' },
  { id:'md3', title:'Medical Laboratory Technician', price:10000, location:'Casablanca', image:'https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg?auto=compress&w=800' },
  { id:'md4', title:'Dental Surgeon — Private Practice', price:40000, location:'Marrakech', image:'https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg?auto=compress&w=800' },
  { id:'md5', title:'Nutritionist & Dietitian', price:14000, location:'Casablanca', image:'https://images.pexels.com/photos/3985163/pexels-photo-3985163.jpeg?auto=compress&w=800' },
  { id:'md6', title:'Ambulance Paramedic', price:9000, location:'Rabat', image:'https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg?auto=compress&w=800' },
  { id:'md7', title:'Psychiatrist — Outpatient Clinic', price:55000, location:'Casablanca', image:'https://images.pexels.com/photos/3985163/pexels-photo-3985163.jpeg?auto=compress&w=800' },
  { id:'md8', title:'Hospital Administrator', price:20000, location:'Tangier', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
]
const pills = ['All Medical', 'Doctors', 'Nursing', 'Pharmacy', 'Physiotherapy', 'Healthcare Admin', 'View More']
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Medical & Healthcare' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Find Top Medical & Healthcare Jobs!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>220 verified medical & healthcare positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Medical & Healthcare Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'16px' }}>220 Medical & Healthcare positions across Morocco</p>

        <div style={{ display:'flex', gap:'8px', marginBottom:'16px', overflowX:'auto', paddingBottom:'4px' }}>
          {pills.map(p=>
            pillSlugs[p] ? (
              <Link key={p} href={`/${locale}/jobs/medical/${pillSlugs[p]}`} style={{ padding:'8px 20px', borderRadius:'100px', fontSize:'12px', fontWeight:700, cursor:'pointer', whiteSpace:'nowrap' as const, textDecoration:'none', display:'inline-block', backgroundColor:'#e8efec', color:'#3c4a46' }}>{p}</Link>
            ) : (
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Medical & Healthcare Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Medical & Healthcare Positions</h2>
        ...
        <section style={{ borderRadius:'40px', background:'linear-gradient(135deg,#22d4a8,#0f9b8e)', padding:'56px 48px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'40px', flexWrap:'wrap' as const, marginBottom:'64px' }}>
          <div>
            ...
            <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.85)', maxWidth:'480px', lineHeight:1.7 }}>Post your medical & healthcare job today for free and reach thousands of qualified candidates across Morocco.</p>
        ...
        <CategoryFooterNav
          relatedTitle="Explore Other Medical Jobs"
          related={[
            { label:'Doctors', href:`/${locale}/jobs/medical/doctors` },
            { label:'Nursing', href:`/${locale}/jobs/medical/nursing` },
            { label:'Pharmacy', href:`/${locale}/jobs/medical/pharmacy` },
            { label:'Physiotherapy', href:`/${locale}/jobs/medical/physiotherapy` },
            { label:'Healthcare Admin', href:`/${locale}/jobs/medical/healthcare-admin` },
          ]}
