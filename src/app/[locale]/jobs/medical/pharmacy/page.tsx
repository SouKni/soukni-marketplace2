...
const topChoices = [
  { id:'ph1', title:'Clinical Pharmacist — Hospital', desc:'University hospital hiring a Clinical Pharmacist for ward rounds, medication review, and formulary management across 3 departments.', price:18000, location:'Casablanca, CHU', rating:4.8, reviews:16, image:HERO },
  { id:'ph2', title:'Pharmacy Manager — Chain Retail', desc:'National pharmacy chain seeking a Pharmacy Manager to oversee a high-volume branch, manage a team of 6, and ensure regulatory compliance.', price:15000, location:'Rabat, Agdal', rating:4.7, reviews:22, image:HERO },
  { id:'ph3', title:'Regulatory Affairs Pharmacist', desc:'Pharmaceutical importer hiring a Regulatory Affairs Pharmacist to manage AMM submissions, labelling compliance, and Health Ministry liaisons.', price:20000, location:'Casablanca, Finance City', rating:4.9, reviews:11, image:HERO },
]
const bentoListings = [
  { id:'phb1', title:'Community Pharmacist', price:12000, location:'Casablanca', image:HERO },
  { id:'phb2', title:'Hospital Pharmacy Technician', price:9000, location:'Rabat', image:HERO },
  { id:'phb3', title:'Industrial Pharmacist', price:16000, location:'Casablanca', image:HERO },
  { id:'phb4', title:'Pharmacovigilance Officer', price:14000, location:'Casablanca', image:HERO },
  { id:'phb5', title:'Medical Sales Representative', price:13000, location:'Marrakech', image:HERO },
]
const discoveryGrid = [
  { id:'phd1', title:'Compounding Pharmacist', price:13000, location:'Casablanca', image:HERO },
  { id:'phd2', title:'Pharmacy Technician', price:8000, location:'Rabat', image:HERO },
  { id:'phd3', title:'Drug Information Specialist', price:14000, location:'Casablanca', image:HERO },
  { id:'phd4', title:'Oncology Pharmacist', price:18000, location:'Casablanca', image:HERO },
  { id:'phd5', title:'Paediatric Pharmacist', price:16000, location:'Rabat', image:HERO },
  { id:'phd6', title:'Nuclear Medicine Pharmacist', price:20000, location:'Casablanca', image:HERO },
  { id:'phd7', title:'Pharmacy Buyer & Procurement', price:11000, location:'Casablanca', image:HERO },
  { id:'phd8', title:'Locum Pharmacist', price:12000, location:'Marrakech', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Pharmacy' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Pharmacy Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Pharmacy</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Pharmacy Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Pharmacy Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Pharmacy Positions</h2>
