...
const topChoices = [
  { id:'pt1', title:'Senior Physiotherapist — Sports Clinic', desc:'Elite sports medicine clinic seeking a Senior Physiotherapist with MSK and sports injury experience. Work with professional athletes and active patients.', price:16000, location:'Casablanca, Anfa', rating:4.9, reviews:14, image:HERO },
  { id:'pt2', title:'Neurological Physiotherapist', desc:'Rehabilitation centre hiring a Neurological Physiotherapist for stroke, TBI, and MS patients. Bobath or NDT certification preferred.', price:14000, location:'Rabat, Souissi', rating:4.8, reviews:11, image:HERO },
  { id:'pt3', title:'Paediatric Physiotherapist', desc:"Children's hospital seeking a Paediatric Physiotherapist for developmental delay, cerebral palsy, and post-surgical rehabilitation caseloads.", price:13000, location:'Casablanca, CHU', rating:4.7, reviews:9, image:HERO },
]
const bentoListings = [
  { id:'ptb1', title:'Cardiorespiratory Physiotherapist', price:13000, location:'Casablanca', image:HERO },
  { id:'ptb2', title:'Orthopaedic Physiotherapist', price:12000, location:'Rabat', image:HERO },
  { id:'ptb3', title:'Occupational Therapist', price:12000, location:'Marrakech', image:HERO },
  { id:'ptb4', title:'Hand Therapy Specialist', price:14000, location:'Casablanca', image:HERO },
  { id:'ptb5', title:'Home Visit Physiotherapist', price:10000, location:'Fès', image:HERO },
]
const discoveryGrid = [
  { id:'ptd1', title:'Lymphoedema Physiotherapist', price:13000, location:'Casablanca', image:HERO },
  { id:'ptd2', title:'Physiotherapy Assistant', price:7000, location:'Rabat', image:HERO },
  { id:'ptd3', title:'Pilates & Physio Instructor', price:10000, location:'Marrakech', image:HERO },
  { id:'ptd4', title:'Aquatic Physiotherapist', price:12000, location:'Agadir', image:HERO },
  { id:'ptd5', title:"Women's Health Physiotherapist", price:13000, location:'Casablanca', image:HERO },
  { id:'ptd6', title:'Dry Needling Specialist', price:14000, location:'Rabat', image:HERO },
  { id:'ptd7', title:'Physiotherapy Clinic Manager', price:16000, location:'Casablanca', image:HERO },
  { id:'ptd8', title:'Telehealth Physiotherapist', price:10000, location:'Remote, Morocco', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Physiotherapy' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Physiotherapy Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>148 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <Link href={`/${locale}/jobs/medical`} style={{ color:'#6b7a76', textDecoration:'none' }}>Medical</Link><span>›</span>
          <span style={{ color:'#161d1b' }}>Physiotherapy</span>
        </nav>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Physiotherapy Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>148 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Physiotherapy Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Physiotherapy Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h3 style={{ fontWeight:900, fontSize:'16px', color:'#161d1b', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'16px' }}>Explore Other Medical Categories</h3>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
              <Link key="doctors" href={`/${locale}/jobs/medical/doctors`}
              ...
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=400" alt="Doctors" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  ...
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Doctors</p>
                  </div>
                </div>
              </Link>
              <Link key="nursing" href={`/${locale}/jobs/medical/nursing`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400" alt="Nursing" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Nursing</p>
                  </div>
                </div>
              </Link>
              <Link key="pharmacy" href={`/${locale}/jobs/medical/pharmacy`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400" alt="Pharmacy" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Pharmacy</p>
                  </div>
                </div>
              </Link>
              <Link key="healthcare-admin" href={`/${locale}/jobs/medical/healthcare-admin`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=400" alt="Healthcare Admin" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Healthcare Admin</p>
                  </div>
                </div>
              </Link>
              <Link key="view-more" href={`/${locale}/jobs/medical`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
