...
const topChoices = [
  { id:'ri1', title:'Real Estate Investment Manager — Fund', desc:'Moroccan REIT seeking an Investment Manager to source, underwrite, and manage a MAD 1.5Bn commercial real estate portfolio. CFA preferred with 7+ years RE investment experience.', price:65000, location:'Casablanca, Finance City', rating:4.9, reviews:23, image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=800' },
  { id:'ri2', title:'Asset Management Director — RE Portfolio', desc:'Family office in Casablanca hiring an Asset Management Director to maximise returns on a mixed portfolio of commercial, retail, and residential assets across Morocco.', price:55000, location:'Casablanca, Anfa', rating:4.8, reviews:18, image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
  { id:'ri3', title:'Real Estate Financial Analyst', desc:'Growing real estate private equity firm seeking a Financial Analyst to build financial models, conduct DCF analyses, and support investment committee presentations.', price:28000, location:'Casablanca, Finance City', rating:4.9, reviews:15, image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'rib1', title:'Investment Associate — RE', price:22000, location:'Casablanca', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=800' },
  { id:'rib2', title:'Portfolio Performance Analyst', price:18000, location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
  { id:'rib3', title:'Transactions & Deals Manager', price:35000, location:'Casablanca', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=800' },
  { id:'rib4', title:'Valuation Surveyor — RICS', price:25000, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'rib5', title:'Investor Relations Manager', price:28000, location:'Casablanca', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'rid1', title:'Junior Investment Analyst', price:11000, location:'Casablanca', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=800' },
  { id:'rid2', title:'Market Research & Data Analyst', price:14000, location:'Rabat', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
  { id:'rid3', title:'Property Due Diligence Analyst', price:16000, location:'Casablanca', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=800' },
  { id:'rid4', title:'Fund Administration Officer', price:12000, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'rid5', title:'ESG & Sustainability Analyst — RE', price:18000, location:'Casablanca', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=800' },
  { id:'rid6', title:'Debt & Financing Analyst', price:20000, location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
  { id:'rid7', title:'Commercial Asset Manager', price:30000, location:'Casablanca', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=800' },
  { id:'rid8', title:'REIT Reporting Analyst', price:15000, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Investment' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Investment Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>27 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Investment Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>27 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Investment Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Investment Positions</h2>
