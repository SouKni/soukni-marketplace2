...
const HERO = 'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=800'
const topChoices = [
  { id:'rpm1', title:'Head of Property Management — Holding Group', desc:'Major real estate holding group seeking a Head of Property Management to oversee a portfolio of 500+ residential and commercial units. Team of 20, full P&L ownership.', price:38000, location:'Casablanca, Anfa', rating:4.9, reviews:42, image:'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=800' },
  { id:'rpm2', title:'Syndic Manager — Luxury Residences', desc:'Premium residential compound in Rabat hiring a Syndic Manager to oversee all building services, maintenance scheduling, and resident relations for 280 units.', price:16000, location:'Rabat, Hay Riad', rating:4.8, reviews:33, image:'https://images.pexels.com/photos/7415083/pexels-photo-7415083.jpeg?auto=compress&w=800' },
  { id:'rpm3', title:'Short-Term Rental Manager — Airbnb Portfolio', desc:'Growing Airbnb management company seeking a Portfolio Manager to oversee 60+ properties across Marrakech and Casablanca. Guest experience, pricing strategy, and maintenance coordination.', price:18000, location:'Marrakech', rating:4.9, reviews:27, image:'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'rpmb1', title:'Building Facilities Manager', price:14000, location:'Casablanca', image:'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=800' },
  { id:'rpmb2', title:'Property Administrator', price:9000, location:'Rabat', image:'https://images.pexels.com/photos/7415083/pexels-photo-7415083.jpeg?auto=compress&w=800' },
  { id:'rpmb3', title:'Tenant Relations Officer', price:8000, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'rpmb4', title:'Maintenance Coordinator — Residential', price:10000, location:'Marrakech', image:'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=800' },
  { id:'rpmb5', title:'Portfolio Analyst — RE Assets', price:16000, location:'Casablanca', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'rpmd1', title:'Property Inspector', price:8000, location:'Casablanca', image:'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=800' },
  { id:'rpmd2', title:'Concierge Manager — Luxury Riad', price:10000, location:'Marrakech', image:'https://images.pexels.com/photos/7415083/pexels-photo-7415083.jpeg?auto=compress&w=800' },
  { id:'rpmd3', title:'Service Charge Accountant', price:12000, location:'Casablanca', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=800' },
  { id:'rpmd4', title:'Lease Administration Specialist', price:11000, location:'Rabat', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'rpmd5', title:'Resident Services Coordinator', price:8500, location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
  { id:'rpmd6', title:'Property Management Software Admin', price:10000, location:'Rabat', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
  { id:'rpmd7', title:'Commercial Property Manager', price:20000, location:'Casablanca', image:'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=800' },
  { id:'rpmd8', title:'Move-In/Out Coordinator', price:7500, location:'Marrakech', image:'https://images.pexels.com/photos/7415083/pexels-photo-7415083.jpeg?auto=compress&w=800' },
]
...
export default function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  function applySearch() {
    setApplied({ keyword, city, price: salary })
    setPage(1)
  }
  ...
  const salaryPrices = discoveryGrid.map(i => i.price)
  const salaryMin = Math.min(...salaryPrices)
  const salaryMax = Math.max(...salaryPrices)
  const salaryMid = Math.round((salaryMin + salaryMax) / 2)
  const salaryRanges = ['Any Range', `${salaryMin.toLocaleString()} – ${salaryMid.toLocaleString()} MAD`, `${salaryMid.toLocaleString()} – ${salaryMax.toLocaleString()} MAD`, `${salaryMax.toLocaleString()}+ MAD`]
  ...
  const filteredDiscoveryGridAll = React.useMemo(() => {
    return discoveryGrid.filter(item => {
      ...
      const mp = priceInRange(item.price, applied.price)
      return mk && mc && mp
    })
  }, [applied.keyword, applied.city, applied.price])
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Property Management' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Property Management Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>95 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'-28px auto 0', padding:'0 40px', position:'relative', zIndex:30 }}>
        <div style={{ backgroundColor:'rgba(255,255,255,0.9)', backdropFilter:'blur(20px)', borderRadius:'100px', padding:'10px 10px 10px 24px', boxShadow:'0 8px 40px rgba(0,0,0,0.12)', border:'1px solid rgba(255,255,255,0.6)', display:'flex', alignItems:'center' }}>
          <div style={{ flex:1, padding:'6px 20px', borderRight:'1px solid rgba(186,202,197,0.3)', display:'flex', flexDirection:'column' as const, gap:'1px' }}>
            ...
            <input value={city} onChange={e=>setCity(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} placeholder="Casablanca" style={{ fontSize:'13px', fontWeight:500, color:'#161d1b', border:'none', outline:'none', background:'none', padding:0, width:'100%', fontFamily:'inherit' }} />
          </div>
          <div style={{ flex:2, padding:'6px 20px', borderRight:'1px solid rgba(186,202,197,0.3)', display:'flex', flexDirection:'column' as const, gap:'1px' }}>
            ...
            <input value={keyword} onChange={e=>setKeyword(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} placeholder="Search..." style={{ fontSize:'13px', fontWeight:500, color:'#161d1b', border:'none', outline:'none', background:'none', padding:0, width:'100%', fontFamily:'inherit' }} />
          </div>
          ...
          <div style={{ flex:1, padding:'6px 20px', borderRight:'1px solid rgba(186,202,197,0.3)', display:'flex', flexDirection:'column' as const, gap:'1px' }}>
            ...
            <select value={salary} onChange={e=>setSalary(e.target.value)} style={{ fontSize:'13px', fontWeight:500, color:'#161d1b', border:'none', outline:'none', background:'none', padding:0, width:'100%', fontFamily:'inherit', cursor:'pointer' }}>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <Breadcrumb
          items={[
            ...
            { label:'Real Estate', href:`/${locale}/jobs/real-estate` },
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Property Management Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>95 positions across Morocco</p>
        ...
        <div style={{ display:'flex', gap:'8px', marginBottom:'32px', flexWrap:'wrap' as const }}>
          {['All','Full-Time','Part-Time','Commission'].map(t=>(
            <button key={t} onClick={()=>setTab(t)}
              style={{ padding:'8px 20px', borderRadius:'100px', fontSize:'12px', fontWeight:700, cursor:'pointer', border:'none', transition:'all 0.15s',
                backgroundColor: tab===t ? '#161d1b' : '#e8efec',
                color:           tab===t ? 'white'   : '#3c4a46',
              }}>{t}</button>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Property Management Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Property Management Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h3 style={{ fontWeight:900, fontSize:'16px', color:'#161d1b', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'16px' }}>Explore Other Real Estate Categories</h3>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
              <Link key="sales-agent" href={`/${locale}/jobs/real-estate/sales-agent`}
              ...
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/7415083/pexels-photo-7415083.jpeg?auto=compress&w=400" alt="Sales Agent" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  ...
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Sales Agent</p>
                  </div>
                </div>
              </Link>
              <Link key="development" href={`/${locale}/jobs/real-estate/development`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400" alt="Development" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Development</p>
                  </div>
                </div>
              </Link>
              <Link key="legal-compliance" href={`/${locale}/jobs/real-estate/legal-compliance`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400" alt="Legal & Compliance" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Legal & Compliance</p>
                  </div>
                </div>
              </Link>
              <Link key="marketing-re" href={`/${locale}/jobs/real-estate/marketing-re`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400" alt="Marketing" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Marketing</p>
                  </div>
                </div>
              </Link>
              <Link key="investment" href={`/${locale}/jobs/real-estate/investment`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=400" alt="Investment" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>Investment</p>
                  </div>
                </div>
              </Link>
              <Link key="view-more" href={`/${locale}/jobs/real-estate/`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  <img src="https://images.pexels.com/photos/1546168/pexels-photo-1546168.jpeg?auto=compress&w=400" alt="View More" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                  <div style={{ position:'absolute', inset:0, background:'linear-gradient(to top,rgba(0,0,0,0.7),rgba(0,0,0,0.1))' }} />
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>View More</p>
                  </div>
                </div>
              </Link>
          </div>
        ...
        <CategoryFooterNav
          backHref={`/${locale}/jobs/real-estate`}
