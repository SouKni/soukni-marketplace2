...
const HERO = 'https://images.pexels.com/photos/7415083/pexels-photo-7415083.jpeg?auto=compress&w=800'
const topChoices = [
  { id:'rsa1', title:'Senior Luxury Property Sales Agent', desc:'Top real estate agency in Marrakech seeking a Senior Sales Agent for luxury villas and riads. Proven track record with HNW clients and international buyers. Commission-based with excellent earning potential.', price:25000, location:'Marrakech, Guéliz', rating:4.9, reviews:58, image:'https://images.pexels.com/photos/7415083/pexels-photo-7415083.jpeg?auto=compress&w=800' },
  { id:'rsa2', title:'New Developments Sales Executive — Casablanca', desc:'Major property developer hiring a Sales Executive to sell off-plan apartments in premium Casablanca developments. Full sales cycle from lead to contract signing.', price:18000, location:'Casablanca, Anfa', rating:4.8, reviews:44, image:'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=800' },
  { id:'rsa3', title:'Commercial Property Broker — Office & Retail', desc:'Leading commercial property firm seeking an experienced Broker to handle lettings and sales of office and retail spaces across Casablanca CBD. Strong corporate network required.', price:22000, location:'Casablanca, Finance City', rating:4.9, reviews:31, image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'rsab1', title:'Junior Property Sales Consultant', price:8000, location:'Rabat', image:'https://images.pexels.com/photos/7415083/pexels-photo-7415083.jpeg?auto=compress&w=800' },
  { id:'rsab2', title:'Real Estate Sales Manager', price:32000, location:'Casablanca', image:'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=800' },
  { id:'rsab3', title:'Off-Plan Sales Specialist', price:20000, location:'Tangier', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'rsab4', title:'Bilingual Property Agent FR/EN', price:15000, location:'Marrakech', image:'https://images.pexels.com/photos/7415083/pexels-photo-7415083.jpeg?auto=compress&w=800' },
  { id:'rsab5', title:'Holiday & Short-Let Sales Agent', price:14000, location:'Agadir', image:'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'rsad1', title:'Property Sales Negotiator', price:10000, location:'Casablanca', image:'https://images.pexels.com/photos/7415083/pexels-photo-7415083.jpeg?auto=compress&w=800' },
  { id:'rsad2', title:'Land Sales Specialist', price:18000, location:'Rabat', image:'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=800' },
  { id:'rsad3', title:'Residential Lettings Agent', price:9000, location:'Marrakech', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'rsad4', title:'Buyer Acquisition Specialist', price:12000, location:'Casablanca', image:'https://images.pexels.com/photos/7415083/pexels-photo-7415083.jpeg?auto=compress&w=800' },
  { id:'rsad5', title:'Property Photographer & Stager', price:8000, location:'Marrakech', image:'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=800' },
  { id:'rsad6', title:'Mortgage & Finance Advisor', price:14000, location:'Casablanca', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=800' },
  { id:'rsad7', title:'Foreign Investor Relations Agent', price:20000, location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800' },
  { id:'rsad8', title:'Real Estate CRM Specialist', price:11000, location:'Rabat', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Sales Agent' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Sales Agent Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>180 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Sales Agent Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>180 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Sales Agent Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Sales Agent Positions</h2>
