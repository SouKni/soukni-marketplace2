...
const HERO = 'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800'
const topChoices = [
  { id:'bar1', title:'Head Bartender & Bar Manager — Rooftop', desc:'Trendy rooftop bar in Casablanca seeking a Head Bartender to lead cocktail programme, train bar team of 6, and manage stock and supplier relationships. Creative mixology portfolio required.', price:16000, location:'Casablanca, Corniche', rating:4.9, reviews:44, image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'bar2', title:'Sommelier & Wine Director — Fine Dining', desc:'Award-winning fine dining restaurant in Rabat hiring a Sommelier to curate wine list of 250+ references, conduct staff training, and provide tableside sommelier service.', price:18000, location:'Rabat, Souissi', rating:4.9, reviews:36, image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'bar3', title:'Mixologist — Luxury Hotel Bar', desc:'5-star hotel in Marrakech seeking a creative Mixologist to develop signature cocktail menu, manage spirits programme, and deliver exceptional guest experience at the flagship bar.', price:14000, location:'Marrakech, Palmeraie', rating:4.8, reviews:28, image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'barb1', title:'Senior Bartender — Cocktail Bar', price:10000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'barb2', title:'Bar Supervisor — Hotel', price:12000, location:'Marrakech', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'barb3', title:'Champagne & Spirits Specialist', price:14000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'barb4', title:'Pool Bar Bartender — Resort', price:9000, location:'Agadir', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'barb5', title:'Whisky & Craft Beer Expert', price:11000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'bard1', title:'Junior Bartender — Trainee', price:6000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'bard2', title:'Barback & Bar Support', price:5500, location:'Rabat', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'bard3', title:'Non-Alcoholic Cocktail Specialist', price:8000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'bard4', title:'Flair Bartender — Events', price:12000, location:'Marrakech', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'bard5', title:'Coffee & Specialty Drinks Barista', price:8000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'bard6', title:'Wine Buyer & Cellar Manager', price:16000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'bard7', title:'Cocktail Trainer & Brand Ambassador', price:14000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'bard8', title:'Bar Consultant — New Openings', price:18000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Bartending' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Bartending Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <Link href={`/${locale}/jobs/restaurant`} style={{ color:'#6b7a76', textDecoration:'none' }}>Restaurant & Hospitality</Link><span>›</span>
          <span style={{ color:'#161d1b' }}>Bartending</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Bartending Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Bartending Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Bartending Positions</h2>
