...
const HERO = 'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800'
const topChoices = [
  { id:'ce1', title:'Catering Operations Director — Group', desc:'Leading catering company in Casablanca seeking a Director to oversee all catering operations for corporate events, weddings, and private functions. 200+ events/year, team of 80.', price:45000, location:'Casablanca', rating:4.9, reviews:52, image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'ce2', title:'Wedding & Private Events Chef', desc:'Luxury events company in Marrakech hiring a dedicated Events Chef to plan and execute personalised menus for high-end weddings and private parties at exclusive riads and villas.', price:22000, location:'Marrakech', rating:4.9, reviews:44, image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'ce3', title:'Corporate Catering Account Manager', desc:'B2B catering specialist seeking an Account Manager to manage corporate lunch and events contracts across Casablanca. Client relationship management and menu customisation.', price:18000, location:'Casablanca, Finance City', rating:4.8, reviews:36, image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'ceb1', title:'Event Catering Supervisor', price:12000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'ceb2', title:'Buffet & Banquet Chef', price:14000, location:'Marrakech', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'ceb3', title:'Catering Sales Coordinator', price:10000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'ceb4', title:'Private Dining & Experiences Manager', price:20000, location:'Marrakech', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'ceb5', title:'Food Truck & Concept Chef', price:12000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'ced1', title:'Catering Driver & Delivery Coordinator', price:6000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'ced2', title:'Event Setup & Breakdown Staff', price:5500, location:'Marrakech', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'ced3', title:'Halal Catering Specialist', price:10000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'ced4', title:'Corporate Lunch Box Chef', price:9000, location:'Rabat', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'ced5', title:'Catering Kitchen Assistant', price:5000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'ced6', title:'Vegan & Healthy Catering Chef', price:11000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'ced7', title:'Wedding Cake & Dessert Caterer', price:13000, location:'Marrakech', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'ced8', title:'Street Food & Festival Chef', price:10000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Catering & Events' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Catering & Events Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>370 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Catering & Events</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Catering & Events Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>370 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Catering & Events Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Catering & Events Positions</h2>
