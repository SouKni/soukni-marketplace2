...
const topChoices = [
  { id:'ck1', title:'Executive Chef — 5-Star Luxury Resort', desc:'Prestigious 5-star resort in Marrakech seeks an Executive Chef to lead a team of 40+ kitchen staff across 4 restaurants. Michelin-level culinary standards, menu development, and food cost management.', price:42000, location:'Marrakech, Palmeraie', rating:4.9, reviews:58, image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'ck2', title:'Head Chef — Fine Dining Restaurant', desc:'Award-winning fine dining restaurant in Rabat seeking a Head Chef to lead kitchen brigade of 12. Creative seasonal menu design, supplier relationships, and team development.', price:28000, location:'Rabat, Souissi', rating:4.9, reviews:44, image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'ck3', title:'Sous Chef — Modern Moroccan Cuisine', desc:'Acclaimed modern Moroccan restaurant in Casablanca hiring a Sous Chef to support Head Chef in daily service, mise en place, and kitchen team training. 5+ years fine dining experience.', price:18000, location:'Casablanca, Anfa', rating:4.8, reviews:36, image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'ckb1', title:'Chef de Partie — Cold Section', price:12000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'ckb2', title:'Pastry Sous Chef', price:16000, location:'Marrakech', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'ckb3', title:'Saucier — French Fine Dining', price:14000, location:'Rabat', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'ckb4', title:'Commis Chef — Hotel Kitchen', price:7000, location:'Agadir', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'ckb5', title:'Private Chef — Luxury Riad', price:20000, location:'Marrakech', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'ckd1', title:'Kitchen Porter — Senior', price:5000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'ckd2', title:'Pizza Chef — Italian Restaurant', price:10000, location:'Rabat', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'ckd3', title:'Breakfast Chef — Boutique Hotel', price:9000, location:'Marrakech', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'ckd4', title:'Garde Manger Specialist', price:11000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'ckd5', title:'Grill Chef — Steakhouse', price:12000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'ckd6', title:'Sushi Chef — Japanese Restaurant', price:15000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'ckd7', title:'Dietary & Allergen Chef', price:13000, location:'Rabat', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'ckd8', title:'Banquet Chef — Events Kitchen', price:14000, location:'Marrakech', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Chef & Kitchen' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Chef & Kitchen Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>680 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Chef & Kitchen</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Chef & Kitchen Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>680 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Chef & Kitchen Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Chef & Kitchen Positions</h2>
