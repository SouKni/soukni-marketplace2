...
const topChoices = [
  { id:'fb1', title:'F&B Director — International Hotel Group', desc:'Leading international hotel group hiring an F&B Director to oversee all food and beverage operations across 6 outlets. P&L responsibility, team leadership of 120+, and guest experience optimization.', price:55000, location:'Casablanca, Anfa', rating:4.9, reviews:44, image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'fb2', title:'F&B Operations Manager — Resort', desc:'5-star resort in Agadir seeking an F&B Operations Manager to coordinate daily operations across restaurant, bar, pool bar, and in-room dining. Full team of 85 FTE.', price:32000, location:'Agadir, Tildi', rating:4.8, reviews:36, image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'fb3', title:'Restaurant Group Operations Director', desc:'Fast-expanding restaurant group seeking an Operations Director to oversee 8 restaurant concepts in Casablanca and Rabat. Standardisation, training, and growth management.', price:48000, location:'Casablanca', rating:4.9, reviews:28, image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'fbb1', title:'F&B Cost Controller', price:18000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'fbb2', title:'Outlet Manager — Hotel Restaurant', price:20000, location:'Marrakech', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'fbb3', title:'Beverage Manager', price:16000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'fbb4', title:'F&B Training Manager', price:18000, location:'Rabat', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'fbb5', title:'Quality Assurance Manager — F&B', price:22000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'fbd1', title:'F&B Coordinator', price:11000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'fbd2', title:'Purchasing & Stores Manager', price:14000, location:'Marrakech', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'fbd3', title:'Bar Manager', price:14000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'fbd4', title:'Events & Banqueting Manager', price:18000, location:'Rabat', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'fbd5', title:'F&B Revenue Analyst', price:13000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'fbd6', title:'Restaurant Marketing Executive', price:12000, location:'Marrakech', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'fbd7', title:'Menu Engineering Consultant', price:20000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'fbd8', title:'F&B Hygiene & Safety Officer', price:11000, location:'Agadir', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='F&B Management' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>F&B Management Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>320 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>F&B Management</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>F&B Management Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>320 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni F&B Management Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More F&B Management Positions</h2>
