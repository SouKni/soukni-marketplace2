...
const topChoices = [
  { id:'fh1', title:'Restaurant Manager — Fine Dining', desc:'Award-winning fine dining restaurant in Rabat seeking an experienced Restaurant Manager to lead front of house team of 15. Wine knowledge, VIP guest relations, and full P&L management.', price:22000, location:'Rabat, Souissi', rating:4.9, reviews:48, image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'fh2', title:'Head Waiter & Floor Supervisor — Luxury Hotel', desc:'5-star hotel seeking a Head Waiter to supervise restaurant and bar service for 3 outlets. Staff training, table management, and ensuring Michelin-level service standards.', price:14000, location:'Marrakech, Palmeraie', rating:4.8, reviews:39, image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'fh3', title:'Host & Reservations Manager', desc:'Prestigious restaurant group in Casablanca hiring a Host Manager to oversee reservations, guest welcome, and dining room flow for 4 busy restaurant venues.', price:12000, location:'Casablanca, Anfa', rating:4.8, reviews:31, image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'fhb1', title:'Senior Waiter — Fine Dining', price:9000, location:'Rabat', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'fhb2', title:'Restaurant Supervisor', price:11000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'fhb3', title:'Sommelier — Restaurant', price:15000, location:'Marrakech', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'fhb4', title:'Guest Relations Officer', price:10000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'fhb5', title:'Breakfast & Brunch Waiter', price:7500, location:'Agadir', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'fhd1', title:'Waiter — Casual Dining', price:6000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'fhd2', title:'Runner & Food Expeditor', price:5500, location:'Rabat', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'fhd3', title:'Hostess — Fine Dining', price:7000, location:'Marrakech', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'fhd4', title:'Rooftop Bar Server', price:8000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'fhd5', title:'Pool Bar Attendant — Resort', price:7000, location:'Agadir', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'fhd6', title:'Room Service Waiter — Hotel', price:7500, location:'Marrakech', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'fhd7', title:'Banquet Waiter — Events', price:6500, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'fhd8', title:'Demi Chef de Rang', price:8500, location:'Rabat', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Front of House' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Front of House Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>540 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Front of House</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Front of House Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>540 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Front of House Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Front of House Positions</h2>
