...
const topChoices = [
  { id:'pb1', title:'Head Pastry Chef — 5-Star Hotel', desc:'Luxury hotel in Marrakech seeking a Head Pastry Chef to lead a team of 8 in producing world-class desserts, breads, and patisserie for 4 F&B outlets. Strong French technique required.', price:28000, location:'Marrakech, Palmeraie', rating:4.9, reviews:41, image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'pb2', title:'Executive Pastry Chef — Chocolate Atelier', desc:'Premium chocolate and patisserie brand in Casablanca hiring an Executive Pastry Chef to develop product range, lead artisan production, and manage retail and wholesale quality.', price:22000, location:'Casablanca, Maarif', rating:4.8, reviews:33, image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'pb3', title:'Artisan Baker — Sourdough Specialist', desc:'Award-winning artisan bakery in Rabat seeking a Head Baker experienced in sourdough, viennoiserie, and heritage grain breads. Early morning shift, creative freedom in product development.', price:14000, location:'Rabat, Agdal', rating:4.8, reviews:26, image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'pbb1', title:'Pastry Chef de Partie', price:12000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'pbb2', title:'Wedding Cake Specialist', price:15000, location:'Marrakech', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'pbb3', title:'Chocolate & Confectionery Artist', price:16000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'pbb4', title:'Bread Baker — Hotel Breakfast', price:10000, location:'Agadir', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'pbb5', title:'Ice Cream & Gelato Chef', price:11000, location:'Rabat', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'pbd1', title:'Commis Pastry Chef', price:7000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'pbd2', title:'Cake Decorator & Sugar Artist', price:10000, location:'Marrakech', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'pbd3', title:'Viennoiserie Specialist', price:11000, location:'Casablanca', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'pbd4', title:'Production Baker — Industrial', price:8000, location:'Tangier', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'pbd5', title:'Gluten-Free & Dietary Baker', price:10000, location:'Rabat', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'pbd6', title:'Pastry Trainer — Hotel School', price:14000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
  { id:'pbd7', title:'Caramel & Nougatine Specialist', price:12000, location:'Marrakech', image:'https://images.pexels.com/photos/1640774/pexels-photo-1640774.jpeg?auto=compress&w=800' },
  { id:'pbd8', title:'Pastry R&D Chef', price:18000, location:'Casablanca', image:'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&w=800' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Pastry & Bakery' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Pastry & Bakery Jobs in Morocco!</h1>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Pastry & Bakery</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Pastry & Bakery Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Pastry & Bakery Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Pastry & Bakery Positions</h2>
