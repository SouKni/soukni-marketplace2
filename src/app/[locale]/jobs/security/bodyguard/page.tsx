...
const topChoices = [
  { id:'bg1', title:'Personal Bodyguard — High Net Worth Client', desc:'Private family office seeking an experienced personal bodyguard for a Casablanca-based HNWI. International travel required. Military or police background essential.', price:28000, location:'Casablanca, Anfa', rating:4.9, reviews:12, image:HERO },
  { id:'bg2', title:'Celebrity Close Protection Officer', desc:'Entertainment management agency hiring a Close Protection Officer for touring artists visiting Morocco. Martial arts certification and driving licence required.', price:22000, location:'Marrakech', rating:4.8, reviews:9, image:HERO },
  { id:'bg3', title:'Executive Protection Specialist', desc:'Corporate security firm seeking an Executive Protection Specialist for a senior executive team. Experience in advance work and threat assessment essential.', price:25000, location:'Casablanca, Finance City', rating:4.9, reviews:7, image:HERO },
]
const bentoListings = [
  { id:'bgb1', title:'VIP Escort Bodyguard', price:20000, location:'Casablanca', image:HERO },
  { id:'bgb2', title:'Female Close Protection Officer', price:18000, location:'Marrakech', image:HERO },
  { id:'bgb3', title:'Diplomatic Protection Officer', price:26000, location:'Rabat', image:HERO },
  { id:'bgb4', title:'Residential Security Bodyguard', price:16000, location:'Casablanca', image:HERO },
  { id:'bgb5', title:'Event VIP Protection Officer', price:15000, location:'Marrakech', image:HERO },
]
const discoveryGrid = [
  { id:'bgd1', title:'Armed Bodyguard — Banking Executive', price:22000, location:'Casablanca', image:HERO },
  { id:'bgd2', title:'Travel Protection Specialist', price:20000, location:'Rabat', image:HERO },
  { id:'bgd3', title:'Bodyguard Driver — HNW Family', price:18000, location:'Casablanca', image:HERO },
  { id:'bgd4', title:'Night Club VIP Protection', price:12000, location:'Marrakech', image:HERO },
  { id:'bgd5', title:'Bodyguard — Hotel Group', price:14000, location:'Marrakech', image:HERO },
  { id:'bgd6', title:'Close Protection Team Leader', price:28000, location:'Casablanca', image:HERO },
  { id:'bgd7', title:'Bodyguard — Real Estate Developer', price:20000, location:'Casablanca', image:HERO },
  { id:'bgd8', title:'International Bodyguard Escort', price:25000, location:'Rabat', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Bodyguard' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Bodyguard Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>64 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Bodyguard Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>64 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Bodyguard Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Bodyguard Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {ALL_SEC_CATS.filter(c=>c.slug!=='bodyguard').map(c=>(
