...
const topChoices = [
  { id:'co1', title:'Senior CCTV Operator — Control Room', desc:'Nationwide retail chain seeking a Senior CCTV Operator to manage a 200-camera control room across multiple sites. Incident reporting and VMS system expertise required.', price:8500, location:'Casablanca, Finance City', rating:4.8, reviews:27, image:HERO },
  { id:'co2', title:'CCTV Operator & Analyst', desc:'Security company hiring a CCTV Operator/Analyst to monitor feeds, identify threats, and produce detailed incident reports for a major hotel group.', price:7000, location:'Marrakech, Hivernage', rating:4.7, reviews:19, image:HERO },
  { id:'co3', title:'Night Shift CCTV Operator', desc:'Industrial estate seeking a Night Shift CCTV Operator for real-time monitoring, alarm response coordination, and shift handover reporting.', price:6500, location:'Tangier Free Zone', rating:4.6, reviews:34, image:HERO },
]
const bentoListings = [
  { id:'cob1', title:'Control Room CCTV Operator', price:7500, location:'Casablanca', image:HERO },
  { id:'cob2', title:'CCTV Technician & Operator', price:8000, location:'Rabat', image:HERO },
  { id:'cob3', title:'Casino Surveillance Operator', price:8500, location:'Marrakech', image:HERO },
  { id:'cob4', title:'Traffic CCTV Monitoring Officer', price:6500, location:'Casablanca', image:HERO },
  { id:'cob5', title:'Remote CCTV Monitoring Agent', price:6000, location:'Remote, Morocco', image:HERO },
]
const discoveryGrid = [
  { id:'cod1', title:'Airport CCTV Operator', price:7500, location:'Casablanca', image:HERO },
  { id:'cod2', title:'Hospital CCTV Surveillance Officer', price:6500, location:'Rabat', image:HERO },
  { id:'cod3', title:'Port CCTV Control Room Operator', price:7000, location:'Tangier', image:HERO },
  { id:'cod4', title:'Mall Surveillance Operator', price:6500, location:'Marrakech', image:HERO },
  { id:'cod5', title:'Bank CCTV Monitoring Officer', price:7500, location:'Casablanca', image:HERO },
  { id:'cod6', title:'CCTV Operator — Logistics Hub', price:6800, location:'Tangier', image:HERO },
  { id:'cod7', title:'Smart City CCTV Analyst', price:9000, location:'Rabat', image:HERO },
  { id:'cod8', title:'CCTV Operator — Gated Community', price:6000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='CCTV Operator' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>CCTV Operator Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>142 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>CCTV Operator Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>142 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni CCTV Operator Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More CCTV Operator Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {ALL_SEC_CATS.filter(c=>c.slug!=='cctv-operator').map(c=>(
