  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <CategoryFooterNav
          relatedTitle="Explore Other Security Jobs"
          related={[
            { label:'Security Guard', href:`/${locale}/jobs/security/security-guard` },
            { label:'Site Security', href:`/${locale}/jobs/security/site-security` },
            { label:'CCTV Operator', href:`/${locale}/jobs/security/cctv-operator` },
            { label:'Security Manager', href:`/${locale}/jobs/security/security-manager` },
            { label:'Bodyguard', href:`/${locale}/jobs/security/bodyguard` },
          ]}
