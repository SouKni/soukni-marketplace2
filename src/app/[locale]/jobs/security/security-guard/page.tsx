...
const ALL_SEC_CATS = [
  { slug:'security-guard',   label:'Security Guard',   image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=400' },
  { slug:'site-security',    label:'Site Security',    image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { slug:'cctv-operator',    label:'CCTV Operator',    image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { slug:'security-manager', label:'Security Manager', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { slug:'bodyguard',        label:'Bodyguard',        image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=400' },
]

const HERO = 'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800'
const topChoices = [
  { id:'sg1', title:'Senior Security Guard — Shopping Mall', desc:'Major retail destination in Casablanca seeking experienced security guards for access control, crowd management, and incident response. 24/7 rotation with performance bonuses.', price:5500, location:'Casablanca, Maarif', rating:4.7, reviews:42, image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'sg2', title:'Armed Security Guard — Banking Sector', desc:'Leading Moroccan bank hiring armed security guards for branch protection. Police or military background required. Competitive salary with full benefits package.', price:7500, location:'Rabat, Agdal', rating:4.8, reviews:29, image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'sg3', title:'Night Shift Security Guard', desc:'Industrial park seeking reliable night shift security guards for perimeter patrol, vehicle checks, and incident logging. Transport allowance provided.', price:5000, location:'Tangier Free Zone', rating:4.6, reviews:51, image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
]
const bentoListings = [
  { id:'sgb1', title:'Hotel Security Guard', price:5200, location:'Marrakech', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'sgb2', title:'Airport Security Guard', price:6500, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'sgb3', title:'Residential Complex Guard', price:4500, location:'Rabat', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'sgb4', title:'Event Security Guard', price:4800, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'sgb5', title:'Warehouse Security Guard', price:4600, location:'Tangier', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
]
const discoveryGrid = [
  { id:'sgd1', title:'School Security Guard', price:4500, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'sgd2', title:'VIP Escort Security Guard', price:7000, location:'Rabat', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'sgd3', title:'Port Security Guard', price:6000, location:'Tangier', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'sgd4', title:'Casino Security Guard', price:6500, location:'Marrakech', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'sgd5', title:'Hospital Security Guard', price:5000, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'sgd6', title:'Embassy Security Guard', price:8000, location:'Rabat', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
  { id:'sgd7', title:'Construction Site Guard', price:4800, location:'Agadir', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=800' },
  { id:'sgd8', title:'Supermarket Security Guard', price:4500, location:'Fès', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800' },
]
    ...
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Security Guard Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>340 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        <Breadcrumb
          items={[
            ...
            { label:'Security', href:`/${locale}/jobs/security` },
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>340 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h3 style={{ fontWeight:900, fontSize:'16px', color:'#161d1b', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'16px' }}>Explore Other Security Categories</h3>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {ALL_SEC_CATS.filter(c=>c.slug!=='security-guard').map(c=>(
              <Link key={c.slug} href={`/${locale}/jobs/security/${c.slug}`}
              ...
              >
                <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden' }}>
                  ...
                  <div style={{ position:'absolute', bottom:'10px', left:0, right:0, textAlign:'center' as const, padding:'0 6px' }}>
                    <p style={{ fontSize:'11px', fontWeight:900, color:'white', lineHeight:1.2 }}>{c.label}</p>
                  </div>
                </div>
              </Link>
            ))}
              <Link href={`/${locale}/jobs/security`}
                style={{ position:'relative', borderRadius:'20px', overflow:'hidden', textDecoration:'none', display:'block', border:'2px solid transparent', transition:'all 0.2s' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='#22d4a8'}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='transparent'}}
              >
