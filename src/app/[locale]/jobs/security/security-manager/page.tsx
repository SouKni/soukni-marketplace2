...
const topChoices = [
  { id:'sm1', title:'Head of Security — Luxury Hotel Group', desc:'Five-star hotel group seeking a Head of Security to oversee protection across 4 Moroccan properties, manage a 60-person security team, and implement group-wide security policy.', price:22000, location:'Marrakech, Hivernage', rating:4.9, reviews:18, image:HERO },
  { id:'sm2', title:'Security Manager — Corporate Campus', desc:'Multinational company hiring a Security Manager for its Casablanca HQ. Responsible for physical security, access control systems, and executive protection coordination.', price:18000, location:'Casablanca, Finance City', rating:4.8, reviews:24, image:HERO },
  { id:'sm3', title:'Regional Security Manager — Retail', desc:'National retail chain seeking a Regional Security Manager to oversee LP operations across 45 stores. Loss prevention and shrinkage reduction focus.', price:16000, location:'Casablanca, Maarif', rating:4.7, reviews:31, image:HERO },
]
const bentoListings = [
  { id:'smb1', title:'Airport Security Manager', price:20000, location:'Casablanca', image:HERO },
  { id:'smb2', title:'Port Security Operations Manager', price:19000, location:'Tangier', image:HERO },
  { id:'smb3', title:'Industrial Security Director', price:24000, location:'Tangier Free Zone', image:HERO },
  { id:'smb4', title:'Mall Security Manager', price:14000, location:'Casablanca', image:HERO },
  { id:'smb5', title:'Bank Security Manager', price:18000, location:'Rabat', image:HERO },
]
const discoveryGrid = [
  { id:'smd1', title:'Event Security Manager', price:15000, location:'Casablanca', image:HERO },
  { id:'smd2', title:'Hospital Security Manager', price:14000, location:'Rabat', image:HERO },
  { id:'smd3', title:'University Campus Security Manager', price:13000, location:'Rabat', image:HERO },
  { id:'smd4', title:'Residential Estate Security Manager', price:12000, location:'Marrakech', image:HERO },
  { id:'smd5', title:'Security Risk & Compliance Manager', price:20000, location:'Casablanca', image:HERO },
  { id:'smd6', title:'VIP Protection Manager', price:22000, location:'Rabat', image:HERO },
  { id:'smd7', title:'Security Operations Centre Manager', price:18000, location:'Casablanca', image:HERO },
  { id:'smd8', title:'Security Training Manager', price:14000, location:'Casablanca', image:HERO },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'440px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Security Manager' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Security Manager Jobs in Morocco!</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>98 verified positions across Morocco</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Security Manager Jobs in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'32px' }}>98 positions across Morocco</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Security Manager Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Security Manager Positions</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {ALL_SEC_CATS.filter(c=>c.slug!=='security-manager').map(c=>(
