...
import { MapPin, Heart, MessageCircle, Phone, Search, ChevronLeft, ChevronRight, ChevronDown, Sliders, Bookmark, Grid3x3, List, Diamond, Smartphone, Globe, Link2, Share2, Compass, Plus, MessageSquare, Menu, Trees, Home as HomeIcon, Building2, Tractor, Factory, Layers, MoreHorizontal } from 'lucide-react'

const categoryPills = [
  { label: 'All Land', icon: Trees, active: true },
  { label: 'Residential Land', icon: HomeIcon },
  { label: 'Commercial Land', icon: Building2 },
  { label: 'Agricultural Land', icon: Tractor },
  { label: 'Industrial Land', icon: Factory },
  { label: 'Mixed-Use Development', icon: Layers },
]

type Project = { id: string; title: string; location: string; image: string }
const newProjects: Project[] = [
  { id: 'p1', title: 'Rabat Green Belt Plots', location: 'Souissi Extension, Rabat', image: 'https://images.pexels.com/photos/210617/pexels-photo-210617.jpeg?auto=compress&w=600' },
...
type Listing = { id: string; title: string; location: string; price: string; sqm?: string; zoning?: string; image: string }

const row1: Listing[] = [
  { id: '1', title: 'Prime Residential Plot', location: 'Hay Riad, Rabat', price: '2,450,000', sqm: '600 sqm', zoning: 'Zoning: R+2', image: 'https://images.pexels.com/photos/280221/pexels-photo-280221.jpeg?auto=compress&w=600' },
  { id: '2', title: 'Agdal Medical Plot', location: 'Agdal-Riad, Rabat', price: '18,500,00', sqm: '120 sqm', zoning: 'Clinic Ready', image: 'https://images.pexels.com/photos/247786/pexels-photo-247786.jpeg?auto=compress&w=600' },
  { id: '3', title: 'Flagship Retail Land', location: 'Avenue Fal Ould Oumeir', price: '22,000,00', sqm: '85 sqm', zoning: 'High Traffic', image: 'https://images.pexels.com/photos/1005638/pexels-photo-1005638.jpeg?auto=compress&w=600' },
  { id: '4', title: 'Technopolis Industrial Plot', location: 'Technopolis, Salé-Rabat', price: '110,000,00', sqm: '2,500 sqm', zoning: 'Logistics A+', image: 'https://images.pexels.com/photos/236722/pexels-photo-236722.jpeg?auto=compress&w=600' },
]

const row2: Listing[] = [
  { id: '5', title: 'Hassan Mixed-Use Plot', location: 'Hassan, Rabat', price: '12,500,00', sqm: '380 sqm', zoning: 'Zoning: R+3', image: 'https://images.pexels.com/photos/1170412/pexels-photo-1170412.jpeg?auto=compress&w=600' },
  { id: '6', title: 'Casablanca Road Frontage Land', location: 'Route de Casablanca, Rabat', price: '85,000,00', sqm: '1,400 sqm', zoning: 'Commercial', image: 'https://images.pexels.com/photos/3954402/pexels-photo-3954402.jpeg?auto=compress&w=600' },
  { id: '7', title: 'Akkari Industrial Land', location: 'Akkari Industrial Zone', price: '35,000,00', sqm: '3,200 sqm', zoning: 'Industrial A+', image: 'https://images.pexels.com/photos/4481259/pexels-photo-4481259.jpeg?auto=compress&w=600' },
  { id: '8', title: 'Ocean District Corner Plot', location: "Quartier de l'Océan, Rabat", price: '9,500,00', sqm: '210 sqm', zoning: 'High Footfall', image: 'https://images.pexels.com/photos/264636/pexels-photo-264636.jpeg?auto=compress&w=600' },
]

const row3: Listing[] = [
  { id: '9', title: 'Hay Riad Tech Plot', location: 'Hay Riad, Rabat', price: '28,000,00', sqm: '210 sqm', image: 'https://images.pexels.com/photos/380768/pexels-photo-380768.jpeg?auto=compress&w=600' },
  { id: '10', title: 'Agdal Boutique Plot', location: 'Agdal, Rabat', price: '15,500,00', sqm: '95 sqm', image: 'https://images.pexels.com/photos/342800/pexels-photo-342800.jpeg?auto=compress&w=600' },
  { id: '11', title: 'Technopolis Logistics Land', location: 'Technopolis, Rabat', price: '42,000,00', sqm: '1,200 sqm', image: 'https://images.pexels.com/photos/2760243/pexels-photo-2760243.jpeg?auto=compress&w=600' },
  { id: '12', title: 'Hassan Co-working Plot', location: 'Hassan, Rabat', price: '19,000,00', sqm: '180 sqm', image: 'https://images.pexels.com/photos/1170412/pexels-photo-1170412.jpeg?auto=compress&w=600' },
]

const row4: Listing[] = [
  { id: '13', title: 'Casablanca Road Flagship Land', location: 'Route de Casablanca, Rabat', price: '95,000,00', sqm: '650 sqm', image: 'https://images.pexels.com/photos/3954402/pexels-photo-3954402.jpeg?auto=compress&w=600' },
  { id: '14', title: 'High-Footfall Corner Plot', location: "Quartier de l'Océan, Rabat", price: '12,000,00', sqm: '110 sqm', image: 'https://images.pexels.com/photos/264636/pexels-photo-264636.jpeg?auto=compress&w=600' },
  { id: '15', title: 'Marina Executive Plot', location: 'Marina District, Rabat', price: '35,000,00', sqm: '320 sqm', image: 'https://images.pexels.com/photos/260689/pexels-photo-260689.jpeg?auto=compress&w=600' },
  { id: '16', title: 'Agdal-Riad Clinic Plot', location: 'Agdal-Riad, Rabat', price: '22,500,00', sqm: '145 sqm', image: 'https://images.pexels.com/photos/247786/pexels-photo-247786.jpeg?auto=compress&w=600' },
]

const row5: Listing[] = [
  { id: '17', title: 'Marina Oceanfront Plot', location: 'Marina, Rabat', price: '55,000,00', image: 'https://images.pexels.com/photos/260689/pexels-photo-260689.jpeg?auto=compress&w=600' },
  { id: '18', title: 'Agdal Retail Flagship Land', location: 'Agdal, Rabat', price: '32,000,00', image: 'https://images.pexels.com/photos/1005638/pexels-photo-1005638.jpeg?auto=compress&w=600' },
  { id: '19', title: 'Souissi Executive Plot', location: 'Technopolis, Rabat', price: '120,000,00', image: 'https://images.pexels.com/photos/236722/pexels-photo-236722.jpeg?auto=compress&w=600' },
  { id: '20', title: 'Souissi Executive Villa Plot', location: 'Souissi, Rabat', price: '48,000,00', image: 'https://images.pexels.com/photos/280221/pexels-photo-280221.jpeg?auto=compress&w=600' },
]

const row6: Listing[] = [
  { id: '21', title: 'Hassan Tech Loft Plot', location: 'Hassan, Rabat', price: '15,500,00', image: 'https://images.pexels.com/photos/1170412/pexels-photo-1170412.jpeg?auto=compress&w=600' },
  { id: '22', title: 'Casablanca Road Gallery Plot', location: 'Route de Casablanca, Rabat', price: '95,000,00', image: 'https://images.pexels.com/photos/3954402/pexels-photo-3954402.jpeg?auto=compress&w=600' },
  { id: '23', title: 'Akkari Storage Land', location: 'Akkari, Rabat', price: '28,000,00', image: 'https://images.pexels.com/photos/4481259/pexels-photo-4481259.jpeg?auto=compress&w=600' },
  { id: '24', title: 'Ocean District Corner Land', location: 'Ocean District, Rabat', price: '11,000,00', image: 'https://images.pexels.com/photos/264636/pexels-photo-264636.jpeg?auto=compress&w=600' },
]

const row7: Listing[] = [
  { id: '25', title: 'Hay Riad Business Plot', location: 'Hay Riad, Rabat', price: '65,000,00', image: 'https://images.pexels.com/photos/380768/pexels-photo-380768.jpeg?auto=compress&w=600' },
  { id: '26', title: 'Agdal-Riad Medical Plot', location: 'Agdal-Riad, Rabat', price: '24,500,00', image: 'https://images.pexels.com/photos/342800/pexels-photo-342800.jpeg?auto=compress&w=600' },
  { id: '27', title: 'Hassan Co-working Land', location: 'Hassan, Rabat', price: '18,000,00', image: 'https://images.pexels.com/photos/2760243/pexels-photo-2760243.jpeg?auto=compress&w=600' },
  { id: '28', title: 'Marina Executive Land', location: 'Marina District, Rabat', price: '42,000,00', image: 'https://images.pexels.com/photos/1170412/pexels-photo-1170412.jpeg?auto=compress&w=600' },
]
    ...
    >
      ...
      <div style={{ padding: '20px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px', gap: '8px' }}>
          ...
          <div style={{ color: '#006b5f', fontWeight: 700, fontSize: '18px', whiteSpace: 'nowrap' as const }}>{item.price} MAD</div>
        </div>
        <p style={{ fontSize: '14px', color: '#3c4a46', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '4px' }}>
          <MapPin size={16} /> {item.location}
        </p>
        {(item.sqm || item.zoning) && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', color: '#3c4a46', fontSize: '12px', fontWeight: 600, marginBottom: '24px' }}>
            ...
            {item.zoning && <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>▦ {item.zoning}</span>}
          </div>
        )}
        <div style={{ display: 'flex', gap: '8px', marginTop: (item.sqm || item.zoning) ? 0 : '8px' }}>
...
export default function LandForSalePage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    <div style={{ fontFamily: 'Hanken Grotesk, Inter, sans-serif', backgroundColor: '#f4fbf8', color: '#161d1b', minHeight: '100vh', paddingBottom: '90px' }}>
      ...
      <section style={{ position: 'relative', height: '480px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: '1280px', margin: '0 auto', padding: '0 40px', height: '100%', display: 'flex', flexDirection: 'column' as const, justifyContent: 'center', alignItems: 'center' }}>
          <h1 style={{ color: 'white', fontSize: '48px', fontWeight: 700, textAlign: 'center' as const, marginBottom: '32px', textShadow: '0 4px 12px rgba(0,0,0,0.4)' }}>Find Your Perfect Plot in Rabat</h1>
          <div style={{ width: '100%', maxWidth: '1100px', backgroundColor: 'rgba(255,255,255,0.7)', backdropFilter: 'blur(12px)', border: '1px solid rgba(255,255,255,0.4)', padding: '24px', borderRadius: '2rem', boxShadow: '0 25px 50px rgba(0,0,0,0.25)' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5,1fr)', gap: 0 }}>
              ...
              <div style={{ padding: '8px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <button style={{ backgroundColor: '#006b5f', color: 'white', width: '48px', height: '48px', borderRadius: '50%', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 16px rgba(0,107,95,0.3)', flexShrink: 0 }}>
                  <Search size={20} />
                </button>
              </div>
            </div>
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 40px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '32px', borderBottom: '1px solid rgba(186,202,197,0.3)', paddingBottom: '16px', flexWrap: 'wrap' as const, gap: '16px' }}>
          <div>
            <h2 style={{ fontSize: '24px', fontWeight: 600 }}>Land for Sale in Rabat</h2>
            <p style={{ fontSize: '16px', color: '#3c4a46' }}>1,420 Prime Plots found in Rabat District</p>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px', flexWrap: 'wrap' as const }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '4px', border: '1px solid rgba(186,202,197,0.3)', borderRadius: '8px', padding: '4px', backgroundColor: 'white' }}>
              <button style={{ padding: '6px', backgroundColor: '#e2eae7', borderRadius: '6px', border: 'none', cursor: 'pointer', color: '#006b5f', display: 'flex' }}><Grid3x3 size={20} /></button>
              <button style={{ padding: '6px', backgroundColor: 'transparent', border: 'none', cursor: 'pointer', color: '#3c4a46', display: 'flex' }}><List size={20} /></button>
            </div>
          </div>
        </div>
        ...
        <section style={{ marginBottom: '48px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
            <h2 style={{ fontSize: '24px', fontWeight: 600 }}>New Land Developments in Rabat</h2>
            <a href="#" style={{ display: 'flex', alignItems: 'center', gap: '4px', color: '#006b5f', fontWeight: 700, textDecoration: 'none' }}>View All →</a>
          </div>
        ...
        <div style={{ margin: '32px 0' }}>
          <div style={{ backgroundColor: '#006b5f', borderRadius: '2.5rem', padding: '48px', minHeight: '220px', display: 'flex', flexDirection: 'column' as const, justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
            ...
            <h2 style={{ color: 'white', fontSize: '32px', fontWeight: 700, marginBottom: '16px', maxWidth: '600px' }}>Sell Your Land Faster with Diamond Verified FREE Member Account</h2>
            <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '16px', marginBottom: '24px', maxWidth: '600px' }}>Reach thousands of developers and investors. Get 5x more visibility and a professional verification badge for your land listings.</p>
        ...
        <section style={{ margin: '32px 0 48px' }}>
          <div style={{ backgroundColor: '#e8efec', borderRadius: '2.5rem', overflow: 'hidden', border: '1px solid rgba(186,202,197,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '48px', gap: '32px', flexWrap: 'wrap' as const }}>
            <div style={{ flex: 1, minWidth: '320px' }}>
              ...
              <h2 style={{ fontSize: '40px', fontWeight: 700, marginBottom: '16px', lineHeight: 1.2 }}>The Future of Land Investment</h2>
        ...
        <ListingGrid items={row5} />
        <ListingGrid items={row6} />
        <ListingGrid items={row7} />
        ...
        <div style={{ display: 'flex', flexDirection: 'column' as const, alignItems: 'center', gap: '24px', marginTop: '64px', paddingTop: '32px', paddingBottom: '32px', borderTop: '1px solid rgba(186,202,197,0.3)' }}>
          <p style={{ color: '#3c4a46', fontSize: '16px' }}>You've viewed 28 of 1,420 properties</p>
      ...
      <footer style={{ backgroundColor: '#7A7A7A', color: 'white', padding: '64px 40px' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '48px', marginBottom: '64px' }}>
            <div>
              <h3 style={{ fontSize: '24px', fontWeight: 600, marginBottom: '24px' }}>SouKni Land Rabat</h3>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', marginBottom: '32px', lineHeight: 1.6 }}>The premier marketplace for land and development opportunities in Morocco's capital. Connecting investors with prime plots since 2026.</p>
