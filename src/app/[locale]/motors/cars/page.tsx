...
import { MapPin, ChevronRight, Search, Heart, MessageCircle, Diamond } from 'lucide-react'
import { useMarket } from '@/context/MarketContext'

const subCategories = ['All Cars', 'Sedan', 'SUV', 'Coupe', 'Convertible', 'Electric', 'Pickup', 'Hatchback']
...
export default function CarsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const [activePill, setActivePill] = useState('All Cars')
  ...
  return (
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif', backgroundColor: '#f4fbf8', minHeight: '100vh' }}>
      ...
      <section style={{ position: 'relative', height: '380px', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
        <img src="https://images.pexels.com/photos/3802510/pexels-photo-3802510.jpeg?auto=compress&w=1600" alt="Used Cars"
        ...
        <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', padding: '0 20px', maxWidth: '700px', width: '100%' }}>
          <h1 style={{ fontSize: '44px', fontWeight: 900, color: 'white', letterSpacing: '-0.03em', marginBottom: '10px', lineHeight: 1.1 }}>Used Cars for Sale in Morocco</h1>
          <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.8)', marginBottom: '28px' }}>24,180 verified listings across Morocco</p>
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', flexWrap: 'wrap', gap: '12px' }}>
          <h2 style={{ fontSize: '22px', fontWeight: 800, color: '#0f172a' }}>
            Used Cars for sale in Morocco <span style={{ color: '#64748b', fontWeight: 400, fontSize: '16px' }}>24,180 Ads</span>
          </h2>
        ...
        {/* DIAMOND BANNER */}
        <section style={{ borderRadius: '40px', background: 'linear-gradient(135deg, #2dd4bf, #2dd4bf)', padding: '56px 48px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '40px', flexWrap: 'wrap' }}>
          <div style={{ maxWidth: '480px' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: '16px', marginBottom: '24px', lineHeight: 1.6 }}>Get priority placement and a verified badge on every car listing you post.</p>
