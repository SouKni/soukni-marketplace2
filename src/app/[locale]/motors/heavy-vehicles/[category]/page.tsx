...
const CATEGORIES: Record<string,{
  ...
  'all-equipment': {
    ...
    desc:'Browse the complete SouKni heavy equipment marketplace.',
    count:'192',
    brands:['Caterpillar','John Deere','Komatsu','Liebherr','JCB','New Holland','Case IH','Mercedes-Benz'],
    priceRanges:['Any Price','0 – 500,000 MAD','500,000 – 1,500,000 MAD','1,500,000 – 3,000,000 MAD','3,000,000+ MAD'],
  },
  'agricultural': {
    label:'Agricultural',
    hero:'https://images.pexels.com/photos/175389/pexels-photo-175389.jpeg?auto=compress&w=1600',
    desc:'Tractors, combines, and farm equipment for Moroccan agriculture.',
    count:'64',
    brands:['John Deere','New Holland','Case IH','Fendt'],
    priceRanges:['Any Price','0 – 1,000,000 MAD','1,000,000 – 2,500,000 MAD','2,500,000 – 4,000,000 MAD','4,000,000+ MAD'],
  },
  'construction': {
    label:'Construction',
    hero:'https://images.pexels.com/photos/162553/excavator-construction-site-machine-162553.jpeg?auto=compress&w=1600',
    desc:'Excavators, bulldozers, and machinery for construction sites.',
    count:'58',
    brands:['Caterpillar','Komatsu','Liebherr','JCB'],
    priceRanges:['Any Price','0 – 800,000 MAD','800,000 – 1,800,000 MAD','1,800,000 – 3,500,000 MAD','3,500,000+ MAD'],
  },
  'cranes-lifting': {
    label:'Cranes & Lifting',
    hero:'https://images.pexels.com/photos/2760243/pexels-photo-2760243.jpeg?auto=compress&w=1600',
    desc:'Mobile cranes, telehandlers, and material handling equipment.',
    count:'31',
    brands:['Liebherr','Kalmar','JCB','Jungheinrich'],
    priceRanges:['Any Price','0 – 1,000,000 MAD','1,000,000 – 2,500,000 MAD','2,500,000 – 5,000,000 MAD','5,000,000+ MAD'],
  },
  'trucks-buses': {
    label:'Trucks & Buses',
    hero:'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=1600',
    desc:'Heavy trucks, prime movers, and coach buses.',
    count:'27',
    brands:['Mercedes-Benz','SITRAK','Yutong'],
    priceRanges:['Any Price','0 – 500,000 MAD','500,000 – 800,000 MAD','800,000+ MAD'],
  },
  'generators-power': {
    label:'Generators & Power',
    hero:'https://images.pexels.com/photos/2760243/pexels-photo-2760243.jpeg?auto=compress&w=1600',
    desc:'Industrial generators and power equipment for sites and farms.',
    count:'12',
    brands:['Caterpillar','Cummins','Perkins'],
    priceRanges:['Any Price','0 – 150,000 MAD','150,000 – 350,000 MAD','350,000+ MAD'],
  },
}
...
const EQUIP_IMGS = [
  'https://images.pexels.com/photos/162553/excavator-construction-site-machine-162553.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/175389/pexels-photo-175389.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/4506105/pexels-photo-4506105.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/2760243/pexels-photo-2760243.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/4506270/pexels-photo-4506270.jpeg?auto=compress&w=400',
]
...
function ListingCard({ brand, title, price, location, condition, img, badge, year }: any) {
...
function makeListings(cat: string, count: number) {
  const titleMap: Record<string,string[]> = {
    'all-equipment':    ['8R 410 Tractor','320 Excavator','LTM 1060 Crane','540-170 Telehandler','CR11 Combine','Magnum 380 Tractor'],
    'agricultural':     ['8R 410 Tractor','CR11 Combine','Magnum 380 Tractor','1050 Vario Tractor'],
    'construction':     ['320 Hydraulic Excavator','D65 Bulldozer','540-170 Telehandler','JS220 Excavator'],
    'cranes-lifting':   ['LTM 1060 Mobile Crane','DRU450 Reach Stacker','EKS 412s Forklift','540-170 Telehandler'],
    'trucks-buses':     ['C7H 6x4 Prime Mover','Arocs 3240 Mixer','C9 Coach Bus'],
    'generators-power': ['XQ125 Generator','C15 Power Unit','1500-Series Generator'],
  }
  ...
  const locs   = ['Rabat','Casablanca','Tangier','Agadir','Marrakech']
  const conds  = ['Excellent','Like New','Good',undefined,undefined]
  return Array.from({length:count},(_,i)=>({
    brand:     cat_data.brands[i%cat_data.brands.length],
    title:     titles[i%titles.length],
    price:     350000 + ((i*97310)%3800000),
    location:  locs[i%locs.length],
    year:      years[i%years.length],
    condition: conds[i%conds.length],
    img:       EQUIP_IMGS[i%EQUIP_IMGS.length],
    badge:     badges[i%badges.length],
  }))
}

export default function HeavyVehiclesCategoryPage() {
  ...
  function mapDbRowToCard(row: any) {
    return {
      ...
      img: (row.images && row.images[0]) || EQUIP_IMGS[0],
    ...
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      ...
      <section style={{ position:'relative', height:'360px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center' as const, maxWidth:'860px', padding:'0 24px', width:'100%' }}>
          <p style={{ fontSize:'11px', ...UB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.2em', marginBottom:'12px' }}>MOTORS › HEAVY VEHICLES</p>
        ...
        <div style={{ backgroundColor:'rgba(255,255,255,0.97)', backdropFilter:'blur(16px)', border:'1px solid rgba(107,122,118,0.12)', borderRadius:'100px', boxShadow:'0 12px 40px rgba(0,0,0,0.08)', display:'flex', alignItems:'stretch', height:'68px' }}>
          ...
          <div style={{ flex:1.8, padding:'0 22px', display:'flex', flexDirection:'column' as const, justifyContent:'center' }}>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
              ...
              <input type="text" value={keyword} onChange={e=>setKeyword(e.target.value)} placeholder={`e.g. ${catData.brands[0]}...`}
      ...
      <main style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 24px 80px' }}>
        ...
        <Breadcrumb
          items={[
            ...
            { label:'Heavy Vehicles', href:`/${locale}/motors/heavy-vehicles` },
            { label:catData.label },
          ]}
          mutedColor={C.muted}
          inkColor={C.ink}
        ...
        <CategoryFooterNav
          relatedTitle="Explore Other Equipment Types"
          related={ALL_CATS.filter(c=>c.slug!==catSlug).map(cat=>({ label:cat.label, href:`/${locale}/motors/heavy-vehicles/${cat.slug}` }))}
          backHref={`/${locale}/motors/heavy-vehicles`}
          backLabel="Back to All Equipment"
          inkColor={C.ink}
          mintDkColor={C.mint}
        />
      </main>
