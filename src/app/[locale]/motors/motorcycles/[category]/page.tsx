  ...
  return (
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      ...
      <main style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 24px 80px' }}>
        ...
        <CategoryFooterNav
          relatedTitle="Explore Other Motorcycle Types"
          related={ALL_CATS.filter(c=>c.slug!==catSlug).map(cat=>({ label:cat.label, href:`/${locale}/motors/motorcycles/${cat.slug}` }))}
          backHref={`/${locale}/motors/motorcycles`}
          backLabel="Back to All Motorcycles"
          inkColor={C.ink}
          mintDkColor={C.mint}
        />
      </main>
