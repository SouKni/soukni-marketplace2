...
const CATEGORIES: Record<string,{
  ...
  'all-motorcycles': {
    ...
    desc:'Browse the complete SouKni motorcycle and scooter marketplace.',
    count:'2,972',
    brands:['Yamaha','Honda','BMW','Ducati','Kawasaki','Suzuki','Harley-Davidson','KTM','Triumph','Vespa'],
    priceRanges:['Any Price','0 – 80,000 MAD','80,000 – 150,000 MAD','150,000 – 250,000 MAD','250,000+ MAD'],
  },
  'sport': {
    label:'Sport',
    hero:'https://images.pexels.com/photos/2393816/pexels-photo-2393816.jpeg?auto=compress&w=1600',
    desc:'High-performance sportbikes for track and street.',
    count:'640',
    brands:['Ducati','BMW','Kawasaki','Yamaha','Aprilia','Honda'],
    priceRanges:['Any Price','0 – 120,000 MAD','120,000 – 200,000 MAD','200,000 – 300,000 MAD','300,000+ MAD'],
  },
  'cruiser': {
    label:'Cruiser',
    hero:'https://images.pexels.com/photos/2393835/pexels-photo-2393835.jpeg?auto=compress&w=1600',
    desc:'Classic and modern cruisers built for comfort and style.',
    count:'380',
    brands:['Harley-Davidson','Indian','Triumph','Honda'],
    priceRanges:['Any Price','0 – 150,000 MAD','150,000 – 250,000 MAD','250,000 – 350,000 MAD','350,000+ MAD'],
  },
  'scooter': {
    label:'Scooter',
    hero:'https://images.pexels.com/photos/116675/pexels-photo-116675.jpeg?auto=compress&w=1600',
    desc:'Nimble scooters for effortless city commuting.',
    count:'890',
    brands:['Vespa','Yamaha','Honda'],
    priceRanges:['Any Price','0 – 40,000 MAD','40,000 – 80,000 MAD','80,000 – 130,000 MAD','130,000+ MAD'],
  },
  'off-road': {
    label:'Off-Road',
    hero:'https://images.pexels.com/photos/1149831/pexels-photo-1149831.jpeg?auto=compress&w=1600',
    desc:'Dirt bikes and adventure motorcycles built for the trail.',
    count:'310',
    brands:['KTM','Honda','Yamaha','Kawasaki'],
    priceRanges:['Any Price','0 – 60,000 MAD','60,000 – 120,000 MAD','120,000 – 200,000 MAD','200,000+ MAD'],
  },
  'touring': {
    label:'Touring',
    hero:'https://images.pexels.com/photos/1149831/pexels-photo-1149831.jpeg?auto=compress&w=1600',
    desc:'Long-distance touring bikes built for comfort on the road.',
    count:'175',
    brands:['BMW','Honda','Triumph','Suzuki'],
    priceRanges:['Any Price','0 – 150,000 MAD','150,000 – 250,000 MAD','250,000 – 350,000 MAD','350,000+ MAD'],
  },
  'naked': {
    label:'Naked',
    hero:'https://images.pexels.com/photos/2393835/pexels-photo-2393835.jpeg?auto=compress&w=1600',
    desc:'Naked streetfighters, stripped-down and ready to ride.',
    count:'577',
    brands:['Yamaha','KTM','Triumph','Kawasaki','Suzuki'],
    priceRanges:['Any Price','0 – 90,000 MAD','90,000 – 150,000 MAD','150,000 – 220,000 MAD','220,000+ MAD'],
  },
}
...
const BIKE_IMGS = [
  'https://images.pexels.com/photos/2393816/pexels-photo-2393816.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/2393835/pexels-photo-2393835.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/1416382/pexels-photo-1416382.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/1149831/pexels-photo-1149831.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/2549942/pexels-photo-2549942.jpeg?auto=compress&w=400',
]
    ...
    <article onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)}
      ...
      <div style={{ padding:'16px 18px', flex:1, display:'flex', flexDirection:'column' as const }}>
        ...
        <div style={{ marginTop:'auto', display:'flex', gap:'8px' }}>
          ...
          >Message</button>
          <a href="https://wa.me/212600000000?text=Hi%2C%20I%20found%20your%20bike%20listing%20on%20SouKni!" target="_blank" rel="noopener noreferrer"
...
function makeListings(cat: string, count: number) {
  const titleMap: Record<string,string[]> = {
    'all-motorcycles': ['Panigale V4','S1000RR','Fat Boy 114','GTS 300','R1250GS','1290 Super Duke'],
    'sport':           ['Panigale V4','S1000RR','Ninja ZX-10R','YZF-R1','RS 660','CBR650R'],
    'cruiser':         ['Fat Boy 114','Scout Rogue','Rocket 3 Storm R','Rebel 1100'],
    'scooter':         ['GTS 300','TMAX','X-ADV'],
    'off-road':        ['RC 390','450 EXC-F','WR250R','KLX300'],
    'touring':         ['R1250GS','Gold Wing','Tiger 900','V-Strom 650'],
    'naked':           ['MT-09 SP','1290 Super Duke','Speed Triple 1200','Z900','GSX-S1000'],
  }
  const cat_data = CATEGORIES[cat] || CATEGORIES['all-motorcycles']
  const titles = titleMap[cat] || titleMap['all-motorcycles']
  ...
  const conds  = ['Excellent','Like New','Good',undefined,undefined]
  ...
  return Array.from({length:count},(_,i)=>({
    ...
    price:     60000 + ((i*11310)%280000),
    location:  locs[i%locs.length],
    year:      years[i%years.length],
    condition: conds[i%conds.length],
    img:       BIKE_IMGS[i%BIKE_IMGS.length],
...
export default function MotorcyclesCategoryPage() {
  ...
  const catSlug  = (params?.category as string) || 'all-motorcycles'
  const catData  = CATEGORIES[catSlug] || CATEGORIES['all-motorcycles']
  ...
  function mapDbRowToCard(row: any) {
    return {
      ...
      img: (row.images && row.images[0]) || BIKE_IMGS[0],
    ...
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      ...
      <section style={{ position:'relative', height:'360px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center' as const, maxWidth:'860px', padding:'0 24px', width:'100%' }}>
          <p style={{ fontSize:'11px', ...UB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.2em', marginBottom:'12px' }}>MOTORS › MOTORCYCLES</p>
          <h1 style={{ fontSize:'clamp(32px,5vw,52px)', ...UB, color:'white', marginBottom:'16px', lineHeight:1.05, textShadow:'0 4px 20px rgba(0,0,0,0.4)' }}>
            {catData.label} Motorcycles in Morocco
          </h1>
      ...
      <div style={{ maxWidth:'1280px', margin:'-36px auto 0', padding:'0 24px', position:'relative', zIndex:30 }}>
        <div style={{ backgroundColor:'rgba(255,255,255,0.97)', backdropFilter:'blur(16px)', border:'1px solid rgba(107,122,118,0.12)', borderRadius:'100px', boxShadow:'0 12px 40px rgba(0,0,0,0.08)', display:'flex', alignItems:'stretch', height:'68px' }}>
          ...
          <div style={{ width:'1px', backgroundColor:'rgba(107,122,118,0.12)', margin:'12px 0' }} />
          <DDrop label="PRICE RANGE" value={price} options={catData.priceRanges} open={priceOpen} setOpen={setPriceOpen} onChange={setPrice} />
          <div style={{ width:'1px', backgroundColor:'rgba(107,122,118,0.12)', margin:'12px 0' }} />
          ...
          >
            ...
            <span style={{ fontSize:'14px', ...UB, color:C.ink }}>All Filters</span>
          </button>
        </div>
      </div>
      ...
      <main style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 24px 80px' }}>
        ...
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'10px', ...UB, color:C.muted, textTransform:'uppercase' as const, letterSpacing:'0.12em', marginBottom:'12px' }}>
          {[
            ...
            { label:'Motorcycles', href:`/${locale}/motors/motorcycles` },
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:'16px', marginBottom:'24px', flexWrap:'wrap' as const }}>
          <div>
            <h2 style={{ fontSize:'clamp(20px,2.5vw,28px)', ...UB, color:C.ink, marginBottom:'4px' }}>{catData.label} Motorcycles in Morocco</h2>
        ...
        <section style={{ marginBottom:'48px' }}>
          <h3 style={{ fontSize:'clamp(18px,2.5vw,24px)', ...UB, color:C.ink, textTransform:'uppercase' as const, marginBottom:'20px' }}>Explore Other Motorcycle Types</h3>
        ...
        <div style={{ textAlign:'center' as const }}>
          <Link href={`/${locale}/motors/motorcycles`}
