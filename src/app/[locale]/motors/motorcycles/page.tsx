...
const I = {
  hero:    'https://images.pexels.com/photos/2393816/pexels-photo-2393816.jpeg?auto=compress&w=1600',
  c1:      'https://images.pexels.com/photos/2393816/pexels-photo-2393816.jpeg?auto=compress&w=600',
  c2:      'https://images.pexels.com/photos/1149831/pexels-photo-1149831.jpeg?auto=compress&w=600',
  c3:      'https://images.pexels.com/photos/2393816/pexels-photo-2393816.jpeg?auto=compress&w=600',
  c4:      'https://images.pexels.com/photos/116675/pexels-photo-116675.jpeg?auto=compress&w=600',
  bento1:  'https://images.pexels.com/photos/2393816/pexels-photo-2393816.jpeg?auto=compress&w=900',
  bento2:  'https://images.pexels.com/photos/1416382/pexels-photo-1416382.jpeg?auto=compress&w=600',
  bento3:  'https://images.pexels.com/photos/2393835/pexels-photo-2393835.jpeg?auto=compress&w=600',
  bento4:  'https://images.pexels.com/photos/1149831/pexels-photo-1149831.jpeg?auto=compress&w=600',
  inspect: 'https://images.pexels.com/photos/2393835/pexels-photo-2393835.jpeg?auto=compress&w=1200',
  ride:    'https://images.pexels.com/photos/2549942/pexels-photo-2549942.jpeg?auto=compress&w=1200',
  g1:      'https://images.pexels.com/photos/2393816/pexels-photo-2393816.jpeg?auto=compress&w=400',
  g2:      'https://images.pexels.com/photos/1149831/pexels-photo-1149831.jpeg?auto=compress&w=400',
  g3:      'https://images.pexels.com/photos/1416382/pexels-photo-1416382.jpeg?auto=compress&w=400',
  g4:      'https://images.pexels.com/photos/2393835/pexels-photo-2393835.jpeg?auto=compress&w=400',
  g5:      'https://images.pexels.com/photos/2549942/pexels-photo-2549942.jpeg?auto=compress&w=400',
}
...
const featuredItems = [
  { brand:'Ducati',           title:'Panigale V4 — 2024',              price:280000, location:'Casablanca', img:I.c1, badges:['featured','diamond']   },
  { brand:'BMW',               title:'R1250GS Adventure',                price:225000, location:'Rabat',      img:I.c2, badges:['featured','diamond']   },
  { brand:'Harley-Davidson',  title:'Fat Boy 114 — 2023',               price:260000, location:'Marrakech',  img:I.c3, badges:['featured','certified'] },
  { brand:'Vespa',             title:'GTS 300 — Like New',               price:85000,  location:'Tangier',    img:I.c4, badges:['featured','new']       },
]

function makeGrid(count: number) {
  const brands = ['Yamaha','Honda','BMW','Ducati','Kawasaki','Suzuki','KTM','Triumph']
  const titles = ['YZF-R1','CBR650R','S1000RR','Panigale V4','Ninja ZX-10R','Hayabusa','1290 Super Duke','Speed Triple 1200']
  const imgs   = [I.g1,I.g2,I.g3,I.g4,I.g5]
  const badges: BadgeT[] = ['certified','diamond','featured','new','certified']
  return Array.from({length:count},(_,i)=>({
    brand: brands[i%brands.length],
    title: titles[i%titles.length],
    price: 70000 + ((i*11310)%270000),
...
const CATS = [
  { label:'All Motorcycles', slug:'all-motorcycles' },
  { label:'Sport',           slug:'sport'           },
  { label:'Cruiser',         slug:'cruiser'         },
  { label:'Scooter',         slug:'scooter'         },
  { label:'Off-Road',        slug:'off-road'        },
  { label:'Touring',         slug:'touring'         },
...
export default function MotorcyclesPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const [cc,           setCc          ] = useState('Any CC')
  ...
  const neighborhoods = ['All','Maarif','Agdal','Souissi','Hay Riad','Gueliz','Médina','Océan']
  const ccOptions     = ['Any CC','0 – 125cc','126 – 250cc','251 – 500cc','501 – 750cc','751 – 1000cc','1000cc+']
  const priceRanges   = ['Select','Any Price','0 – 80,000 MAD','80,000 – 150,000 MAD','150,000 – 250,000 MAD','250,000+ MAD']

  function DDrop({ label, value, options, open, setOpen, onChange }: any) {
    return (
      <div style={{ position:'relative', flex:1 }}>
        <button onClick={()=>{ setOpen(!open); setCityOpen(false); setNeighOpen(false); setCcOpen(false); setPriceOpen(false) }}
  ...
  return (
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      ...
      <section style={{ position:'relative', height:'520px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        <img src={I.hero} alt="Motorcycles" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center' as const, maxWidth:'960px', padding:'0 24px', width:'100%' }}>
          <h1 style={{ fontSize:'clamp(36px,6vw,64px)', ...UB, color:'white', marginBottom:'36px', lineHeight:1, textShadow:'0 4px 20px rgba(0,0,0,0.4)' }}>
            MOTORCYCLES & SCOOTERS.<br/><span style={{ color:C.mint }}>NEW AND PRE-OWNED IN MOROCCO.</span>
          </h1>
          <div style={{ maxWidth:'780px', margin:'0 auto', backgroundColor:'rgba(255,255,255,0.12)', backdropFilter:'blur(12px)', border:'1px solid rgba(255,255,255,0.22)', borderRadius:'100px', padding:'8px', display:'flex', alignItems:'center' }}>
            ...
            <div style={{ flex:2, padding:'0 28px', display:'flex', flexDirection:'column' as const, gap:'2px' }}>
              ...
              <input type="text" value={makeModel} onChange={e=>setMakeModel(e.target.value)} placeholder="Search bikes, scooters, or gear..."
        ...
        <div style={{ backgroundColor:'rgba(255,255,255,0.97)', backdropFilter:'blur(16px)', border:'1px solid rgba(107,122,118,0.12)', borderRadius:'100px', boxShadow:'0 12px 40px rgba(0,0,0,0.08)', display:'flex', alignItems:'stretch', height:'72px' }}>
          ...
          <div style={{ flex:1.6, padding:'0 18px', display:'flex', flexDirection:'column' as const, justifyContent:'center' }}>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
              ...
              <input type="text" value={makeModel} onChange={e=>setMakeModel(e.target.value)} placeholder="Search brands..."
          ...
          <div style={{ width:'1px', backgroundColor:'rgba(107,122,118,0.12)', margin:'12px 0' }} />
          <DDrop label="ENGINE SIZE (CC)" value={cc} options={ccOptions} open={ccOpen} setOpen={setCcOpen} onChange={setCc} />
          <div style={{ width:'1px', backgroundColor:'rgba(107,122,118,0.12)', margin:'12px 0' }} />
          ...
          >
            ...
            <span style={{ fontSize:'13px', ...UB, color:C.ink }}>All Filters</span>
          </button>
        </div>
      </div>
      ...
      <main style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 24px 80px' }}>
        ...
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'10px', ...UB, color:C.muted, textTransform:'uppercase' as const, letterSpacing:'0.12em', marginBottom:'12px' }}>
          {['Home','Motors','Motorcycles & Scooters'].map((c,i,arr)=>(
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:'16px', marginBottom:'24px', flexWrap:'wrap' as const }}>
          <div>
            <h2 style={{ fontSize:'clamp(20px,2.5vw,28px)', ...UB, color:C.ink, marginBottom:'4px' }}>Motorcycles & Scooters in Morocco</h2>
            <p style={{ fontSize:'14px', color:C.mint, ...CB }}>2,972 Listings across Morocco</p>
          </div>
        ...
        <div style={{ display:'flex', gap:'10px', flexWrap:'wrap' as const, marginBottom:'20px', alignItems:'center' }}>
          {CATS.map(cat=>(
            <Link key={cat.slug} href={`/${locale}/motors/motorcycles/${cat.slug}`}
        ...
        {/* ══ 7. FEATURED HIGH-PERFORMANCE BIKES ═══════════════ */}
        <section style={{ marginBottom:'48px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'24px' }}>
            <div>
              <h3 style={{ fontSize:'clamp(18px,2.5vw,24px)', ...UB, color:C.ink, textTransform:'uppercase' as const, marginBottom:'4px' }}>Featured High-Performance Bikes</h3>
              <p style={{ fontSize:'14px', color:C.muted }}>Top-tier speed and precision engineering</p>
            </div>
        ...
        <section style={{ marginBottom:'64px' }}>
          <div style={{ backgroundColor:C.ink, borderRadius:'40px', padding:'56px 64px', display:'flex', alignItems:'center', justifyContent:'space-between', position:'relative' as const, overflow:'hidden', minHeight:'240px', boxShadow:'0 16px 48px rgba(0,0,0,0.2)', flexWrap:'wrap' as const, gap:'24px' }}>
            ...
            <div style={{ position:'relative', zIndex:1, maxWidth:'480px' }}>
              <p style={{ fontSize:'11px', ...UB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.15em', marginBottom:'16px' }}>SOUKNI MOTO PRO</p>
              <h2 style={{ fontSize:'clamp(24px,3.5vw,38px)', ...UB, color:'white', marginBottom:'20px', lineHeight:1.1 }}>Get your motorcycle professionally inspected before selling.</h2>
        ...
        {/* ══ 9. EXCLUSIVE CERTIFIED COLLECTION BENTO ══════════ */}
        <section style={{ marginBottom:'64px' }}>
          <h3 style={{ fontSize:'clamp(20px,3vw,32px)', ...UB, color:C.ink, textTransform:'uppercase' as const, marginBottom:'32px' }}>Exclusive Certified Collection</h3>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gridTemplateRows:'380px 380px', gap:'20px' }}>
            <div style={{ gridColumn:'1/3', gridRow:'1/3', backgroundColor:'white', borderRadius:'40px', overflow:'hidden', display:'flex', flexDirection:'column' as const, border:'1px solid rgba(107,122,118,0.1)' }}>
              <div style={{ flex:1, overflow:'hidden', position:'relative', minHeight:0 }}>
                <img src={I.bento1} alt="Ducati Panigale V4" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
              ...
              <div style={{ padding:'24px 28px', flexShrink:0 }}>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:'6px', gap:'12px' }}>
                  <div>
                    <p style={{ fontSize:'11px', ...CB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.1em', marginBottom:'3px' }}>DUCATI</p>
                    <h4 style={{ fontSize:'20px', ...CB, color:C.ink }}>Panigale V4 — Track Ready</h4>
                  </div>
                  <span style={{ fontSize:'22px', ...CB, color:C.mint, flexShrink:0 }}>{formatPrice(280000)}</span>
                </div>
                <p style={{ fontSize:'13px', color:C.muted, ...CB, marginBottom:'16px' }}>2024 · Full dealership service history · Casablanca</p>
                <div style={{ display:'flex', gap:'10px' }}>
            ...
            <div style={{ gridColumn:'3', gridRow:'1', backgroundColor:'white', borderRadius:'32px', overflow:'hidden', display:'flex', flexDirection:'column' as const, border:'1px solid rgba(107,122,118,0.1)' }}>
              <div style={{ flex:1, overflow:'hidden', position:'relative', minHeight:0 }}>
                <img src={I.bento2} alt="Suzuki Hayabusa" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
              ...
              <div style={{ padding:'16px 18px', flexShrink:0 }}>
                <p style={{ fontSize:'9px', ...CB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.1em', marginBottom:'2px' }}>SUZUKI</p>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:'6px', marginBottom:'10px' }}>
                  <h4 style={{ fontSize:'13px', ...CB, color:C.ink }}>Hayabusa</h4>
                  <span style={{ fontSize:'14px', ...CB, color:C.mint, flexShrink:0 }}>{formatPrice(215000)}</span>
                </div>
                <div style={{ display:'flex', gap:'6px' }}>
            ...
            <div style={{ gridColumn:'4', gridRow:'1', backgroundColor:'white', borderRadius:'32px', overflow:'hidden', display:'flex', flexDirection:'column' as const, border:'1px solid rgba(107,122,118,0.1)' }}>
              <div style={{ flex:1, overflow:'hidden', position:'relative', minHeight:0 }}>
                <img src={I.bento3} alt="Triumph Rocket 3" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                <div style={{ position:'absolute', top:'12px', left:'12px' }}>
              ...
              <div style={{ padding:'16px 18px', flexShrink:0 }}>
                <p style={{ fontSize:'9px', ...CB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.1em', marginBottom:'2px' }}>TRIUMPH</p>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:'6px', marginBottom:'10px' }}>
                  <h4 style={{ fontSize:'13px', ...CB, color:C.ink }}>Rocket 3 Storm R</h4>
            ...
            <div style={{ gridColumn:'3/5', gridRow:'2', backgroundColor:'white', borderRadius:'32px', overflow:'hidden', display:'flex', flexDirection:'row' as const, border:'1px solid rgba(107,122,118,0.1)' }}>
              <div style={{ width:'50%', overflow:'hidden', position:'relative' }}>
                <img src={I.bento4} alt="KTM 1290 Super Duke" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                <div style={{ position:'absolute', top:'12px', left:'12px' }}>
              ...
              <div style={{ flex:1, padding:'28px 32px', display:'flex', flexDirection:'column' as const, justifyContent:'center' }}>
                <p style={{ fontSize:'11px', ...CB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.1em', marginBottom:'6px' }}>KTM</p>
                <h4 style={{ fontSize:'18px', ...CB, color:C.ink, marginBottom:'6px' }}>1290 Super Duke R</h4>
                <p style={{ fontSize:'13px', color:C.muted, ...CB, marginBottom:'12px' }}>2024 · Naked streetfighter · Casablanca</p>
                <span style={{ fontSize:'22px', ...CB, color:C.mint, marginBottom:'20px', display:'block' }}>{formatPrice(185000)}</span>
                <div style={{ display:'flex', gap:'10px' }}>
        ...
        <section style={{ marginBottom:'64px' }}>
          <div style={{ position:'relative', borderRadius:'40px', overflow:'hidden', height:'320px', display:'flex', alignItems:'center', boxShadow:'0 16px 48px rgba(0,0,0,0.15)', cursor:'pointer' }}>
            <img src={I.ride} alt="Ride Without Limits" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
            ...
            <div style={{ position:'relative', zIndex:1, padding:'0 64px', maxWidth:'560px' }}>
              <p style={{ fontSize:'11px', ...UB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.15em', marginBottom:'14px' }}>SOUKNI MOTO PRO</p>
              <h2 style={{ fontSize:'clamp(26px,3.5vw,42px)', ...UB, color:'white', marginBottom:'18px', lineHeight:1.05 }}>Ride Without Limits.</h2>
              <p style={{ fontSize:'17px', color:'rgba(255,255,255,0.9)', marginBottom:'28px', lineHeight:1.55 }}>Verified sellers, certified pre-owned bikes, and gear-ready delivery across Morocco.</p>
              <button style={{ backgroundColor:C.mint, color:C.ink, border:'none', padding:'16px 40px', borderRadius:'100px', fontSize:'11px', ...UB, textTransform:'uppercase' as const, letterSpacing:'0.12em', cursor:'pointer', transition:'transform 0.2s' }}
                onMouseEnter={e=>e.currentTarget.style.transform='scale(1.04)'}
                onMouseLeave={e=>e.currentTarget.style.transform='scale(1)'}
              >EXPLORE MOTO PRO</button>
            </div>
          </div>
        </section>

        {/* ══ 11. MOTORCYCLE DISCOVERIES GRID ═══════════════════ */}
        <section style={{ marginBottom:'48px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'28px' }}>
            <h3 style={{ fontSize:'clamp(18px,2.5vw,24px)', ...UB, color:C.ink, textTransform:'uppercase' as const }}>Motorcycle Discoveries</h3>
        ...
        <section style={{ marginBottom:'64px' }}>
          <div style={{ backgroundColor:C.mint, borderRadius:'40px', padding:'56px 64px', display:'flex', alignItems:'center', justifyContent:'space-between', boxShadow:`0 16px 48px ${C.mint}30`, flexWrap:'wrap' as const, gap:'28px' }}>
            <div style={{ maxWidth:'520px' }}>
              ...
              <p style={{ fontSize:'17px', color:`${C.ink}b3`, lineHeight:1.6 }}>Priority placement and a certified badge on every motorcycle listing you post. Sell your bike 5x faster.</p>
            </div>
        ...
        <section style={{ marginBottom:'64px' }}>
          <div style={{ backgroundColor:C.cream, borderRadius:'40px', height:'440px', position:'relative' as const, overflow:'hidden', display:'flex', alignItems:'center', padding:'0 64px', border:'1px solid rgba(107,122,118,0.1)' }}>
            <div style={{ position:'relative', zIndex:1, maxWidth:'480px' }}>
              ...
              <p style={{ fontSize:'17px', color:C.muted, marginBottom:'36px', maxWidth:'400px', lineHeight:1.6 }}>Get early access to exclusive bike listings, certified sellers, and gear deals.</p>
              <div style={{ display:'flex', gap:'14px', flexWrap:'wrap' as const }}>
