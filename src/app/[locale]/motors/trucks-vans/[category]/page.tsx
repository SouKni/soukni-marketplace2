...
const CATEGORIES: Record<string,{
  ...
  'all-trucks-vans': {
    label:'All Trucks & Vans',
    hero:'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=1600',
    desc:'Browse the complete SouKni commercial vehicle marketplace.',
    count:'195',
    brands:['Ford','Toyota','Mercedes-Benz','Iveco','Isuzu','Hyundai','Renault','Nissan'],
    priceRanges:['Any Price','0 – 200,000 MAD','200,000 – 350,000 MAD','350,000 – 500,000 MAD','500,000 – 800,000 MAD','800,000+ MAD'],
  },
  'pickup': {
    label:'Pickup',
    hero:'https://images.pexels.com/photos/2536639/pexels-photo-2536639.jpeg?auto=compress&w=1600',
    desc:'Double-cab and single-cab pickups built for work and off-road.',
    count:'68',
    brands:['Toyota','Ford','Isuzu','Nissan'],
    priceRanges:['Any Price','0 – 250,000 MAD','250,000 – 400,000 MAD','400,000+ MAD'],
  },
  'van': {
    label:'Van',
    hero:'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=1600',
    desc:'Cargo and passenger vans from trusted commercial brands.',
    count:'54',
    brands:['Mercedes-Benz','Ford','Renault','Peugeot'],
    priceRanges:['Any Price','0 – 250,000 MAD','250,000 – 450,000 MAD','450,000+ MAD'],
  },
  'box-truck': {
    label:'Box Truck',
    hero:'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=1600',
    desc:'Enclosed box trucks for delivery and logistics.',
    count:'22',
    brands:['Hyundai','Iveco','Mercedes-Benz'],
    priceRanges:['Any Price','0 – 300,000 MAD','300,000 – 500,000 MAD','500,000+ MAD'],
  },
  'flatbed': {
    label:'Flatbed',
    hero:'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=1600',
    desc:'Flatbed trucks for construction and heavy cargo.',
    count:'14',
    brands:['Iveco','Ford','Mercedes-Benz'],
    priceRanges:['Any Price','0 – 350,000 MAD','350,000 – 600,000 MAD','600,000+ MAD'],
  },
  'refrigerated': {
    label:'Refrigerated',
    hero:'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=1600',
    desc:'Cold-chain certified refrigerated vans and trucks.',
    count:'18',
    brands:['Renault','Mercedes-Benz','Iveco'],
    priceRanges:['Any Price','0 – 300,000 MAD','300,000 – 500,000 MAD','500,000+ MAD'],
  },
  'minivan': {
    label:'Minivan',
    hero:'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=1600',
    desc:'Passenger minibuses for shuttle and group transport.',
    count:'12',
    brands:['Peugeot','Renault','Hyundai'],
    priceRanges:['Any Price','0 – 200,000 MAD','200,000 – 350,000 MAD','350,000+ MAD'],
  },
  'heavy-duty': {
    label:'Heavy Duty',
    hero:'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=1600',
    desc:'Heavy-duty trucks for industrial and long-haul work.',
    count:'7',
    brands:['Iveco','Mercedes-Benz','Ford'],
    priceRanges:['Any Price','0 – 500,000 MAD','500,000 – 900,000 MAD','900,000+ MAD'],
  },
}
...
const TRUCK_IMGS = [
  'https://images.pexels.com/photos/2536639/pexels-photo-2536639.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/2536639/pexels-photo-2536639.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/2536639/pexels-photo-2536639.jpeg?auto=compress&w=400',
]
    ...
    <article onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)}
      ...
      <div style={{ padding:'16px 18px', flex:1, display:'flex', flexDirection:'column' as const }}>
        ...
        <div style={{ marginTop:'auto', display:'flex', gap:'8px' }}>
          ...
          >Message</button>
          <a href="https://wa.me/212600000000?text=Hi%2C%20I%20found%20your%20vehicle%20listing%20on%20SouKni!" target="_blank" rel="noopener noreferrer"
...
function makeListings(cat: string, count: number) {
  const titleMap: Record<string,string[]> = {
    'all-trucks-vans': ['Hilux Double Cab','Transit Custom','Sprinter Cargo','Master Refrigerated','D-Max Pickup','H350 Box Truck','Boxer Minibus'],
    'pickup':          ['Hilux Double Cab','Ranger Wildtrak','D-Max Pickup','Navara Double Cab'],
    'van':             ['Sprinter Cargo','Transit Custom','Trafic Cargo','Partner Van'],
    'box-truck':       ['H350 Box Truck','Daily Box Truck','Sprinter Box Body'],
    'flatbed':         ['Daily Flatbed','Transit Flatbed','Sprinter Flatbed'],
    'refrigerated':    ['Master Refrigerated','Sprinter Refrigerated','Daily Refrigerated'],
    'minivan':         ['Boxer Minibus','Trafic Minibus','H350 Minibus'],
    'heavy-duty':      ['Daily Heavy Duty','Eurocargo Heavy Duty','Actros Heavy Duty'],
  }
  const cat_data = CATEGORIES[cat] || CATEGORIES['all-trucks-vans']
  const titles = titleMap[cat] || titleMap['all-trucks-vans']
  ...
  const colors = ['White','Grey','Blue','Silver']
  return Array.from({length:count},(_,i)=>({
    ...
    img:       TRUCK_IMGS[i%TRUCK_IMGS.length],
    badge:     badges[i%badges.length],
  }))
}

export default function TrucksVansCategoryPage() {
  const params   = useParams()
  const locale   = (params?.locale as string) || 'en'
  const catSlug  = (params?.category as string) || 'all-trucks-vans'
  const catData  = CATEGORIES[catSlug] || CATEGORIES['all-trucks-vans']
    ...
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      ...
      <section style={{ position:'relative', height:'360px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center' as const, maxWidth:'860px', padding:'0 24px', width:'100%' }}>
          <p style={{ fontSize:'11px', ...UB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.2em', marginBottom:'12px' }}>MOTORS › TRUCKS & VANS</p>
