...
const I = {
  hero:    'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=1600',
  c1:      'https://images.pexels.com/photos/2536639/pexels-photo-2536639.jpeg?auto=compress&w=600',
  c2:      'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=600',
  c3:      'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=600',
  c4:      'https://images.pexels.com/photos/2536639/pexels-photo-2536639.jpeg?auto=compress&w=600',
  bento1:  'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=900',
  bento2:  'https://images.pexels.com/photos/2536639/pexels-photo-2536639.jpeg?auto=compress&w=600',
  bento3:  'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=600',
  bento4:  'https://images.pexels.com/photos/2536639/pexels-photo-2536639.jpeg?auto=compress&w=600',
  inspect: 'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=1200',
  business:'https://images.pexels.com/photos/2536639/pexels-photo-2536639.jpeg?auto=compress&w=1200',
  g1:      'https://images.pexels.com/photos/2536639/pexels-photo-2536639.jpeg?auto=compress&w=400',
  g2:      'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=400',
  g3:      'https://images.pexels.com/photos/2536639/pexels-photo-2536639.jpeg?auto=compress&w=400',
  g4:      'https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&w=400',
  g5:      'https://images.pexels.com/photos/2536639/pexels-photo-2536639.jpeg?auto=compress&w=400',
}
...
function FeaturedCard({ brand, title, price, location, img, badges, formatPrice, phone }: any) {
...
function GridCard({ brand, title, price, img, badge, formatPrice, phone }: any) {
  const [saved, setSaved] = useState(false)
  const [hov,   setHov  ] = useState(false)
  return (
    <div onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)}
...
const featuredItems = [
  { brand:'Toyota',          title:'Hilux Double Cab — 2023',           price:385000, location:'Casablanca',  img:I.c1, badges:['featured','diamond']   },
  { brand:'Mercedes-Benz',   title:'Sprinter Cargo — Low Mileage',       price:420000, location:'Tangier',     img:I.c2, badges:['featured','diamond']   },
  { brand:'Ford',            title:'Transit Custom — 2022',              price:295000, location:'Rabat',       img:I.c3, badges:['featured','certified'] },
  { brand:'Nissan',          title:'Navara Double Cab — 2023',           price:365000, location:'Rabat',       img:I.c4, badges:['featured','new']       },
]

function makeGrid(count: number) {
  const brands = ['Ford','Toyota','Mercedes-Benz','Iveco','Isuzu','Hyundai','Renault','Nissan']
  const titles = ['Hilux Double Cab','Transit Custom','Sprinter Cargo','Master Refrigerated','D-Max Pickup','H350 Box Truck','Boxer Minibus','Navara Double Cab']
  const imgs   = [I.g1,I.g2,I.g3,I.g4,I.g5]
  const badges: BadgeT[] = ['certified','diamond','featured','new','certified']
  return Array.from({length:count},(_,i)=>({
    brand: brands[i%brands.length],
    title: titles[i%titles.length],
    price: 180000 + ((i*17310)%400000),
...
const CATS = [
  ...
  { label:'Van',                slug:'van'             },
  { label:'Box Truck',          slug:'box-truck'       },
  { label:'Flatbed',            slug:'flatbed'         },
  { label:'Refrigerated',       slug:'refrigerated'    },
...
export default function TrucksVansPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const priceRanges = ['Any Price','0 – 200,000 MAD','200,000 – 350,000 MAD','350,000 – 500,000 MAD','500,000 – 800,000 MAD','800,000+ MAD']
  ...
  return (
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      ...
      <section style={{ position:'relative', height:'520px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        <img src={I.hero} alt="Trucks & Vans" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center' as const, maxWidth:'960px', padding:'0 24px', width:'100%' }}>
          <h1 style={{ fontSize:'clamp(36px,6vw,64px)', ...UB, color:'white', marginBottom:'36px', lineHeight:1, textShadow:'0 4px 20px rgba(0,0,0,0.4)' }}>
            TRUCKS & VANS FOR YOUR BUSINESS.<br/><span style={{ color:C.mint }}>RELIABLE. VERIFIED. READY TO WORK.</span>
          </h1>
          <div style={{ maxWidth:'780px', margin:'0 auto', backgroundColor:'rgba(255,255,255,0.12)', backdropFilter:'blur(12px)', border:'1px solid rgba(255,255,255,0.22)', borderRadius:'100px', padding:'8px', display:'flex', alignItems:'center' }}>
            ...
            <div style={{ flex:2, padding:'0 28px', display:'flex', flexDirection:'column' as const, gap:'2px' }}>
              ...
              <input type="text" value={makeModel} onChange={e=>setMakeModel(e.target.value)} placeholder="Search make, model..."
        ...
        <div style={{ backgroundColor:'rgba(255,255,255,0.97)', backdropFilter:'blur(16px)', border:'1px solid rgba(107,122,118,0.12)', borderRadius:'100px', boxShadow:'0 12px 40px rgba(0,0,0,0.08)', display:'flex', alignItems:'stretch', height:'72px' }}>
          ...
          <div style={{ flex:1.4, padding:'0 18px', display:'flex', flexDirection:'column' as const, justifyContent:'center' }}>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
              ...
              <input type="text" value={makeModel} onChange={e=>setMakeModel(e.target.value)} placeholder="e.g. Ford, Hilux..."
      ...
      <main style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 24px 80px' }}>
        ...
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'10px', ...UB, color:C.muted, textTransform:'uppercase' as const, letterSpacing:'0.12em', marginBottom:'12px' }}>
          {['Home','Motors','Trucks & Vans'].map((c,i,arr)=>(
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:'16px', marginBottom:'24px', flexWrap:'wrap' as const }}>
          <div>
            <h2 style={{ fontSize:'clamp(20px,2.5vw,28px)', ...UB, color:C.ink, marginBottom:'4px' }}>Trucks & Vans for Sale in Morocco</h2>
            <p style={{ fontSize:'14px', color:C.mint, ...CB }}>195 Ads across Morocco</p>
          </div>
        ...
        {/* ══ 7. FEATURED COMMERCIAL VEHICLES ══════════════════ */}
        <section style={{ marginBottom:'48px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'24px' }}>
            <div>
              <h3 style={{ fontSize:'clamp(18px,2.5vw,24px)', ...UB, color:C.ink, textTransform:'uppercase' as const, marginBottom:'4px' }}>Featured Commercial Vehicles</h3>
              <p style={{ fontSize:'14px', color:C.muted }}>Inspected, verified, and ready to work</p>
            </div>
        ...
        <section style={{ marginBottom:'64px' }}>
          <div style={{ backgroundColor:C.ink, borderRadius:'40px', padding:'56px 64px', display:'flex', alignItems:'center', justifyContent:'space-between', position:'relative' as const, overflow:'hidden', minHeight:'240px', boxShadow:'0 16px 48px rgba(0,0,0,0.2)', flexWrap:'wrap' as const, gap:'24px' }}>
            ...
            <div style={{ position:'relative', zIndex:1, maxWidth:'480px' }}>
              ...
              <h2 style={{ fontSize:'clamp(24px,3.5vw,38px)', ...UB, color:'white', marginBottom:'20px', lineHeight:1.1 }}>Get your commercial vehicle fleet-inspected before selling.</h2>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gridTemplateRows:'380px 380px', gap:'20px' }}>
            <div style={{ gridColumn:'1/3', gridRow:'1/3', backgroundColor:'white', borderRadius:'40px', overflow:'hidden', display:'flex', flexDirection:'column' as const, border:'1px solid rgba(107,122,118,0.1)' }}>
              <div style={{ flex:1, overflow:'hidden', position:'relative', minHeight:0 }}>
                <img src={I.bento1} alt="Mercedes Sprinter" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
              ...
              <div style={{ padding:'24px 28px', flexShrink:0 }}>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:'6px', gap:'12px' }}>
                  <div>
                    <p style={{ fontSize:'11px', ...CB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.1em', marginBottom:'3px' }}>MERCEDES-BENZ</p>
                    <h4 style={{ fontSize:'20px', ...CB, color:C.ink }}>Sprinter Cargo — Low Mileage</h4>
                  </div>
                  <span style={{ fontSize:'22px', ...CB, color:C.mint, flexShrink:0 }}>{formatPrice(420000)}</span>
                </div>
                <p style={{ fontSize:'13px', color:C.muted, ...CB, marginBottom:'16px' }}>2024 · 8,000 km · Full service history · Tangier</p>
                <div style={{ display:'flex', gap:'10px' }}>
            ...
            <div style={{ gridColumn:'3', gridRow:'1', backgroundColor:'white', borderRadius:'32px', overflow:'hidden', display:'flex', flexDirection:'column' as const, border:'1px solid rgba(107,122,118,0.1)' }}>
              <div style={{ flex:1, overflow:'hidden', position:'relative', minHeight:0 }}>
                <img src={I.bento2} alt="Isuzu D-Max" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                <div style={{ position:'absolute', top:'12px', left:'12px' }}>
                  <span style={{ backgroundColor:'white', color:C.mint, fontSize:'8px', ...CB, padding:'5px 12px', borderRadius:'100px', textTransform:'uppercase' as const }}>Verified</span>
                </div>
              </div>
              <div style={{ padding:'16px 18px', flexShrink:0 }}>
                <p style={{ fontSize:'9px', ...CB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.1em', marginBottom:'2px' }}>ISUZU</p>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:'6px', marginBottom:'10px' }}>
                  <h4 style={{ fontSize:'13px', ...CB, color:C.ink }}>D-Max Pickup</h4>
                  <span style={{ fontSize:'14px', ...CB, color:C.mint, flexShrink:0 }}>{formatPrice(310000)}</span>
                </div>
                <div style={{ display:'flex', gap:'6px' }}>
            ...
            <div style={{ gridColumn:'4', gridRow:'1', backgroundColor:'white', borderRadius:'32px', overflow:'hidden', display:'flex', flexDirection:'column' as const, border:'1px solid rgba(107,122,118,0.1)' }}>
              <div style={{ flex:1, overflow:'hidden', position:'relative', minHeight:0 }}>
                <img src={I.bento3} alt="Hyundai H350" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                <div style={{ position:'absolute', top:'12px', left:'12px' }}>
                  <span style={{ backgroundColor:C.ink, color:C.mint, fontSize:'8px', ...CB, padding:'5px 12px', borderRadius:'100px', textTransform:'uppercase' as const }}>Diamond Member</span>
                </div>
              </div>
              <div style={{ padding:'16px 18px', flexShrink:0 }}>
                <p style={{ fontSize:'9px', ...CB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.1em', marginBottom:'2px' }}>HYUNDAI</p>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:'6px', marginBottom:'10px' }}>
                  <h4 style={{ fontSize:'13px', ...CB, color:C.ink }}>H350 Box Truck</h4>
                  <span style={{ fontSize:'14px', ...CB, color:C.mint, flexShrink:0 }}>{formatPrice(275000)}</span>
                </div>
                <div style={{ display:'flex', gap:'6px' }}>
                  <button style={{ flex:1, border:`1px solid rgba(107,122,118,0.2)`, color:C.ink, backgroundColor:'transparent', padding:'8px', borderRadius:'12px', fontSize:'9px', ...CB, cursor:'pointer' }}>Message</button>
                  <WhatsAppButton phone={undefined} title="this listing" style={{ flex:1, padding:'8px', borderRadius:'12px', fontSize:'9px', ...CB }}>WhatsApp</WhatsAppButton>
            ...
            <div style={{ gridColumn:'3/5', gridRow:'2', backgroundColor:'white', borderRadius:'32px', overflow:'hidden', display:'flex', flexDirection:'row' as const, border:'1px solid rgba(107,122,118,0.1)' }}>
              <div style={{ width:'50%', overflow:'hidden', position:'relative' }}>
                <img src={I.bento4} alt="Renault Master" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
                <div style={{ position:'absolute', top:'12px', left:'12px' }}>
              ...
              <div style={{ flex:1, padding:'28px 32px', display:'flex', flexDirection:'column' as const, justifyContent:'center' }}>
                <p style={{ fontSize:'11px', ...CB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.1em', marginBottom:'6px' }}>RENAULT</p>
                <h4 style={{ fontSize:'18px', ...CB, color:C.ink, marginBottom:'6px' }}>Master Refrigerated</h4>
                <p style={{ fontSize:'13px', color:C.muted, ...CB, marginBottom:'12px' }}>2023 · 15,200 km · Full cold-chain certified · Casablanca</p>
                <span style={{ fontSize:'22px', ...CB, color:C.mint, marginBottom:'20px', display:'block' }}>{formatPrice(350000)}</span>
                <div style={{ display:'flex', gap:'10px' }}>
        ...
        <section style={{ marginBottom:'64px' }}>
          <div style={{ position:'relative', borderRadius:'40px', overflow:'hidden', height:'320px', display:'flex', alignItems:'center', boxShadow:'0 16px 48px rgba(0,0,0,0.15)', cursor:'pointer' }}>
            <img src={I.business} alt="Built For Business" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
            ...
            <div style={{ position:'relative', zIndex:1, padding:'0 64px', maxWidth:'560px' }}>
              ...
              <h2 style={{ fontSize:'clamp(26px,3.5vw,42px)', ...UB, color:'white', marginBottom:'18px', lineHeight:1.05 }}>Built For Business.</h2>
              <p style={{ fontSize:'17px', color:'rgba(255,255,255,0.9)', marginBottom:'28px', lineHeight:1.55 }}>Reliable pickups, vans, and box trucks ready to work from day one.</p>
              <button style={{ backgroundColor:C.mint, color:C.ink, border:'none', padding:'16px 40px', borderRadius:'100px', fontSize:'11px', ...UB, textTransform:'uppercase' as const, letterSpacing:'0.12em', cursor:'pointer', transition:'transform 0.2s' }}
                onMouseEnter={e=>e.currentTarget.style.transform='scale(1.04)'}
                onMouseLeave={e=>e.currentTarget.style.transform='scale(1)'}
              >EXPLORE COMMERCIAL FLEET</button>
            </div>
          </div>
        </section>

        {/* ══ 11. COMMERCIAL VEHICLE DISCOVERIES GRID ══════════ */}
        <section style={{ marginBottom:'48px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'28px' }}>
            <h3 style={{ fontSize:'clamp(18px,2.5vw,24px)', ...UB, color:C.ink, textTransform:'uppercase' as const }}>Commercial Vehicle Discoveries</h3>
        ...
        <section style={{ marginBottom:'64px' }}>
          <div style={{ backgroundColor:C.mint, borderRadius:'40px', padding:'56px 64px', display:'flex', alignItems:'center', justifyContent:'space-between', boxShadow:`0 16px 48px ${C.mint}30`, flexWrap:'wrap' as const, gap:'28px' }}>
            <div style={{ maxWidth:'520px' }}>
              ...
              <p style={{ fontSize:'17px', color:`${C.ink}b3`, lineHeight:1.6 }}>Priority placement and a verified badge on every commercial vehicle you list. Move your fleet 5x faster.</p>
            </div>
        ...
        <section style={{ marginBottom:'64px' }}>
          <div style={{ backgroundColor:C.cream, borderRadius:'40px', height:'440px', position:'relative' as const, overflow:'hidden', display:'flex', alignItems:'center', padding:'0 64px', border:'1px solid rgba(107,122,118,0.1)' }}>
            <div style={{ position:'relative', zIndex:1, maxWidth:'480px' }}>
              ...
              <p style={{ fontSize:'17px', color:C.muted, marginBottom:'36px', maxWidth:'400px', lineHeight:1.6 }}>Get early access to fleet deals, business financing, and verified commercial sellers.</p>
              <div style={{ display:'flex', gap:'14px', flexWrap:'wrap' as const }}>
