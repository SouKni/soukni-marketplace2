...
function ListingCard({ brand, title, price, location, condition, img, badge, petType }: any) {
    ...
    <article onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)}
      ...
      <div style={{ padding:'16px 18px', flex:1, display:'flex', flexDirection:'column' as const }}>
        ...
        <div style={{ marginTop:'auto', display:'flex', gap:'8px' }}>
          ...
          >Message</button>
          <a href="https://wa.me/212600000000?text=Hi%2C%20I%20found%20your%20pet%20listing%20on%20SouKni!" target="_blank" rel="noopener noreferrer"
  ...
  return (
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      ...
      <main style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 24px 80px' }}>
        ...
        <section style={{ marginBottom:'48px' }}>
          <h3 style={{ fontSize:'clamp(18px,2.5vw,24px)', ...UB, color:C.ink, textTransform:'uppercase' as const, marginBottom:'20px' }}>Explore Other Pet Categories</h3>
        ...
        <div style={{ textAlign:'center' as const }}>
          <Link href={`/${locale}/pets-accessories`}
          ...
          >← Back to All Pets & Accessories</Link>
        </div>
      </main>
    </div>
  )
