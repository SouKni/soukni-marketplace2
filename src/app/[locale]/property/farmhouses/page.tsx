...
const FARMHOUSE_LISTINGS = [
  ...
  { id:'fh4', badge:'Exclusive', title:'Agricultural Estate — Irrigated Land', price:'3,600,000', location:'Settat Region', beds:5, baths:4, area:22000, image:'https://images.pexels.com/photos/1643384/pexels-photo-1643384.jpeg?auto=compress&w=700' },
  { id:'fh5', badge:'Verified', title:'Traditional Farmhouse Near Vineyard', price:'2,100,000', location:'Meknès Countryside', beds:4, baths:3, area:6800, image:'https://images.pexels.com/photos/1029599/pexels-photo-1029599.jpeg?auto=compress&w=700' },
  { id:'fh6', badge:'New Listing', title:'Countryside Retreat with Stables', price:'2,400,000', location:'Rabat Rural Outskirts', beds:4, baths:3, area:9500, image:'https://images.pexels.com/photos/440731/pexels-photo-440731.jpeg?auto=compress&w=700' },
  { id:'fh7', badge:'Verified', title:'Fruit Orchard Farmhouse Estate', price:'1,780,000', location:'Marrakech Rural', beds:3, baths:2, area:7200, image:'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=700' },
  { id:'fh8', badge:'Exclusive', title:'Large Estate with Two Farmhouses', price:'4,200,000', location:'Beni Mellal Region', beds:6, baths:5, area:18500, image:'https://images.pexels.com/photos/2581922/pexels-photo-2581922.jpeg?auto=compress&w=700' },
]


const newProjects = [
  { name:'Meknès Estate Collection', city:'Meknès Countryside', price:'From 1.8M MAD', image:'https://images.pexels.com/photos/1148955/pexels-photo-1148955.jpeg?auto=compress&w=200' },
  { name:'Settat Agricultural Lots', city:'Settat Region',      price:'From 1.2M MAD', image:'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=200' },
]
      ...
      <div style={{ flex:1, padding:20, display:'flex', flexDirection:'column' as const, justifyContent:'space-between' }}>
        <div>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:6 }}>
            ...
            <span style={{ fontSize:11, color:C.muted, fontWeight:500 }}>Farmhouse</span>
          </div>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:20, fontSize:12, color:'#475569', borderTop:'1px solid #f1f5f9', paddingTop:12 }}>
            ...
            {prop.area && <span style={{ display:'flex', alignItems:'center', gap:6 }}><Maximize size={14} /> {prop.area.toLocaleString()} sqm land</span>}
          </div>
        </div>
...
export default function FarmhousesPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const [propertyType, setPropertyType] = useState('All Farmhouses')
  ...
  return (
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      <section style={{ position:'relative', height:520, display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        <img src="https://images.pexels.com/photos/1148955/pexels-photo-1148955.jpeg?auto=compress&w=1600" alt="Farmhouses" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center' as const, maxWidth:960, padding:'0 24px', width:'100%' }}>
          <h1 style={{ fontSize:'clamp(36px,6vw,64px)', ...UB, color:'white', marginBottom:36, lineHeight:1, textShadow:'0 4px 20px rgba(0,0,0,0.4)' }}>
            FARMHOUSES.<br/><span style={{ color:C.mint }}>LAND & LEGACY.</span>
          </h1>
      ...
      <main style={{ maxWidth:1280, margin:'0 auto', padding:'32px 24px 80px' }}>
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:16, marginBottom:24, flexWrap:'wrap' as const }}>
          <div>
            ...
            <p style={{ fontSize:14, color:C.mint, ...CB }}>980 Ads</p>
          </div>
          ...
          {ALL_CATS.map(cat=>(
            <Link key={cat.slug} href={`/${locale}/property/${cat.slug}`}
              style={{ padding:'10px 22px', borderRadius:100, fontSize:11, ...UB, textTransform:'uppercase' as const, letterSpacing:'0.1em', cursor:'pointer', border:'1px solid', textDecoration:'none', display:'inline-block',
                backgroundColor: cat.slug==='farmhouses' ? C.mint : 'white', color: cat.slug==='farmhouses' ? 'white' : C.muted, borderColor: cat.slug==='farmhouses' ? C.mint : 'rgba(186,202,197,0.4)' }}>
              {cat.label}
            </Link>
          ))}
          ...
          <div style={{ display:'flex', flexDirection:'column' as const, gap:20 }}>
            ...
            <div style={{ background:'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)', borderRadius:16, padding:'28px 32px', display:'flex', alignItems:'center', justifyContent:'space-between', position:'relative', overflow:'hidden' }}>
              ...
              <div style={{ position:'relative', zIndex:1 }}>
                <h2 style={{ fontSize:20, fontWeight:800, color:'white', marginBottom:6 }}>What's your farmhouse worth today?</h2>
            ...
            <div style={{ borderRadius:16, overflow:'hidden', border:'1px solid #f1f5f9' }}>
              <div style={{ background:'linear-gradient(135deg, #0f9b8e 0%, #22d4a8 100%)', padding:'28px 32px', display:'flex', alignItems:'center', gap:20 }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize:13, color:'rgba(255,255,255,0.85)' }}>Explore farmhouses with immersive 360° tours and AI-powered videos.</p>
                </div>
              </div>
            </div>
            <div style={{ position:'relative', borderRadius:16, overflow:'hidden', height:220, cursor:'pointer' }}>
              ...
              <div style={{ position:'absolute', inset:0, background:'linear-gradient(to right, rgba(15,23,42,0.92) 0%, rgba(15,23,42,0.62) 60%, transparent 100%)', display:'flex', flexDirection:'column' as const, justifyContent:'center', padding:32 }}>
                <div style={{ maxWidth:380 }}>
                  ...
                  <p style={{ fontSize:13, color:'#cbd5e1', marginBottom:18, lineHeight:1.6 }}>Boost your farmhouse listings to over 2M monthly seekers.</p>
          ...
          <aside style={{ display:'flex', flexDirection:'column' as const, gap:20, position:'sticky', top:114 }}>
            <div style={{ backgroundColor:'white', borderRadius:16, padding:20, border:'1px solid #f1f5f9', boxShadow:'0 4px 20px rgba(0,0,0,0.05)' }}>
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:20 }}>
                <h3 style={{ fontWeight:800, color:C.ink, fontSize:14 }}>New Rural Developments</h3>
            ...
            <div style={{ background:'rgba(34,212,168,0.06)', border:'2px solid rgba(34,212,168,0.2)', borderRadius:16, padding:20 }}>
              ...
              <p style={{ fontSize:12, color:'#475569', marginBottom:14, lineHeight:1.6 }}>Reach over 2M farmhouse seekers monthly in Morocco.</p>
            ...
            <div style={{ backgroundColor:'white', borderRadius:16, padding:20, border:'1px solid #f1f5f9', boxShadow:'0 4px 20px rgba(0,0,0,0.05)' }}>
              ...
              <p style={{ fontSize:12, color:C.muted, marginBottom:14, lineHeight:1.6 }}>We'll notify you when new farmhouses matching your search are listed.</p>
