...
function BadgeChip({ label }: { label: string }) {
  ...
  return (
    <span style={{ backgroundColor: isNavy ? 'rgba(15,23,42,0.8)' : isGold ? '#8d4f00' : '#22d4a8', color: 'white', fontSize: '9px', fontWeight: 800, padding: '3px 8px', borderRadius: '4px', letterSpacing: '0.08em', textTransform: 'uppercase' }}>{label}</span>
  )
}
  ...
  return (
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif', backgroundColor: '#f4fbf8', minHeight: '100vh' }}>
      ...
      <section style={{ position: 'relative', height: '380px', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
        <img src="https://images.pexels.com/photos/1918291/pexels-photo-1918291.jpeg?auto=compress&w=1600" alt="Properties for Rent in Morocco"
        ...
        <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', padding: '0 20px', maxWidth: '760px', width: '100%' }}>
          <h1 style={{ fontFamily: 'Inter, sans-serif', fontWeight: 900, letterSpacing: '-0.05em', fontSize: '48px', color: 'white', marginBottom: '12px', lineHeight: 1.05 }}>Properties for Rent in Morocco</h1>
          <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.82)', marginBottom: '28px' }}>1,840 verified rental listings across Morocco</p>
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '14px 24px', fontSize: '11px', color: '#6b7a76', display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        <span>›</span>
        <span style={{ color: '#161d1b', fontWeight: 600 }}>Property for Rent</span>
      </div>
        ...
        <section style={{ marginBottom: '28px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
            <h1 style={{ fontSize: '22px', fontWeight: 800, color: '#161d1b' }}>
              Property for Rent in Morocco <span style={{ color: '#6b7a76', fontWeight: 400, fontSize: '16px' }}>8,320 Ads</span>
            </h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '28px', alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)', borderRadius: '16px', padding: '28px 32px', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <button style={{ backgroundColor: '#22d4a8', color: 'white', border: 'none', padding: '11px 24px', borderRadius: '8px', fontWeight: 700, fontSize: '13px', cursor: 'pointer' }}>Set Up Alerts →</button>
              </div>
            </div>
          ...
          <aside style={{ display: 'flex', flexDirection: 'column', gap: '20px', position: 'sticky', top: '114px' }}>
            ...
            <div style={{ backgroundColor: 'white', borderRadius: '16px', padding: '20px', border: '1px solid #f1f5f9', boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
              ...
              <p style={{ fontSize: '12px', color: '#6b7a76', marginBottom: '14px', lineHeight: 1.6 }}>We'll notify you when new rentals matching your search are listed.</p>
