...
const subCategories = ['Apartments', 'Villas', 'Townhouses', 'Offices', 'Mixed Use', 'View More']

const listings = [
  { id: 'np1', badge: 'New', title: 'The Marina Heights — Phase 1', type: 'Apartment', price: 'From 1,200,000', unit: 'MAD', location: 'Casablanca Finance City', beds: 2, baths: 2, area: 110, image: 'https://images.pexels.com/photos/1643384/pexels-photo-1643384.jpeg?auto=compress&w=700' },
  { id: 'np2', badge: 'Diamond', title: 'Atlas Green Resort Villas', type: 'Villa', price: 'From 3,500,000', unit: 'MAD', location: 'Marrakech, Palmeraie', beds: 4, baths: 3, area: 320, image: 'https://images.pexels.com/photos/2581922/pexels-photo-2581922.jpeg?auto=compress&w=700' },
  { id: 'np3', badge: 'New', title: 'Bab Tangier Residences', type: 'Apartment', price: 'From 980,000', unit: 'MAD', location: 'Tangier, Nouveau Centre', beds: 2, baths: 1, area: 85, image: 'https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&w=700' },
  { id: 'np4', badge: 'Verified', title: 'Rabat Business District Towers', type: 'Office', price: 'From 2,800,000', unit: 'MAD', location: 'Rabat, Hay Riad', beds: 0, baths: 2, area: 150, image: 'https://images.pexels.com/photos/1181406/pexels-photo-1181406.jpeg?auto=compress&w=700' },
  { id: 'np5', badge: 'Diamond', title: 'Agadir Bay Luxury Apartments', type: 'Apartment', price: 'From 1,800,000', unit: 'MAD', location: 'Agadir, Front de Mer', beds: 3, baths: 2, area: 130, image: 'https://images.pexels.com/photos/1918291/pexels-photo-1918291.jpeg?auto=compress&w=700' },
  { id: 'np6', badge: 'New', title: 'Fès Heritage Townhouses', type: 'Townhouse', price: 'From 1,500,000', unit: 'MAD', location: 'Fès, Ville Nouvelle', beds: 3, baths: 2, area: 200, image: 'https://images.pexels.com/photos/440731/pexels-photo-440731.jpeg?auto=compress&w=700' },
  { id: 'np7', badge: 'Verified', title: 'Casablanca Green City Mixed Use', type: 'Mixed Use', price: 'From 900,000', unit: 'MAD', location: 'Casablanca, Sidi Maarouf', beds: 1, baths: 1, area: 65, image: 'https://images.pexels.com/photos/1029599/pexels-photo-1029599.jpeg?auto=compress&w=700' },
  { id: 'np8', badge: 'Diamond', title: 'Marrakech Golf Estate', type: 'Villa', price: 'From 5,200,000', unit: 'MAD', location: 'Marrakech, Amelkis', beds: 5, baths: 4, area: 450, image: 'https://images.pexels.com/photos/261102/pexels-photo-261102.jpeg?auto=compress&w=700' },
]
...
function ProjectCard({ prop }: { prop: typeof listings[0] }) {
      ...
      <div style={{ flex: 1, padding: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '6px' }}>
            <h3 style={{ fontSize: '20px', fontWeight: 800, color: '#161d1b', letterSpacing: '-0.02em' }}>{prop.price} <span style={{ fontSize: '13px', fontWeight: 400, color: '#6b7a76' }}>{prop.unit}</span></h3>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px', fontSize: '12px', color: '#475569', borderTop: '1px solid #f1f5f9', paddingTop: '12px' }}>
            {prop.beds > 0 && <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}><Bed size={14} /> {prop.beds} Beds</span>}
  ...
  return (
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif', backgroundColor: '#f4fbf8', minHeight: '100vh' }}>
      ...
      <section style={{ position: 'relative', height: '380px', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
        <img src="https://images.pexels.com/photos/323780/pexels-photo-323780.jpeg?auto=compress&w=1600" alt="New Projects in Morocco"
        ...
        <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', padding: '0 20px', maxWidth: '760px', width: '100%' }}>
          <h1 style={{ fontFamily: 'Inter, sans-serif', fontWeight: 900, letterSpacing: '-0.05em', fontSize: '48px', color: 'white', marginBottom: '12px', lineHeight: 1.05 }}>New Projects in Morocco</h1>
          <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.82)', marginBottom: '28px' }}>84 off-plan and new-build developments</p>
          <div style={{ display: 'flex', backgroundColor: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.25)', borderRadius: '100px', padding: '6px 6px 6px 0', maxWidth: '640px', margin: '0 auto' }}>
            ...
            <input type="text" placeholder="Developer, project name or area..."
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '14px 24px', fontSize: '11px', color: '#6b7a76', display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        <span>›</span>
        <span style={{ color: '#161d1b', fontWeight: 600 }}>New Projects</span>
      </div>
      ...
      <main style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 24px 80px' }}>
        <section style={{ marginBottom: '28px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
            <h1 style={{ fontSize: '22px', fontWeight: 800, color: '#161d1b' }}>
              New Projects in Morocco <span style={{ color: '#6b7a76', fontWeight: 400, fontSize: '16px' }}>642 Projects</span>
            </h1>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', gap: '8px' }}>
              {['All', 'Off-Plan', 'Ready', 'Under Construction'].map(f => (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '28px', alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            {listings.map(p => <ProjectCard key={p.id} prop={p} />)}
          ...
          <aside style={{ display: 'flex', flexDirection: 'column', gap: '20px', position: 'sticky', top: '114px' }}>
            <div style={{ background: 'rgba(45,212,191,0.06)', border: '2px solid rgba(45,212,191,0.2)', borderRadius: '16px', padding: '20px' }}>
              ...
              <h3 style={{ fontSize: '18px', fontWeight: 800, color: '#161d1b', marginTop: '10px', marginBottom: '6px' }}>List Your Development on SouKni</h3>
            ...
            <div style={{ backgroundColor: 'white', borderRadius: '16px', padding: '20px', border: '1px solid #f1f5f9', boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
              <h3 style={{ fontWeight: 800, color: '#161d1b', fontSize: '14px', marginBottom: '6px' }}>Get Project Alerts</h3>
              <p style={{ fontSize: '12px', color: '#6b7a76', marginBottom: '14px', lineHeight: 1.6 }}>Be first to know when new projects launch in your preferred city.</p>
        ...
        <section style={{ marginTop: '40px', borderRadius: '16px', background: 'linear-gradient(135deg, #22d4a8 0%, #0f9b8e 100%)', padding: '40px 48px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '24px' }}>
          <div>
            <h2 style={{ fontSize: '28px', fontWeight: 800, color: 'white', marginBottom: '8px' }}>Become a Diamond Developer — Get Verified</h2>
            <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.9)' }}>Unlock exclusive benefits and attract premium investors to your projects.</p>
          </div>
