  ...
  return (
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif', backgroundColor: '#f4fbf8', minHeight: '100vh' }}>
      ...
      <section style={{ position: 'relative', height: '380px', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
        <img src="https://images.pexels.com/photos/2029694/pexels-photo-2029694.jpeg?auto=compress&w=1600" alt="Rooms for Rent in Morocco"
        ...
        <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', padding: '0 20px', maxWidth: '760px', width: '100%' }}>
          <h1 style={{ fontFamily: 'Inter, sans-serif', fontWeight: 900, letterSpacing: '-0.05em', fontSize: '48px', color: 'white', marginBottom: '12px', lineHeight: 1.05 }}>Rooms for Rent in Morocco</h1>
          <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.82)', marginBottom: '28px' }}>3,215 verified room listings across Morocco</p>
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '14px 24px', fontSize: '11px', color: '#6b7a76', display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        <span>›</span>
        <span style={{ color: '#161d1b', fontWeight: 600 }}>Rooms for Rent</span>
      </div>
        ...
        <section style={{ marginBottom: '28px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
            <h1 style={{ fontSize: '22px', fontWeight: 800, color: '#161d1b' }}>
              Rooms for Rent in Morocco <span style={{ color: '#6b7a76', fontWeight: 400, fontSize: '16px' }}>1,248 Ads</span>
            </h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '28px', alignItems: 'start' }}>
          ...
          <aside style={{ display: 'flex', flexDirection: 'column', gap: '20px', position: 'sticky', top: '114px' }}>
            ...
            <div style={{ backgroundColor: 'white', borderRadius: '16px', padding: '20px', border: '1px solid #f1f5f9', boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
              ...
              <p style={{ fontSize: '12px', color: '#6b7a76', marginBottom: '14px', lineHeight: 1.6 }}>Be first to know when rooms matching your search are listed.</p>
