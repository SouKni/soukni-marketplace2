...
const HERO = 'https://images.pexels.com/photos/1813272/pexels-photo-1813272.jpeg?auto=compress&w=1600'
const SIBLINGS = [
...
const topChoices = [
  { id:'t1', title:'Classic Gentleman Cut', price:200, location:'Rabat', rating:4.7, reviews:14, image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400', desc:'Mens haircuts, beard trimming, hot towel shaves and grooming. Certified on SouKni Morocco.' },
  { id:'t2', title:'Skin Fade & Taper', price:450, location:'Casablanca', rating:4.8, reviews:26, image:'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&w=400', desc:'Mens haircuts, beard trimming, hot towel shaves and grooming. Certified on SouKni Morocco.' },
  { id:'t3', title:'Beard Trim & Shape', price:700, location:'Marrakech', rating:4.9, reviews:38, image:'https://images.pexels.com/photos/2681751/pexels-photo-2681751.jpeg?auto=compress&w=400', desc:'Mens haircuts, beard trimming, hot towel shaves and grooming. Certified on SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Hot Towel Shave', price:150, location:'Marrakech', image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400' },
  { id:'b2', title:'Kids Haircut', price:330, location:'Tangier', image:'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&w=400' },
  { id:'b3', title:'Hair & Beard Combo', price:510, location:'Agadir', image:'https://images.pexels.com/photos/2681751/pexels-photo-2681751.jpeg?auto=compress&w=400' },
  { id:'b4', title:'Scalp Treatment', price:690, location:'Fès', image:'https://images.pexels.com/photos/1813272/pexels-photo-1813272.jpeg?auto=compress&w=400' },
  { id:'b5', title:'Executive Grooming Package', price:870, location:'Meknès', image:'https://images.pexels.com/photos/3997990/pexels-photo-3997990.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Classic Gentleman Cut', price:100, location:'Rabat', image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Skin Fade & Taper', price:230, location:'Casablanca', image:'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&w=400' },
  { id:'d3', title:'Beard Trim & Shape', price:360, location:'Marrakech', image:'https://images.pexels.com/photos/2681751/pexels-photo-2681751.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Hot Towel Shave', price:490, location:'Tangier', image:'https://images.pexels.com/photos/1813272/pexels-photo-1813272.jpeg?auto=compress&w=400' },
  { id:'d5', title:'Kids Haircut', price:620, location:'Agadir', image:'https://images.pexels.com/photos/3997990/pexels-photo-3997990.jpeg?auto=compress&w=400' },
  { id:'d6', title:'Hair & Beard Combo', price:750, location:'Fès', image:'https://images.pexels.com/photos/3757952/pexels-photo-3757952.jpeg?auto=compress&w=400' },
  { id:'d7', title:'Scalp Treatment', price:880, location:'Meknès', image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400' },
  { id:'d8', title:'Executive Grooming Package', price:1010, location:'Kenitra', image:'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&w=400' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Barbers' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Barbers</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Mens haircuts, beard trimming, hot towel shaves and grooming</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'11px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Barbers</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Barbers in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Mens haircuts, beard trimming, hot towel shaves and grooming</p>
          ...
          {SIBLINGS.map(s=>(
            <Link key={s.slug} href={`/${locale}/services/beauty-grooming/${s.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'9px 20px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: s.slug==='barbers' ? '#161d1b' : 'white',
                color: s.slug==='barbers' ? 'white' : '#6b7a76',
                borderColor: s.slug==='barbers' ? '#161d1b' : 'rgba(186,202,197,0.4)',
              }}>{s.label}</button>
            </Link>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Barbers Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Barbers Services</h2>
        ...
        <section style={{ marginBottom:'48px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {SIBLINGS.filter(s=>s.slug!=='barbers').map(s=>(
