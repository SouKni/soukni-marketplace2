...
const HERO = 'https://images.pexels.com/photos/3997990/pexels-photo-3997990.jpeg?auto=compress&w=1600'
const SIBLINGS = [
  { slug:'hair-salons', label:'Hair Salons' },
  { slug:'nail-studios', label:'Nail Studios' },
...
const topChoices = [
  { id:'t1', title:'Hydrafacial Treatment', price:200, location:'Rabat', rating:4.7, reviews:14, image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400', desc:'Facials, chemical peels, microneedling and advanced skincare. Certified on SouKni Morocco.' },
  { id:'t2', title:'Anti-Ageing Facial', price:450, location:'Casablanca', rating:4.8, reviews:26, image:'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&w=400', desc:'Facials, chemical peels, microneedling and advanced skincare. Certified on SouKni Morocco.' },
  { id:'t3', title:'Chemical Peel Session', price:700, location:'Marrakech', rating:4.9, reviews:38, image:'https://images.pexels.com/photos/2681751/pexels-photo-2681751.jpeg?auto=compress&w=400', desc:'Facials, chemical peels, microneedling and advanced skincare. Certified on SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Microneedling Therapy', price:150, location:'Marrakech', image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400' },
  { id:'b2', title:'LED Light Therapy', price:330, location:'Tangier', image:'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&w=400' },
  { id:'b3', title:'Oxygen Facial', price:510, location:'Agadir', image:'https://images.pexels.com/photos/2681751/pexels-photo-2681751.jpeg?auto=compress&w=400' },
  { id:'b4', title:'Brightening Facial', price:690, location:'Fès', image:'https://images.pexels.com/photos/1813272/pexels-photo-1813272.jpeg?auto=compress&w=400' },
  { id:'b5', title:'Mens Skincare Facial', price:870, location:'Meknès', image:'https://images.pexels.com/photos/3997990/pexels-photo-3997990.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Hydrafacial Treatment', price:100, location:'Rabat', image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Anti-Ageing Facial', price:230, location:'Casablanca', image:'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&w=400' },
  { id:'d3', title:'Chemical Peel Session', price:360, location:'Marrakech', image:'https://images.pexels.com/photos/2681751/pexels-photo-2681751.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Microneedling Therapy', price:490, location:'Tangier', image:'https://images.pexels.com/photos/1813272/pexels-photo-1813272.jpeg?auto=compress&w=400' },
  { id:'d5', title:'LED Light Therapy', price:620, location:'Agadir', image:'https://images.pexels.com/photos/3997990/pexels-photo-3997990.jpeg?auto=compress&w=400' },
  { id:'d6', title:'Oxygen Facial', price:750, location:'Fès', image:'https://images.pexels.com/photos/3757952/pexels-photo-3757952.jpeg?auto=compress&w=400' },
  { id:'d7', title:'Brightening Facial', price:880, location:'Meknès', image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400' },
  { id:'d8', title:'Mens Skincare Facial', price:1010, location:'Kenitra', image:'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&w=400' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Skincare' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <p style={{ fontSize:'11px', fontWeight:800, color:'#22d4a8', textTransform:'uppercase' as const, letterSpacing:'0.2em', marginBottom:'12px' }}>BEAUTY & GROOMING</p>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Skincare</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Facials, chemical peels, microneedling and advanced skincare</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'11px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <Link href={`/${locale}/services/beauty-grooming`} style={{ color:'#6b7a76', textDecoration:'none' }} onMouseEnter={e=>e.currentTarget.style.color='#22d4a8'} onMouseLeave={e=>e.currentTarget.style.color='#6b7a76'}>Beauty & Grooming</Link><span>›</span>
          <span style={{ color:'#161d1b' }}>Skincare</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Skincare in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Facials, chemical peels, microneedling and advanced skincare</p>

        <div style={{ display:'flex', gap:'8px', marginBottom:'20px', overflowX:'auto', paddingBottom:'4px' }}>
          {SIBLINGS.map(s=>(
            <Link key={s.slug} href={`/${locale}/services/beauty-grooming/${s.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'9px 20px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: s.slug==='skincare' ? '#161d1b' : 'white',
                color: s.slug==='skincare' ? 'white' : '#6b7a76',
                borderColor: s.slug==='skincare' ? '#161d1b' : 'rgba(186,202,197,0.4)',
              }}>{s.label}</button>
            </Link>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Skincare Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Skincare Services</h2>
        ...
        <section style={{ marginBottom:'48px' }}>
          <h3 style={{ fontSize:'16px', fontWeight:900, color:'#161d1b', textTransform:'uppercase' as const, letterSpacing:'0.08em', marginBottom:'16px' }}>Explore Other Beauty Services</h3>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {SIBLINGS.filter(s=>s.slug!=='skincare').map(s=>(
              <Link key={s.slug} href={`/${locale}/services/beauty-grooming/${s.slug}`}
        ...
        <div style={{ textAlign:'center' as const }}>
          <Link href={`/${locale}/services/beauty-grooming`}
