...
const topChoices = [
  { id:'t1', title:'Aromatherapy Full Body', price:200, location:'Rabat', rating:4.7, reviews:14, image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400', desc:'Holistic beauty treatments, body wraps and aromatherapy. Certified on SouKni Morocco.' },
  { id:'t2', title:'Detox Body Wrap', price:450, location:'Casablanca', rating:4.8, reviews:26, image:'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&w=400', desc:'Holistic beauty treatments, body wraps and aromatherapy. Certified on SouKni Morocco.' },
  { id:'t3', title:'Hot Stone Massage', price:700, location:'Marrakech', rating:4.9, reviews:38, image:'https://images.pexels.com/photos/2681751/pexels-photo-2681751.jpeg?auto=compress&w=400', desc:'Holistic beauty treatments, body wraps and aromatherapy. Certified on SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Lymphatic Drainage', price:150, location:'Marrakech', image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400' },
  { id:'b2', title:'Reflexology Session', price:330, location:'Tangier', image:'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&w=400' },
  { id:'b3', title:'Holistic Wellness Consult', price:510, location:'Agadir', image:'https://images.pexels.com/photos/2681751/pexels-photo-2681751.jpeg?auto=compress&w=400' },
  { id:'b4', title:'Beauty Ritual Package', price:690, location:'Fès', image:'https://images.pexels.com/photos/1813272/pexels-photo-1813272.jpeg?auto=compress&w=400' },
  { id:'b5', title:'Rose & Argan Treatment', price:870, location:'Meknès', image:'https://images.pexels.com/photos/3997990/pexels-photo-3997990.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Aromatherapy Full Body', price:100, location:'Rabat', image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Detox Body Wrap', price:230, location:'Casablanca', image:'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&w=400' },
  { id:'d3', title:'Hot Stone Massage', price:360, location:'Marrakech', image:'https://images.pexels.com/photos/2681751/pexels-photo-2681751.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Lymphatic Drainage', price:490, location:'Tangier', image:'https://images.pexels.com/photos/1813272/pexels-photo-1813272.jpeg?auto=compress&w=400' },
  { id:'d5', title:'Reflexology Session', price:620, location:'Agadir', image:'https://images.pexels.com/photos/3997990/pexels-photo-3997990.jpeg?auto=compress&w=400' },
  { id:'d6', title:'Holistic Wellness Consult', price:750, location:'Fès', image:'https://images.pexels.com/photos/3757952/pexels-photo-3757952.jpeg?auto=compress&w=400' },
  { id:'d7', title:'Beauty Ritual Package', price:880, location:'Meknès', image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400' },
  { id:'d8', title:'Rose & Argan Treatment', price:1010, location:'Kenitra', image:'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&w=400' },
]
    ...
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Wellness</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Holistic beauty treatments, body wraps and aromatherapy</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'11px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Wellness</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Wellness in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Holistic beauty treatments, body wraps and aromatherapy</p>
          ...
          {SIBLINGS.map(s=>(
            <Link key={s.slug} href={`/${locale}/services/beauty-grooming/${s.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'9px 20px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: s.slug==='wellness' ? '#161d1b' : 'white',
                color: s.slug==='wellness' ? 'white' : '#6b7a76',
                borderColor: s.slug==='wellness' ? '#161d1b' : 'rgba(186,202,197,0.4)',
              }}>{s.label}</button>
            </Link>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Wellness Services</h2>
        ...
        <section style={{ marginBottom:'48px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {SIBLINGS.filter(s=>s.slug!=='wellness').map(s=>(
