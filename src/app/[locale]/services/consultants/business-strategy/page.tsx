      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <Breadcrumb
          items={[
            ...
            { label:'Consultants', href:`/${locale}/services/consultants` },
        ...
        <CategoryFooterNav
          relatedTitle="Explore Other Consulting Areas"
          related={SIBLINGS.filter(s=>s.slug!=='business-strategy').map(s=>({ label:s.label, href:`/${locale}/services/consultants/${s.slug}` }))}
          backHref={`/${locale}/services/consultants`}
