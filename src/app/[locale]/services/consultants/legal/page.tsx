...
const topChoices = [
  { id:'t1', title:'Contract Review & Draft', price:1500, location:'Rabat', rating:4.7, reviews:12, image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400', desc:'Legal advice, contract drafting, compliance and corporate law services. Certified consultant on SouKni Morocco.' },
  { id:'t2', title:'Company Registration', price:2700, location:'Casablanca', rating:4.8, reviews:21, image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400', desc:'Legal advice, contract drafting, compliance and corporate law services. Certified consultant on SouKni Morocco.' },
  { id:'t3', title:'Property Law Advice', price:3900, location:'Marrakech', rating:4.9, reviews:30, image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=400', desc:'Legal advice, contract drafting, compliance and corporate law services. Certified consultant on SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Employment Law Consult', price:1000, location:'Marrakech', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'b2', title:'IP & Trademark Filing', price:1900, location:'Tangier', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { id:'b3', title:'Dispute Mediation', price:2800, location:'Agadir', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=400' },
  { id:'b4', title:'Notarial Services', price:3700, location:'Fès', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'b5', title:'GDPR Compliance', price:4600, location:'Meknès', image:'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Contract Review & Draft', price:800, location:'Rabat', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Company Registration', price:1500, location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { id:'d3', title:'Property Law Advice', price:2200, location:'Marrakech', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Employment Law Consult', price:2900, location:'Tangier', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'d5', title:'IP & Trademark Filing', price:3600, location:'Agadir', image:'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&w=400' },
  { id:'d6', title:'Dispute Mediation', price:4300, location:'Fès', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'d7', title:'Notarial Services', price:5000, location:'Meknès', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { id:'d8', title:'GDPR Compliance', price:5700, location:'Kenitra', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=400' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Legal' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Legal</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Legal advice, contract drafting, compliance and corporate law services</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'11px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Legal</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Legal Consultants in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Legal advice, contract drafting, compliance and corporate law services</p>
          ...
          {SIBLINGS.map(s=>(
            <Link key={s.slug} href={`/${locale}/services/consultants/${s.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'9px 20px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: s.slug==='legal' ? '#161d1b' : 'white',
                color: s.slug==='legal' ? 'white' : '#6b7a76',
                borderColor: s.slug==='legal' ? '#161d1b' : 'rgba(186,202,197,0.4)',
              }}>{s.label}</button>
            </Link>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Legal Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Legal Services</h2>
        ...
        <section style={{ marginBottom:'48px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'12px' }}>
            {SIBLINGS.filter(s=>s.slug!=='legal').map(s=>(
