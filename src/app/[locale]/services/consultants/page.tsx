...
const HERO = 'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=1600'

const SUBCATS = [
  { slug:'business-strategy', label:'Business Strategy', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { slug:'legal',             label:'Legal',             image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=600' },
...
const topChoices = [
  { id:'c1', title:'Business Strategy Consultant — Morocco Market Entry', price:4500, location:'Casablanca', rating:4.9, reviews:72, image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=800', desc:'Senior strategy consultant with 15 years experience helping international companies enter the Moroccan and African markets. Business plans, feasibility studies, and partner identification.' },
  { id:'c2', title:'Corporate Lawyer — Contracts & Company Law', price:3200, location:'Rabat', rating:4.9, reviews:58, image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=800', desc:'Bilingual corporate lawyer (FR/AR/EN) specialising in company registration, commercial contracts, employment law and regulatory compliance for businesses operating in Morocco.' },
  { id:'c3', title:'CFO Advisory — Financial Planning & Tax', price:5500, location:'Casablanca', rating:4.8, reviews:44, image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=800', desc:'Big 4 alumni offering CFO-as-a-service for growing businesses. Financial modelling, tax optimisation, investor relations and IFRS reporting for Moroccan and international companies.' },
]

const bentoListings = [
  { id:'cb1', title:'Digital Marketing Strategy — 90-Day Plan', price:8000,  location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'cb2', title:'IT Infrastructure Audit & Roadmap',         price:6500,  location:'Rabat',      image:'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&w=600' },
  { id:'cb3', title:'Brand Positioning & Identity Workshop',     price:5000,  location:'Marrakech',  image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'cb4', title:'Startup Investment Pitch Coaching',         price:3500,  location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'cb5', title:'ERP Selection & Implementation Plan',       price:9000,  location:'Casablanca', image:'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&w=600' },
]

const discoveryGrid = [
  { id:'cd1', title:'Franchise Feasibility Report',             price:3500, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'cd2', title:'IP & Trademark Registration — Morocco',   price:2800, location:'Rabat',      image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { id:'cd3', title:'Cash Flow Modelling & Forecast',          price:3200, location:'Casablanca', image:'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&w=400' },
  { id:'cd4', title:'SEO & Content Strategy Session',          price:2000, location:'Marrakech',  image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'cd5', title:'Cybersecurity Assessment Report',         price:5500, location:'Casablanca', image:'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&w=400' },
  { id:'cd6', title:'Operations Efficiency Audit',             price:4000, location:'Tangier',    image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'cd7', title:'Employment Contract Templates Pack',      price:1800, location:'Casablanca', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { id:'cd8', title:'Social Media Ads Campaign Launch',        price:2500, location:'Rabat',      image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
]

const BUDGETS = ['Any Budget','0-2000 MAD','2000-5000 MAD','5000-10000 MAD','10000+ MAD']
  ...
  const filtered = useMemo(() => {
    let list = discoveryGrid.filter(item => {
      ...
      const mb = budget === 'Any Budget'        ? true
               ...
               : budget === '2000-5000 MAD'     ? item.price > 2000 && item.price <= 5000
               : budget === '5000-10000 MAD'    ? item.price > 5000 && item.price <= 10000
               : item.price > 10000
      return mc && mk && mb
    })
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt="Consultants" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Consultants</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Business strategy, legal, finance, marketing and technology consulting across Morocco</p>
          <div style={{ display:'flex', alignItems:'stretch', backgroundColor:'rgba(255,255,255,0.12)', backdropFilter:'blur(24px)', border:'1px solid rgba(255,255,255,0.25)', borderRadius:'100px', overflow:'hidden', maxWidth:'620px', margin:'0 auto' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column' as const, padding:'12px 20px', flex:1, borderRight:'1px solid rgba(255,255,255,0.2)', gap:'2px' }}>
              ...
              <div style={{ display:'flex', alignItems:'center', gap:'6px' }}>
                <input value={heroKeyword} onChange={e=>setHeroKeyword(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} placeholder="Business strategy, legal, finance..." style={{ backgroundColor:'transparent', border:'none', outline:'none', fontSize:'13px', fontWeight:600, color:'white', padding:0, flex:1 }} />
        ...
        <div style={{ backgroundColor:'rgba(255,255,255,0.97)', backdropFilter:'blur(16px)', border:'1px solid rgba(107,122,118,0.12)', borderRadius:'100px', boxShadow:'0 8px 40px rgba(0,0,0,0.12)', display:'flex', alignItems:'stretch', height:'68px' }}>
          ...
          <div style={{ flex:2, padding:'0 22px', borderRight:'1px solid rgba(186,202,197,0.3)', display:'flex', flexDirection:'column' as const, justifyContent:'center', gap:'2px' }}>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
              ...
              <input value={heroKeyword} onChange={e=>setHeroKeyword(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} placeholder="Strategy, legal, finance, marketing..." style={{ fontSize:'14px', fontWeight:600, color:'#161d1b', border:'none', outline:'none', background:'none', flex:1 }} />
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', marginBottom:'16px', flexWrap:'wrap' as const, gap:'12px' }}>
          <div>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b', marginBottom:'4px' }}>Consultants in Morocco</h2>
        ...
        <section style={{ marginBottom:'32px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {SUBCATS.map(sub=>(
              <Link key={sub.slug} href={`/${locale}/services/consultants/${sub.slug}`} style={{ textDecoration:'none' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Consultants Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>
              {filtered.length > 0 ? `${filtered.length} More Consulting Services` : 'No results found'}
            </h2>
          ...
          {filtered.length === 0 ? (
            <div style={{ textAlign:'center' as const, padding:'60px 20px', backgroundColor:'white', borderRadius:'24px', border:'1px solid rgba(107,122,118,0.1)' }}>
              <p style={{ fontSize:'18px', fontWeight:700, color:'#161d1b', marginBottom:'8px' }}>No consultants match your search</p>
        ...
        <section style={{ borderRadius:'40px', background:'linear-gradient(135deg,#22d4a8,#0f9b8e)', padding:'56px 48px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'40px', flexWrap:'wrap' as const, marginBottom:'48px' }}>
          <div>
            ...
            <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.85)', maxWidth:'480px', lineHeight:1.7 }}>List your consulting service for free and reach thousands of businesses across Morocco.</p>
        ...
        <CategoryFooterNav
          relatedTitle="Explore Other Consultant Categories"
          related={SUBCATS.map(s=>({ label:s.label, href:`/${locale}/services/consultants/${s.slug}` }))}
