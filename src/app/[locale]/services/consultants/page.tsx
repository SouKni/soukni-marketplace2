...
const topChoices = [
  {
    id: 'c1',
    title: 'Elite Business Strategy & Corporate Advisory',
    desc: 'Senior strategy consultant with 20+ years advising Fortune 500 firms and Moroccan SMEs. Specializes in market entry, restructuring, and growth acceleration.',
    price: 1200,
  ...
  {
    id: 'c2',
    title: 'Legal & Corporate Compliance Expert',
    desc: 'Qualified lawyer specializing in Moroccan commercial law, contract drafting, business registration, and cross-border compliance for international firms.',
    price: 950,
    location: 'Rabat, Hassan',
    rating: 4.8,
    reviews: 134,
    image: 'https://images.pexels.com/photos/5668858/pexels-photo-5668858.jpeg?auto=compress&w=800',
  },
  {
    id: 'c3',
    title: 'Financial Planning & Wealth Management',
    desc: 'Certified financial planner offering personalized investment strategies, portfolio management, and retirement planning for high-net-worth individuals in Morocco.',
    price: 800,
...
const bentoListings = [
  { id:'bc1', title:'Digital Transformation Consulting', price:900,  location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'bc2', title:'HR & Talent Acquisition Strategy',  price:650,  location:'Rabat',      image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'bc3', title:'Tax Optimization & Accounting',     price:750,  location:'Tangier',    image:'https://images.pexels.com/photos/5668858/pexels-photo-5668858.jpeg?auto=compress&w=600' },
  { id:'bc4', title:'Export & International Trade',      price:1100, location:'Agadir',     image:'https://images.pexels.com/photos/3760067/pexels-photo-3760067.jpeg?auto=compress&w=600' },
  { id:'bc5', title:'Marketing & Brand Strategy',        price:850,  location:'Marrakech',  image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
]

const discoveryGrid = [
  { id:'dc1',  title:'Startup Fundraising Advisor',      price:1500, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'dc2',  title:'Real Estate Investment Advisory',  price:900,  location:'Rabat',      image:'https://images.pexels.com/photos/5668858/pexels-photo-5668858.jpeg?auto=compress&w=600' },
  { id:'dc3',  title:'IT Security & Cybersecurity',      price:1200, location:'Casablanca', image:'https://images.pexels.com/photos/3760067/pexels-photo-3760067.jpeg?auto=compress&w=600' },
  { id:'dc4',  title:'Supply Chain Optimization',        price:850,  location:'Tangier',    image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'dc5',  title:'Social Media & Growth Hacking',    price:600,  location:'Rabat',      image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'dc6',  title:'Executive Leadership Coaching',    price:1000, location:'Casablanca', image:'https://images.pexels.com/photos/5668858/pexels-photo-5668858.jpeg?auto=compress&w=600' },
  { id:'dc7',  title:'E-commerce Strategy & Launch',     price:700,  location:'Marrakech',  image:'https://images.pexels.com/photos/3760067/pexels-photo-3760067.jpeg?auto=compress&w=600' },
  { id:'dc8',  title:'Logistics & Operations Expert',    price:780,  location:'Agadir',     image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
]

const pills = ['All Consulting','Business Strategy','Legal','Finance','HR','Marketing','Technology','View More']
...
export default function ConsultantsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const [activePill, setActivePill] = useState('All Consulting')
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      ...
      <section style={{ position:'relative', height:'440px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        <img src={HERO} alt="Consultancy" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>
            Find Expert Consultants &amp; Advisors Near You!
          </h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>803 verified business, legal &amp; financial consultants across Morocco</p>

          {/* 3-SECTION GLASSMORPHIC SEARCH BAR */}
          <div style={{ display:'flex', alignItems:'stretch', backgroundColor:'rgba(255,255,255,0.12)', backdropFilter:'blur(24px)', border:'1px solid rgba(255,255,255,0.25)', borderRadius:'100px', overflow:'hidden', maxWidth:'680px', margin:'0 auto', boxShadow:'0 8px 32px rgba(0,0,0,0.2)' }}>
            {/* CITY */}
            <div style={{ display:'flex', flexDirection:'column', padding:'14px 20px', flex:'0 0 180px', borderRight:'1px solid rgba(255,255,255,0.2)', cursor:'pointer', gap:'2px' }}>
            ...
            {/* KEYWORD */}
            <div style={{ display:'flex', flexDirection:'column', padding:'14px 20px', flex:1, borderRight:'1px solid rgba(255,255,255,0.2)', cursor:'pointer', gap:'2px' }}>
              ...
              <input
                ...
                placeholder="Business strategy, legal, finance..."
                style={{ backgroundColor:'transparent', border:'none', outline:'none', fontSize:'14px', fontWeight:600, color:'white', fontFamily:'Inter, sans-serif', padding:0, width:'100%' }}
              />
            </div>
            {/* SEARCH BUTTON */}
            <button style={{ backgroundColor:'#22d4a8', color:'white', border:'none', padding:'0 32px', fontWeight:800, fontSize:'14px', cursor:'pointer', letterSpacing:'-0.01em', display:'flex', alignItems:'center', gap:'8px', flexShrink:0, transition:'background 0.15s' }}
      ...
      <div style={{ maxWidth:'1440px', margin:'-28px auto 0', padding:'0 40px', position:'relative', zIndex:30 }}>
        <div style={{ backgroundColor:'rgba(255,255,255,0.9)', backdropFilter:'blur(20px)', borderRadius:'100px', padding:'10px 10px 10px 24px', boxShadow:'0 8px 40px rgba(0,0,0,0.12)', border:'1px solid rgba(255,255,255,0.6)', display:'flex', alignItems:'center' }}>
          {[
            ...
            { label:'Keyword', val:'What expertise do you need?' },
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px' }}>
        ...
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase', letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Consultancy</span>
        </nav>

        <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b', marginBottom:'4px' }}>Business Consultants &amp; Expert Advisors in Rabat</h2>
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'16px' }}>803 Ads in Rabat District</p>
        ...
        {/* BENTO COLLECTION — 3+2 clean layout */}
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Consultants Collection</h2>
        ...
        {/* DISCOVERY GRID — 2 columns horizontal cards */}
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Consultants &amp; Advisors</h2>
        ...
        <section style={{ borderRadius:'40px', background:'linear-gradient(135deg,#22d4a8,#0f9b8e)', padding:'56px 48px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'40px', flexWrap:'wrap', marginBottom:'64px' }}>
          <div>
            ...
            <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.85)', maxWidth:'480px', lineHeight:1.7 }}>Offer your expertise today for free and reach thousands of businesses and individuals across Morocco.</p>
