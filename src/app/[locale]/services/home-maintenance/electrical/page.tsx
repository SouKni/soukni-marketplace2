...
const HERO = 'https://images.pexels.com/photos/257736/pexels-photo-257736.jpeg?auto=compress&w=1600'
const SIBLINGS = [
...
const topChoices = [
  { id:'t1', title:'Fuse Box Upgrade', price:300, location:'Rabat', rating:4.7, reviews:10, image:'https://images.pexels.com/photos/6419128/pexels-photo-6419128.jpeg?auto=compress&w=400', desc:'Wiring, fuse boxes and electrical installations. Certified and verified by SouKni Morocco.' },
  { id:'t2', title:'Socket & Switch Install', price:1200, location:'Casablanca', rating:4.8, reviews:19, image:'https://images.pexels.com/photos/257736/pexels-photo-257736.jpeg?auto=compress&w=400', desc:'Wiring, fuse boxes and electrical installations. Certified and verified by SouKni Morocco.' },
  { id:'t3', title:'LED Lighting Retrofit', price:2100, location:'Marrakech', rating:4.9, reviews:28, image:'https://images.pexels.com/photos/4239146/pexels-photo-4239146.jpeg?auto=compress&w=400', desc:'Wiring, fuse boxes and electrical installations. Certified and verified by SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Emergency Electrician', price:200, location:'Marrakech', image:'https://images.pexels.com/photos/6419128/pexels-photo-6419128.jpeg?auto=compress&w=400' },
  { id:'b2', title:'EV Charger Install', price:900, location:'Tangier', image:'https://images.pexels.com/photos/257736/pexels-photo-257736.jpeg?auto=compress&w=400' },
  { id:'b3', title:'Smart Home Wiring', price:1600, location:'Agadir', image:'https://images.pexels.com/photos/4239146/pexels-photo-4239146.jpeg?auto=compress&w=400' },
  { id:'b4', title:'Outdoor Lighting', price:2300, location:'Fès', image:'https://images.pexels.com/photos/1109541/pexels-photo-1109541.jpeg?auto=compress&w=400' },
  { id:'b5', title:'Electrical Inspection', price:3000, location:'Meknès', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Fuse Box Upgrade', price:150, location:'Rabat', image:'https://images.pexels.com/photos/6419128/pexels-photo-6419128.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Socket & Switch Install', price:650, location:'Casablanca', image:'https://images.pexels.com/photos/257736/pexels-photo-257736.jpeg?auto=compress&w=400' },
  { id:'d3', title:'LED Lighting Retrofit', price:1150, location:'Marrakech', image:'https://images.pexels.com/photos/4239146/pexels-photo-4239146.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Emergency Electrician', price:1650, location:'Tangier', image:'https://images.pexels.com/photos/1109541/pexels-photo-1109541.jpeg?auto=compress&w=400' },
  { id:'d5', title:'EV Charger Install', price:2150, location:'Agadir', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'d6', title:'Smart Home Wiring', price:2650, location:'Fès', image:'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&w=400' },
  { id:'d7', title:'Outdoor Lighting', price:3150, location:'Meknès', image:'https://images.pexels.com/photos/6419128/pexels-photo-6419128.jpeg?auto=compress&w=400' },
  { id:'d8', title:'Electrical Inspection', price:3650, location:'Kenitra', image:'https://images.pexels.com/photos/257736/pexels-photo-257736.jpeg?auto=compress&w=400' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Electrical' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Electrical</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Wiring, fuse boxes and electrical installations</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'11px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Electrical</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Electrical in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Wiring, fuse boxes and electrical installations</p>
          ...
          {SIBLINGS.map(s=>(
            <Link key={s.slug} href={`/${locale}/services/home-maintenance/${s.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'9px 20px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: s.slug==='electrical' ? '#161d1b' : 'white',
                color: s.slug==='electrical' ? 'white' : '#6b7a76',
                borderColor: s.slug==='electrical' ? '#161d1b' : 'rgba(186,202,197,0.4)',
              }}>{s.label}</button>
            </Link>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Electrical Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Electrical Services</h2>
        ...
        <section style={{ marginBottom:'48px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {SIBLINGS.filter(s=>s.slug!=='electrical').map(s=>(
