      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <Breadcrumb
          items={[
            ...
            { label:'Home Maintenance', href:`/${locale}/services/home-maintenance` },
            { label:'Renovation' },
          ]}
        />
        ...
        <CategoryFooterNav
          relatedTitle="Explore Other Maintenance Services"
          related={SIBLINGS.filter(s=>s.slug!=='renovation').map(s=>({ label:s.label, href:`/${locale}/services/home-maintenance/${s.slug}` }))}
          backHref={`/${locale}/services/home-maintenance`}
          backLabel="Back to Home Maintenance"
        />
      </div>
    </div>
  )
