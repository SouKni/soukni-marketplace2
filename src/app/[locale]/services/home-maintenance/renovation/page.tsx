...
const HERO = 'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&w=1600'
const SIBLINGS = [
  { slug:'plumbing', label:'Plumbing' },
  { slug:'electrical', label:'Electrical' },
  { slug:'cleaning', label:'Cleaning' },
  { slug:'painting', label:'Painting' },
  { slug:'ac-heating', label:'AC & Heating' },
  { slug:'renovation', label:'Renovation' },
]
const topChoices = [
  { id:'t1', title:'Full Kitchen Renovation', price:300, location:'Rabat', rating:4.7, reviews:10, image:'https://images.pexels.com/photos/6419128/pexels-photo-6419128.jpeg?auto=compress&w=400', desc:'Full home renovation and refurbishment services. Certified and verified by SouKni Morocco.' },
  { id:'t2', title:'Bathroom Overhaul', price:1200, location:'Casablanca', rating:4.8, reviews:19, image:'https://images.pexels.com/photos/257736/pexels-photo-257736.jpeg?auto=compress&w=400', desc:'Full home renovation and refurbishment services. Certified and verified by SouKni Morocco.' },
  { id:'t3', title:'Open Plan Conversion', price:2100, location:'Marrakech', rating:4.9, reviews:28, image:'https://images.pexels.com/photos/4239146/pexels-photo-4239146.jpeg?auto=compress&w=400', desc:'Full home renovation and refurbishment services. Certified and verified by SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Basement Conversion', price:200, location:'Marrakech', image:'https://images.pexels.com/photos/6419128/pexels-photo-6419128.jpeg?auto=compress&w=400' },
  { id:'b2', title:'Terrace & Garden Build', price:900, location:'Tangier', image:'https://images.pexels.com/photos/257736/pexels-photo-257736.jpeg?auto=compress&w=400' },
  { id:'b3', title:'Roof Terrace Addition', price:1600, location:'Agadir', image:'https://images.pexels.com/photos/4239146/pexels-photo-4239146.jpeg?auto=compress&w=400' },
  { id:'b4', title:'Home Extension', price:2300, location:'Fès', image:'https://images.pexels.com/photos/1109541/pexels-photo-1109541.jpeg?auto=compress&w=400' },
  { id:'b5', title:'Full Property Refurb', price:3000, location:'Meknès', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Full Kitchen Renovation', price:150, location:'Rabat', image:'https://images.pexels.com/photos/6419128/pexels-photo-6419128.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Bathroom Overhaul', price:650, location:'Casablanca', image:'https://images.pexels.com/photos/257736/pexels-photo-257736.jpeg?auto=compress&w=400' },
  { id:'d3', title:'Open Plan Conversion', price:1150, location:'Marrakech', image:'https://images.pexels.com/photos/4239146/pexels-photo-4239146.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Basement Conversion', price:1650, location:'Tangier', image:'https://images.pexels.com/photos/1109541/pexels-photo-1109541.jpeg?auto=compress&w=400' },
  { id:'d5', title:'Terrace & Garden Build', price:2150, location:'Agadir', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'d6', title:'Roof Terrace Addition', price:2650, location:'Fès', image:'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&w=400' },
  { id:'d7', title:'Home Extension', price:3150, location:'Meknès', image:'https://images.pexels.com/photos/6419128/pexels-photo-6419128.jpeg?auto=compress&w=400' },
  { id:'d8', title:'Full Property Refurb', price:3650, location:'Kenitra', image:'https://images.pexels.com/photos/257736/pexels-photo-257736.jpeg?auto=compress&w=400' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Renovation' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <p style={{ fontSize:'11px', fontWeight:800, color:'#22d4a8', textTransform:'uppercase' as const, letterSpacing:'0.2em', marginBottom:'12px' }}>HOME MAINTENANCE</p>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Renovation</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Full home renovation and refurbishment services</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'11px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <Link href={`/${locale}/services/home-maintenance`} style={{ color:'#6b7a76', textDecoration:'none' }}>Home Maintenance</Link><span>›</span>
          <span style={{ color:'#161d1b' }}>Renovation</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Renovation in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Full home renovation and refurbishment services</p>

        <div style={{ display:'flex', gap:'8px', marginBottom:'20px', overflowX:'auto', paddingBottom:'4px' }}>
          {SIBLINGS.map(s=>(
            <Link key={s.slug} href={`/${locale}/services/home-maintenance/${s.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'9px 20px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: s.slug==='renovation' ? '#161d1b' : 'white',
                color: s.slug==='renovation' ? 'white' : '#6b7a76',
                borderColor: s.slug==='renovation' ? '#161d1b' : 'rgba(186,202,197,0.4)',
              }}>{s.label}</button>
            </Link>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Renovation Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Renovation Services</h2>
        ...
        <section style={{ marginBottom:'48px' }}>
          <h3 style={{ fontSize:'16px', fontWeight:900, color:'#161d1b', textTransform:'uppercase' as const, letterSpacing:'0.08em', marginBottom:'16px' }}>Explore Other Maintenance Services</h3>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {SIBLINGS.filter(s=>s.slug!=='renovation').map(s=>(
              <Link key={s.slug} href={`/${locale}/services/home-maintenance/${s.slug}`}
        ...
        <div style={{ textAlign:'center' as const }}>
          <Link href={`/${locale}/services/home-maintenance`}
