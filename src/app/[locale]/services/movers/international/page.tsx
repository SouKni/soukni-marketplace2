...
const SIBLINGS = [
  { slug:'local-moves', label:'Local Moves' },
  { slug:'long-distance', label:'Long Distance' },
  { slug:'office-moves', label:'Office Moves' },
  { slug:'international', label:'International' },
  { slug:'storage', label:'Storage' },
  { slug:'packing', label:'Packing' },
]
const topChoices = [
  { id:'t1', title:'Morocco to France Move', price:800, location:'Rabat', rating:4.7, reviews:12, image:'https://images.pexels.com/photos/4483610/pexels-photo-4483610.jpeg?auto=compress&w=600', desc:'Professional International service across Morocco. Certified and verified by SouKni.' },
  { id:'t2', title:'Europe Relocation Package', price:2000, location:'Casablanca', rating:4.8, reviews:20, image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600', desc:'Professional International service across Morocco. Certified and verified by SouKni.' },
  { id:'t3', title:'Air Freight Express', price:3200, location:'Marrakech', rating:4.9, reviews:28, image:'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=600', desc:'Professional International service across Morocco. Certified and verified by SouKni.' },
]
const bentoListings = [
  { id:'b1', title:'Sea Container Shipping', price:600, location:'Marrakech', image:'https://images.pexels.com/photos/4483610/pexels-photo-4483610.jpeg?auto=compress&w=600' },
  { id:'b2', title:'Customs Clearance Help', price:1400, location:'Tangier', image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600' },
  { id:'b3', title:'Pet Relocation Service', price:2200, location:'Agadir', image:'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=600' },
  { id:'b4', title:'Diplomatic Move', price:3000, location:'Fès', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'b5', title:'Expat Relocation Pack', price:3800, location:'Meknès', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=600' },
]
const discoveryGrid = [
  { id:'d1', title:'Morocco to France Move', price:400, location:'Rabat', image:'https://images.pexels.com/photos/4483610/pexels-photo-4483610.jpeg?auto=compress&w=600' },
  { id:'d2', title:'Europe Relocation Package', price:1000, location:'Casablanca', image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600' },
  { id:'d3', title:'Air Freight Express', price:1600, location:'Marrakech', image:'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=600' },
  { id:'d4', title:'Sea Container Shipping', price:2200, location:'Tangier', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'d5', title:'Customs Clearance Help', price:2800, location:'Agadir', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=600' },
  { id:'d6', title:'Pet Relocation Service', price:3400, location:'Fès', image:'https://images.pexels.com/photos/1216589/pexels-photo-1216589.jpeg?auto=compress&w=600' },
  { id:'d7', title:'Diplomatic Move', price:4000, location:'Meknès', image:'https://images.pexels.com/photos/4483610/pexels-photo-4483610.jpeg?auto=compress&w=600' },
  { id:'d8', title:'Expat Relocation Pack', price:4600, location:'Kenitra', image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='International' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <p style={{ fontSize:'11px', fontWeight:800, color:'#22d4a8', textTransform:'uppercase' as const, letterSpacing:'0.2em', marginBottom:'12px' }}>MOVERS & STORAGE</p>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>International</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>International relocation and shipping</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>International in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>International relocation and shipping</p>

        {/* SIBLING PILLS */}
        <div style={{ display:'flex', gap:'8px', marginBottom:'20px', overflowX:'auto', paddingBottom:'4px' }}>
          {SIBLINGS.map(s=>(
            <Link key={s.slug} href={`/${locale}/services/movers/${s.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'9px 20px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: s.slug==='international' ? '#161d1b' : 'white',
                color: s.slug==='international' ? 'white' : '#6b7a76',
                borderColor: s.slug==='international' ? '#161d1b' : 'rgba(186,202,197,0.4)',
              }}>{s.label}</button>
            </Link>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni International Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More International Services</h2>
        ...
        <CategoryFooterNav
          ...
          related={SIBLINGS.filter(s=>s.slug!=='international').map(s=>({ label:s.label, href:`/${locale}/services/movers/${s.slug}` }))}
