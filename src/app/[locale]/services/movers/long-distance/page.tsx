...
const topChoices = [
  { id:'t1', title:'Casablanca to Marrakech', price:800, location:'Rabat', rating:4.7, reviews:12, image:'https://images.pexels.com/photos/4483610/pexels-photo-4483610.jpeg?auto=compress&w=600', desc:'Professional Long Distance service across Morocco. Certified and verified by SouKni.' },
  { id:'t2', title:'Rabat to Tangier Move', price:2000, location:'Casablanca', rating:4.8, reviews:20, image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600', desc:'Professional Long Distance service across Morocco. Certified and verified by SouKni.' },
  { id:'t3', title:'Cross-Country Full Move', price:3200, location:'Marrakech', rating:4.9, reviews:28, image:'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=600', desc:'Professional Long Distance service across Morocco. Certified and verified by SouKni.' },
]
const bentoListings = [
  { id:'b1', title:'Fragile Items Only', price:600, location:'Marrakech', image:'https://images.pexels.com/photos/4483610/pexels-photo-4483610.jpeg?auto=compress&w=600' },
  { id:'b2', title:'Vehicle Transport', price:1400, location:'Tangier', image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600' },
  { id:'b3', title:'Large Furniture Move', price:2200, location:'Agadir', image:'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=600' },
  { id:'b4', title:'Family Relocation', price:3000, location:'Fès', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'b5', title:'Multi-Stop Move', price:3800, location:'Meknès', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=600' },
]
const discoveryGrid = [
  { id:'d1', title:'Casablanca to Marrakech', price:400, location:'Rabat', image:'https://images.pexels.com/photos/4483610/pexels-photo-4483610.jpeg?auto=compress&w=600' },
  { id:'d2', title:'Rabat to Tangier Move', price:1000, location:'Casablanca', image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600' },
  { id:'d3', title:'Cross-Country Full Move', price:1600, location:'Marrakech', image:'https://images.pexels.com/photos/3846022/pexels-photo-3846022.jpeg?auto=compress&w=600' },
  { id:'d4', title:'Fragile Items Only', price:2200, location:'Tangier', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'d5', title:'Vehicle Transport', price:2800, location:'Agadir', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=600' },
  { id:'d6', title:'Large Furniture Move', price:3400, location:'Fès', image:'https://images.pexels.com/photos/1216589/pexels-photo-1216589.jpeg?auto=compress&w=600' },
  { id:'d7', title:'Family Relocation', price:4000, location:'Meknès', image:'https://images.pexels.com/photos/4483610/pexels-photo-4483610.jpeg?auto=compress&w=600' },
  { id:'d8', title:'Multi-Stop Move', price:4600, location:'Kenitra', image:'https://images.pexels.com/photos/1427541/pexels-photo-1427541.jpeg?auto=compress&w=600' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Long Distance' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Long Distance</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Inter-city and cross-country moves</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Long Distance in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Inter-city and cross-country moves</p>
          ...
          {SIBLINGS.map(s=>(
            <Link key={s.slug} href={`/${locale}/services/movers/${s.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'9px 20px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: s.slug==='long-distance' ? '#161d1b' : 'white',
                color: s.slug==='long-distance' ? 'white' : '#6b7a76',
                borderColor: s.slug==='long-distance' ? '#161d1b' : 'rgba(186,202,197,0.4)',
              }}>{s.label}</button>
            </Link>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Long Distance Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Long Distance Services</h2>
        ...
        <CategoryFooterNav
          ...
          related={SIBLINGS.filter(s=>s.slug!=='long-distance').map(s=>({ label:s.label, href:`/${locale}/services/movers/${s.slug}` }))}
