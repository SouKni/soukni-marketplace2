...
const SUBCATS = [
  { slug:'photography',     label:'Photography',        image:'https://images.pexels.com/photos/1261731/pexels-photo-1261731.jpeg?auto=compress&w=600' },
  { slug:'catering',        label:'Catering & Chef',    image:'https://images.pexels.com/photos/3218467/pexels-photo-3218467.jpeg?auto=compress&w=600' },
  { slug:'music-dj',        label:'Music & DJ',         image:'https://images.pexels.com/photos/1540406/pexels-photo-1540406.jpeg?auto=compress&w=600' },
  { slug:'pet-care',        label:'Pet Care',           image:'https://images.pexels.com/photos/1108099/pexels-photo-1108099.jpeg?auto=compress&w=600' },
  { slug:'childcare',       label:'Childcare',          image:'https://images.pexels.com/photos/3662667/pexels-photo-3662667.jpeg?auto=compress&w=600' },
  { slug:'gardening',       label:'Gardening',          image:'https://images.pexels.com/photos/1453499/pexels-photo-1453499.jpeg?auto=compress&w=600' },
  { slug:'it-support',      label:'IT Support',         image:'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&w=600' },
  { slug:'tailoring',       label:'Tailoring & Sewing', image:'https://images.pexels.com/photos/3738745/pexels-photo-3738745.jpeg?auto=compress&w=600' },
  { slug:'car-services',    label:'Car Services',       image:'https://images.pexels.com/photos/3802510/pexels-photo-3802510.jpeg?auto=compress&w=600' },
  { slug:'elderly-care',    label:'Elderly Care',       image:'https://images.pexels.com/photos/3791664/pexels-photo-3791664.jpeg?auto=compress&w=600' },
  { slug:'astrology',       label:'Astrology & Tarot',  image:'https://images.pexels.com/photos/1741230/pexels-photo-1741230.jpeg?auto=compress&w=600' },
  { slug:'3d-printing',     label:'3D Printing',        image:'https://images.pexels.com/photos/3866316/pexels-photo-3866316.jpeg?auto=compress&w=600' },
]

const topChoices = [
  { id:'o1', title:'Wedding Photography Package', price:400, location:'Rabat', rating:4.7, reviews:8, image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400', desc:'Verified Wedding Photography Package provider on SouKni Morocco.' },
  { id:'o2', title:'Corporate Headshot Session', price:1000, location:'Casablanca', rating:4.8, reviews:14, image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400', desc:'Verified Corporate Headshot Session provider on SouKni Morocco.' },
  { id:'o3', title:'Private Chef for Dinner Party', price:1600, location:'Marrakech', rating:4.9, reviews:20, image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400', desc:'Verified Private Chef for Dinner Party provider on SouKni Morocco.' },
]

const bentoListings = [
  { id:'ob1', title:'Wedding DJ & Sound System', price:300, location:'Marrakech', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { id:'ob2', title:'Pet Sitting — Weekly', price:800, location:'Tangier', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'ob3', title:'Dog Walking Daily Service', price:1300, location:'Agadir', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'ob4', title:'Babysitter Weekend', price:1800, location:'Fès', image:'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&w=400' },
  { id:'ob5', title:'Nanny Full-Time', price:2300, location:'Meknès', image:'https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg?auto=compress&w=400' },
]

const discoveryGrid = [
  { id:'od1', title:'Wedding Photography Package', price:200, location:'Rabat', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { id:'od2', title:'Corporate Headshot Session', price:580, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'od3', title:'Private Chef for Dinner Party', price:960, location:'Marrakech', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'od4', title:'Wedding DJ & Sound System', price:1340, location:'Tangier', image:'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&w=400' },
  { id:'od5', title:'Pet Sitting — Weekly', price:1720, location:'Agadir', image:'https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg?auto=compress&w=400' },
  { id:'od6', title:'Dog Walking Daily Service', price:2100, location:'Fès', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { id:'od7', title:'Babysitter Weekend', price:2480, location:'Meknès', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'od8', title:'Nanny Full-Time', price:2860, location:'Kenitra', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
]

const BUDGETS = ['Any Budget','0-500 MAD','500-1500 MAD','1500-3000 MAD','3000+ MAD']
  ...
  const filtered = useMemo(() => {
    let list = discoveryGrid.filter(item => {
      ...
      const mb = budget === 'Any Budget'      ? true
               : budget === '0-500 MAD'       ? item.price <= 500
               : budget === '500-1500 MAD'    ? item.price > 500 && item.price <= 1500
               : budget === '1500-3000 MAD'   ? item.price > 1500 && item.price <= 3000
               : item.price > 3000
      return mc && mk && mb
    })
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt="Other Services" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>🌟 Other Services</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Photography, catering, pet care, IT support and every other service Morocco needs</p>
          <div style={{ display:'flex', alignItems:'stretch', backgroundColor:'rgba(255,255,255,0.12)', backdropFilter:'blur(24px)', border:'1px solid rgba(255,255,255,0.25)', borderRadius:'100px', overflow:'hidden', maxWidth:'620px', margin:'0 auto' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column' as const, padding:'12px 20px', flex:1, borderRight:'1px solid rgba(255,255,255,0.2)', gap:'2px' }}>
              ...
              <div style={{ display:'flex', alignItems:'center', gap:'6px' }}>
                <input value={heroKeyword} onChange={e=>setHeroKeyword(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} placeholder="Photography, catering, pet care..." style={{ backgroundColor:'transparent', border:'none', outline:'none', fontSize:'13px', fontWeight:600, color:'white', padding:0, flex:1 }} />
        ...
        <div style={{ backgroundColor:'rgba(255,255,255,0.97)', backdropFilter:'blur(16px)', border:'1px solid rgba(107,122,118,0.12)', borderRadius:'100px', boxShadow:'0 8px 40px rgba(0,0,0,0.12)', display:'flex', alignItems:'stretch', height:'68px' }}>
          ...
          <div style={{ flex:2, padding:'0 22px', borderRight:'1px solid rgba(186,202,197,0.3)', display:'flex', flexDirection:'column' as const, justifyContent:'center', gap:'2px' }}>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
              ...
              <input value={heroKeyword} onChange={e=>setHeroKeyword(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} placeholder="Photography, pet care, catering..." style={{ fontSize:'14px', fontWeight:600, color:'#161d1b', border:'none', outline:'none', background:'none', flex:1 }} />
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'11px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Other Services</span>
        </nav>
        ...
        <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', marginBottom:'16px', flexWrap:'wrap' as const, gap:'12px' }}>
          <div>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b', marginBottom:'4px' }}>🌟 Other Services in Morocco</h2>
        ...
        <section style={{ marginBottom:'32px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(6,1fr)', gap:'12px' }}>
            {SUBCATS.map(sub=>(
              <Link key={sub.slug} href={`/${locale}/services/other-services/${sub.slug}`} style={{ textDecoration:'none' }}>
        ...
        <div style={{ display:'flex', gap:'8px', marginBottom:'32px', flexWrap:'wrap' as const }}>
          {[{emoji:'✨',label:'New'},{emoji:'⭐',label:'Top Rated'},{emoji:'💰',label:'Best Price'}].map(c=>(
            <button key={c.label} onClick={()=>setChip(c.label)}
              style={{ display:'flex', alignItems:'center', gap:'6px', padding:'8px 16px', borderRadius:'100px', fontSize:'12px', fontWeight:700, cursor:'pointer', border:chip===c.label?'none':'1px solid rgba(186,202,197,0.5)', backgroundColor:chip===c.label?'#161d1b':'white', color:chip===c.label?'white':'#3c4a46', transition:'all 0.15s' }}
              onMouseEnter={e=>{if(chip!==c.label){e.currentTarget.style.borderColor='#22d4a8';e.currentTarget.style.color='#161d1b'}}}
              onMouseLeave={e=>{if(chip!==c.label){e.currentTarget.style.borderColor='rgba(186,202,197,0.5)';e.currentTarget.style.color='#3c4a46'}}}
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Other Services Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>
              {filtered.length > 0 ? `${filtered.length} More Other Services` : 'No results found'}
            </h2>
        ...
        <section style={{ borderRadius:'40px', background:'linear-gradient(135deg,#22d4a8,#0f9b8e)', padding:'56px 48px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'40px', flexWrap:'wrap' as const, marginBottom:'64px' }}>
          <div>
            ...
            <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.85)', maxWidth:'480px', lineHeight:1.7 }}>List your service for free and reach thousands of customers across Morocco.</p>
