...
const topChoices = [
  { id:'t1', title:'Wedding Photography Package', price:400, location:'Rabat', rating:4.7, reviews:10, image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400', desc:'Professional Photography service. Certified and verified by SouKni Morocco.' },
  { id:'t2', title:'Corporate Headshots', price:1100, location:'Casablanca', rating:4.8, reviews:18, image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400', desc:'Professional Photography service. Certified and verified by SouKni Morocco.' },
  { id:'t3', title:'Product Photography', price:1800, location:'Marrakech', rating:4.9, reviews:26, image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400', desc:'Professional Photography service. Certified and verified by SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Event Coverage', price:300, location:'Marrakech', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { id:'b2', title:'Real Estate Photos', price:800, location:'Tangier', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'b3', title:'Portrait Session', price:1300, location:'Agadir', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'b4', title:'Food Photography', price:1800, location:'Fès', image:'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&w=400' },
  { id:'b5', title:'Street Photography', price:2300, location:'Meknès', image:'https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Wedding Photography Package', price:200, location:'Rabat', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Corporate Headshots', price:580, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'d3', title:'Product Photography', price:960, location:'Marrakech', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Event Coverage', price:1340, location:'Tangier', image:'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&w=400' },
  { id:'d5', title:'Real Estate Photos', price:1720, location:'Agadir', image:'https://images.pexels.com/photos/4386466/pexels-photo-4386466.jpeg?auto=compress&w=400' },
  { id:'d6', title:'Portrait Session', price:2100, location:'Fès', image:'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&w=400' },
  { id:'d7', title:'Food Photography', price:2480, location:'Meknès', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'d8', title:'Street Photography', price:2860, location:'Kenitra', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
]
    ...
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Professional photography for events, brands and portraits</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Professional photography for events, brands and portraits</p>
        ...
        <section style={{ marginBottom:'48px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'12px' }}>
            {SIBLINGS.filter(s=>s.slug!=='photography').slice(0,8).map(s=>(
