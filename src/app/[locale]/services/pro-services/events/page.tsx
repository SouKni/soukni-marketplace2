...
const HERO = 'https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&w=1600'
const SIBLINGS = [
...
const topChoices = [
  { id:'t1', title:'Wedding Planning Full Service', price:800, location:'Rabat', rating:4.7, reviews:12, image:'https://images.pexels.com/photos/1261731/pexels-photo-1261731.jpeg?auto=compress&w=400', desc:'Event planning, decoration, coordination and full event management. Certified on SouKni Morocco.' },
  { id:'t2', title:'Birthday Party Setup', price:2200, location:'Casablanca', rating:4.8, reviews:22, image:'https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&w=400', desc:'Event planning, decoration, coordination and full event management. Certified on SouKni Morocco.' },
  { id:'t3', title:'Corporate Event Management', price:3600, location:'Marrakech', rating:4.9, reviews:32, image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400', desc:'Event planning, decoration, coordination and full event management. Certified on SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Decoration & Florals', price:600, location:'Marrakech', image:'https://images.pexels.com/photos/1261731/pexels-photo-1261731.jpeg?auto=compress&w=400' },
  { id:'b2', title:'Catering Coordination', price:1600, location:'Tangier', image:'https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&w=400' },
  { id:'b3', title:'Kids Party Planning', price:2600, location:'Agadir', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'b4', title:'Product Launch Event', price:3600, location:'Fès', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'b5', title:'Graduation Ceremony', price:4600, location:'Meknès', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Wedding Planning Full Service', price:400, location:'Rabat', image:'https://images.pexels.com/photos/1261731/pexels-photo-1261731.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Birthday Party Setup', price:1100, location:'Casablanca', image:'https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&w=400' },
  { id:'d3', title:'Corporate Event Management', price:1800, location:'Marrakech', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Decoration & Florals', price:2500, location:'Tangier', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'d5', title:'Catering Coordination', price:3200, location:'Agadir', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'d6', title:'Kids Party Planning', price:3900, location:'Fès', image:'https://images.pexels.com/photos/3771069/pexels-photo-3771069.jpeg?auto=compress&w=400' },
  { id:'d7', title:'Product Launch Event', price:4600, location:'Meknès', image:'https://images.pexels.com/photos/1261731/pexels-photo-1261731.jpeg?auto=compress&w=400' },
  { id:'d8', title:'Graduation Ceremony', price:5300, location:'Kenitra', image:'https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&w=400' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Events' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Events</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Event planning, decoration, coordination and full event management</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'11px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Events</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Events in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Event planning, decoration, coordination and full event management</p>
          ...
          {SIBLINGS.map(s=>(
            <Link key={s.slug} href={`/${locale}/services/pro-services/${s.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'9px 20px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: s.slug==='events' ? '#161d1b' : 'white',
                color: s.slug==='events' ? 'white' : '#6b7a76',
                borderColor: s.slug==='events' ? '#161d1b' : 'rgba(186,202,197,0.4)',
              }}>{s.label}</button>
            </Link>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Events Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Events Services</h2>
        ...
        <section style={{ marginBottom:'48px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {SIBLINGS.filter(s=>s.slug!=='events').map(s=>(
