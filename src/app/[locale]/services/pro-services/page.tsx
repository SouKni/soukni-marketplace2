...
const SUBCATS = [
  ...
  { slug:'events',      label:'Events',      image:'https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&w=600' },
  { slug:'translation', label:'Translation', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=600' },
  { slug:'design',      label:'Design',      image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { slug:'security',    label:'Security',    image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { slug:'concierge',   label:'Concierge',   image:'https://images.pexels.com/photos/3771069/pexels-photo-3771069.jpeg?auto=compress&w=600' },
]

const topChoices = [
  { id:'p1', title:'Wedding Photographer — Luxury Riad Marrakech', price:8500, location:'Marrakech', rating:4.9, reviews:103, image:'https://images.pexels.com/photos/1261731/pexels-photo-1261731.jpeg?auto=compress&w=800', desc:'Award-winning wedding photographer with 10 years experience shooting luxury weddings across Morocco. Full-day coverage, edited gallery of 800+ images, drone footage and same-week preview delivery.' },
  { id:'p2', title:'Full Wedding Planning & Event Management',      price:25000, location:'Casablanca', rating:4.9, reviews:87, image:'https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&w=800', desc:'End-to-end wedding and event planning from venue selection to on-the-day coordination. Floral design, catering management, entertainment booking and full décor styling for up to 500 guests.' },
  { id:'p3', title:'Brand Identity & Logo Design — Full Package',   price:5500, location:'Casablanca', rating:4.8, reviews:74, image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=800', desc:'Senior brand designer offering complete brand identity packages: logo, typography, colour palette, brand guidelines, stationery and social media kit. 3 concept directions, unlimited revisions.' },
]

const bentoListings = [
  { id:'pb1', title:'Product Photography — E-Commerce Pack',   price:2800, location:'Casablanca', image:'https://images.pexels.com/photos/1261731/pexels-photo-1261731.jpeg?auto=compress&w=600' },
  { id:'pb2', title:'Legal Document Translation FR-AR-EN',     price:1200, location:'Rabat',      image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=600' },
  { id:'pb3', title:'Executive Protection — VIP Security',     price:4500, location:'Marrakech',  image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'pb4', title:'Airport VIP Transfer & Concierge',        price:800,  location:'Casablanca', image:'https://images.pexels.com/photos/3771069/pexels-photo-3771069.jpeg?auto=compress&w=600' },
  { id:'pb5', title:'UI UX Design — Mobile App Full Project',  price:12000,location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
]

const discoveryGrid = [
  { id:'pd1', title:'Corporate Headshots — Half Day',          price:1800, location:'Casablanca', image:'https://images.pexels.com/photos/1261731/pexels-photo-1261731.jpeg?auto=compress&w=400' },
  { id:'pd2', title:'Birthday Party Full Decoration',          price:3500, location:'Rabat',      image:'https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&w=400' },
  { id:'pd3', title:'Website Localisation — FR to AR',         price:2200, location:'Casablanca', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'pd4', title:'Social Media Graphic Pack — 30 Posts',    price:1500, location:'Marrakech',  image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'pd5', title:'CCTV Installation — 8 Camera System',     price:3800, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'pd6', title:'Personal Shopping & Styling Session',     price:1200, location:'Casablanca', image:'https://images.pexels.com/photos/3771069/pexels-photo-3771069.jpeg?auto=compress&w=400' },
  { id:'pd7', title:'Food Photography — Restaurant Menu',      price:2400, location:'Marrakech',  image:'https://images.pexels.com/photos/1261731/pexels-photo-1261731.jpeg?auto=compress&w=400' },
  { id:'pd8', title:'Event Security Team — 10 Officers',       price:5500, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
]

const BUDGETS = ['Any Budget','0-2000 MAD','2000-6000 MAD','6000-15000 MAD','15000+ MAD']
...
export default function ProServicesPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const filtered = useMemo(() => {
    let list = discoveryGrid.filter(item => {
      ...
      const mb = budget === 'Any Budget'        ? true
               : budget === '0-2000 MAD'        ? item.price <= 2000
               : budget === '2000-6000 MAD'     ? item.price > 2000 && item.price <= 6000
               : budget === '6000-15000 MAD'    ? item.price > 6000 && item.price <= 15000
               : item.price > 15000
      return mc && mk && mb
    })
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt="Pro Services" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Pro Services</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Photography, events, translation, design, security and concierge across Morocco</p>
          <div style={{ display:'flex', alignItems:'stretch', backgroundColor:'rgba(255,255,255,0.12)', backdropFilter:'blur(24px)', border:'1px solid rgba(255,255,255,0.25)', borderRadius:'100px', overflow:'hidden', maxWidth:'620px', margin:'0 auto' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column' as const, padding:'12px 20px', flex:1, borderRight:'1px solid rgba(255,255,255,0.2)', gap:'2px' }}>
              ...
              <div style={{ display:'flex', alignItems:'center', gap:'6px' }}>
                <input value={heroKeyword} onChange={e=>setHeroKeyword(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} placeholder="Photography, events, design..." style={{ backgroundColor:'transparent', border:'none', outline:'none', fontSize:'13px', fontWeight:600, color:'white', padding:0, flex:1 }} />
        ...
        <div style={{ backgroundColor:'rgba(255,255,255,0.97)', backdropFilter:'blur(16px)', border:'1px solid rgba(107,122,118,0.12)', borderRadius:'100px', boxShadow:'0 8px 40px rgba(0,0,0,0.12)', display:'flex', alignItems:'stretch', height:'68px' }}>
          ...
          <div style={{ flex:2, padding:'0 22px', borderRight:'1px solid rgba(186,202,197,0.3)', display:'flex', flexDirection:'column' as const, justifyContent:'center', gap:'2px' }}>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
              ...
              <input value={heroKeyword} onChange={e=>setHeroKeyword(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} placeholder="Photography, events, design..." style={{ fontSize:'14px', fontWeight:600, color:'#161d1b', border:'none', outline:'none', background:'none', flex:1 }} />
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', marginBottom:'16px', flexWrap:'wrap' as const, gap:'12px' }}>
          <div>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b', marginBottom:'4px' }}>Pro Services in Morocco</h2>
        ...
        <section style={{ marginBottom:'32px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(6,1fr)', gap:'12px' }}>
            {SUBCATS.map(sub=>(
              <Link key={sub.slug} href={`/${locale}/services/pro-services/${sub.slug}`} style={{ textDecoration:'none' }}>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Pro Services Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>
              {filtered.length > 0 ? `${filtered.length} More Pro Services` : 'No results found'}
            </h2>
        ...
        <section style={{ borderRadius:'40px', background:'linear-gradient(135deg,#22d4a8,#0f9b8e)', padding:'56px 48px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'40px', flexWrap:'wrap' as const, marginBottom:'48px' }}>
          <div>
            ...
            <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.85)', maxWidth:'480px', lineHeight:1.7 }}>List your professional service for free and reach thousands of clients across Morocco.</p>
