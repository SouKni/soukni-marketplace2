...
const HERO = 'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=1600'

const topChoices = [
  {
    id: 'ps1',
    title: 'Elite Notary & Administrative Documents Expert',
    desc: 'Licensed notary with 18+ years handling property deeds, business incorporation, inheritance files, and all official administrative procedures across Morocco.',
    price: 800,
  ...
  {
    id: 'ps2',
    title: 'Premium Event Planning & Luxury Production',
    desc: 'Full-service event production company specializing in corporate galas, weddings, and private events. End-to-end management from concept to execution.',
    price: 5000,
    location: 'Marrakech, Palmeraie',
    rating: 5.0,
    reviews: 143,
    image: 'https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&w=800',
  },
  {
    id: 'ps3',
    title: 'Certified Translation & Interpretation Services',
    desc: 'Sworn translator for Arabic, French, English, Spanish and German. Official documents, legal contracts, and simultaneous interpretation for conferences.',
    price: 400,
...
const bentoListings = [
  { id:'bp1', title:'Professional Photography Studio',    price:1200, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=600' },
  { id:'bp2', title:'Videography & Film Production',      price:2500, location:'Rabat',      image:'https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&w=600' },
  { id:'bp3', title:'Graphic Design & Branding Agency',   price:900,  location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'bp4', title:'Drone Photography & Mapping',        price:1800, location:'Marrakech',  image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=600' },
  { id:'bp5', title:'3D Rendering & Architecture Viz',    price:2200, location:'Casablanca', image:'https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&w=600' },
]

const discoveryGrid = [
  { id:'dp1',  title:'Customs Clearance Agent',           price:600,  location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=600' },
  { id:'dp2',  title:'Patent & IP Registration',          price:1500, location:'Rabat',      image:'https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&w=600' },
  { id:'dp3',  title:'Security Guard & Escort Service',   price:800,  location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'dp4',  title:'Private Investigator',              price:2000, location:'Rabat',      image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=600' },
  { id:'dp5',  title:'Chauffeur & VIP Driver',            price:500,  location:'Casablanca', image:'https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&w=600' },
  { id:'dp6',  title:'Personal Shopper & Stylist',        price:700,  location:'Marrakech',  image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'dp7',  title:'Wedding Planner & Coordinator',     price:3500, location:'Casablanca', image:'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&w=600' },
  { id:'dp8',  title:'Catering & Private Chef Service',   price:1200, location:'Rabat',      image:'https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&w=600' },
]

const pills = ['All Pro Services','Photography','Events','Translation','Design','Security','Concierge','View More']
        ...
        <div style={{ flex:1, padding:'28px 32px', display:'flex', flexDirection:'column', justifyContent:'space-between' }}>
          ...
          <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginTop:'20px' }}>
            <div>
              ...
              <span style={{ fontSize:'12px', color:'#6b7a76' }}> / project</span>
            </div>
...
export default function ProServicesPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const [activePill, setActivePill] = useState('All Pro Services')
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      ...
      <section style={{ position:'relative', height:'440px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>
            Discover Premium Professional Services Near You!
          </h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>1,240 verified pro service providers across Morocco</p>
          <div style={{ display:'flex', alignItems:'stretch', backgroundColor:'rgba(255,255,255,0.12)', backdropFilter:'blur(24px)', border:'1px solid rgba(255,255,255,0.25)', borderRadius:'100px', overflow:'hidden', maxWidth:'680px', margin:'0 auto', boxShadow:'0 8px 32px rgba(0,0,0,0.2)' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', padding:'14px 20px', flex:1, borderRight:'1px solid rgba(255,255,255,0.2)', gap:'2px' }}>
              ...
              <input value={keyword} onChange={e=>setKeyword(e.target.value)} placeholder="Photography, events, translation..."
                style={{ backgroundColor:'transparent', border:'none', outline:'none', fontSize:'14px', fontWeight:600, color:'white', fontFamily:'Inter, sans-serif', padding:0, width:'100%' }} />
            </div>
      ...
      <div style={{ maxWidth:'1440px', margin:'-28px auto 0', padding:'0 40px', position:'relative', zIndex:30 }}>
        <div style={{ backgroundColor:'rgba(255,255,255,0.9)', backdropFilter:'blur(20px)', borderRadius:'100px', padding:'10px 10px 10px 24px', boxShadow:'0 8px 40px rgba(0,0,0,0.12)', border:'1px solid rgba(255,255,255,0.6)', display:'flex', alignItems:'center' }}>
          {[
            ...
            { label:'Keyword', val:'What pro service do you need?' },
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px' }}>
        ...
        <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b', marginBottom:'4px' }}>Professional Services &amp; Specialists in Rabat</h2>
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'16px' }}>1,240 Ads in Rabat District</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Pro Services Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Pro Services</h2>
        ...
        <section style={{ borderRadius:'40px', background:'linear-gradient(135deg,#22d4a8,#0f9b8e)', padding:'56px 48px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'40px', flexWrap:'wrap', marginBottom:'64px' }}>
          <div>
            ...
            <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.85)', maxWidth:'480px', lineHeight:1.7 }}>Offer your professional services today for free and reach thousands of clients across Morocco.</p>
