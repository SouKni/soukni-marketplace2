...
const topChoices = [
  { id:'t1', title:'Legal Document Translation', price:800, location:'Rabat', rating:4.7, reviews:12, image:'https://images.pexels.com/photos/1261731/pexels-photo-1261731.jpeg?auto=compress&w=400', desc:'Document translation, live interpreting and website localisation. Certified on SouKni Morocco.' },
  { id:'t2', title:'Medical Translation', price:2200, location:'Casablanca', rating:4.8, reviews:22, image:'https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&w=400', desc:'Document translation, live interpreting and website localisation. Certified on SouKni Morocco.' },
  { id:'t3', title:'Website Localisation', price:3600, location:'Marrakech', rating:4.9, reviews:32, image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400', desc:'Document translation, live interpreting and website localisation. Certified on SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Simultaneous Interpreting', price:600, location:'Marrakech', image:'https://images.pexels.com/photos/1261731/pexels-photo-1261731.jpeg?auto=compress&w=400' },
  { id:'b2', title:'Certified Translation', price:1600, location:'Tangier', image:'https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&w=400' },
  { id:'b3', title:'Technical Manual', price:2600, location:'Agadir', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'b4', title:'Subtitling Services', price:3600, location:'Fès', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'b5', title:'Arabic-French-English', price:4600, location:'Meknès', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Legal Document Translation', price:400, location:'Rabat', image:'https://images.pexels.com/photos/1261731/pexels-photo-1261731.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Medical Translation', price:1100, location:'Casablanca', image:'https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&w=400' },
  { id:'d3', title:'Website Localisation', price:1800, location:'Marrakech', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Simultaneous Interpreting', price:2500, location:'Tangier', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=400' },
  { id:'d5', title:'Certified Translation', price:3200, location:'Agadir', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'d6', title:'Technical Manual', price:3900, location:'Fès', image:'https://images.pexels.com/photos/3771069/pexels-photo-3771069.jpeg?auto=compress&w=400' },
  { id:'d7', title:'Subtitling Services', price:4600, location:'Meknès', image:'https://images.pexels.com/photos/1261731/pexels-photo-1261731.jpeg?auto=compress&w=400' },
  { id:'d8', title:'Arabic-French-English', price:5300, location:'Kenitra', image:'https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&w=400' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Translation' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <p style={{ fontSize:'11px', fontWeight:800, color:'#22d4a8', textTransform:'uppercase' as const, letterSpacing:'0.2em', marginBottom:'12px' }}>PRO SERVICES</p>
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Translation</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Document translation, live interpreting and website localisation</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'11px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <Link href={`/${locale}/services/pro-services`} style={{ color:'#6b7a76', textDecoration:'none' }} onMouseEnter={e=>e.currentTarget.style.color='#22d4a8'} onMouseLeave={e=>e.currentTarget.style.color='#6b7a76'}>Pro Services</Link><span>›</span>
          <span style={{ color:'#161d1b' }}>Translation</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Translation in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Document translation, live interpreting and website localisation</p>

        <div style={{ display:'flex', gap:'8px', marginBottom:'20px', overflowX:'auto', paddingBottom:'4px' }}>
          {SIBLINGS.map(s=>(
            <Link key={s.slug} href={`/${locale}/services/pro-services/${s.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'9px 20px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: s.slug==='translation' ? '#161d1b' : 'white',
                color: s.slug==='translation' ? 'white' : '#6b7a76',
                borderColor: s.slug==='translation' ? '#161d1b' : 'rgba(186,202,197,0.4)',
              }}>{s.label}</button>
            </Link>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Translation Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Translation Services</h2>
        ...
        <section style={{ marginBottom:'48px' }}>
          <h3 style={{ fontSize:'16px', fontWeight:900, color:'#161d1b', textTransform:'uppercase' as const, letterSpacing:'0.08em', marginBottom:'16px' }}>Explore Other Pro Services</h3>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {SIBLINGS.filter(s=>s.slug!=='translation').map(s=>(
              <Link key={s.slug} href={`/${locale}/services/pro-services/${s.slug}`}
        ...
        <div style={{ textAlign:'center' as const }}>
          <Link href={`/${locale}/services/pro-services`}
