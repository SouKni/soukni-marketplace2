...
const HERO = 'https://images.pexels.com/photos/3218467/pexels-photo-3218467.jpeg?auto=compress&w=1600'
const SIBLINGS = [
...
const topChoices = [
  { id:'t1', title:'Moroccan Cuisine Class', price:120, location:'Rabat', rating:4.7, reviews:10, image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400', desc:'Cooking classes, music lessons, drawing and creative arts. Certified tutor on SouKni Morocco.' },
  { id:'t2', title:'Pastry & Patisserie', price:210, location:'Casablanca', rating:4.8, reviews:19, image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400', desc:'Cooking classes, music lessons, drawing and creative arts. Certified tutor on SouKni Morocco.' },
  { id:'t3', title:'Piano Music Theory', price:300, location:'Marrakech', rating:4.9, reviews:28, image:'https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&w=400', desc:'Cooking classes, music lessons, drawing and creative arts. Certified tutor on SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Watercolour Painting', price:100, location:'Marrakech', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'b2', title:'Guitar Beginners', price:180, location:'Tangier', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'b3', title:'Sewing & Fashion', price:260, location:'Agadir', image:'https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&w=400' },
  { id:'b4', title:'Pottery Ceramics', price:340, location:'Fès', image:'https://images.pexels.com/photos/3218467/pexels-photo-3218467.jpeg?auto=compress&w=400' },
  { id:'b5', title:'Photography Basics', price:420, location:'Meknès', image:'https://images.pexels.com/photos/1552252/pexels-photo-1552252.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Moroccan Cuisine Class', price:80, location:'Rabat', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Pastry & Patisserie', price:140, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'d3', title:'Piano Music Theory', price:200, location:'Marrakech', image:'https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Watercolour Painting', price:260, location:'Tangier', image:'https://images.pexels.com/photos/3218467/pexels-photo-3218467.jpeg?auto=compress&w=400' },
  { id:'d5', title:'Guitar Beginners', price:320, location:'Agadir', image:'https://images.pexels.com/photos/1552252/pexels-photo-1552252.jpeg?auto=compress&w=400' },
  { id:'d6', title:'Sewing & Fashion', price:380, location:'Fès', image:'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&w=400' },
  { id:'d7', title:'Pottery Ceramics', price:440, location:'Meknès', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'d8', title:'Photography Basics', price:500, location:'Kenitra', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Cooking & Arts' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Cooking & Arts</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Cooking classes, music lessons, drawing and creative arts</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'11px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Cooking & Arts</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Cooking & Arts in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Cooking classes, music lessons, drawing and creative arts</p>
          ...
          {SIBLINGS.map(s=>(
            <Link key={s.slug} href={`/${locale}/services/tutors/${s.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'9px 20px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: s.slug==='cooking-arts' ? '#161d1b' : 'white',
                color: s.slug==='cooking-arts' ? 'white' : '#6b7a76',
                borderColor: s.slug==='cooking-arts' ? '#161d1b' : 'rgba(186,202,197,0.4)',
              }}>{s.label}</button>
            </Link>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Cooking & Arts Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Cooking & Arts Lessons</h2>
        ...
        <section style={{ marginBottom:'48px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {SIBLINGS.filter(s=>s.slug!=='cooking-arts').map(s=>(
