...
const topChoices = [
  {
    id: 't1',
    title: 'Advanced Calculus & Pure Mathematics Masterclass',
    desc: 'Taught by a Professor of Mathematics. Specializes in University-level calculus, linear algebra, and competitive exam preparation. Over 500 students coached successfully.',
    price: 450,
    location: 'Rabat, Agdal',
    rating: 4.9,
    reviews: 312,
    image: 'https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&w=800',
  },
  {
    id: 't2',
    title: 'Executive Language & Cross-Cultural Fluency',
    desc: 'Professional English, French, and Arabic coaching for high-achieving international professionals. Certified TEFL instructor with 10+ years of corporate training experience.',
    price: 350,
  ...
  {
    id: 't3',
    title: 'Master Calligraphy & Traditional Moroccan Arts',
    desc: 'An artisan master in Arabic calligraphy, zellige tile art, and traditional Moroccan craft techniques. Private and group sessions available in Marrakech and online.',
    price: 460,
...
const bentoListings = [
  { id:'bt1', title:'French Language Masterclass',           price:150, location:'Rabat',      image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'bt2', title:'Premium Mathematics — BAC & University', price:250, location:'Casablanca', image:'https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&w=600' },
  { id:'bt3', title:'Advanced Physics Coaching',             price:220, location:'Rabat',      image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'bt4', title:'Full-Stack Web Development',            price:350, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'bt5', title:'Arabic Calligraphy Mastery',            price:200, location:'Marrakech',  image:'https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&w=600' },
]

const discoveryGrid = [
  { id:'dt1',  title:'Music Production with a Pro',         price:400, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'dt2',  title:'Advanced Chemistry Tutoring',         price:150, location:'Rabat',      image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'dt3',  title:'Digital Marketing Strategy',          price:300, location:'Tangier',    image:'https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&w=600' },
  { id:'dt4',  title:'Acoustic Guitar for All Levels',      price:100, location:'Rabat',      image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'dt5',  title:'Yoga & Mindfulness Practice',         price:120, location:'Marrakech',  image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
  { id:'dt6',  title:'AI & Data Science Mentorship',        price:500, location:'Casablanca', image:'https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&w=600' },
  { id:'dt7',  title:'Business Leadership Coaching',        price:400, location:'Casablanca', image:'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&w=600' },
  { id:'dt8',  title:'Moroccan Gourmet Pastry Class',       price:200, location:'Fès',        image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=600' },
]

const pills = ['All Categories','Languages','Mathematics','Sciences','Cooking & Arts','Sports & Fitness','Technology','View More']
...
export default function TutorsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const [activePill, setActivePill] = useState('All Categories')
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      ...
      <section style={{ position:'relative', height:'440px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        <img src={HERO} alt="Tutors & Classes" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>
            Discover Top-Rated Educators Near You!
          </h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>996 verified tutors, private classes &amp; courses across Morocco</p>
          <div style={{ display:'flex', alignItems:'stretch', backgroundColor:'rgba(255,255,255,0.12)', backdropFilter:'blur(24px)', border:'1px solid rgba(255,255,255,0.25)', borderRadius:'100px', overflow:'hidden', maxWidth:'680px', margin:'0 auto', boxShadow:'0 8px 32px rgba(0,0,0,0.2)' }}>
            <div style={{ display:'flex', flexDirection:'column', padding:'14px 20px', flex:'0 0 180px', borderRight:'1px solid rgba(255,255,255,0.2)', gap:'2px' }}>
              ...
              <input value={city} onChange={e=>setCity(e.target.value)} placeholder="Rabat"
            ...
            <div style={{ display:'flex', flexDirection:'column', padding:'14px 20px', flex:1, borderRight:'1px solid rgba(255,255,255,0.2)', gap:'2px' }}>
              ...
              <input value={keyword} onChange={e=>setKeyword(e.target.value)} placeholder="Maths, Arabic, Guitar, Cooking..."
                style={{ backgroundColor:'transparent', border:'none', outline:'none', fontSize:'14px', fontWeight:600, color:'white', fontFamily:'Inter, sans-serif', padding:0, width:'100%' }} />
            </div>
      ...
      <div style={{ maxWidth:'1440px', margin:'-28px auto 0', padding:'0 40px', position:'relative', zIndex:30 }}>
        <div style={{ backgroundColor:'rgba(255,255,255,0.9)', backdropFilter:'blur(20px)', borderRadius:'100px', padding:'10px 10px 10px 24px', boxShadow:'0 8px 40px rgba(0,0,0,0.12)', border:'1px solid rgba(255,255,255,0.6)', display:'flex', alignItems:'center' }}>
          {[
            ...
            { label:'Keyword', val:'What would you like to learn?' },
            { label:'Neighborhood', val:'Online/Offline' },
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px' }}>
        ...
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'12px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase', letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Tutors &amp; Classes</span>
        </nav>

        <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b', marginBottom:'4px' }}>Home Tutors, Private Classes &amp; Courses in Rabat</h2>
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'16px' }}>996 Ads in Rabat District</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Tutors Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Tutors &amp; Classes</h2>
        ...
        <section style={{ borderRadius:'40px', background:'linear-gradient(135deg,#22d4a8,#0f9b8e)', padding:'56px 48px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'40px', flexWrap:'wrap', marginBottom:'64px' }}>
          <div>
            ...
            <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.85)', maxWidth:'480px', lineHeight:1.7 }}>Share your knowledge today for free and reach thousands of eager learners across Morocco.</p>
