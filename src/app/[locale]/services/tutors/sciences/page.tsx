...
const HERO = 'https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&w=1600'
const SIBLINGS = [
...
const topChoices = [
  { id:'t1', title:'Physics Bac Prep', price:120, location:'Rabat', rating:4.7, reviews:10, image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400', desc:'Physics, chemistry and biology tutoring for Bac and university. Certified tutor on SouKni Morocco.' },
  { id:'t2', title:'Chemistry Lab Coach', price:210, location:'Casablanca', rating:4.8, reviews:19, image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400', desc:'Physics, chemistry and biology tutoring for Bac and university. Certified tutor on SouKni Morocco.' },
  { id:'t3', title:'Biology SVTE', price:300, location:'Marrakech', rating:4.9, reviews:28, image:'https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&w=400', desc:'Physics, chemistry and biology tutoring for Bac and university. Certified tutor on SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Science Primary Level', price:100, location:'Marrakech', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'b2', title:'Organic Chemistry', price:180, location:'Tangier', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'b3', title:'Astronomy & Physics', price:260, location:'Agadir', image:'https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&w=400' },
  { id:'b4', title:'Earth Sciences', price:340, location:'Fès', image:'https://images.pexels.com/photos/3218467/pexels-photo-3218467.jpeg?auto=compress&w=400' },
  { id:'b5', title:'Biology University', price:420, location:'Meknès', image:'https://images.pexels.com/photos/1552252/pexels-photo-1552252.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Physics Bac Prep', price:80, location:'Rabat', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Chemistry Lab Coach', price:140, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'d3', title:'Biology SVTE', price:200, location:'Marrakech', image:'https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Science Primary Level', price:260, location:'Tangier', image:'https://images.pexels.com/photos/3218467/pexels-photo-3218467.jpeg?auto=compress&w=400' },
  { id:'d5', title:'Organic Chemistry', price:320, location:'Agadir', image:'https://images.pexels.com/photos/1552252/pexels-photo-1552252.jpeg?auto=compress&w=400' },
  { id:'d6', title:'Astronomy & Physics', price:380, location:'Fès', image:'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&w=400' },
  { id:'d7', title:'Earth Sciences', price:440, location:'Meknès', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'d8', title:'Biology University', price:500, location:'Kenitra', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Sciences' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Sciences</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Physics, chemistry and biology tutoring for Bac and university</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'11px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Sciences</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Sciences in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Physics, chemistry and biology tutoring for Bac and university</p>
          ...
          {SIBLINGS.map(s=>(
            <Link key={s.slug} href={`/${locale}/services/tutors/${s.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'9px 20px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: s.slug==='sciences' ? '#161d1b' : 'white',
                color: s.slug==='sciences' ? 'white' : '#6b7a76',
                borderColor: s.slug==='sciences' ? '#161d1b' : 'rgba(186,202,197,0.4)',
              }}>{s.label}</button>
            </Link>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Sciences Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Sciences Lessons</h2>
        ...
        <section style={{ marginBottom:'48px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'12px' }}>
            {SIBLINGS.filter(s=>s.slug!=='sciences').map(s=>(
