...
const topChoices = [
  { id:'t1', title:'Python Data Science', price:120, location:'Rabat', rating:4.7, reviews:10, image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400', desc:'Coding, web development, data science and IT coaching. Certified tutor on SouKni Morocco.' },
  { id:'t2', title:'Web Dev Bootcamp', price:210, location:'Casablanca', rating:4.8, reviews:19, image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400', desc:'Coding, web development, data science and IT coaching. Certified tutor on SouKni Morocco.' },
  { id:'t3', title:'iOS App Development', price:300, location:'Marrakech', rating:4.9, reviews:28, image:'https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&w=400', desc:'Coding, web development, data science and IT coaching. Certified tutor on SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Cybersecurity Basics', price:100, location:'Marrakech', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'b2', title:'Excel Data Analysis', price:180, location:'Tangier', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'b3', title:'AI Machine Learning', price:260, location:'Agadir', image:'https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&w=400' },
  { id:'b4', title:'UI UX Design', price:340, location:'Fès', image:'https://images.pexels.com/photos/3218467/pexels-photo-3218467.jpeg?auto=compress&w=400' },
  { id:'b5', title:'Digital Marketing', price:420, location:'Meknès', image:'https://images.pexels.com/photos/1552252/pexels-photo-1552252.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Python Data Science', price:80, location:'Rabat', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Web Dev Bootcamp', price:140, location:'Casablanca', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
  { id:'d3', title:'iOS App Development', price:200, location:'Marrakech', image:'https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Cybersecurity Basics', price:260, location:'Tangier', image:'https://images.pexels.com/photos/3218467/pexels-photo-3218467.jpeg?auto=compress&w=400' },
  { id:'d5', title:'Excel Data Analysis', price:320, location:'Agadir', image:'https://images.pexels.com/photos/1552252/pexels-photo-1552252.jpeg?auto=compress&w=400' },
  { id:'d6', title:'AI Machine Learning', price:380, location:'Fès', image:'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&w=400' },
  { id:'d7', title:'UI UX Design', price:440, location:'Meknès', image:'https://images.pexels.com/photos/4126743/pexels-photo-4126743.jpeg?auto=compress&w=400' },
  { id:'d8', title:'Digital Marketing', price:500, location:'Kenitra', image:'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&w=400' },
]
    ...
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Coding, web development, data science and IT coaching</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Technology in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Coding, web development, data science and IT coaching</p>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Technology Lessons</h2>
