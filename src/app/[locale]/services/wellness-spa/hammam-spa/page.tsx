...
const topChoices = [
  { id:'t1', title:'Royal Hammam Experience', price:250, location:'Rabat', rating:4.7, reviews:14, image:'https://images.pexels.com/photos/3757952/pexels-photo-3757952.jpeg?auto=compress&w=400', desc:'Traditional Moroccan hammam, luxury spa rituals and body treatments. Certified on SouKni Morocco.' },
  { id:'t2', title:'Couple Spa Package', price:430, location:'Casablanca', rating:4.8, reviews:25, image:'https://images.pexels.com/photos/3997989/pexels-photo-3997989.jpeg?auto=compress&w=400', desc:'Traditional Moroccan hammam, luxury spa rituals and body treatments. Certified on SouKni Morocco.' },
  { id:'t3', title:'Traditional Kessa Scrub', price:610, location:'Marrakech', rating:4.9, reviews:36, image:'https://images.pexels.com/photos/4056535/pexels-photo-4056535.jpeg?auto=compress&w=400', desc:'Traditional Moroccan hammam, luxury spa rituals and body treatments. Certified on SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Black Soap Ritual', price:180, location:'Marrakech', image:'https://images.pexels.com/photos/3757952/pexels-photo-3757952.jpeg?auto=compress&w=400' },
  { id:'b2', title:'Argan Oil Treatment', price:320, location:'Tangier', image:'https://images.pexels.com/photos/3997989/pexels-photo-3997989.jpeg?auto=compress&w=400' },
  { id:'b3', title:'Ghassoul Clay Wrap', price:460, location:'Agadir', image:'https://images.pexels.com/photos/4056535/pexels-photo-4056535.jpeg?auto=compress&w=400' },
  { id:'b4', title:'Luxury Day Spa Package', price:600, location:'Fès', image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400' },
  { id:'b5', title:'Hammam & Massage Combo', price:740, location:'Meknès', image:'https://images.pexels.com/photos/3822621/pexels-photo-3822621.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Royal Hammam Experience', price:150, location:'Rabat', image:'https://images.pexels.com/photos/3757952/pexels-photo-3757952.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Couple Spa Package', price:260, location:'Casablanca', image:'https://images.pexels.com/photos/3997989/pexels-photo-3997989.jpeg?auto=compress&w=400' },
  { id:'d3', title:'Traditional Kessa Scrub', price:370, location:'Marrakech', image:'https://images.pexels.com/photos/4056535/pexels-photo-4056535.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Black Soap Ritual', price:480, location:'Tangier', image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400' },
  { id:'d5', title:'Argan Oil Treatment', price:590, location:'Agadir', image:'https://images.pexels.com/photos/3822621/pexels-photo-3822621.jpeg?auto=compress&w=400' },
  { id:'d6', title:'Ghassoul Clay Wrap', price:700, location:'Fès', image:'https://images.pexels.com/photos/3757952/pexels-photo-3757952.jpeg?auto=compress&w=400' },
  { id:'d7', title:'Luxury Day Spa Package', price:810, location:'Meknès', image:'https://images.pexels.com/photos/3997989/pexels-photo-3997989.jpeg?auto=compress&w=400' },
  { id:'d8', title:'Hammam & Massage Combo', price:920, location:'Kenitra', image:'https://images.pexels.com/photos/4056535/pexels-photo-4056535.jpeg?auto=compress&w=400' },
]
  ...
  return (
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <img src={HERO} alt='Hammam & Spa' style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <h1 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(28px,5vw,48px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>Hammam & Spa</h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Traditional Moroccan hammam, luxury spa rituals and body treatments</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        <nav style={{ display:'flex', alignItems:'center', gap:'6px', fontSize:'11px', fontWeight:700, color:'#6b7a76', textTransform:'uppercase' as const, letterSpacing:'0.06em', marginBottom:'8px' }}>
          ...
          <span style={{ color:'#161d1b' }}>Hammam & Spa</span>
        </nav>

        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'4px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b' }}>Hammam & Spa in Morocco</h2>
          <div style={{ display:'flex', gap:'8px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Traditional Moroccan hammam, luxury spa rituals and body treatments</p>
          ...
          {SIBLINGS.map(s=>(
            <Link key={s.slug} href={`/${locale}/services/wellness-spa/${s.slug}`} style={{ textDecoration:'none' }}>
              <button style={{ padding:'9px 20px', borderRadius:'100px', fontSize:'11px', fontWeight:700, cursor:'pointer', border:'1px solid', whiteSpace:'nowrap' as const, transition:'all 0.15s',
                backgroundColor: s.slug==='hammam-spa' ? '#161d1b' : 'white',
                color: s.slug==='hammam-spa' ? 'white' : '#6b7a76',
                borderColor: s.slug==='hammam-spa' ? '#161d1b' : 'rgba(186,202,197,0.4)',
              }}>{s.label}</button>
            </Link>
          ))}
        </div>
        ...
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Hammam & Spa Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Hammam & Spa Services</h2>
        ...
        <section style={{ marginBottom:'48px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'12px' }}>
            {SIBLINGS.filter(s=>s.slug!=='hammam-spa').map(s=>(
