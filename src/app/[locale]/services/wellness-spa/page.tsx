...
const HERO = 'https://images.pexels.com/photos/3865560/pexels-photo-3865560.jpeg?auto=compress&w=1600'

const topChoices = [
  {
    id: 'ws1',
    title: 'Royal Hammam & Moroccan Spa Experience',
    desc: 'Authentic Moroccan hammam ritual with black soap, kessa exfoliation, and rhassoul clay mask. Traditional techniques passed down through generations in Marrakech.',
    price: 450,
    location: 'Marrakech, Medina',
    rating: 4.9,
    reviews: 324,
    image: 'https://images.pexels.com/photos/3865560/pexels-photo-3865560.jpeg?auto=compress&w=800',
  },
  {
    id: 'ws2',
    title: 'Luxury Deep Tissue & Hot Stone Massage',
    desc: 'Certified massage therapist specializing in deep tissue, hot stone, and aromatherapy treatments. In-studio and home visits available across Casablanca.',
    price: 380,
  ...
  {
    id: 'ws3',
    title: 'Premium Yoga & Mindfulness Retreat Coach',
    desc: 'RYT-500 certified yoga instructor offering private sessions, corporate wellness programs, and weekend retreats across Morocco. All levels welcome.',
    price: 300,
    location: 'Rabat, Agdal',
    rating: 4.8,
    reviews: 142,
    image: 'https://images.pexels.com/photos/3822621/pexels-photo-3822621.jpeg?auto=compress&w=800',
  },
]

const bentoListings = [
  { id:'bw1', title:'Argan Oil Body Treatment',        price:320, location:'Marrakech', image:'https://images.pexels.com/photos/3865560/pexels-photo-3865560.jpeg?auto=compress&w=600' },
  { id:'bw2', title:'Prenatal Massage Specialist',     price:280, location:'Casablanca', image:'https://images.pexels.com/photos/3997379/pexels-photo-3997379.jpeg?auto=compress&w=600' },
  { id:'bw3', title:'Reiki & Energy Healing',          price:250, location:'Rabat',      image:'https://images.pexels.com/photos/3822621/pexels-photo-3822621.jpeg?auto=compress&w=600' },
  { id:'bw4', title:'Pilates Personal Training',       price:350, location:'Casablanca', image:'https://images.pexels.com/photos/3865560/pexels-photo-3865560.jpeg?auto=compress&w=600' },
  { id:'bw5', title:'Traditional Herbal Therapy',      price:290, location:'Fès',        image:'https://images.pexels.com/photos/3997379/pexels-photo-3997379.jpeg?auto=compress&w=600' },
]

const discoveryGrid = [
  { id:'dw1',  title:'Facial & Skin Care Specialist',    price:220, location:'Casablanca', image:'https://images.pexels.com/photos/3865560/pexels-photo-3865560.jpeg?auto=compress&w=600' },
  { id:'dw2',  title:'Thai Massage & Stretching',        price:300, location:'Rabat',      image:'https://images.pexels.com/photos/3997379/pexels-photo-3997379.jpeg?auto=compress&w=600' },
  { id:'dw3',  title:'Meditation & Breathwork Coach',    price:200, location:'Marrakech',  image:'https://images.pexels.com/photos/3822621/pexels-photo-3822621.jpeg?auto=compress&w=600' },
  { id:'dw4',  title:'Sports Recovery & Physiotherapy',  price:400, location:'Casablanca', image:'https://images.pexels.com/photos/3865560/pexels-photo-3865560.jpeg?auto=compress&w=600' },
  { id:'dw5',  title:'Moroccan Argan Facial',            price:180, location:'Agadir',     image:'https://images.pexels.com/photos/3997379/pexels-photo-3997379.jpeg?auto=compress&w=600' },
  { id:'dw6',  title:'Lymphatic Drainage Massage',       price:340, location:'Rabat',      image:'https://images.pexels.com/photos/3822621/pexels-photo-3822621.jpeg?auto=compress&w=600' },
  { id:'dw7',  title:'Couples Spa Package',              price:600, location:'Marrakech',  image:'https://images.pexels.com/photos/3865560/pexels-photo-3865560.jpeg?auto=compress&w=600' },
  { id:'dw8',  title:'Nail Art & Luxury Manicure',       price:150, location:'Casablanca', image:'https://images.pexels.com/photos/3997379/pexels-photo-3997379.jpeg?auto=compress&w=600' },
]

const pills = ['All Wellness','Hammam & Spa','Massage','Yoga & Pilates','Skincare','Meditation','Energy Healing','View More']
...
export default function WellnessSpaPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const [activePill, setActivePill] = useState('All Wellness')
    ...
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      ...
      <section style={{ position:'relative', height:'440px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          <h1 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'clamp(32px,5vw,52px)', color:'white', marginBottom:'12px', lineHeight:1.05 }}>
            Discover Premium Wellness &amp; Spa Near You!
          </h1>
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'32px' }}>421 verified hammams, spas &amp; wellness practitioners across Morocco</p>
          ...
          <div style={{ display:'flex', alignItems:'stretch', backgroundColor:'rgba(255,255,255,0.12)', backdropFilter:'blur(24px)', border:'1px solid rgba(255,255,255,0.25)', borderRadius:'100px', overflow:'hidden', maxWidth:'680px', margin:'0 auto', boxShadow:'0 8px 32px rgba(0,0,0,0.2)' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', padding:'14px 20px', flex:1, borderRight:'1px solid rgba(255,255,255,0.2)', gap:'2px' }}>
              ...
              <input value={keyword} onChange={e=>setKeyword(e.target.value)} placeholder="Hammam, massage, yoga, spa..."
                style={{ backgroundColor:'transparent', border:'none', outline:'none', fontSize:'14px', fontWeight:600, color:'white', fontFamily:'Inter, sans-serif', padding:0, width:'100%' }} />
            </div>
      ...
      <div style={{ maxWidth:'1440px', margin:'-28px auto 0', padding:'0 40px', position:'relative', zIndex:30 }}>
        <div style={{ backgroundColor:'rgba(255,255,255,0.9)', backdropFilter:'blur(20px)', borderRadius:'100px', padding:'10px 10px 10px 24px', boxShadow:'0 8px 40px rgba(0,0,0,0.12)', border:'1px solid rgba(255,255,255,0.6)', display:'flex', alignItems:'center' }}>
          {[
            { label:'City', val:'Marrakech' },
            { label:'Keyword', val:'What wellness service do you need?' },
      ...
      <div style={{ maxWidth:'1440px', margin:'32px auto 0', padding:'0 40px' }}>
        ...
        <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#161d1b', marginBottom:'4px' }}>Hammams, Spas &amp; Wellness Services in Rabat</h2>
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'16px' }}>421 Ads in Rabat District</p>
        ...
        {/* BENTO COLLECTION — 3+2 */}
        <section style={{ marginBottom:'40px' }}>
          <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'22px', color:'#22d4a8', marginBottom:'16px' }}>SouKni Wellness Collection</h2>
        ...
        <section style={{ marginBottom:'40px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'20px' }}>
            <h2 style={{ fontFamily:'Inter, sans-serif', fontWeight:900, letterSpacing:'-0.05em', fontSize:'20px', color:'#161d1b' }}>More Wellness &amp; Spa Services</h2>
        ...
        <section style={{ borderRadius:'40px', background:'linear-gradient(135deg,#22d4a8,#0f9b8e)', padding:'56px 48px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'40px', flexWrap:'wrap', marginBottom:'64px' }}>
          <div>
            ...
            <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.85)', maxWidth:'480px', lineHeight:1.7 }}>Offer your wellness expertise today for free and reach thousands of clients across Morocco.</p>
