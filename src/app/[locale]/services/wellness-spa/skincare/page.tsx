...
const topChoices = [
  { id:'t1', title:'Hydrafacial Treatment', price:250, location:'Rabat', rating:4.7, reviews:14, image:'https://images.pexels.com/photos/3757952/pexels-photo-3757952.jpeg?auto=compress&w=400', desc:'Facials, chemical peels, LED therapy and advanced skincare treatments. Certified on SouKni Morocco.' },
  { id:'t2', title:'Anti-Ageing Facial', price:430, location:'Casablanca', rating:4.8, reviews:25, image:'https://images.pexels.com/photos/3997989/pexels-photo-3997989.jpeg?auto=compress&w=400', desc:'Facials, chemical peels, LED therapy and advanced skincare treatments. Certified on SouKni Morocco.' },
  { id:'t3', title:'Chemical Peel Session', price:610, location:'Marrakech', rating:4.9, reviews:36, image:'https://images.pexels.com/photos/4056535/pexels-photo-4056535.jpeg?auto=compress&w=400', desc:'Facials, chemical peels, LED therapy and advanced skincare treatments. Certified on SouKni Morocco.' },
]
const bentoListings = [
  { id:'b1', title:'Microneedling Therapy', price:180, location:'Marrakech', image:'https://images.pexels.com/photos/3757952/pexels-photo-3757952.jpeg?auto=compress&w=400' },
  { id:'b2', title:'LED Light Therapy', price:320, location:'Tangier', image:'https://images.pexels.com/photos/3997989/pexels-photo-3997989.jpeg?auto=compress&w=400' },
  { id:'b3', title:'Oxygen Facial', price:460, location:'Agadir', image:'https://images.pexels.com/photos/4056535/pexels-photo-4056535.jpeg?auto=compress&w=400' },
  { id:'b4', title:'Collagen Boosting Treatment', price:600, location:'Fès', image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400' },
  { id:'b5', title:'Mens Skincare Facial', price:740, location:'Meknès', image:'https://images.pexels.com/photos/3822621/pexels-photo-3822621.jpeg?auto=compress&w=400' },
]
const discoveryGrid = [
  { id:'d1', title:'Hydrafacial Treatment', price:150, location:'Rabat', image:'https://images.pexels.com/photos/3757952/pexels-photo-3757952.jpeg?auto=compress&w=400' },
  { id:'d2', title:'Anti-Ageing Facial', price:260, location:'Casablanca', image:'https://images.pexels.com/photos/3997989/pexels-photo-3997989.jpeg?auto=compress&w=400' },
  { id:'d3', title:'Chemical Peel Session', price:370, location:'Marrakech', image:'https://images.pexels.com/photos/4056535/pexels-photo-4056535.jpeg?auto=compress&w=400' },
  { id:'d4', title:'Microneedling Therapy', price:480, location:'Tangier', image:'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=400' },
  { id:'d5', title:'LED Light Therapy', price:590, location:'Agadir', image:'https://images.pexels.com/photos/3822621/pexels-photo-3822621.jpeg?auto=compress&w=400' },
  { id:'d6', title:'Oxygen Facial', price:700, location:'Fès', image:'https://images.pexels.com/photos/3757952/pexels-photo-3757952.jpeg?auto=compress&w=400' },
  { id:'d7', title:'Collagen Boosting Treatment', price:810, location:'Meknès', image:'https://images.pexels.com/photos/3997989/pexels-photo-3997989.jpeg?auto=compress&w=400' },
  { id:'d8', title:'Mens Skincare Facial', price:920, location:'Kenitra', image:'https://images.pexels.com/photos/4056535/pexels-photo-4056535.jpeg?auto=compress&w=400' },
]
    ...
    <div style={{ fontFamily:'Inter, sans-serif', backgroundColor:'#f4fbf8', minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'400px', overflow:'hidden', display:'flex', alignItems:'center', justifyContent:'center' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center', padding:'0 20px', maxWidth:'760px', width:'100%' }}>
          ...
          <p style={{ fontSize:'15px', color:'rgba(255,255,255,0.82)', marginBottom:'28px' }}>Facials, chemical peels, LED therapy and advanced skincare treatments</p>
      ...
      <div style={{ maxWidth:'1440px', margin:'28px auto 0', padding:'0 40px 64px' }}>
        ...
        <p style={{ fontSize:'14px', color:'#6b7a76', marginBottom:'20px' }}>Facials, chemical peels, LED therapy and advanced skincare treatments</p>
