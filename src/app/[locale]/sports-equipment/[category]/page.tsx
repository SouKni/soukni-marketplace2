      ...
      <main style={{ maxWidth:'1280px', margin:'0 auto', padding:'32px 24px 80px' }}>
        <Breadcrumb
          items={[
            ...
            { label:'Sports Equipment', href:`/${locale}/sports-equipment` },
            { label:catData.label },
          ]}
          mutedColor={C.muted}
          inkColor={C.ink}
        ...
        <CategoryFooterNav
          relatedTitle="Explore Other Equipment Categories"
          related={ALL_CATS.filter(c=>c.slug!==catSlug).slice(0,8).map(cat=>({ label:cat.label, href:`/${locale}/sports-equipment/${cat.slug}` }))}
          backHref={`/${locale}/sports-equipment`}
          backLabel="Back to All Sports Equipment"
          inkColor={C.ink}
