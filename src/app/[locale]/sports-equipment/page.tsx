  ...
  return (
    <div style={{ fontFamily: 'Inter,system-ui,sans-serif', backgroundColor: '#f4fbf8', minHeight: '100vh' }}>
      ...
      <main style={{ maxWidth: '1440px', margin: '0 auto', padding: '32px 40px 80px' }}>
        ...
        {/* Breadcrumb */}
        <nav style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '13px', color: '#6b7a76', marginBottom: '24px', fontFamily: 'Inter,sans-serif' }}>
          ...
          <span style={{ color: '#bacac5' }}>›</span>
          <span style={{ color: '#3c4a46', fontWeight: 600 }}>Sports Equipment</span>
        </nav>
