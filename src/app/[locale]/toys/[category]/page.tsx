...
const CATEGORIES: Record<string,{ label:string; hero:string; desc:string; count:string; brands:string[]; priceRanges:string[]; ages:string[] }> = {
  'all-toys': {
    ...
    desc:'Browse the complete SouKni toys and games collection.',
    count:'3,482', ages:['0-2','3-5','6-8','9-12','13+','Adults'],
    brands:['LEGO','Nintendo','Playmobil','Hot Wheels','Barbie','Fisher-Price','Hasbro','Mattel'],
    priceRanges:['Any Price','0 – 200 MAD','200 – 600 MAD','600 – 1,500 MAD','1,500 – 4,000 MAD','4,000+ MAD'],
  },
  'building-lego': {
    label:'Building & LEGO',
    hero:'https://images.pexels.com/photos/163696/toy-car-toy-box-mini-163696.jpeg?auto=compress&w=1600',
    desc:'LEGO sets, building blocks, and construction toys for all ages.',
    count:'842', ages:['4-7','8-12','13-16','16+','Adults'],
    brands:['LEGO','Duplo','Mega Bloks','K\'Nex','Meccano','Playmobil','Cobi'],
    priceRanges:['Any Price','0 – 200 MAD','200 – 600 MAD','600 – 2,000 MAD','2,000 – 5,000 MAD','5,000+ MAD'],
  },
  'video-games': {
    label:'Video Games',
    hero:'https://images.pexels.com/photos/1350789/pexels-photo-1350789.jpeg?auto=compress&w=1600',
    desc:'Consoles, games, and accessories for every platform.',
    count:'612', ages:['7+','10+','13+','16+','18+','All Ages'],
    brands:['Nintendo','PlayStation','Xbox','Sega','Atari','Nintendo Switch','PS5','Xbox Series'],
    priceRanges:['Any Price','0 – 300 MAD','300 – 800 MAD','800 – 2,000 MAD','2,000 – 4,000 MAD','4,000+ MAD'],
  },
  'action-figures': {
    label:'Action Figures',
    hero:'https://images.pexels.com/photos/3661193/pexels-photo-3661193.jpeg?auto=compress&w=1600',
    desc:'Superhero figures, collector statues, and character toys.',
    count:'428', ages:['4-6','7-10','11-14','14+','Collectors'],
    brands:['Marvel Legends','DC Multiverse','Star Wars Black Series','GI Joe','Masters of Universe','Hot Toys','Neca'],
    priceRanges:['Any Price','0 – 150 MAD','150 – 500 MAD','500 – 1,500 MAD','1,500 – 5,000 MAD','5,000+ MAD'],
  },
  'dolls': {
    label:'Dolls & Plush',
    hero:'https://images.pexels.com/photos/1148998/pexels-photo-1148998.jpeg?auto=compress&w=1600',
    desc:'Fashion dolls, stuffed animals, and plush toys for every child.',
    count:'512', ages:['0-2','3-5','6-9','10+','Collectors'],
    brands:['Barbie','Bratz','L.O.L. Surprise','Baby Born','Jellycat','Steiff','Build-A-Bear','Ty'],
    priceRanges:['Any Price','0 – 100 MAD','100 – 400 MAD','400 – 1,000 MAD','1,000 – 3,000 MAD','3,000+ MAD'],
  },
  'outdoor': {
    label:'Outdoor & Sport',
    hero:'https://images.pexels.com/photos/163696/toy-car-toy-box-mini-163696.jpeg?auto=compress&w=1600',
    desc:'Bikes, scooters, sports equipment, and outdoor play sets.',
    count:'384', ages:['2-4','5-8','9-12','13+','All Ages'],
    brands:['Little Tikes','Step2','Schwinn','Razor','Franklin Sports','Nerf','Super Soaker','Radio Flyer'],
    priceRanges:['Any Price','0 – 200 MAD','200 – 600 MAD','600 – 2,000 MAD','2,000 – 5,000 MAD','5,000+ MAD'],
  },
  'board-games': {
    label:'Board Games',
    hero:'https://images.pexels.com/photos/3661193/pexels-photo-3661193.jpeg?auto=compress&w=1600',
    desc:'Classic board games, card games, puzzles, and strategy games.',
    count:'312', ages:['3-5','6-9','10-13','14+','Family','Adults'],
    brands:['Hasbro','Mattel','Ravensburger','Asmodee','Days of Wonder','Fantasy Flight','Catan','Ticket to Ride'],
    priceRanges:['Any Price','0 – 150 MAD','150 – 400 MAD','400 – 1,000 MAD','1,000+ MAD'],
  },
  'educational': {
    label:'Educational Toys',
    hero:'https://images.pexels.com/photos/1148998/pexels-photo-1148998.jpeg?auto=compress&w=1600',
    desc:'STEM toys, learning tablets, science kits, and educational games.',
    count:'392', ages:['0-2','3-5','6-8','9-12','13+'],
    brands:['VTech','LeapFrog','Fisher-Price','Melissa & Doug','Thames & Kosmos','National Geographic','Osmo'],
    priceRanges:['Any Price','0 – 150 MAD','150 – 500 MAD','500 – 1,500 MAD','1,500+ MAD'],
  },
}
...
const IMGS = [
  'https://images.pexels.com/photos/163696/toy-car-toy-box-mini-163696.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/1350789/pexels-photo-1350789.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/3661193/pexels-photo-3661193.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/1148998/pexels-photo-1148998.jpeg?auto=compress&w=400',
  'https://images.pexels.com/photos/163696/toy-car-toy-box-mini-163696.jpeg?auto=compress&w=400',
]
  ...
  return (
    <article onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)}
      ...
      <div style={{ position:'relative', aspectRatio:'1/1', overflow:'hidden', backgroundColor:C.cream }}>
        ...
        {age && <div style={{ position:'absolute', bottom:'10px', right:'10px', zIndex:10, backgroundColor:'rgba(22,29,27,0.75)', color:'white', fontSize:'9px', ...CB, padding:'3px 8px', borderRadius:'5px' }}>Ages {age}</div>}
      ...
      <div style={{ padding:'16px 18px', flex:1, display:'flex', flexDirection:'column' as const }}>
        ...
        <div style={{ marginTop:'auto', display:'flex', gap:'8px' }}>
          ...
          >Message</button>
          <a href="https://wa.me/212600000000?text=Hi%2C%20I%20found%20your%20toy%20listing%20on%20SouKni!" target="_blank" rel="noopener noreferrer"
...
function makeListings(cat: string, count: number) {
  const titleMap: Record<string,string[]> = {
    'all-toys':      ['Millennium Falcon','Switch OLED','City Hospital','Ultimate Garage','Dreamhouse','Baby Piano'],
    'building-lego': ['Technic Bugatti 42151','City Police Station','Architecture Big Ben','Star Wars AT-AT','Creator Expert','Duplo Farm','Ninjago City','Ideas Piano'],
    'video-games':   ['Mario Kart 8 Deluxe','Zelda Tears of Kingdom','FIFA 25','Spider-Man 2','Hogwarts Legacy','God of War Ragnarok','Minecraft','Among Us'],
    'action-figures':['Iron Man Mark 85','Batman 12"','Darth Vader Black Series','Captain America','Thanos Infinity War','Spider-Man Miles','Thor Ragnarok','Black Widow'],
    'dolls':         ['Barbie Fashionista','LOL Surprise OMG','Baby Born Interactive','Jellycat Bunny XL','Steiff Bear Limited','Bratz Original','Monster High Draculaura'],
    'outdoor':       ['Trek Bikes 20"','Razor E300 Scooter','Little Tikes Slide','Nerf Ultra Dorado','Super Soaker Soakzooka','Razor Dirt Rocket','Schwinn Gremlin'],
    'board-games':   ['Monopoly Classic','Catan Base Game','Ticket to Ride Europe','Codenames','Pandemic','Dixit','7 Wonders','Azul'],
    'educational':   ['VTech InnoTab','LeapPad Platinum','Osmo Genius Kit','Thames & Kosmos','National Geo Microscope','Coding Starter Kit','Math Learning Tablet'],
  }
  const cat_data = CATEGORIES[cat] || CATEGORIES['all-toys']
  const titles = titleMap[cat] || titleMap['all-toys']
  ...
  const conds = ['New Sealed','Like New','Excellent','Good',undefined,undefined]
  return Array.from({length:count},(_,i)=>({
    brand:     cat_data.brands[i%cat_data.brands.length],
    title:     titles[i%titles.length],
    price:     120 + ((i*1373)%4500),
...
export default function ToysCategoryPage() {
  ...
  const catSlug  = (params?.category as string) || 'all-toys'
  const catData  = CATEGORIES[catSlug] || CATEGORIES['all-toys']
  ...
  useEffect(() => {
    const t = setTimeout(() => {
      fetchListings({ category: 'toys', sortBy: 'newest', limit: 24 }).then(rows => setDbListings(rows || []))
    }, 400)
    ...
    <div style={{ ...UB, backgroundColor:C.surface, color:C.ink, minHeight:'100vh' }}>
      <section style={{ position:'relative', height:'360px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:10, textAlign:'center' as const, maxWidth:'860px', padding:'0 24px', width:'100%' }}>
          <p style={{ fontSize:'11px', ...UB, color:C.mint, textTransform:'uppercase' as const, letterSpacing:'0.2em', marginBottom:'12px' }}>THE VAULT › TOYS & GAMES</p>
        ...
        <div style={{ backgroundColor:'white', borderRadius:'20px', padding:'20px 24px', marginBottom:'16px', border:'1px solid rgba(107,122,118,0.1)' }}>
          ...
          <div style={{ display:'flex', gap:'8px', flexWrap:'wrap' as const }}>
            <button onClick={()=>setActiveAge('All Ages')}
              style={{ padding:'7px 16px', borderRadius:'100px', fontSize:'10px', ...UB, border:`1px solid`, cursor:'pointer', transition:'all 0.15s', backgroundColor:activeAge==='All Ages'?C.mint:'transparent', color:activeAge==='All Ages'?C.ink:C.muted, borderColor:activeAge==='All Ages'?C.mint:'rgba(107,122,118,0.2)' }}>All Ages</button>
            {catData.ages.map(age=>(
              <button key={age} onClick={()=>setActiveAge(age)}
                style={{ padding:'7px 16px', borderRadius:'100px', fontSize:'10px', ...UB, border:`1px solid`, cursor:'pointer', transition:'all 0.15s', backgroundColor:activeAge===age?C.mint:'transparent', color:activeAge===age?C.ink:C.muted, borderColor:activeAge===age?C.mint:'rgba(107,122,118,0.2)' }}
